...
namespace MiddleFaceCell62

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0062`, spanning `[102621/100000, 102631/100000]`. -/
def brick : Brick where
  lamLo := 102621 / 100000
  lamHi := 102631 / 100000
  centers := ![985740555372659221 / 5000000000000000000,
    598642863600987793 / 2000000000000000000,
    907068227415786873 / 2000000000000000000,
    1258729938744861579 / 2500000000000000000]
  slopes := ![105342221247721569 / 62500000000000000,
    2124276474406295587 / 500000000000000000,
    2515949329866526629 / 500000000000000000,
    3110733981533079151 / 500000000000000000]
  yXiSlope := 64726913 / 100000000
  vRhoSlope := 11060757 / 12500000
...
/-- Unconditional real-range conclusion for the B0062 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102621 / 100000 : ℝ) ≤ lam → lam ≤ 102631 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19705 / 100000 : ℝ) ≤ q ∧ q ≤ 19725 / 100000) :
    (195777 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (195974 / 1000000 : ℝ) := by
  have hmonoLo : sin (19705 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19725 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19705 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19725 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19705 / 100000 : ℝ) ≤ q ∧ q ≤ 19725 / 100000) :
    (980609 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980649 / 1000000 : ℝ) := by
  have hmonoLo : cos (19725 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19705 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19725 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19705 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29910 / 100000 : ℝ) ≤ q ∧ q ≤ 29955 / 100000) :
    (294660 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (295091 / 1000000 : ℝ) := by
  have hmonoLo : sin (29910 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29955 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29910 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29955 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29910 / 100000 : ℝ) ≤ q ∧ q ≤ 29955 / 100000) :
    (955469 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (955603 / 1000000 : ℝ) := by
  have hmonoLo : cos (29955 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29910 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29955 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29910 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45327 / 100000 : ℝ) ≤ q ∧ q ≤ 45380 / 100000) :
    (437907 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (438385 / 1000000 : ℝ) := by
  have hmonoLo : sin (45327 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45380 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45327 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45380 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50317 / 100000 : ℝ) ≤ q ∧ q ≤ 50382 / 100000) :
    (482205 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (482775 / 1000000 : ℝ) := by
  have hmonoLo : sin (50317 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50382 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50317 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50382 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50317 / 100000 : ℝ) ≤ q ∧ q ≤ 50382 / 100000) :
    (875744 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (876059 / 1000000 : ℝ) := by
  have hmonoLo : cos (50382 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50317 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50382 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50317 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19705000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19725000 / 100000000) :
    (19577700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19597400 / 100000000 : ℝ) ∧
      (98060900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98064900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19705000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19725000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19725000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19705000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29910000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29955000 / 100000000) :
    (29466000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29509100 / 100000000 : ℝ) ∧
      (95546900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95560300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29910000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29955000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29955000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29910000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45327000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45380000 / 100000000) :
    (43790700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43838500 / 100000000 : ℝ) ∧
      (89878700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89902000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45327000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45380000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45380000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45327000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50317000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50382000 / 100000000) :
    (48220500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48277500 / 100000000 : ℝ) ∧
      (87574400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87605900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50317000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50382000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50382000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50317000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0062. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102621 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102631 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19705000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19725000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29910000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29955000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45327000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45380000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50317000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50382000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0062 brick. -/
...
throughout the B0062 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102621 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102631 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19705 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19725 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29910 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45327 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45380 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50317 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50382 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980649 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19705 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19705 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (898787 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45380 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45380 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (482775 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50382 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50382 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (437907 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45327 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45327 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102631 / 100000 : ℝ) * (50382 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102621 / 100000 : ℝ) * (29910 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16252 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16804 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980649 / 1000000 : ℝ) * (16252 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189878 / 100000 : ℝ) * (16804 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189878 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29910 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29955 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102621 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102631 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102621 / 100000 : ℝ) * (294660 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102631 / 100000 : ℝ) * (295091 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19705 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19725 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29910 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29955 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102621 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102631 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19705 / 100000, 19725 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29910 / 100000, 29955 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102621 / 100000, 102631 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨195777 / 1000000, 195974 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980609 / 1000000, 980649 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨294660 / 1000000, 295091 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨955469 / 1000000, 955603 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0062 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0062 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102631 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102621 / 100000 : ℝ) * (482205 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102631 / 100000 : ℝ) * (482775 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50317 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50382 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50317 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50382 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102621 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0062`.
...
/-- Sound projection of the B0062 checker instance into the generic
...
/-- Every projected type-(iv) height in B0062 has an equal-area regular
...
/-- Candidate-facing conclusion for B0062.  No stationarity hypothesis is
...
/-- Complete B0062 candidate-facing conclusion.  The checked stationary pair
