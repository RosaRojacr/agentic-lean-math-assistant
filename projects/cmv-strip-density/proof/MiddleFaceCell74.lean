...
namespace MiddleFaceCell74

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0074`, spanning `[102741/100000, 102751/100000]`. -/
def brick : Brick where
  lamLo := 102741 / 100000
  lamHi := 102751 / 100000
  centers := ![398250636610259959 / 2000000000000000000,
    760874489655888087 / 2500000000000000000,
    4594694476630319789 / 10000000000000000000,
    5108409862377652451 / 10000000000000000000]
  slopes := ![805425312686245971 / 500000000000000000,
    1033354653663145619 / 250000000000000000,
    4862454593937042811 / 1000000000000000000,
    1507305855800479313 / 250000000000000000]
  yXiSlope := 64245133 / 100000000
  vRhoSlope := 4414099 / 5000000
...
/-- Unconditional real-range conclusion for the B0074 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102741 / 100000 : ℝ) ≤ lam → lam ≤ 102751 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19903 / 100000 : ℝ) ≤ q ∧ q ≤ 19922 / 100000) :
    (197718 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (197905 / 1000000 : ℝ) := by
  have hmonoLo : sin (19903 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19922 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19903 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19922 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19903 / 100000 : ℝ) ≤ q ∧ q ≤ 19922 / 100000) :
    (980221 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980259 / 1000000 : ℝ) := by
  have hmonoLo : cos (19922 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19903 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19922 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19903 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30413 / 100000 : ℝ) ≤ q ∧ q ≤ 30457 / 100000) :
    (299463 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (299883 / 1000000 : ℝ) := by
  have hmonoLo : sin (30413 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30457 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30413 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30457 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30413 / 100000 : ℝ) ≤ q ∧ q ≤ 30457 / 100000) :
    (953975 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954108 / 1000000 : ℝ) := by
  have hmonoLo : cos (30457 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30413 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30457 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30413 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45921 / 100000 : ℝ) ≤ q ∧ q ≤ 45973 / 100000) :
    (443240 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (443707 / 1000000 : ℝ) := by
  have hmonoLo : sin (45921 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45973 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45921 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45973 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51052 / 100000 : ℝ) ≤ q ∧ q ≤ 51116 / 100000) :
    (488631 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (489190 / 1000000 : ℝ) := by
  have hmonoLo : sin (51052 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51116 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51052 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51116 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51052 / 100000 : ℝ) ≤ q ∧ q ≤ 51116 / 100000) :
    (872177 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (872491 / 1000000 : ℝ) := by
  have hmonoLo : cos (51116 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51052 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51116 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51052 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19903000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19922000 / 100000000) :
    (19771800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19790500 / 100000000 : ℝ) ∧
      (98022100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98025900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19903000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19922000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19922000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19903000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30413000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30457000 / 100000000) :
    (29946300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29988300 / 100000000 : ℝ) ∧
      (95397500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95410800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30413000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30457000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30457000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30413000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45921000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45973000 / 100000000) :
    (44324000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44370700 / 100000000 : ℝ) ∧
      (89617200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89640300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45921000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45973000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45973000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45921000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51052000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51116000 / 100000000) :
    (48863100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48919000 / 100000000 : ℝ) ∧
      (87217700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87249100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51052000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51116000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51116000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51052000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0074. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102741 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102751 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19903000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19922000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30413000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30457000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45921000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45973000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51052000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51116000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0074 brick. -/
...
throughout the B0074 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102741 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102751 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19903 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19922 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30413 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45921 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45973 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51052 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51116 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980259 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19903 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19903 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (896172 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45973 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45973 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (489190 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51116 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51116 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (443240 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45921 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45921 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102751 / 100000 : ℝ) * (51116 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102741 / 100000 : ℝ) * (30413 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16268 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16840 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980259 / 1000000 : ℝ) * (16268 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189617 / 100000 : ℝ) * (16840 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189617 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30413 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30457 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102741 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102751 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102741 / 100000 : ℝ) * (299463 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102751 / 100000 : ℝ) * (299883 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19903 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19922 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30413 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30457 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102741 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102751 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19903 / 100000, 19922 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30413 / 100000, 30457 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102741 / 100000, 102751 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨197718 / 1000000, 197905 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980221 / 1000000, 980259 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨299463 / 1000000, 299883 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953975 / 1000000, 954108 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0074 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0074 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102751 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102741 / 100000 : ℝ) * (488631 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102751 / 100000 : ℝ) * (489190 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51052 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51116 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51052 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51116 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102741 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0074`.
...
/-- Sound projection of the B0074 checker instance into the generic
...
/-- Every projected type-(iv) height in B0074 has an equal-area regular
...
/-- Candidate-facing conclusion for B0074.  No stationarity hypothesis is
...
/-- Complete B0074 candidate-facing conclusion.  The checked stationary pair
