...
namespace MiddleFaceCell45

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0045`, spanning `[102451/100000, 102461/100000]`. -/
def brick : Brick where
  lamLo := 102451 / 100000
  lamHi := 102461 / 100000
  centers := ![970927719335037679 / 5000000000000000000,
    2919499846014175323 / 10000000000000000000,
    4447597952412005773 / 10000000000000000000,
    4926663659312009157 / 10000000000000000000]
  slopes := ![225274775917743193 / 125000000000000000,
    4426918473084309851 / 1000000000000000000,
    132395363236908863 / 25000000000000000,
    6520009024444676253 / 1000000000000000000]
  yXiSlope := 32718647 / 50000000
  vRhoSlope := 3551359 / 4000000
...
/-- Unconditional real-range conclusion for the B0045 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102451 / 100000 : ℝ) ≤ lam → lam ≤ 102461 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19408 / 100000 : ℝ) ≤ q ∧ q ≤ 19429 / 100000) :
    (192863 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (193070 / 1000000 : ℝ) := by
  have hmonoLo : sin (19408 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19429 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19408 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19429 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19408 / 100000 : ℝ) ≤ q ∧ q ≤ 19429 / 100000) :
    (981184 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981226 / 1000000 : ℝ) := by
  have hmonoLo : cos (19429 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19408 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19429 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19408 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29172 / 100000 : ℝ) ≤ q ∧ q ≤ 29218 / 100000) :
    (287599 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (288041 / 1000000 : ℝ) := by
  have hmonoLo : sin (29172 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29218 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29172 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29218 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29172 / 100000 : ℝ) ≤ q ∧ q ≤ 29218 / 100000) :
    (957618 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957751 / 1000000 : ℝ) := by
  have hmonoLo : cos (29218 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29172 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29218 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29172 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44448 / 100000 : ℝ) ≤ q ∧ q ≤ 44504 / 100000) :
    (429988 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (430494 / 1000000 : ℝ) := by
  have hmonoLo : sin (44448 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44504 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44448 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44504 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49233 / 100000 : ℝ) ≤ q ∧ q ≤ 49301 / 100000) :
    (472680 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (473280 / 1000000 : ℝ) := by
  have hmonoLo : sin (49233 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49301 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49233 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49301 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49233 / 100000 : ℝ) ≤ q ∧ q ≤ 49301 / 100000) :
    (880912 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (881234 / 1000000 : ℝ) := by
  have hmonoLo : cos (49301 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49233 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49301 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49233 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19408000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19429000 / 100000000) :
    (19286300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19307000 / 100000000 : ℝ) ∧
      (98118400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98122600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19408000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19429000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19429000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19408000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29172000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29218000 / 100000000) :
    (28759900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28804100 / 100000000 : ℝ) ∧
      (95761800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95775100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29172000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29218000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29218000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29172000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44448000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44504000 / 100000000) :
    (42998800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43049400 / 100000000 : ℝ) ∧
      (90259300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90283500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44448000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44504000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44504000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44448000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49233000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49301000 / 100000000) :
    (47268000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47328000 / 100000000 : ℝ) ∧
      (88091200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88123400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49233000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49301000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49301000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49233000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0045. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102451 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102461 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19408000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19429000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29172000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29218000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44448000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44504000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49233000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49301000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0045 brick. -/
...
throughout the B0045 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102451 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102461 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19408 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19429 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29172 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44448 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44504 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49233 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49301 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981226 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19408 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19408 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (902593 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44504 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44504 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (473280 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49301 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49301 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (429988 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44448 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44448 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102461 / 100000 : ℝ) * (49301 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102451 / 100000 : ℝ) * (29172 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16228 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16753 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981226 / 1000000 : ℝ) * (16228 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190259 / 100000 : ℝ) * (16753 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190259 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29172 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29218 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102451 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102461 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102451 / 100000 : ℝ) * (287599 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102461 / 100000 : ℝ) * (288041 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19408 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19429 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29172 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29218 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102451 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102461 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19408 / 100000, 19429 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29172 / 100000, 29218 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102451 / 100000, 102461 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨192863 / 1000000, 193070 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981184 / 1000000, 981226 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨287599 / 1000000, 288041 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957618 / 1000000, 957751 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0045 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0045 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102461 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102451 / 100000 : ℝ) * (472680 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102461 / 100000 : ℝ) * (473280 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49233 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49301 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49233 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49301 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102451 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0045`.
...
/-- Sound projection of the B0045 checker instance into the generic
...
/-- Every projected type-(iv) height in B0045 has an equal-area regular
...
/-- Candidate-facing conclusion for B0045.  No stationarity hypothesis is
...
/-- Complete B0045 candidate-facing conclusion.  The checked stationary pair
