...
namespace MiddleFaceCell17

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0017`, spanning `[102171/100000, 102181/100000]`. -/
def brick : Brick where
  lamLo := 102171 / 100000
  lamHi := 102181 / 100000
  centers := ![236041120036673519 / 1250000000000000000,
    2790919311863333247 / 10000000000000000000,
    2146210734655122449 / 5000000000000000000,
    4736334833395369883 / 10000000000000000000]
  slopes := ![1014600522583828733 / 500000000000000000,
    2384228744345211427 / 500000000000000000,
    580566945628650283 / 100000000000000000,
    4433731582053469 / 625000000000000]
  yXiSlope := 66688377 / 100000000
  vRhoSlope := 89300201 / 100000000
...
/-- Unconditional real-range conclusion for the B0017 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102171 / 100000 : ℝ) ≤ lam → lam ≤ 102181 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18872 / 100000 : ℝ) ≤ q ∧ q ≤ 18895 / 100000) :
    (187601 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (187828 / 1000000 : ℝ) := by
  have hmonoLo : sin (18872 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18895 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18872 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18895 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18872 / 100000 : ℝ) ≤ q ∧ q ≤ 18895 / 100000) :
    (982201 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982246 / 1000000 : ℝ) := by
  have hmonoLo : cos (18895 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18872 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18895 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18872 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27884 / 100000 : ℝ) ≤ q ∧ q ≤ 27934 / 100000) :
    (275240 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (275722 / 1000000 : ℝ) := by
  have hmonoLo : sin (27884 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27934 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27884 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27934 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27884 / 100000 : ℝ) ≤ q ∧ q ≤ 27934 / 100000) :
    (961237 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961376 / 1000000 : ℝ) := by
  have hmonoLo : cos (27934 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27884 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27934 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27884 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42894 / 100000 : ℝ) ≤ q ∧ q ≤ 42955 / 100000) :
    (415907 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (416462 / 1000000 : ℝ) := by
  have hmonoLo : sin (42894 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42955 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42894 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42955 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47326 / 100000 : ℝ) ≤ q ∧ q ≤ 47400 / 100000) :
    (455790 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (456449 / 1000000 : ℝ) := by
  have hmonoLo : sin (47326 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47400 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47326 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47400 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47326 / 100000 : ℝ) ≤ q ∧ q ≤ 47400 / 100000) :
    (889749 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (890088 / 1000000 : ℝ) := by
  have hmonoLo : cos (47400 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47326 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47400 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47326 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18872000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18895000 / 100000000) :
    (18760100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18782800 / 100000000 : ℝ) ∧
      (98220100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98224600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18872000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18895000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18895000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18872000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27884000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27934000 / 100000000) :
    (27524000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27572200 / 100000000 : ℝ) ∧
      (96123700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96137600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27884000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27934000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27934000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27884000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42894000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42955000 / 100000000) :
    (41590700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41646200 / 100000000 : ℝ) ∧
      (90915300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90940800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42894000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42955000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42955000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42894000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47326000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47400000 / 100000000) :
    (45579000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45644900 / 100000000 : ℝ) ∧
      (88974900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89008800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47326000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47400000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47400000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47326000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0017. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102171 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102181 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18872000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18895000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27884000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27934000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42894000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42955000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47326000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47400000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0017 brick. -/
...
B0017 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0017 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102171 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102181 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18872 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18895 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27884 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42894 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42955 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47326 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47400 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982246 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18872 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18872 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (909153 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42955 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42955 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (456449 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47400 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47400 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (415907 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42894 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42894 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102181 / 100000 : ℝ) * (47400 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102171 / 100000 : ℝ) * (27884 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16188 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16667 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982246 / 1000000 : ℝ) * (16188 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190915 / 100000 : ℝ) * (16667 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190915 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27884 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27934 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102171 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102181 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102171 / 100000 : ℝ) * (275240 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102181 / 100000 : ℝ) * (275722 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18872 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18895 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27884 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27934 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102171 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102181 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18872 / 100000, 18895 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27884 / 100000, 27934 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102171 / 100000, 102181 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨187601 / 1000000, 187828 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982201 / 1000000, 982246 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨275240 / 1000000, 275722 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961237 / 1000000, 961376 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0017 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0017 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102181 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102171 / 100000 : ℝ) * (455790 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102181 / 100000 : ℝ) * (456449 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47326 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47400 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47326 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47400 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102171 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0017`.
...
/-- Sound projection of the B0017 checker instance into the generic
...
/-- Every projected type-(iv) height in B0017 has an equal-area regular
...
/-- Candidate-facing conclusion for B0017.  No stationarity hypothesis is
...
/-- Complete B0017 candidate-facing conclusion.  The checked stationary pair
