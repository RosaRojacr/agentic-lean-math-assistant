...
namespace MiddleFaceCell1

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0001`, spanning `[102011/100000, 102021/100000]`. -/
def brick : Brick where
  lamLo := 102011 / 100000
  lamHi := 102021 / 100000
  centers := ![1854653989960542853 / 10000000000000000000,
    1356415533656163899 / 5000000000000000000,
    2098416632355537239 / 5000000000000000000,
    4619807386656918461 / 10000000000000000000]
  slopes := ![1091808971094555759 / 500000000000000000,
    2498619664087603829 / 500000000000000000,
    6150277577946194091 / 1000000000000000000,
    7480040094373674411 / 1000000000000000000]
  yXiSlope := 33727901 / 50000000
  vRhoSlope := 89611669 / 100000000
...
/-- Unconditional real-range conclusion for the B0001 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102011 / 100000 : ℝ) ≤ lam → lam ≤ 102021 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18534 / 100000 : ℝ) ≤ q ∧ q ≤ 18559 / 100000) :
    (184280 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (184527 / 1000000 : ℝ) := by
  have hmonoLo : sin (18534 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18559 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18534 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18559 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18534 / 100000 : ℝ) ≤ q ∧ q ≤ 18559 / 100000) :
    (982827 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982874 / 1000000 : ℝ) := by
  have hmonoLo : cos (18559 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18534 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18559 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18534 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27102 / 100000 : ℝ) ≤ q ∧ q ≤ 27155 / 100000) :
    (267714 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (268225 / 1000000 : ℝ) := by
  have hmonoLo : sin (27102 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27155 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27102 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27155 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27102 / 100000 : ℝ) ≤ q ∧ q ≤ 27155 / 100000) :
    (963356 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (963499 / 1000000 : ℝ) := by
  have hmonoLo : cos (27155 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27102 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27155 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27102 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (41936 / 100000 : ℝ) ≤ q ∧ q ≤ 42001 / 100000) :
    (407175 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (407770 / 1000000 : ℝ) := by
  have hmonoLo : sin (41936 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42001 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (41936 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42001 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46159 / 100000 : ℝ) ≤ q ∧ q ≤ 46237 / 100000) :
    (445372 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (446071 / 1000000 : ℝ) := by
  have hmonoLo : sin (46159 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46237 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46159 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46237 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46159 / 100000 : ℝ) ≤ q ∧ q ≤ 46237 / 100000) :
    (894997 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (895346 / 1000000 : ℝ) := by
  have hmonoLo : cos (46237 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46159 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46237 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46159 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18534000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18559000 / 100000000) :
    (18428000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18452700 / 100000000 : ℝ) ∧
      (98282700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98287400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18534000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18559000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18559000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18534000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27102000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27155000 / 100000000) :
    (26771400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (26822500 / 100000000 : ℝ) ∧
      (96335600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96349900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27102000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27155000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27155000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27102000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (41936000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42001000 / 100000000) :
    (40717500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (40777000 / 100000000 : ℝ) ∧
      (91308400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91335000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (41936000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42001000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42001000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (41936000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46159000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46237000 / 100000000) :
    (44537200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44607100 / 100000000 : ℝ) ∧
      (89499700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89534600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46159000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46237000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46237000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46159000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0001. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102011 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102021 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18534000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18559000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27102000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27155000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (41936000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42001000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46159000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46237000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0001 brick. -/
...
B0001 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0001 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102011 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102021 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18534 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18559 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27102 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (41936 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42001 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46159 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46237 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982874 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18534 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18534 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (913084 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42001 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42001 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (446071 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46237 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46237 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (407175 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (41936 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (41936 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102021 / 100000 : ℝ) * (46237 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102011 / 100000 : ℝ) * (27102 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16165 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16616 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982874 / 1000000 : ℝ) * (16165 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191308 / 100000 : ℝ) * (16616 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191308 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27102 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27155 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102011 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102021 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102011 / 100000 : ℝ) * (267714 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102021 / 100000 : ℝ) * (268225 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18534 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18559 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27102 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27155 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102011 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102021 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18534 / 100000, 18559 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27102 / 100000, 27155 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102011 / 100000, 102021 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨184280 / 1000000, 184527 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982827 / 1000000, 982874 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨267714 / 1000000, 268225 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨963356 / 1000000, 963499 / 1000000, by norm_num⟩
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102021 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102011 / 100000 : ℝ) * (445372 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102021 / 100000 : ℝ) * (446071 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46159 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46237 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46159 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46237 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102011 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0001`.
...
/-- Sound projection of the B0001 checker instance into the generic
...
/-- Every projected type-(iv) height in B0001 has an equal-area regular
...
/-- Candidate-facing conclusion for B0001.  No stationarity hypothesis is
...
/-- Complete B0001 candidate-facing conclusion.  The checked stationary pair
