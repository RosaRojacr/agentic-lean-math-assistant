...
namespace MiddleFaceCell85

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0085`, spanning `[102851/100000, 102861/100000]`. -/
def brick : Brick where
  lamLo := 102851 / 100000
  lamHi := 102861 / 100000
  centers := ![502154834622386593 / 2500000000000000000,
    193026075464870671 / 625000000000000000,
    4647377249440055733 / 10000000000000000000,
    5173817113956407371 / 10000000000000000000]
  slopes := ![1547365900182780361 / 1000000000000000000,
    504342954033895841 / 125000000000000000,
    2358913730182280181 / 500000000000000000,
    5864760612550426959 / 1000000000000000000]
  yXiSlope := 63816643 / 100000000
  vRhoSlope := 22024769 / 25000000
...
/-- Unconditional real-range conclusion for the B0085 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102851 / 100000 : ℝ) ≤ lam → lam ≤ 102861 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20077 / 100000 : ℝ) ≤ q ∧ q ≤ 20095 / 100000) :
    (199423 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (199601 / 1000000 : ℝ) := by
  have hmonoLo : sin (20077 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20095 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20077 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20095 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20077 / 100000 : ℝ) ≤ q ∧ q ≤ 20095 / 100000) :
    (979877 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979914 / 1000000 : ℝ) := by
  have hmonoLo : cos (20095 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20077 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20095 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20077 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30863 / 100000 : ℝ) ≤ q ∧ q ≤ 30906 / 100000) :
    (303753 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (304164 / 1000000 : ℝ) := by
  have hmonoLo : sin (30863 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30906 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30863 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30906 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30863 / 100000 : ℝ) ≤ q ∧ q ≤ 30906 / 100000) :
    (952619 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952751 / 1000000 : ℝ) := by
  have hmonoLo : cos (30906 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30863 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30906 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30863 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46449 / 100000 : ℝ) ≤ q ∧ q ≤ 46499 / 100000) :
    (447966 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (448414 / 1000000 : ℝ) := by
  have hmonoLo : sin (46449 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46499 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46449 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46499 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51707 / 100000 : ℝ) ≤ q ∧ q ≤ 51769 / 100000) :
    (494335 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (494875 / 1000000 : ℝ) := by
  have hmonoLo : sin (51707 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51769 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51707 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51769 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51707 / 100000 : ℝ) ≤ q ∧ q ≤ 51769 / 100000) :
    (868964 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (869272 / 1000000 : ℝ) := by
  have hmonoLo : cos (51769 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51707 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51769 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51707 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20077000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20095000 / 100000000) :
    (19942300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19960100 / 100000000 : ℝ) ∧
      (97987700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97991400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20077000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20095000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20095000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20077000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30863000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30906000 / 100000000) :
    (30375300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30416400 / 100000000 : ℝ) ∧
      (95261900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95275100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30863000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30906000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30906000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30863000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46449000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46499000 / 100000000) :
    (44796600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44841400 / 100000000 : ℝ) ∧
      (89382600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89405100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46449000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46499000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46499000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46449000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51707000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51769000 / 100000000) :
    (49433500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49487500 / 100000000 : ℝ) ∧
      (86896400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86927200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51707000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51769000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51769000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51707000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0085. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102851 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102861 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20077000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20095000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30863000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30906000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46449000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46499000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51707000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51769000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0085 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 259 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (259 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0085 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102851 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102861 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20077 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20095 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30863 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46449 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46499 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51707 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51769 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979914 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20077 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20077 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (893826 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46499 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46499 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (494875 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51769 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51769 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (447966 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46449 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46449 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102861 / 100000 : ℝ) * (51769 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102851 / 100000 : ℝ) * (30863 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16283 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16872 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979914 / 1000000 : ℝ) * (16283 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189382 / 100000 : ℝ) * (16872 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189382 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30863 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30906 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102851 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102861 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102851 / 100000 : ℝ) * (303753 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102861 / 100000 : ℝ) * (304164 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20077 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20095 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30863 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30906 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102851 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102861 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20077 / 100000, 20095 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30863 / 100000, 30906 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102851 / 100000, 102861 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨199423 / 1000000, 199601 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979877 / 1000000, 979914 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨303753 / 1000000, 304164 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952619 / 1000000, 952751 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0085 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0085 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102861 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102851 / 100000 : ℝ) * (494335 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102861 / 100000 : ℝ) * (494875 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51707 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51769 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51707 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51769 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102851 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0085`.
...
/-- Sound projection of the B0085 checker instance into the generic
...
/-- Every projected type-(iv) height in B0085 has an equal-area regular
...
/-- Candidate-facing conclusion for B0085.  No stationarity hypothesis is
...
/-- Complete B0085 candidate-facing conclusion.  The checked stationary pair
