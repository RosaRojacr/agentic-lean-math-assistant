...
namespace MiddleFaceCell66

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0066`, spanning `[102661/100000, 102671/100000]`. -/
def brick : Brick where
  lamLo := 102661 / 100000
  lamHi := 102671 / 100000
  centers := ![989085861463413343 / 5000000000000000000,
    752532407901452417 / 2500000000000000000,
    1138838106250138447 / 2500000000000000000,
    5059673790453170591 / 10000000000000000000]
  slopes := ![1659937693268485711 / 1000000000000000000,
    526156585864162033 / 125000000000000000,
    24869889265884789 / 5000000000000000,
    6155805124463266263 / 1000000000000000000]
  yXiSlope := 4035287 / 6250000
  vRhoSlope := 22104371 / 25000000
...
/-- Unconditional real-range conclusion for the B0066 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102661 / 100000 : ℝ) ≤ lam → lam ≤ 102671 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19772 / 100000 : ℝ) ≤ q ∧ q ≤ 19792 / 100000) :
    (196434 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (196631 / 1000000 : ℝ) := by
  have hmonoLo : sin (19772 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19792 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19772 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19792 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19772 / 100000 : ℝ) ≤ q ∧ q ≤ 19792 / 100000) :
    (980477 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980517 / 1000000 : ℝ) := by
  have hmonoLo : cos (19792 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19772 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19792 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19772 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30079 / 100000 : ℝ) ≤ q ∧ q ≤ 30124 / 100000) :
    (296274 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (296705 / 1000000 : ℝ) := by
  have hmonoLo : sin (30079 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30124 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30079 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30124 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30079 / 100000 : ℝ) ≤ q ∧ q ≤ 30124 / 100000) :
    (954969 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (955103 / 1000000 : ℝ) := by
  have hmonoLo : cos (30124 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30079 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30124 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30079 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45527 / 100000 : ℝ) ≤ q ∧ q ≤ 45580 / 100000) :
    (439704 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (440181 / 1000000 : ℝ) := by
  have hmonoLo : sin (45527 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45580 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45527 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45580 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50564 / 100000 : ℝ) ≤ q ∧ q ≤ 50629 / 100000) :
    (484367 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (484937 / 1000000 : ℝ) := by
  have hmonoLo : sin (50564 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50629 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50564 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50629 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50564 / 100000 : ℝ) ≤ q ∧ q ≤ 50629 / 100000) :
    (874549 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (874865 / 1000000 : ℝ) := by
  have hmonoLo : cos (50629 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50564 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50629 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50564 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19772000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19792000 / 100000000) :
    (19643400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19663100 / 100000000 : ℝ) ∧
      (98047700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98051700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19772000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19792000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19792000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19772000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30079000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30124000 / 100000000) :
    (29627400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29670500 / 100000000 : ℝ) ∧
      (95496900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95510300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30079000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30124000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30124000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30079000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45527000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45580000 / 100000000) :
    (43970400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44018100 / 100000000 : ℝ) ∧
      (89790900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89814300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45527000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45580000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45580000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45527000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50564000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50629000 / 100000000) :
    (48436700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48493700 / 100000000 : ℝ) ∧
      (87454900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87486500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50564000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50629000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50629000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50564000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0066. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102661 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102671 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19772000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19792000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30079000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30124000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45527000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45580000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50564000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50629000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0066 brick. -/
...
throughout the B0066 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102661 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102671 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19772 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19792 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30079 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45527 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45580 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50564 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50629 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980517 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19772 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19772 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (897909 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45580 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45580 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (484937 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50629 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50629 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (439704 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45527 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45527 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102671 / 100000 : ℝ) * (50629 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102661 / 100000 : ℝ) * (30079 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16257 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16816 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980517 / 1000000 : ℝ) * (16257 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189790 / 100000 : ℝ) * (16816 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189790 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30079 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30124 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102661 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102671 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102661 / 100000 : ℝ) * (296274 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102671 / 100000 : ℝ) * (296705 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19772 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19792 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30079 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30124 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102661 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102671 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19772 / 100000, 19792 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30079 / 100000, 30124 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102661 / 100000, 102671 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨196434 / 1000000, 196631 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980477 / 1000000, 980517 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨296274 / 1000000, 296705 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954969 / 1000000, 955103 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0066 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0066 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102671 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102661 / 100000 : ℝ) * (484367 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102671 / 100000 : ℝ) * (484937 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50564 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50629 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50564 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50629 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102661 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0066`.
...
/-- Sound projection of the B0066 checker instance into the generic
...
/-- Every projected type-(iv) height in B0066 has an equal-area regular
...
/-- Candidate-facing conclusion for B0066.  No stationarity hypothesis is
...
/-- Complete B0066 candidate-facing conclusion.  The checked stationary pair
