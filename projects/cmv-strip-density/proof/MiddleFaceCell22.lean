...
namespace MiddleFaceCell22

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0022`, spanning `[102221/100000, 102231/100000]`. -/
def brick : Brick where
  lamLo := 102221 / 100000
  lamHi := 102231 / 100000
  centers := ![474590923814204883 / 2500000000000000000,
    562919113276915833 / 2000000000000000000,
    4321200768536306977 / 10000000000000000000,
    119288126237986423 / 250000000000000000]
  slopes := ![1984976517937964869 / 1000000000000000000,
    2351215086214981387 / 500000000000000000,
    1426665416491544181 / 250000000000000000,
    6982782739112149949 / 1000000000000000000]
  yXiSlope := 33228423 / 50000000
  vRhoSlope := 17841093 / 20000000
...
/-- Unconditional real-range conclusion for the B0022 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102221 / 100000 : ℝ) ≤ lam → lam ≤ 102231 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18972 / 100000 : ℝ) ≤ q ∧ q ≤ 18995 / 100000) :
    (188583 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (188810 / 1000000 : ℝ) := by
  have hmonoLo : sin (18972 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18995 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18972 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18995 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18972 / 100000 : ℝ) ≤ q ∧ q ≤ 18995 / 100000) :
    (982013 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982058 / 1000000 : ℝ) := by
  have hmonoLo : cos (18995 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18972 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18995 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18972 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28121 / 100000 : ℝ) ≤ q ∧ q ≤ 28171 / 100000) :
    (277518 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (277999 / 1000000 : ℝ) := by
  have hmonoLo : sin (28121 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28171 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28121 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28171 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28121 / 100000 : ℝ) ≤ q ∧ q ≤ 28171 / 100000) :
    (960581 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960721 / 1000000 : ℝ) := by
  have hmonoLo : cos (28171 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28121 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28171 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28121 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43182 / 100000 : ℝ) ≤ q ∧ q ≤ 43242 / 100000) :
    (418524 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (419070 / 1000000 : ℝ) := by
  have hmonoLo : sin (43182 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43242 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43182 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43242 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47679 / 100000 : ℝ) ≤ q ∧ q ≤ 47752 / 100000) :
    (458929 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (459579 / 1000000 : ℝ) := by
  have hmonoLo : sin (47679 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47752 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47679 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47752 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47679 / 100000 : ℝ) ≤ q ∧ q ≤ 47752 / 100000) :
    (888137 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (888473 / 1000000 : ℝ) := by
  have hmonoLo : cos (47752 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47679 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47752 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47679 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18972000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18995000 / 100000000) :
    (18858300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18881000 / 100000000 : ℝ) ∧
      (98201300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98205800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18972000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18995000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18995000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18972000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28121000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28171000 / 100000000) :
    (27751800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27799900 / 100000000 : ℝ) ∧
      (96058100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96072100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28121000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28171000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28171000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28121000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43182000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43242000 / 100000000) :
    (41852400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41907000 / 100000000 : ℝ) ∧
      (90795400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90820600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43182000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43242000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43242000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43182000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47679000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47752000 / 100000000) :
    (45892900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45957900 / 100000000 : ℝ) ∧
      (88813700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88847300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47679000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47752000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47752000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47679000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0022. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102221 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102231 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18972000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18995000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28121000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28171000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43182000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43242000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47679000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47752000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0022 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 239 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
...
throughout the B0022 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102221 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102231 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18972 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18995 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28121 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43182 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43242 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47679 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47752 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982058 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18972 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18972 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (907954 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43242 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43242 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (459579 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47752 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47752 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (418524 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43182 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43182 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102231 / 100000 : ℝ) * (47752 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102221 / 100000 : ℝ) * (28121 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16196 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16683 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982058 / 1000000 : ℝ) * (16196 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190795 / 100000 : ℝ) * (16683 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190795 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28121 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28171 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102221 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102231 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102221 / 100000 : ℝ) * (277518 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102231 / 100000 : ℝ) * (277999 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18972 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18995 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28121 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28171 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102221 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102231 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18972 / 100000, 18995 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28121 / 100000, 28171 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102221 / 100000, 102231 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨188583 / 1000000, 188810 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982013 / 1000000, 982058 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨277518 / 1000000, 277999 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960581 / 1000000, 960721 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0022 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0022 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102231 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102221 / 100000 : ℝ) * (458929 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102231 / 100000 : ℝ) * (459579 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47679 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47752 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47679 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47752 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102221 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0022`.
...
/-- Sound projection of the B0022 checker instance into the generic
...
/-- Every projected type-(iv) height in B0022 has an equal-area regular
...
/-- Candidate-facing conclusion for B0022.  No stationarity hypothesis is
...
/-- Complete B0022 candidate-facing conclusion.  The checked stationary pair
