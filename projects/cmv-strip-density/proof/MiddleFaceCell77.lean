...
namespace MiddleFaceCell77

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0077`, spanning `[102771/100000, 102781/100000]`. -/
def brick : Brick where
  lamLo := 102771 / 100000
  lamHi := 102781 / 100000
  centers := ![249507377735447421 / 1250000000000000000,
    763964202557729559 / 2500000000000000000,
    230461053044266653 / 500000000000000000,
    5126428476640821133 / 10000000000000000000]
  slopes := ![99568299386974819 / 62500000000000000,
    410588679822163103 / 100000000000000000,
    4822045486176158227 / 1000000000000000000,
    2991653852704461281 / 500000000000000000]
  yXiSlope := 8015883 / 12500000
  vRhoSlope := 44115857 / 50000000
...
/-- Unconditional real-range conclusion for the B0077 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102771 / 100000 : ℝ) ≤ lam → lam ≤ 102781 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19951 / 100000 : ℝ) ≤ q ∧ q ≤ 19970 / 100000) :
    (198189 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198376 / 1000000 : ℝ) := by
  have hmonoLo : sin (19951 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19970 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19951 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19970 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19951 / 100000 : ℝ) ≤ q ∧ q ≤ 19970 / 100000) :
    (980126 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980164 / 1000000 : ℝ) := by
  have hmonoLo : cos (19970 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19951 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19970 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19951 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30537 / 100000 : ℝ) ≤ q ∧ q ≤ 30580 / 100000) :
    (300646 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (301057 / 1000000 : ℝ) := by
  have hmonoLo : sin (30537 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30580 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30537 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30580 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30537 / 100000 : ℝ) ≤ q ∧ q ≤ 30580 / 100000) :
    (953606 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953736 / 1000000 : ℝ) := by
  have hmonoLo : cos (30580 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30537 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30580 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30537 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46067 / 100000 : ℝ) ≤ q ∧ q ≤ 46118 / 100000) :
    (444548 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (445006 / 1000000 : ℝ) := by
  have hmonoLo : sin (46067 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46118 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46067 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46118 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51233 / 100000 : ℝ) ≤ q ∧ q ≤ 51296 / 100000) :
    (490209 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (490759 / 1000000 : ℝ) := by
  have hmonoLo : sin (51233 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51296 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51233 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51296 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51233 / 100000 : ℝ) ≤ q ∧ q ≤ 51296 / 100000) :
    (871295 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (871605 / 1000000 : ℝ) := by
  have hmonoLo : cos (51296 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51233 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51296 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51233 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19951000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19970000 / 100000000) :
    (19818900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19837600 / 100000000 : ℝ) ∧
      (98012600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98016400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19951000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19970000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19970000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19951000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30537000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30580000 / 100000000) :
    (30064600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30105700 / 100000000 : ℝ) ∧
      (95360600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95373600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30537000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30580000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30580000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30537000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46067000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46118000 / 100000000) :
    (44454800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44500600 / 100000000 : ℝ) ∧
      (89552800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89575500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46067000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46118000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46118000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46067000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51233000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51296000 / 100000000) :
    (49020900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49075900 / 100000000 : ℝ) ∧
      (87129500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87160500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51233000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51296000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51296000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51233000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0077. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102771 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102781 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19951000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19970000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30537000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30580000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46067000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46118000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51233000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51296000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0077 brick. -/
...
throughout the B0077 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102771 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102781 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19951 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19970 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30537 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46067 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46118 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51233 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51296 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980164 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19951 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19951 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (895528 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46118 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46118 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (490759 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51296 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51296 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (444548 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46067 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46067 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102781 / 100000 : ℝ) * (51296 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102771 / 100000 : ℝ) * (30537 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16272 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16849 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980164 / 1000000 : ℝ) * (16272 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189552 / 100000 : ℝ) * (16849 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189552 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30537 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30580 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102771 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102781 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102771 / 100000 : ℝ) * (300646 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102781 / 100000 : ℝ) * (301057 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19951 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19970 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30537 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30580 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102771 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102781 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19951 / 100000, 19970 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30537 / 100000, 30580 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102771 / 100000, 102781 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198189 / 1000000, 198376 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980126 / 1000000, 980164 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨300646 / 1000000, 301057 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953606 / 1000000, 953736 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0077 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0077 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102781 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102771 / 100000 : ℝ) * (490209 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102781 / 100000 : ℝ) * (490759 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51233 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51296 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51233 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51296 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102771 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0077`.
...
/-- Sound projection of the B0077 checker instance into the generic
...
/-- Every projected type-(iv) height in B0077 has an equal-area regular
...
/-- Candidate-facing conclusion for B0077.  No stationarity hypothesis is
...
/-- Complete B0077 candidate-facing conclusion.  The checked stationary pair
