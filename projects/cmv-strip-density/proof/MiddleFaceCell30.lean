...
namespace MiddleFaceCell30

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0030`, spanning `[102301/100000, 102311/100000]`. -/
def brick : Brick where
  lamLo := 102301 / 100000
  lamHi := 102311 / 100000
  centers := ![191397185258685363 / 1000000000000000000,
    285180794057774827 / 1000000000000000000,
    4366244963581292249 / 10000000000000000000,
    603337812091256117 / 1250000000000000000]
  slopes := ![239718808141758203 / 125000000000000000,
    230080099574104403 / 50000000000000000,
    5555871229130031609 / 1000000000000000000,
    6813199310676367363 / 1000000000000000000]
  yXiSlope := 16523503 / 25000000
  vRhoSlope := 44528139 / 50000000
...
/-- Unconditional real-range conclusion for the B0030 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102301 / 100000 : ℝ) ≤ lam → lam ≤ 102311 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19129 / 100000 : ℝ) ≤ q ∧ q ≤ 19151 / 100000) :
    (190125 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (190342 / 1000000 : ℝ) := by
  have hmonoLo : sin (19129 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19151 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19129 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19151 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19129 / 100000 : ℝ) ≤ q ∧ q ≤ 19151 / 100000) :
    (981717 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981760 / 1000000 : ℝ) := by
  have hmonoLo : cos (19151 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19129 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19151 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19129 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28494 / 100000 : ℝ) ≤ q ∧ q ≤ 28542 / 100000) :
    (281099 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (281561 / 1000000 : ℝ) := by
  have hmonoLo : sin (28494 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28542 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28494 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28542 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28494 / 100000 : ℝ) ≤ q ∧ q ≤ 28542 / 100000) :
    (959543 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (959679 / 1000000 : ℝ) := by
  have hmonoLo : cos (28542 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28494 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28542 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28494 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43633 / 100000 : ℝ) ≤ q ∧ q ≤ 43692 / 100000) :
    (422616 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (423151 / 1000000 : ℝ) := by
  have hmonoLo : sin (43633 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43692 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43633 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43692 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48231 / 100000 : ℝ) ≤ q ∧ q ≤ 48303 / 100000) :
    (463826 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (464465 / 1000000 : ℝ) := by
  have hmonoLo : sin (48231 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48303 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48231 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48303 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48231 / 100000 : ℝ) ≤ q ∧ q ≤ 48303 / 100000) :
    (885591 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (885926 / 1000000 : ℝ) := by
  have hmonoLo : cos (48303 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48231 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48303 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48231 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19129000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19151000 / 100000000) :
    (19012500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19034200 / 100000000 : ℝ) ∧
      (98171700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98176000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19129000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19151000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19151000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19129000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28494000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28542000 / 100000000) :
    (28109900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28156100 / 100000000 : ℝ) ∧
      (95954300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95967900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28494000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28542000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28542000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28494000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43633000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43692000 / 100000000) :
    (42261600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42315100 / 100000000 : ℝ) ∧
      (90605900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90630900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43633000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43692000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43692000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43633000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48231000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48303000 / 100000000) :
    (46382600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46446500 / 100000000 : ℝ) ∧
      (88559100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88592600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48231000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48303000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48303000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48231000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0030. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102301 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102311 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19129000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19151000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28494000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28542000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43633000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43692000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48231000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48303000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0030 brick. -/
...
throughout the B0030 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102301 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102311 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19129 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19151 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28494 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43633 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43692 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48231 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48303 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981760 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19129 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19129 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (906059 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43692 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43692 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (464465 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48303 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48303 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (422616 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43633 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43633 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102311 / 100000 : ℝ) * (48303 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102301 / 100000 : ℝ) * (28494 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16207 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16707 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981760 / 1000000 : ℝ) * (16207 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190605 / 100000 : ℝ) * (16707 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190605 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28494 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28542 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102301 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102311 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102301 / 100000 : ℝ) * (281099 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102311 / 100000 : ℝ) * (281561 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19129 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19151 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28494 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28542 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102301 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102311 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19129 / 100000, 19151 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28494 / 100000, 28542 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102301 / 100000, 102311 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨190125 / 1000000, 190342 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981717 / 1000000, 981760 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨281099 / 1000000, 281561 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨959543 / 1000000, 959679 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0030 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0030 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102311 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102301 / 100000 : ℝ) * (463826 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102311 / 100000 : ℝ) * (464465 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48231 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48303 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48231 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48303 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102301 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0030`.
...
/-- Sound projection of the B0030 checker instance into the generic
...
/-- Every projected type-(iv) height in B0030 has an equal-area regular
...
/-- Candidate-facing conclusion for B0030.  No stationarity hypothesis is
...
/-- Complete B0030 candidate-facing conclusion.  The checked stationary pair
