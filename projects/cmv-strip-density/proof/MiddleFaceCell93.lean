...
namespace MiddleFaceCell93

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0093`, spanning `[102931/100000, 102941/100000]`. -/
def brick : Brick where
  lamLo := 102931 / 100000
  lamHi := 102941 / 100000
  centers := ![2020822859155054403 / 10000000000000000000,
    1560210547460501789 / 5000000000000000000,
    292794957829839703 / 625000000000000000,
    1044055798298734919 / 2000000000000000000]
  slopes := ![375966443035712401 / 250000000000000000,
    991680451438073227 / 250000000000000000,
    4618457186465310057 / 1000000000000000000,
    718944067093200247 / 125000000000000000]
  yXiSlope := 63512431 / 100000000
  vRhoSlope := 8796841 / 10000000
...
/-- Unconditional real-range conclusion for the B0093 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102931 / 100000 : ℝ) ≤ lam → lam ≤ 102941 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20199 / 100000 : ℝ) ≤ q ∧ q ≤ 20217 / 100000) :
    (200619 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200796 / 1000000 : ℝ) := by
  have hmonoLo : sin (20199 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20217 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20199 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20217 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20199 / 100000 : ℝ) ≤ q ∧ q ≤ 20217 / 100000) :
    (979633 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979670 / 1000000 : ℝ) := by
  have hmonoLo : cos (20217 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20199 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20217 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20199 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31183 / 100000 : ℝ) ≤ q ∧ q ≤ 31225 / 100000) :
    (306800 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (307201 / 1000000 : ℝ) := by
  have hmonoLo : sin (31183 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31225 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31183 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31225 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31183 / 100000 : ℝ) ≤ q ∧ q ≤ 31225 / 100000) :
    (951644 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951774 / 1000000 : ℝ) := by
  have hmonoLo : cos (31225 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31183 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31225 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31183 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46823 / 100000 : ℝ) ≤ q ∧ q ≤ 46872 / 100000) :
    (451307 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (451745 / 1000000 : ℝ) := by
  have hmonoLo : sin (46823 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46872 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46823 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46872 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52173 / 100000 : ℝ) ≤ q ∧ q ≤ 52233 / 100000) :
    (498380 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (498901 / 1000000 : ℝ) := by
  have hmonoLo : sin (52173 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52233 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52173 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52233 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52173 / 100000 : ℝ) ≤ q ∧ q ≤ 52233 / 100000) :
    (866659 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (866959 / 1000000 : ℝ) := by
  have hmonoLo : cos (52233 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52173 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52233 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52173 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20199000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20217000 / 100000000) :
    (20061900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20079600 / 100000000 : ℝ) ∧
      (97963300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97967000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20199000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20217000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20217000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20199000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31183000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31225000 / 100000000) :
    (30680000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30720100 / 100000000 : ℝ) ∧
      (95164400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95177400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31183000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31225000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31225000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31183000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46823000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46872000 / 100000000) :
    (45130700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45174500 / 100000000 : ℝ) ∧
      (89214700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89236900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46823000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46872000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46872000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46823000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52173000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52233000 / 100000000) :
    (49838000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49890100 / 100000000 : ℝ) ∧
      (86665900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86695900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52173000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52233000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52233000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52173000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0093. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102931 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102941 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20199000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20217000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31183000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31225000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46823000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46872000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52173000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52233000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0093 brick. -/
...
throughout the B0093 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102931 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102941 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20199 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20217 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31183 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46823 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46872 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52173 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52233 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979670 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20199 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20199 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (892147 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46872 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46872 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (498901 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52233 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52233 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (451307 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46823 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46823 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102941 / 100000 : ℝ) * (52233 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102931 / 100000 : ℝ) * (31183 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16294 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16895 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979670 / 1000000 : ℝ) * (16294 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189214 / 100000 : ℝ) * (16895 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189214 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31183 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31225 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102931 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102941 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102931 / 100000 : ℝ) * (306800 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102941 / 100000 : ℝ) * (307201 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20199 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20217 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31183 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31225 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102931 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102941 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20199 / 100000, 20217 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31183 / 100000, 31225 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102931 / 100000, 102941 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200619 / 1000000, 200796 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979633 / 1000000, 979670 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨306800 / 1000000, 307201 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951644 / 1000000, 951774 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0093 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0093 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102941 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102931 / 100000 : ℝ) * (498380 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102941 / 100000 : ℝ) * (498901 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52173 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52233 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52173 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52233 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102931 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0093`.
...
/-- Sound projection of the B0093 checker instance into the generic
...
/-- Every projected type-(iv) height in B0093 has an equal-area regular
...
/-- Candidate-facing conclusion for B0093.  No stationarity hypothesis is
...
/-- Complete B0093 candidate-facing conclusion.  The checked stationary pair
