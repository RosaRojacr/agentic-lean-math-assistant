...
namespace MiddleFaceCell55

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0055`, spanning `[102551/100000, 102561/100000]`. -/
def brick : Brick where
  lamLo := 102551 / 100000
  lamHi := 102561 / 100000
  centers := ![391904334769416389 / 2000000000000000000,
    2963227226735293937 / 10000000000000000000,
    44997529080161347 / 100000000000000000,
    4990956127370203931 / 10000000000000000000]
  slopes := ![1731869611834345911 / 1000000000000000000,
    2159845342506435019 / 500000000000000000,
    5136954434362159417 / 1000000000000000000,
    1268086532110302241 / 200000000000000000]
  yXiSlope := 65015303 / 100000000
  vRhoSlope := 88607427 / 100000000
...
/-- Unconditional real-range conclusion for the B0055 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102551 / 100000 : ℝ) ≤ lam → lam ≤ 102561 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19585 / 100000 : ℝ) ≤ q ∧ q ≤ 19605 / 100000) :
    (194600 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (194797 / 1000000 : ℝ) := by
  have hmonoLo : sin (19585 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19605 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19585 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19605 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19585 / 100000 : ℝ) ≤ q ∧ q ≤ 19605 / 100000) :
    (980843 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980883 / 1000000 : ℝ) := by
  have hmonoLo : cos (19605 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19585 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19605 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19585 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29609 / 100000 : ℝ) ≤ q ∧ q ≤ 29655 / 100000) :
    (291782 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (292223 / 1000000 : ℝ) := by
  have hmonoLo : sin (29609 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29655 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29609 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29655 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29609 / 100000 : ℝ) ≤ q ∧ q ≤ 29655 / 100000) :
    (956350 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956485 / 1000000 : ℝ) := by
  have hmonoLo : cos (29655 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29609 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29655 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29609 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44970 / 100000 : ℝ) ≤ q ∧ q ≤ 45025 / 100000) :
    (434695 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (435191 / 1000000 : ℝ) := by
  have hmonoLo : sin (44970 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45025 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44970 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45025 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49876 / 100000 : ℝ) ≤ q ∧ q ≤ 49943 / 100000) :
    (478336 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (478926 / 1000000 : ℝ) := by
  have hmonoLo : sin (49876 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49943 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49876 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49943 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49876 / 100000 : ℝ) ≤ q ∧ q ≤ 49943 / 100000) :
    (877855 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (878177 / 1000000 : ℝ) := by
  have hmonoLo : cos (49943 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49876 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49943 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49876 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19585000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19605000 / 100000000) :
    (19460000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19479700 / 100000000 : ℝ) ∧
      (98084300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98088300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19585000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19605000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19605000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19585000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29609000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29655000 / 100000000) :
    (29178200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29222300 / 100000000 : ℝ) ∧
      (95635000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95648500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29609000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29655000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29655000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29609000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44970000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45025000 / 100000000) :
    (43469500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43519100 / 100000000 : ℝ) ∧
      (90033800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90057800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44970000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45025000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45025000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44970000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49876000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49943000 / 100000000) :
    (47833600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47892600 / 100000000 : ℝ) ∧
      (87785500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87817700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49876000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49943000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49943000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49876000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0055. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102551 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102561 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19585000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19605000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29609000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29655000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44970000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45025000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49876000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49943000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0055 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 1 / 2, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (1 / 2)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0055 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102551 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102561 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19585 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19605 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29609 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44970 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45025 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49876 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49943 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980883 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19585 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19585 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (900338 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45025 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45025 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (478926 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49943 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49943 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (434695 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44970 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44970 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102561 / 100000 : ℝ) * (49943 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102551 / 100000 : ℝ) * (29609 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16242 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16783 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980883 / 1000000 : ℝ) * (16242 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190033 / 100000 : ℝ) * (16783 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190033 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29609 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29655 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102551 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102561 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102551 / 100000 : ℝ) * (291782 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102561 / 100000 : ℝ) * (292223 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19585 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19605 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29609 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29655 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102551 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102561 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19585 / 100000, 19605 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29609 / 100000, 29655 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102551 / 100000, 102561 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨194600 / 1000000, 194797 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980843 / 1000000, 980883 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨291782 / 1000000, 292223 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956350 / 1000000, 956485 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0055 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0055 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102561 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102551 / 100000 : ℝ) * (478336 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102561 / 100000 : ℝ) * (478926 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49876 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49943 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49876 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49943 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102551 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0055`.
...
/-- Sound projection of the B0055 checker instance into the generic
...
/-- Every projected type-(iv) height in B0055 has an equal-area regular
...
/-- Candidate-facing conclusion for B0055.  No stationarity hypothesis is
...
/-- Complete B0055 candidate-facing conclusion.  The checked stationary pair
