...
namespace MiddleFaceCell102

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0102`, spanning `[103021/100000, 103031/100000]`. -/
def brick : Brick where
  lamLo := 103021 / 100000
  lamHi := 103031 / 100000
  centers := ![10170733233543983 / 50000000000000000,
    126231607532225343 / 400000000000000000,
    4725802460726978083 / 10000000000000000000,
    658936498696584821 / 1250000000000000000]
  slopes := ![1457388267939834901 / 1000000000000000000,
    3893657792912516693 / 1000000000000000000,
    2256013900627638933 / 500000000000000000,
    2815052956443616079 / 500000000000000000]
  yXiSlope := 63177263 / 100000000
  vRhoSlope := 4391183 / 5000000
...
/-- Unconditional real-range conclusion for the B0102 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103021 / 100000 : ℝ) ≤ lam → lam ≤ 103031 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20333 / 100000 : ℝ) ≤ q ∧ q ≤ 20350 / 100000) :
    (201931 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202099 / 1000000 : ℝ) := by
  have hmonoLo : sin (20333 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20350 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20333 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20350 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20333 / 100000 : ℝ) ≤ q ∧ q ≤ 20350 / 100000) :
    (979365 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979400 / 1000000 : ℝ) := by
  have hmonoLo : cos (20350 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20333 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20350 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20333 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31537 / 100000 : ℝ) ≤ q ∧ q ≤ 31579 / 100000) :
    (310168 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (310568 / 1000000 : ℝ) := by
  have hmonoLo : sin (31537 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31579 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31537 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31579 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31537 / 100000 : ℝ) ≤ q ∧ q ≤ 31579 / 100000) :
    (950551 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950682 / 1000000 : ℝ) := by
  have hmonoLo : cos (31579 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31537 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31579 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31537 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47234 / 100000 : ℝ) ≤ q ∧ q ≤ 47282 / 100000) :
    (454971 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (455399 / 1000000 : ℝ) := by
  have hmonoLo : sin (47234 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47282 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47234 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47282 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52685 / 100000 : ℝ) ≤ q ∧ q ≤ 52745 / 100000) :
    (502812 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (503332 / 1000000 : ℝ) := by
  have hmonoLo : sin (52685 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52745 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52685 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52745 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52685 / 100000 : ℝ) ≤ q ∧ q ≤ 52745 / 100000) :
    (864093 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (864396 / 1000000 : ℝ) := by
  have hmonoLo : cos (52745 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52685 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52745 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52685 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20333000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20350000 / 100000000) :
    (20193100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20209900 / 100000000 : ℝ) ∧
      (97936500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97940000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20333000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20350000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20350000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20333000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31537000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31579000 / 100000000) :
    (31016800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31056800 / 100000000 : ℝ) ∧
      (95055100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95068200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31537000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31579000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31579000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31537000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47234000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47282000 / 100000000) :
    (45497100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45539900 / 100000000 : ℝ) ∧
      (89028700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89050700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47234000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47282000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47282000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47234000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52685000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52745000 / 100000000) :
    (50281200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50333200 / 100000000 : ℝ) ∧
      (86409300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86439600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52685000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52745000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52745000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52685000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0102. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103021 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103031 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20333000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20350000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31537000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31579000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47234000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47282000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52685000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52745000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0102 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 66 / 125, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (66 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0102 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103021 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103031 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20333 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20350 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31537 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47234 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47282 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52685 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52745 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979400 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20333 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20333 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (890287 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47282 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47282 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (503332 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52745 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52745 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (454971 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47234 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47234 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103031 / 100000 : ℝ) * (52745 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103021 / 100000 : ℝ) * (31537 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16306 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16921 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979400 / 1000000 : ℝ) * (16306 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189028 / 100000 : ℝ) * (16921 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189028 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31537 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31579 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103021 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103031 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103021 / 100000 : ℝ) * (310168 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103031 / 100000 : ℝ) * (310568 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20333 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20350 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31537 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31579 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103021 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103031 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20333 / 100000, 20350 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31537 / 100000, 31579 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103021 / 100000, 103031 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201931 / 1000000, 202099 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979365 / 1000000, 979400 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨310168 / 1000000, 310568 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950551 / 1000000, 950682 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0102 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0102 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103031 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103021 / 100000 : ℝ) * (502812 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103031 / 100000 : ℝ) * (503332 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52685 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52745 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52685 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52745 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103021 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0102`.
...
/-- Sound projection of the B0102 checker instance into the generic
...
/-- Every projected type-(iv) height in B0102 has an equal-area regular
...
/-- Candidate-facing conclusion for B0102.  No stationarity hypothesis is
...
/-- Complete B0102 candidate-facing conclusion.  The checked stationary pair
