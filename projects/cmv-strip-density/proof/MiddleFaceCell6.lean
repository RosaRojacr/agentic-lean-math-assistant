...
namespace MiddleFaceCell6

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0006`, spanning `[102061/100000, 102071/100000]`. -/
def brick : Brick where
  lamLo := 102061 / 100000
  lamHi := 102071 / 100000
  centers := ![186544492098981939 / 1000000000000000000,
    2737629710053524869 / 10000000000000000000,
    4227301395034036033 / 10000000000000000000,
    4656890696976767979 / 10000000000000000000]
  slopes := ![1066551456105323449 / 500000000000000000,
    4922688082234354813 / 1000000000000000000,
    6037723977132513757 / 1000000000000000000,
    1838524804584339857 / 250000000000000000]
  yXiSlope := 16802863 / 25000000
  vRhoSlope := 44756459 / 50000000
...
/-- Unconditional real-range conclusion for the B0006 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102061 / 100000 : ℝ) ≤ lam → lam ≤ 102071 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18642 / 100000 : ℝ) ≤ q ∧ q ≤ 18667 / 100000) :
    (185342 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (185588 / 1000000 : ℝ) := by
  have hmonoLo : sin (18642 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18667 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18642 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18667 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18642 / 100000 : ℝ) ≤ q ∧ q ≤ 18667 / 100000) :
    (982627 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982675 / 1000000 : ℝ) := by
  have hmonoLo : cos (18667 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18642 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18667 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18642 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27350 / 100000 : ℝ) ≤ q ∧ q ≤ 27402 / 100000) :
    (270102 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (270604 / 1000000 : ℝ) := by
  have hmonoLo : sin (27350 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27402 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27350 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27402 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27350 / 100000 : ℝ) ≤ q ∧ q ≤ 27402 / 100000) :
    (962690 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962832 / 1000000 : ℝ) := by
  have hmonoLo : cos (27402 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27350 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27402 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27350 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42241 / 100000 : ℝ) ≤ q ∧ q ≤ 42305 / 100000) :
    (409959 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (410544 / 1000000 : ℝ) := by
  have hmonoLo : sin (42241 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42305 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42241 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42305 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46531 / 100000 : ℝ) ≤ q ∧ q ≤ 46607 / 100000) :
    (448699 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (449379 / 1000000 : ℝ) := by
  have hmonoLo : sin (46531 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46607 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46531 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46607 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46531 / 100000 : ℝ) ≤ q ∧ q ≤ 46607 / 100000) :
    (893341 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (893683 / 1000000 : ℝ) := by
  have hmonoLo : cos (46607 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46531 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46607 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46531 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18642000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18667000 / 100000000) :
    (18534200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18558800 / 100000000 : ℝ) ∧
      (98262700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98267500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18642000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18667000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18667000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18642000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27350000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27402000 / 100000000) :
    (27010200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27060400 / 100000000 : ℝ) ∧
      (96269000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96283200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27350000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27402000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27402000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27350000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42241000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42305000 / 100000000) :
    (40995900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41054400 / 100000000 : ℝ) ∧
      (91184100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91210400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42241000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42305000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42305000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42241000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46531000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46607000 / 100000000) :
    (44869900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44937900 / 100000000 : ℝ) ∧
      (89334100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89368300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46531000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46607000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46607000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46531000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0006. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102061 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102071 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18642000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18667000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27350000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27402000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42241000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42305000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46531000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46607000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0006 brick. -/
...
B0006 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvHi : v p ≤ (47 / 100 : ℝ) := by
    ...
    linarith
  have hwI :
      (⟨2 / 5, 53 / 125, by norm_num⟩ : QInterval).RealContains (w p) := by
  ...
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (53 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (53 / 125)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0006 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102061 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102071 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18642 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18667 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27350 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42241 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42305 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46531 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46607 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982675 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18642 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18642 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (911841 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42305 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42305 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (449379 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46607 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46607 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (409959 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42241 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42241 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102071 / 100000 : ℝ) * (46607 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102061 / 100000 : ℝ) * (27350 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16172 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16632 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982675 / 1000000 : ℝ) * (16172 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191184 / 100000 : ℝ) * (16632 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191184 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27350 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27402 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102061 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102071 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102061 / 100000 : ℝ) * (270102 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102071 / 100000 : ℝ) * (270604 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18642 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18667 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27350 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27402 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102061 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102071 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18642 / 100000, 18667 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27350 / 100000, 27402 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102061 / 100000, 102071 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨185342 / 1000000, 185588 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982627 / 1000000, 982675 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨270102 / 1000000, 270604 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962690 / 1000000, 962832 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0006 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0006 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102071 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102061 / 100000 : ℝ) * (448699 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102071 / 100000 : ℝ) * (449379 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46531 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46607 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46531 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46607 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102061 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0006`.
...
/-- Sound projection of the B0006 checker instance into the generic
...
/-- Every projected type-(iv) height in B0006 has an equal-area regular
...
/-- Candidate-facing conclusion for B0006.  No stationarity hypothesis is
...
/-- Complete B0006 candidate-facing conclusion.  The checked stationary pair
