...
namespace MiddleFaceCell8

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0008`, spanning `[102081/100000, 102091/100000]`. -/
def brick : Brick where
  lamLo := 102081 / 100000
  lamHi := 102091 / 100000
  centers := ![373938295401730681 / 2000000000000000000,
    2747446016979078867 / 10000000000000000000,
    2119666509040052087 / 5000000000000000000,
    1167887455218537207 / 2500000000000000000]
  slopes := ![84539787292742653 / 40000000000000000,
    4893675061516659463 / 1000000000000000000,
    749248567331999509 / 125000000000000000,
    3652561027998333051 / 500000000000000000]
  yXiSlope := 33557447 / 50000000
  vRhoSlope := 89473787 / 100000000
...
/-- Unconditional real-range conclusion for the B0008 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102081 / 100000 : ℝ) ≤ lam → lam ≤ 102091 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18685 / 100000 : ℝ) ≤ q ∧ q ≤ 18709 / 100000) :
    (185764 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (186001 / 1000000 : ℝ) := by
  have hmonoLo : sin (18685 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18709 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18685 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18709 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18685 / 100000 : ℝ) ≤ q ∧ q ≤ 18709 / 100000) :
    (982549 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982595 / 1000000 : ℝ) := by
  have hmonoLo : cos (18709 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18685 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18709 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18685 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27449 / 100000 : ℝ) ≤ q ∧ q ≤ 27500 / 100000) :
    (271056 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (271547 / 1000000 : ℝ) := by
  have hmonoLo : sin (27449 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27500 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27449 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27500 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27449 / 100000 : ℝ) ≤ q ∧ q ≤ 27500 / 100000) :
    (962425 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962564 / 1000000 : ℝ) := by
  have hmonoLo : cos (27500 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27449 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27500 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27449 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42362 / 100000 : ℝ) ≤ q ∧ q ≤ 42425 / 100000) :
    (411063 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (411638 / 1000000 : ℝ) := by
  have hmonoLo : sin (42362 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42425 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42362 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42425 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46677 / 100000 : ℝ) ≤ q ∧ q ≤ 46754 / 100000) :
    (450004 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (450692 / 1000000 : ℝ) := by
  have hmonoLo : sin (46677 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46754 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46677 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46754 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46677 / 100000 : ℝ) ≤ q ∧ q ≤ 46754 / 100000) :
    (892679 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (893027 / 1000000 : ℝ) := by
  have hmonoLo : cos (46754 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46677 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46754 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46677 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18685000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18709000 / 100000000) :
    (18576400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18600100 / 100000000 : ℝ) ∧
      (98254900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98259500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18685000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18709000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18709000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18685000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27449000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27500000 / 100000000) :
    (27105600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27154700 / 100000000 : ℝ) ∧
      (96242500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96256400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27449000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27500000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27500000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27449000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42362000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42425000 / 100000000) :
    (41106300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41163800 / 100000000 : ℝ) ∧
      (91134700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91160700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42362000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42425000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42425000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42362000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46677000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46754000 / 100000000) :
    (45000400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45069200 / 100000000 : ℝ) ∧
      (89267900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89302700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46677000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46754000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46754000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46677000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0008. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102081 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102091 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18685000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18709000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27449000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27500000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42362000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42425000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46677000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46754000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0008 brick. -/
...
B0008 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0008 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102081 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102091 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18685 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18709 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27449 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42362 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42425 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46677 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46754 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982595 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18685 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18685 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (911347 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42425 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42425 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (450692 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46754 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46754 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (411063 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42362 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42362 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102091 / 100000 : ℝ) * (46754 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102081 / 100000 : ℝ) * (27449 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16175 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16639 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982595 / 1000000 : ℝ) * (16175 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191134 / 100000 : ℝ) * (16639 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191134 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27449 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27500 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102081 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102091 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102081 / 100000 : ℝ) * (271056 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102091 / 100000 : ℝ) * (271547 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18685 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18709 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27449 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27500 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102081 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102091 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18685 / 100000, 18709 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27449 / 100000, 27500 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102081 / 100000, 102091 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨185764 / 1000000, 186001 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982549 / 1000000, 982595 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨271056 / 1000000, 271547 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962425 / 1000000, 962564 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0008 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0008 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102091 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102081 / 100000 : ℝ) * (450004 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102091 / 100000 : ℝ) * (450692 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46677 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46754 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46677 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46754 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102081 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0008`.
...
/-- Sound projection of the B0008 checker instance into the generic
...
/-- Every projected type-(iv) height in B0008 has an equal-area regular
...
/-- Candidate-facing conclusion for B0008.  No stationarity hypothesis is
...
/-- Complete B0008 candidate-facing conclusion.  The checked stationary pair
