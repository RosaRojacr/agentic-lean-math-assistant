...
namespace MiddleFaceCell40

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0040`, spanning `[102401/100000, 102411/100000]`. -/
def brick : Brick where
  lamLo := 102401 / 100000
  lamHi := 102411 / 100000
  centers := ![483188059468182573 / 2500000000000000000,
    2897225292334101739 / 10000000000000000000,
    2210455498400815167 / 5000000000000000000,
    4893828949075190489 / 10000000000000000000]
  slopes := ![1839298258911703347 / 1000000000000000000,
    4483200348598732217 / 1000000000000000000,
    5379435379174136641 / 1000000000000000000,
    206699591750238393 / 31250000000000000]
  yXiSlope := 2626117 / 4000000
  vRhoSlope := 88873711 / 100000000
...
/-- Unconditional real-range conclusion for the B0040 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102401 / 100000 : ℝ) ≤ lam → lam ≤ 102411 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19317 / 100000 : ℝ) ≤ q ∧ q ≤ 19338 / 100000) :
    (191970 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (192177 / 1000000 : ℝ) := by
  have hmonoLo : sin (19317 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19338 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19317 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19338 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19317 / 100000 : ℝ) ≤ q ∧ q ≤ 19338 / 100000) :
    (981360 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981401 / 1000000 : ℝ) := by
  have hmonoLo : cos (19338 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19317 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19338 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19317 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28949 / 100000 : ℝ) ≤ q ∧ q ≤ 28996 / 100000) :
    (285463 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (285914 / 1000000 : ℝ) := by
  have hmonoLo : sin (28949 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28996 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28949 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28996 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28949 / 100000 : ℝ) ≤ q ∧ q ≤ 28996 / 100000) :
    (958255 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958390 / 1000000 : ℝ) := by
  have hmonoLo : cos (28996 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28949 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28996 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28949 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44181 / 100000 : ℝ) ≤ q ∧ q ≤ 44238 / 100000) :
    (427576 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (428092 / 1000000 : ℝ) := by
  have hmonoLo : sin (44181 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44238 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44181 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44238 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48904 / 100000 : ℝ) ≤ q ∧ q ≤ 48973 / 100000) :
    (469778 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (470388 / 1000000 : ℝ) := by
  have hmonoLo : sin (48904 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48973 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48904 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48973 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48904 / 100000 : ℝ) ≤ q ∧ q ≤ 48973 / 100000) :
    (882459 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (882785 / 1000000 : ℝ) := by
  have hmonoLo : cos (48973 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48904 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48973 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48904 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19317000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19338000 / 100000000) :
    (19197000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19217700 / 100000000 : ℝ) ∧
      (98136000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98140100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19317000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19338000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19338000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19317000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28949000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28996000 / 100000000) :
    (28546300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28591400 / 100000000 : ℝ) ∧
      (95825500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95839000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28949000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28996000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28996000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28949000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44181000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44238000 / 100000000) :
    (42757600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42809200 / 100000000 : ℝ) ∧
      (90373500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90398000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44181000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44238000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44238000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44181000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48904000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48973000 / 100000000) :
    (46977800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47038800 / 100000000 : ℝ) ∧
      (88245900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88278500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48904000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48973000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48973000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48904000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0040. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102401 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102411 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19317000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19338000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28949000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28996000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44181000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44238000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48904000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48973000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0040 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 49 / 100, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (49 / 100)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0040 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102401 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102411 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19317 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19338 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28949 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44181 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44238 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48904 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48973 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981401 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19317 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19317 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (903735 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44238 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44238 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (470388 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48973 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48973 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (427576 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44181 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44181 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102411 / 100000 : ℝ) * (48973 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102401 / 100000 : ℝ) * (28949 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16221 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16738 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981401 / 1000000 : ℝ) * (16221 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190373 / 100000 : ℝ) * (16738 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190373 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28949 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28996 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102401 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102411 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102401 / 100000 : ℝ) * (285463 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102411 / 100000 : ℝ) * (285914 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19317 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19338 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28949 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28996 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102401 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102411 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19317 / 100000, 19338 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28949 / 100000, 28996 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102401 / 100000, 102411 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨191970 / 1000000, 192177 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981360 / 1000000, 981401 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨285463 / 1000000, 285914 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958255 / 1000000, 958390 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0040 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0040 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102411 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102401 / 100000 : ℝ) * (469778 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102411 / 100000 : ℝ) * (470388 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48904 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48973 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48904 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48973 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102401 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0040`.
...
/-- Sound projection of the B0040 checker instance into the generic
...
/-- Every projected type-(iv) height in B0040 has an equal-area regular
...
/-- Candidate-facing conclusion for B0040.  No stationarity hypothesis is
...
/-- Complete B0040 candidate-facing conclusion.  The checked stationary pair
