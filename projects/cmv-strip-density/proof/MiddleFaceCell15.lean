...
namespace MiddleFaceCell15

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0015`, spanning `[102151/100000, 102161/100000]`. -/
def brick : Brick where
  lamLo := 102151 / 100000
  lamHi := 102161 / 100000
  centers := ![942126199878293527 / 5000000000000000000,
    2781355348732098087 / 10000000000000000000,
    4280769517050406913 / 10000000000000000000,
    1180525328927183857 / 2500000000000000000]
  slopes := ![2047396520393402441 / 1000000000000000000,
    959111187877825559 / 200000000000000000,
    5846362599768416499 / 1000000000000000000,
    1427926826291188699 / 200000000000000000]
  yXiSlope := 33391027 / 50000000
  vRhoSlope := 8933843 / 10000000
...
/-- Unconditional real-range conclusion for the B0015 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102151 / 100000 : ℝ) ≤ lam → lam ≤ 102161 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18831 / 100000 : ℝ) ≤ q ∧ q ≤ 18854 / 100000) :
    (187199 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (187425 / 1000000 : ℝ) := by
  have hmonoLo : sin (18831 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18854 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18831 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18854 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18831 / 100000 : ℝ) ≤ q ∧ q ≤ 18854 / 100000) :
    (982278 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982323 / 1000000 : ℝ) := by
  have hmonoLo : cos (18854 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18831 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18854 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18831 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27788 / 100000 : ℝ) ≤ q ∧ q ≤ 27839 / 100000) :
    (274317 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (274808 / 1000000 : ℝ) := by
  have hmonoLo : sin (27788 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27839 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27788 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27839 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27788 / 100000 : ℝ) ≤ q ∧ q ≤ 27839 / 100000) :
    (961499 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961640 / 1000000 : ℝ) := by
  have hmonoLo : cos (27839 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27788 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27839 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27788 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42777 / 100000 : ℝ) ≤ q ∧ q ≤ 42838 / 100000) :
    (414842 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (415398 / 1000000 : ℝ) := by
  have hmonoLo : sin (42777 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42838 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42777 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42838 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47184 / 100000 : ℝ) ≤ q ∧ q ≤ 47258 / 100000) :
    (454526 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (455186 / 1000000 : ℝ) := by
  have hmonoLo : sin (47184 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47258 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47184 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47258 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47184 / 100000 : ℝ) ≤ q ∧ q ≤ 47258 / 100000) :
    (890396 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (890734 / 1000000 : ℝ) := by
  have hmonoLo : cos (47258 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47184 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47258 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47184 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18831000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18854000 / 100000000) :
    (18719900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18742500 / 100000000 : ℝ) ∧
      (98227800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98232300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18831000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18854000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18854000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18831000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27788000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27839000 / 100000000) :
    (27431700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27480800 / 100000000 : ℝ) ∧
      (96149900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96164000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27788000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27839000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27839000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27788000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42777000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42838000 / 100000000) :
    (41484200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41539800 / 100000000 : ℝ) ∧
      (90963900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90989400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42777000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42838000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42838000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42777000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47184000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47258000 / 100000000) :
    (45452600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45518600 / 100000000 : ℝ) ∧
      (89039600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89073400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47184000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47258000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47258000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47184000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0015. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102151 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102161 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18831000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18854000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27788000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27839000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42777000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42838000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47184000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47258000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0015 brick. -/
...
B0015 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (473 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 43 / 100, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 473 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (43 / 100)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (473 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (43 / 100)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0015 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102151 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102161 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18831 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18854 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27788 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42777 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42838 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47184 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47258 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982323 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18831 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18831 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (909639 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42838 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42838 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (455186 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47258 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47258 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (414842 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42777 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42777 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102161 / 100000 : ℝ) * (47258 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102151 / 100000 : ℝ) * (27788 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16185 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16661 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982323 / 1000000 : ℝ) * (16185 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190963 / 100000 : ℝ) * (16661 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190963 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27788 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27839 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102151 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102161 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102151 / 100000 : ℝ) * (274317 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102161 / 100000 : ℝ) * (274808 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18831 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18854 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27788 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27839 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102151 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102161 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18831 / 100000, 18854 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27788 / 100000, 27839 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102151 / 100000, 102161 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨187199 / 1000000, 187425 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982278 / 1000000, 982323 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨274317 / 1000000, 274808 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961499 / 1000000, 961640 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0015 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0015 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102161 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102151 / 100000 : ℝ) * (454526 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102161 / 100000 : ℝ) * (455186 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47184 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47258 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47184 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47258 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102151 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0015`.
...
/-- Sound projection of the B0015 checker instance into the generic
...
/-- Every projected type-(iv) height in B0015 has an equal-area regular
...
/-- Candidate-facing conclusion for B0015.  No stationarity hypothesis is
...
/-- Complete B0015 candidate-facing conclusion.  The checked stationary pair
