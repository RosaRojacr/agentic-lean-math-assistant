...
namespace MiddleFaceCell107

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0107`, spanning `[103071/100000, 103081/100000]`. -/
def brick : Brick where
  lamLo := 103071 / 100000
  lamHi := 103081 / 100000
  centers := ![408274275063637561 / 2000000000000000000,
    3175160299512241857 / 10000000000000000000,
    47482198850297429 / 100000000000000000,
    662434934538576383 / 1250000000000000000]
  slopes := ![1432619240735411821 / 1000000000000000000,
    1927275356039817403 / 500000000000000000,
    4455195300531305611 / 1000000000000000000,
    5565168600016597911 / 1000000000000000000]
  yXiSlope := 62994163 / 100000000
  vRhoSlope := 10968029 / 12500000
...
/-- Unconditional real-range conclusion for the B0107 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103071 / 100000 : ℝ) ≤ lam → lam ≤ 103081 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20405 / 100000 : ℝ) ≤ q ∧ q ≤ 20422 / 100000) :
    (202636 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202804 / 1000000 : ℝ) := by
  have hmonoLo : sin (20405 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20422 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20405 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20422 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20405 / 100000 : ℝ) ≤ q ∧ q ≤ 20422 / 100000) :
    (979219 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979254 / 1000000 : ℝ) := by
  have hmonoLo : cos (20422 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20405 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20422 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20405 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31731 / 100000 : ℝ) ≤ q ∧ q ≤ 31772 / 100000) :
    (312011 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (312402 / 1000000 : ℝ) := by
  have hmonoLo : sin (31731 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31772 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31731 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31772 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31731 / 100000 : ℝ) ≤ q ∧ q ≤ 31772 / 100000) :
    (949950 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950079 / 1000000 : ℝ) := by
  have hmonoLo : cos (31772 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31731 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31772 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31731 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47458 / 100000 : ℝ) ≤ q ∧ q ≤ 47506 / 100000) :
    (456964 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (457392 / 1000000 : ℝ) := by
  have hmonoLo : sin (47458 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47506 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47458 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47506 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52965 / 100000 : ℝ) ≤ q ∧ q ≤ 53024 / 100000) :
    (505231 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (505741 / 1000000 : ℝ) := by
  have hmonoLo : sin (52965 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (53024 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52965 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (53024 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52965 / 100000 : ℝ) ≤ q ∧ q ≤ 53024 / 100000) :
    (862685 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (862984 / 1000000 : ℝ) := by
  have hmonoLo : cos (53024 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52965 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (53024 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52965 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20405000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20422000 / 100000000) :
    (20263600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20280400 / 100000000 : ℝ) ∧
      (97921900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97925400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20405000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20422000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20422000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20405000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31731000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31772000 / 100000000) :
    (31201100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31240200 / 100000000 : ℝ) ∧
      (94995000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95007900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31731000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31772000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31772000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31731000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47458000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47506000 / 100000000) :
    (45696400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45739200 / 100000000 : ℝ) ∧
      (88926500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88948500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47458000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47506000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47506000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47458000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52965000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 53024000 / 100000000) :
    (50523100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50574100 / 100000000 : ℝ) ∧
      (86268500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86298400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52965000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (53024000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (53024000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52965000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0107. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103071 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103081 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20405000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20422000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31731000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31772000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47458000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47506000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52965000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 53024000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0107 brick. -/
...
throughout the B0107 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103071 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103081 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20405 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20422 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31731 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47458 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47506 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52965 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (53024 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979254 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20405 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20405 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (889265 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47506 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47506 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (505741 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (53024 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (53024 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (456964 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47458 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47458 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103081 / 100000 : ℝ) * (53024 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103071 / 100000 : ℝ) * (31731 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16312 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16936 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979254 / 1000000 : ℝ) * (16312 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188926 / 100000 : ℝ) * (16936 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188926 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31731 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31772 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103071 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103081 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103071 / 100000 : ℝ) * (312011 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103081 / 100000 : ℝ) * (312402 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20405 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20422 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31731 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31772 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103071 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103081 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20405 / 100000, 20422 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31731 / 100000, 31772 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103071 / 100000, 103081 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202636 / 1000000, 202804 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979219 / 1000000, 979254 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨312011 / 1000000, 312402 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨949950 / 1000000, 950079 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0107 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0107 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103081 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103071 / 100000 : ℝ) * (505231 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103081 / 100000 : ℝ) * (505741 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52965 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 53024 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52965 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 53024 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103071 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0107`.
...
/-- Sound projection of the B0107 checker instance into the generic
...
/-- Every projected type-(iv) height in B0107 has an equal-area regular
...
/-- Candidate-facing conclusion for B0107.  No stationarity hypothesis is
...
/-- Complete B0107 candidate-facing conclusion.  The checked stationary pair
