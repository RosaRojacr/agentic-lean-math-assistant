...
namespace MiddleFaceCell97

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0097`, spanning `[102971/100000, 102981/100000]`. -/
def brick : Brick where
  lamLo := 102971 / 100000
  lamHi := 102981 / 100000
  centers := ![405359246244385783 / 2000000000000000000,
    1568110970392854267 / 5000000000000000000,
    940619370839886819 / 2000000000000000000,
    1310793844544610409 / 2500000000000000000]
  slopes := ![741449684674990867 / 500000000000000000,
    1966906242939764243 / 500000000000000000,
    4570479743527019281 / 1000000000000000000,
    712103877641867797 / 125000000000000000]
  yXiSlope := 15840641 / 25000000
  vRhoSlope := 87903789 / 100000000
...
/-- Unconditional real-range conclusion for the B0097 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102971 / 100000 : ℝ) ≤ lam → lam ≤ 102981 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20259 / 100000 : ℝ) ≤ q ∧ q ≤ 20277 / 100000) :
    (201207 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201384 / 1000000 : ℝ) := by
  have hmonoLo : sin (20259 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20277 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20259 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20277 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20259 / 100000 : ℝ) ≤ q ∧ q ≤ 20277 / 100000) :
    (979512 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979549 / 1000000 : ℝ) := by
  have hmonoLo : cos (20277 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20259 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20277 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20259 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31341 / 100000 : ℝ) ≤ q ∧ q ≤ 31383 / 100000) :
    (308304 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (308704 / 1000000 : ℝ) := by
  have hmonoLo : sin (31341 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31383 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31341 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31383 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31341 / 100000 : ℝ) ≤ q ∧ q ≤ 31383 / 100000) :
    (951158 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951288 / 1000000 : ℝ) := by
  have hmonoLo : cos (31383 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31341 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31383 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31341 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47007 / 100000 : ℝ) ≤ q ∧ q ≤ 47055 / 100000) :
    (452948 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (453377 / 1000000 : ℝ) := by
  have hmonoLo : sin (47007 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47055 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47007 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47055 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52402 / 100000 : ℝ) ≤ q ∧ q ≤ 52462 / 100000) :
    (500364 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (500885 / 1000000 : ℝ) := by
  have hmonoLo : sin (52402 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52462 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52402 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52462 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52402 / 100000 : ℝ) ≤ q ∧ q ≤ 52462 / 100000) :
    (865514 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (865815 / 1000000 : ℝ) := by
  have hmonoLo : cos (52462 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52402 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52462 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52402 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20259000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20277000 / 100000000) :
    (20120700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20138400 / 100000000 : ℝ) ∧
      (97951200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97954900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20259000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20277000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20277000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20259000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31341000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31383000 / 100000000) :
    (30830400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30870400 / 100000000 : ℝ) ∧
      (95115800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95128800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31341000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31383000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31383000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31341000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47007000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47055000 / 100000000) :
    (45294800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45337700 / 100000000 : ℝ) ∧
      (89131900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89153700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47007000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47055000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47055000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47007000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52402000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52462000 / 100000000) :
    (50036400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50088500 / 100000000 : ℝ) ∧
      (86551400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86581500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52402000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52462000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52462000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52402000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0097. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102971 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102981 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20259000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20277000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31341000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31383000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47007000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47055000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52402000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52462000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0097 brick. -/
...
throughout the B0097 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102971 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102981 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20259 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20277 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31341 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47007 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47055 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52402 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52462 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979549 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20259 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20259 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (891319 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47055 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47055 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (500885 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52462 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52462 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (452948 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47007 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47007 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102981 / 100000 : ℝ) * (52462 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102971 / 100000 : ℝ) * (31341 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16299 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16907 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979549 / 1000000 : ℝ) * (16299 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189131 / 100000 : ℝ) * (16907 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189131 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31341 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31383 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102971 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102981 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102971 / 100000 : ℝ) * (308304 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102981 / 100000 : ℝ) * (308704 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20259 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20277 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31341 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31383 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102971 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102981 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20259 / 100000, 20277 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31341 / 100000, 31383 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102971 / 100000, 102981 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201207 / 1000000, 201384 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979512 / 1000000, 979549 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨308304 / 1000000, 308704 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951158 / 1000000, 951288 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0097 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0097 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102981 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102971 / 100000 : ℝ) * (500364 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102981 / 100000 : ℝ) * (500885 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52402 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52462 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52402 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52462 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102971 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0097`.
...
/-- Sound projection of the B0097 checker instance into the generic
...
/-- Every projected type-(iv) height in B0097 has an equal-area regular
...
/-- Candidate-facing conclusion for B0097.  No stationarity hypothesis is
...
/-- Complete B0097 candidate-facing conclusion.  The checked stationary pair
