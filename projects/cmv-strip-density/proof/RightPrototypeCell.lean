...
/-!
# Retained upper prototype brick

Kernel-checked certificate for the exact upper prototype data recorded in
`face_bridge_pilot/bridge_certificate.json`.
-/
...
namespace RightPrototypeCell

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact retained upper prototype brick, spanning `[25781/25000, 33/32]`. -/
def brick : Brick where
  lamLo := 25781 / 25000
  lamHi := 33 / 32
  centers := ![2048263294902610889 / 10000000000000000000,
    3193765780936307979 / 10000000000000000000,
    4769698287901120439 / 10000000000000000000,
    2663161348942592843 / 5000000000000000000]
  slopes := ![140927032410729353 / 100000000000000000,
    954393643324404653 / 250000000000000000,
    4401546318656929969 / 1000000000000000000,
    5503812760533025527 / 1000000000000000000]
  yXiSlope := 13 / 20
  vRhoSlope := 219 / 250
...
/-- Unconditional real-range conclusion for the retained upper prototype. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (25781 / 25000 : ℝ) ≤ lam → lam ≤ 33 / 32 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (204818 / 1000000 : ℝ) ≤ q ∧ q ≤ 204834 / 1000000) :
    (2033889 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (2034047 / 10000000 : ℝ) := by
  have hmonoLo : sin (204818 / 1000000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (204834 / 1000000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (204818 / 1000000)).1
  have hhi := (sinTaylor27Interval_sound (204834 / 1000000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (204818 / 1000000 : ℝ) ≤ q ∧ q ≤ 204834 / 1000000) :
    (9790947 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (9790981 / 10000000 : ℝ) := by
  have hmonoLo : cos (204834 / 1000000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (204818 / 1000000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (204834 / 1000000)).1
  have hhi := (cosTaylor26Interval_sound (204818 / 1000000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (319357 / 1000000 : ℝ) ≤ q ∧ q ≤ 319396 / 1000000) :
    (3139561 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (3139932 / 10000000 : ℝ) := by
  have hmonoLo : sin (319357 / 1000000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (319396 / 1000000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (319357 / 1000000)).1
  have hhi := (sinTaylor27Interval_sound (319396 / 1000000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (319357 / 1000000 : ℝ) ≤ q ∧ q ≤ 319396 / 1000000) :
    (9494252 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (9494375 / 10000000 : ℝ) := by
  have hmonoLo : cos (319396 / 1000000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (319357 / 1000000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (319396 / 1000000)).1
  have hhi := (cosTaylor26Interval_sound (319357 / 1000000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (476947 / 1000000 : ℝ) ≤ q ∧ q ≤ 476993 / 1000000) :
    (4590690 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (4591100 / 10000000 : ℝ) := by
  have hmonoLo : sin (476947 / 1000000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (476993 / 1000000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (476947 / 1000000)).1
  have hhi := (sinTaylor27Interval_sound (476993 / 1000000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (532604 / 1000000 : ℝ) ≤ q ∧ q ≤ 532661 / 1000000) :
    (5077783 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (5078275 / 10000000 : ℝ) := by
  have hmonoLo : sin (532604 / 1000000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (532661 / 1000000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (532604 / 1000000)).1
  have hhi := (sinTaylor27Interval_sound (532661 / 1000000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (532604 / 1000000 : ℝ) ≤ q ∧ q ≤ 532661 / 1000000) :
    (8614587 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (8614878 / 10000000 : ℝ) := by
  have hmonoLo : cos (532661 / 1000000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (532604 / 1000000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (532661 / 1000000)).1
  have hhi := (cosTaylor26Interval_sound (532604 / 1000000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (204818 / 1000000 : ℝ) ≤ q ∧
      q ≤ 204834 / 1000000) :
    (2033889 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (2034047 / 10000000 : ℝ) ∧
      (9790947 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (9790981 / 10000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (204818 / 1000000)).1
  have hshi := (sinTaylor27Interval_sound (204834 / 1000000)).2
  have hclo := (cosTaylor26Interval_sound (204834 / 1000000)).1
  have hchi := (cosTaylor26Interval_sound (204818 / 1000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (319357 / 1000000 : ℝ) ≤ q ∧
      q ≤ 319396 / 1000000) :
    (3139561 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (3139932 / 10000000 : ℝ) ∧
      (9494252 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (9494375 / 10000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (319357 / 1000000)).1
  have hshi := (sinTaylor27Interval_sound (319396 / 1000000)).2
  have hclo := (cosTaylor26Interval_sound (319396 / 1000000)).1
  have hchi := (cosTaylor26Interval_sound (319357 / 1000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (476947 / 1000000 : ℝ) ≤ q ∧
      q ≤ 476993 / 1000000) :
    (4590690 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (4591100 / 10000000 : ℝ) ∧
      (8883794 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (8884007 / 10000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (476947 / 1000000)).1
  have hshi := (sinTaylor27Interval_sound (476993 / 1000000)).2
  have hclo := (cosTaylor26Interval_sound (476993 / 1000000)).1
  have hchi := (cosTaylor26Interval_sound (476947 / 1000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (532604 / 1000000 : ℝ) ≤ q ∧
      q ≤ 532661 / 1000000) :
    (5077783 / 10000000 : ℝ) ≤ sin q ∧
      sin q ≤ (5078275 / 10000000 : ℝ) ∧
      (8614587 / 10000000 : ℝ) ≤ cos q ∧
      cos q ≤ (8614878 / 10000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (532604 / 1000000)).1
  have hshi := (sinTaylor27Interval_sound (532661 / 1000000)).2
  have hclo := (cosTaylor26Interval_sound (532661 / 1000000)).1
  have hchi := (cosTaylor26Interval_sound (532604 / 1000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on the retained upper prototype. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
    ...
    (hsigma : -(1 / 100000000 : ℝ) ≤ sigma ∧
      sigma ≤ 1 / 100000000) :
    |eReducedDerivT t xi eta rho sigma| ≤ (7 / 2000 : ℝ) ∧
      |eReducedDerivXi t xi eta rho sigma| ≤ (153 / 1000 : ℝ) ∧
      |eReducedDerivEta t xi eta rho sigma| ≤ (7 : ℝ) ∧
      (2 : ℝ) ≤ eReducedDerivRho t xi eta rho sigma ∧
      |eReducedDerivSigma t xi eta rho sigma| ≤ (7 : ℝ) := by
  let ll := (lamMid : ℝ) + t
  ...
  have hll : (25781 / 25000 : ℝ) ≤ ll ∧ ll ≤ 33 / 32 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (204818 / 1000000 : ℝ) ≤ xx ∧
      xx ≤ 204834 / 1000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (319357 / 1000000 : ℝ) ≤ yy ∧
      yy ≤ 319396 / 1000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (476947 / 1000000 : ℝ) ≤ ww ∧
      ww ≤ 476993 / 1000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (532604 / 1000000 : ℝ) ≤ vv ∧
      vv ≤ 532661 / 1000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
the retained upper prototype brick. -/
...
pairs throughout the retained upper prototype brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (533 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 239 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 533 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (239 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (533 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (239 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the retained upper prototype brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (25781 / 25000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (33 / 32 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (204818 / 1000000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (204834 / 1000000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (319357 / 1000000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (476947 / 1000000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (476993 / 1000000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (532604 / 1000000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (532661 / 1000000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (9790981 / 10000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (204818 / 1000000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (204818 / 1000000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (8883794 / 10000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (476993 / 1000000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (476993 / 1000000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (5078275 / 10000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (532661 / 1000000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (532661 / 1000000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (4590690 / 10000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (476947 / 1000000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (476947 / 1000000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (33 / 32 : ℝ) * (532661 / 1000000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (25781 / 25000 : ℝ) * (319357 / 1000000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16315 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16951 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (9790981 / 10000000 : ℝ) * (16315 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188837 / 100000 : ℝ) * (16951 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188837 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_origin_abs_lt :
    |c4Reduced 0 0 0| < (1 / 4000000000 : ℝ) := by
...
private theorem c4Reduced_derivativeBounds :
    ∀ {t xi eta : ℝ},
      (-(1 / 200000 : ℝ) ≤ t ∧ t ≤ 1 / 200000) →
      (-(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000) →
      (-(1 / 100000000 : ℝ) ≤ eta ∧ eta ≤ 1 / 100000000) →
      |c4ReducedDerivT t xi eta| ≤ (1 / 8000 : ℝ) ∧
      |c4ReducedDerivXi t xi eta| ≤ (8 / 1000 : ℝ) ∧
      (32 / 100 : ℝ) ≤ c4ReducedDerivEta t xi eta := by
  ...
  have hyArg :
      (319357 / 1000000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 319396 / 1000000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (25781 / 25000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (33 / 32 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (25781 / 25000 : ℝ) * (3139561 / 10000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
...
private theorem c4Reduced_eta_zero_abs_lt {t xi : ℝ}
    (ht : -(1 / 200000 : ℝ) ≤ t ∧ t ≤ 1 / 200000)
    (hxi : -(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000) :
    |c4Reduced t xi 0| < (17 / 10000000000 : ℝ) := by
  have hzeroXi : (0 : ℝ) ∈ Icc (-(1 / 10000000)) (1 / 10000000) := by
    constructor <;> norm_num
  have hzeroEta : (0 : ℝ) ∈ Icc (-(1 / 100000000)) (1 / 100000000) := by
    constructor <;> norm_num
  have htChange :
      |c4Reduced t 0 0 - c4Reduced 0 0 0| ≤ (1 / 8000 : ℝ) * |t| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 200000 : ℝ)) (u := t)
      (by norm_num) ht
    · intro q _
      exact MiddleFaceAssembly.C4Residual.reduced_hasDerivAt_t brick q 0 0
    · intro q hq
      exact (c4Reduced_derivativeBounds hq hzeroXi hzeroEta).1
  have hxiChange :
      |c4Reduced t xi 0 - c4Reduced t 0 0| ≤ (8 / 1000 : ℝ) * |xi| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 10000000 : ℝ)) (u := xi)
      (by norm_num) hxi
    · intro q _
      exact MiddleFaceAssembly.C4Residual.reduced_hasDerivAt_xi brick t q 0
    · intro q hq
      exact (c4Reduced_derivativeBounds ht hq hzeroEta).2.1
  have htAbs : |t| ≤ (1 / 200000 : ℝ) := (abs_le).2 ht
  have hxiAbs : |xi| ≤ (1 / 10000000 : ℝ) := (abs_le).2 hxi
  have htriangle :
      |c4Reduced t xi 0| ≤
        |c4Reduced t xi 0 - c4Reduced t 0 0| +
          |c4Reduced t 0 0 - c4Reduced 0 0 0| + |c4Reduced 0 0 0| := by
    calc
      |c4Reduced t xi 0| =
          |(c4Reduced t xi 0 - c4Reduced t 0 0) +
            (c4Reduced t 0 0 - c4Reduced 0 0 0) + c4Reduced 0 0 0| := by ring
      _ ≤ _ := by
        linarith [abs_add_le (c4Reduced t xi 0 - c4Reduced t 0 0)
          (c4Reduced t 0 0 - c4Reduced 0 0 0),
          abs_add_le ((c4Reduced t xi 0 - c4Reduced t 0 0) +
            (c4Reduced t 0 0 - c4Reduced 0 0 0)) (c4Reduced 0 0 0)]
  norm_num at htChange hxiChange htAbs hxiAbs htriangle ⊢
  linarith [c4Reduced_origin_abs_lt]
...
private theorem c4Reduced_eta_growth {t xi eta₁ eta₂ : ℝ}
  ...
  apply (convex_Icc (-(1 / 100000000 : ℝ))
    (1 / 100000000 : ℝ)).mul_sub_le_image_sub_of_le_deriv
      (by unfold c4Reduced MiddleFaceAssembly.C4Residual.reduced; fun_prop)
      (by unfold c4Reduced MiddleFaceAssembly.C4Residual.reduced; fun_prop) ?_
        eta₁ heta₁ eta₂ heta₂ heta
  intro q hq
  have hq' : -(1 / 100000000 : ℝ) ≤ q ∧ q ≤ 1 / 100000000 := by
    have hi : q ∈ Ioo (-(1 / 100000000 : ℝ)) (1 / 100000000) := by
      simpa only [interior_Icc] using hq
    exact ⟨hi.1.le, hi.2.le⟩
  rw [(MiddleFaceAssembly.C4Residual.reduced_hasDerivAt_eta brick t xi q).deriv]
  exact (c4Reduced_derivativeBounds ht hxi hq').2.2
...
private theorem fReduced_low_anchor :
    (105 / 1000000000 : ℝ) < fReduced 0 (-(1 / 10000000)) 0 := by
...
private theorem fReduced_high_anchor :
    fReduced 0 (1 / 10000000) 0 < -(105 / 1000000000 : ℝ) := by
  let xq : ℚ := brick.centers 0 + 1 / 10000000
  let yq : ℚ := brick.centers 1 + brick.yXiSlope / 10000000
  let sx : CertificateExpr :=
    .atom (sin (xq : ℝ)) (sinTaylor27Interval xq)
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
    ...
    (hxi : -(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000) :
    |fReducedDerivT q xi 0| ≤ (1 / 4000 : ℝ) := by
  let xx := (brick.centers 0 : ℝ) + brick.slopes 0 * q + xi
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (204818 / 1000000 : ℝ) ≤ xx ∧ xx ≤ 204834 / 1000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (319357 / 1000000 : ℝ) ≤ yy ∧ yy ≤ 319396 / 1000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (25781 / 25000 : ℝ) ≤ ll ∧ ll ≤ 33 / 32 := by
...
private theorem fReducedDerivEta_abs_le {t xi eta : ℝ}
    ...
    (hxi : -(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000)
    (heta : -(1 / 100000000 : ℝ) ≤ eta ∧ eta ≤ 1 / 100000000) :
    |fReducedDerivEta t xi eta| ≤ (11 / 20 : ℝ) := by
  let xx := (brick.centers 0 : ℝ) + brick.slopes 0 * t + xi
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * t +
    brick.yXiSlope * xi + eta
  let ll := (lamMid : ℝ) + t
...
private theorem fReduced_derivativeBounds :
    ∀ {t xi eta : ℝ},
      ...
      (-(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000) →
      (-(1 / 100000000 : ℝ) ≤ eta ∧ eta ≤ 1 / 100000000) →
      |fReducedDerivT t xi 0| ≤ (1 / 4000 : ℝ) ∧
      |fReducedDerivEta t xi eta| ≤ (11 / 20 : ℝ) := by
  intro t xi eta ht hxi heta
...
private theorem fReduced_face_deviation {t xi eta : ℝ}
    ...
    (hxi : -(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000)
    (heta : -(1 / 100000000 : ℝ) ≤ eta ∧ eta ≤ 1 / 100000000) :
    |fReduced t xi eta - fReduced 0 xi 0| ≤ (7 / 1000000000 : ℝ) := by
  have hzeroEta : (0 : ℝ) ∈ Icc (-(1 / 100000000)) (1 / 100000000) := by
    constructor <;> norm_num
  have htChange :
      |fReduced t xi 0 - fReduced 0 xi 0| ≤ (1 / 4000 : ℝ) * |t| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 200000 : ℝ)) (u := t)
      (by norm_num) ht
    · intro q _
      exact MiddleFaceAssembly.FResidual.reduced_hasDerivAt_t brick q xi 0
    · intro q hq
      exact (fReduced_derivativeBounds hq hxi hzeroEta).1
  have hetaChange :
      |fReduced t xi eta - fReduced t xi 0| ≤ (11 / 20 : ℝ) * |eta| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 100000000 : ℝ)) (u := eta)
      (by norm_num) heta
    · intro q _
      exact MiddleFaceAssembly.FResidual.reduced_hasDerivAt_eta brick t xi q
    · intro q hq
      exact (fReduced_derivativeBounds ht hxi hq).2
  have htAbs : |t| ≤ (1 / 200000 : ℝ) := (abs_le).2 ht
...
margin `88 · 10⁻⁹` over the complete retained upper prototype brick. -/
theorem F_xi_low_face_margin :
  ...
  have hdev := fReduced_face_deviation ht'
    (show -(1 / 10000000 : ℝ) ≤ -(1 / 10000000) ∧
      -(1 / 10000000 : ℝ) ≤ 1 / 10000000 by norm_num) heta
  change (88 / 1000000000 : ℝ) < fReduced t (z 0) (z 1)
  rw [hxi]
  rw [abs_le] at hdev
  linarith [fReduced_low_anchor]

/-- On the upper `xi` face, `F` is uniformly negative with exact strict
margin `86 · 10⁻⁹` over the complete retained upper prototype brick. -/
...
private theorem c3Reduced_derivativeBounds :
    ∀ {t rho sigma : ℝ},
      (-(1 / 200000 : ℝ) ≤ t ∧ t ≤ 1 / 200000) →
      (-(1 / 10000000 : ℝ) ≤ rho ∧ rho ≤ 1 / 10000000) →
      (-(1 / 100000000 : ℝ) ≤ sigma ∧ sigma ≤ 1 / 100000000) →
      |c3ReducedDerivT t rho sigma| ≤ (1 / 2500 : ℝ) ∧
      |c3ReducedDerivRho t rho sigma| ≤ (1 / 1000 : ℝ) ∧
      (1 / 2 : ℝ) ≤ c3ReducedDerivSigma t rho sigma := by
  ...
  · have hwArg :
    ...
    have hvArg :
        (532604 / 1000000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 532661 / 1000000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (33 / 32 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (25781 / 25000 : ℝ) * (5077783 / 10000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
...
private theorem c3Reduced_sigma_zero_abs_lt {t rho : ℝ}
    (ht : -(1 / 200000 : ℝ) ≤ t ∧ t ≤ 1 / 200000)
    (hrho : -(1 / 10000000 : ℝ) ≤ rho ∧ rho ≤ 1 / 10000000) :
    |c3Reduced t rho 0| < (5 / 2000000000 : ℝ) := by
  have hzeroRho : (0 : ℝ) ∈ Icc (-(1 / 10000000)) (1 / 10000000) := by
    constructor <;> norm_num
  have hzeroSigma : (0 : ℝ) ∈ Icc (-(1 / 100000000)) (1 / 100000000) := by
    constructor <;> norm_num
  have htChange :
      |c3Reduced t 0 0 - c3Reduced 0 0 0| ≤ (1 / 2500 : ℝ) * |t| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 200000 : ℝ)) (u := t)
      (by norm_num) ht
    · intro q _
      exact MiddleFaceAssembly.C3Residual.reduced_hasDerivAt_t brick q 0 0
    · intro q hq
      exact (c3Reduced_derivativeBounds hq hzeroRho hzeroSigma).1
  have hrhoChange :
      |c3Reduced t rho 0 - c3Reduced t 0 0| ≤ (1 / 1000 : ℝ) * |rho| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 10000000 : ℝ)) (u := rho)
      (by norm_num) hrho
    · intro q _
      exact MiddleFaceAssembly.C3Residual.reduced_hasDerivAt_rho brick t q 0
    · intro q hq
      exact (c3Reduced_derivativeBounds ht hq hzeroSigma).2.1
  have htAbs : |t| ≤ (1 / 200000 : ℝ) := (abs_le).2 ht
  have hrhoAbs : |rho| ≤ (1 / 10000000 : ℝ) := (abs_le).2 hrho
  have htriangle :
      |c3Reduced t rho 0| ≤
        |c3Reduced t rho 0 - c3Reduced t 0 0| +
          |c3Reduced t 0 0 - c3Reduced 0 0 0| + |c3Reduced 0 0 0| := by
    calc
      |c3Reduced t rho 0| =
          |(c3Reduced t rho 0 - c3Reduced t 0 0) +
            (c3Reduced t 0 0 - c3Reduced 0 0 0) + c3Reduced 0 0 0| := by ring
      _ ≤ _ := by
        linarith [abs_add_le (c3Reduced t rho 0 - c3Reduced t 0 0)
          (c3Reduced t 0 0 - c3Reduced 0 0 0),
          abs_add_le ((c3Reduced t rho 0 - c3Reduced t 0 0) +
            (c3Reduced t 0 0 - c3Reduced 0 0 0)) (c3Reduced 0 0 0)]
  norm_num at htChange hrhoChange htAbs hrhoAbs htriangle ⊢
  linarith [c3Reduced_origin_abs_lt]
...
private theorem c3Reduced_sigma_growth {t rho sigma₁ sigma₂ : ℝ}
  ...
  apply (convex_Icc (-(1 / 100000000 : ℝ))
    (1 / 100000000 : ℝ)).mul_sub_le_image_sub_of_le_deriv
      (by unfold c3Reduced MiddleFaceAssembly.C3Residual.reduced; fun_prop)
      (by unfold c3Reduced MiddleFaceAssembly.C3Residual.reduced; fun_prop) ?_
  ...
  have hq' : -(1 / 100000000 : ℝ) ≤ q ∧ q ≤ 1 / 100000000 := by
    have hi : q ∈ Ioo (-(1 / 100000000 : ℝ)) (1 / 100000000) := by
      simpa only [interior_Icc] using hq
    exact ⟨hi.1.le, hi.2.le⟩
  rw [(MiddleFaceAssembly.C3Residual.reduced_hasDerivAt_sigma brick t rho q).deriv]
  exact (c3Reduced_derivativeBounds ht hrho hq').2.2
...
private theorem eReduced_rho_zero_abs_lt {t xi eta sigma : ℝ}
    ...
    (hxi : -(1 / 10000000 : ℝ) ≤ xi ∧ xi ≤ 1 / 10000000)
    (heta : -(1 / 100000000 : ℝ) ≤ eta ∧ eta ≤ 1 / 100000000)
    (hsigma : -(1 / 100000000 : ℝ) ≤ sigma ∧ sigma ≤ 1 / 100000000) :
    |eReduced t xi eta 0 sigma| < (9 / 50000000 : ℝ) := by
  have hxi0 : (0 : ℝ) ∈ Icc (-(1 / 10000000)) (1 / 10000000) := by
    constructor <;> norm_num
  have heta0 : (0 : ℝ) ∈ Icc (-(1 / 100000000)) (1 / 100000000) := by
    constructor <;> norm_num
  have hrho0 : (0 : ℝ) ∈ Icc (-(1 / 10000000)) (1 / 10000000) := by
    constructor <;> norm_num
  have hsigma0 : (0 : ℝ) ∈ Icc (-(1 / 100000000)) (1 / 100000000) := by
    constructor <;> norm_num
  have htChange :
      |eReduced t 0 0 0 0 - eReduced 0 0 0 0 0| ≤ (7 / 2000 : ℝ) * |t| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 200000 : ℝ)) (u := t)
      (by norm_num) ht
    · intro q _
      exact MiddleFaceAssembly.EResidual.reduced_hasDerivAt_t brick q 0 0 0 0
    · intro q hq
      exact (eReduced_deriv_bounds hq hxi0 heta0 hrho0 hsigma0).1
  have hxiChange :
    ...
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 10000000 : ℝ)) (u := xi)
      (by norm_num) hxi
    · intro q _
      exact MiddleFaceAssembly.EResidual.reduced_hasDerivAt_xi brick t q 0 0 0
    · intro q hq
      exact (eReduced_deriv_bounds ht hq heta0 hrho0 hsigma0).2.1
  have hetaChange :
      |eReduced t xi eta 0 0 - eReduced t xi 0 0 0| ≤ (7 : ℝ) * |eta| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 100000000 : ℝ)) (u := eta)
      (by norm_num) heta
    · intro q _
      exact MiddleFaceAssembly.EResidual.reduced_hasDerivAt_eta brick t xi q 0 0
    · intro q hq
      exact (eReduced_deriv_bounds ht hxi hq hrho0 hsigma0).2.2.1
  have hsigmaChange :
      |eReduced t xi eta 0 sigma - eReduced t xi eta 0 0| ≤
        (7 : ℝ) * |sigma| := by
    apply abs_image_sub_le_of_hasDerivAt (R := (1 / 100000000 : ℝ)) (u := sigma)
      (by norm_num) hsigma
    · intro q _
      exact MiddleFaceAssembly.EResidual.reduced_hasDerivAt_sigma brick t xi eta 0 q
    · intro q hq
      exact (eReduced_deriv_bounds ht hxi heta hrho0 hq).2.2.2.2
  have htAbs : |t| ≤ (1 / 200000 : ℝ) := (abs_le).2 ht
  have hxiAbs : |xi| ≤ (1 / 10000000 : ℝ) := (abs_le).2 hxi
  have hetaAbs : |eta| ≤ (1 / 100000000 : ℝ) := (abs_le).2 heta
  ...
  have h1 :
      |eReduced t xi eta 0 sigma| ≤
        |eReduced t xi eta 0 sigma - eReduced t xi eta 0 0| +
        |eReduced t xi eta 0 0| := by
    convert abs_add_le
      (eReduced t xi eta 0 sigma - eReduced t xi eta 0 0)
      (eReduced t xi eta 0 0) using 1 <;> first | ring | rfl
  have h2 :
      |eReduced t xi eta 0 0| ≤
        |eReduced t xi eta 0 0 - eReduced t xi 0 0 0| +
        |eReduced t xi 0 0 0| := by
    convert abs_add_le
      (eReduced t xi eta 0 0 - eReduced t xi 0 0 0)
      (eReduced t xi 0 0 0) using 1 <;> first | ring | rfl
  have h3 :
      |eReduced t xi 0 0 0| ≤
        |eReduced t xi 0 0 0 - eReduced t 0 0 0 0| +
        |eReduced t 0 0 0 0| := by
    convert abs_add_le
      (eReduced t xi 0 0 0 - eReduced t 0 0 0 0)
      (eReduced t 0 0 0 0) using 1 <;> first | ring | rfl
  have h4 :
      |eReduced t 0 0 0 0| ≤
    ...
    convert abs_add_le
      (eReduced t 0 0 0 0 - eReduced 0 0 0 0 0)
      (eReduced 0 0 0 0 0) using 1 <;> first | ring | rfl
  have htriangle :
      |eReduced t xi eta 0 sigma| ≤
        |eReduced t xi eta 0 sigma - eReduced t xi eta 0 0| +
        |eReduced t xi eta 0 0 - eReduced t xi 0 0 0| +
        ...
        |eReduced 0 0 0 0 0| := by
    linarith
  norm_num at htChange hxiChange hetaChange hsigmaChange htAbs hxiAbs hetaAbs hsigmaAbs htriangle ⊢
  linarith [eReduced_origin_abs_lt]
...
private theorem eReduced_rho_growth {t xi eta sigma rho₁ rho₂ : ℝ}
  ...
  apply (convex_Icc (-(1 / 10000000 : ℝ))
    (1 / 10000000 : ℝ)).mul_sub_le_image_sub_of_le_deriv
      (by unfold eReduced MiddleFaceAssembly.EResidual.reduced; fun_prop)
      (by unfold eReduced MiddleFaceAssembly.EResidual.reduced; fun_prop) ?_
        rho₁ hrho₁ rho₂ hrho₂ hrho
  intro q hq
  have hq' : -(1 / 10000000 : ℝ) ≤ q ∧ q ≤ 1 / 10000000 := by
    have hi : q ∈ Ioo (-(1 / 10000000 : ℝ)) (1 / 10000000) := by
      simpa only [interior_Icc] using hq
    exact ⟨hi.1.le, hi.2.le⟩
  rw [(MiddleFaceAssembly.EResidual.reduced_hasDerivAt_rho brick t xi eta q sigma).deriv]
...
/-- Proof-producing checker instance for the retained upper prototype brick.
...
theorem cellCertificate : MiddleFaceAssembly.CellCertificate brick where
  lambda_one_lt := by
    ...
    have hlamCell : lamInterval.RealContains ((lamMid : ℝ) + t) := by
      ...
      convert ht using 1 <;> first | ring | rfl
...
/-- Sound projection of the retained upper prototype checker instance into the generic
...
/-- Every projected type-(iv) height in the retained upper prototype has an equal-area regular
...
/-- Candidate-facing conclusion for the retained upper prototype.  No stationarity hypothesis is
...
/-- Complete retained-upper-prototype candidate-facing conclusion.  The checked stationary pair
