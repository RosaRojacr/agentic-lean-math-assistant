...
namespace MiddleFaceCell46

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0046`, spanning `[102461/100000, 102471/100000]`. -/
def brick : Brick where
  lamLo := 102461 / 100000
  lamHi := 102471 / 100000
  centers := ![485913501719284701 / 2500000000000000000,
    1461960623210020291 / 5000000000000000000,
    4452885577987982761 / 10000000000000000000,
    4933174420073761569 / 10000000000000000000]
  slopes := ![1794938206784948163 / 1000000000000000000,
    2207941169323104491 / 500000000000000000,
    2639718311238810333 / 500000000000000000,
    1625378124765036961 / 250000000000000000]
  yXiSlope := 32697273 / 50000000
  vRhoSlope := 88766147 / 100000000
...
/-- Unconditional real-range conclusion for the B0046 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102461 / 100000 : ℝ) ≤ lam → lam ≤ 102471 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19426 / 100000 : ℝ) ≤ q ∧ q ≤ 19447 / 100000) :
    (193040 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (193247 / 1000000 : ℝ) := by
  have hmonoLo : sin (19426 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19447 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19426 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19447 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19426 / 100000 : ℝ) ≤ q ∧ q ≤ 19447 / 100000) :
    (981150 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981191 / 1000000 : ℝ) := by
  have hmonoLo : cos (19447 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19426 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19447 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19426 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29216 / 100000 : ℝ) ≤ q ∧ q ≤ 29263 / 100000) :
    (288021 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (288472 / 1000000 : ℝ) := by
  have hmonoLo : sin (29216 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29263 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29216 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29263 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29216 / 100000 : ℝ) ≤ q ∧ q ≤ 29263 / 100000) :
    (957488 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957624 / 1000000 : ℝ) := by
  have hmonoLo : cos (29263 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29216 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29263 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29216 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44501 / 100000 : ℝ) ≤ q ∧ q ≤ 44557 / 100000) :
    (430466 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (430973 / 1000000 : ℝ) := by
  have hmonoLo : sin (44501 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44557 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44501 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44557 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49298 / 100000 : ℝ) ≤ q ∧ q ≤ 49366 / 100000) :
    (473253 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (473853 / 1000000 : ℝ) := by
  have hmonoLo : sin (49298 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49366 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49298 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49366 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49298 / 100000 : ℝ) ≤ q ∧ q ≤ 49366 / 100000) :
    (880604 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (880927 / 1000000 : ℝ) := by
  have hmonoLo : cos (49366 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49298 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49366 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49298 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19426000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19447000 / 100000000) :
    (19304000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19324700 / 100000000 : ℝ) ∧
      (98115000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98119100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19426000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19447000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19447000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19426000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29216000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29263000 / 100000000) :
    (28802100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28847200 / 100000000 : ℝ) ∧
      (95748800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95762400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29216000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29263000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29263000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29216000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44501000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44557000 / 100000000) :
    (43046600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43097300 / 100000000 : ℝ) ∧
      (90236500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90260700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44501000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44557000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44557000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44501000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49298000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49366000 / 100000000) :
    (47325300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47385300 / 100000000 : ℝ) ∧
      (88060400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88092700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49298000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49366000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49366000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49298000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0046. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102461 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102471 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19426000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19447000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29216000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29263000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44501000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44557000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49298000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49366000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0046 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 247 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (247 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0046 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102461 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102471 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19426 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19447 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29216 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44501 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44557 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49298 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49366 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981191 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19426 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19426 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (902365 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44557 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44557 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (473853 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49366 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49366 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (430466 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44501 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44501 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102471 / 100000 : ℝ) * (49366 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102461 / 100000 : ℝ) * (29216 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16230 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16756 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981191 / 1000000 : ℝ) * (16230 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190236 / 100000 : ℝ) * (16756 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190236 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29216 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29263 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102461 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102471 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102461 / 100000 : ℝ) * (288021 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102471 / 100000 : ℝ) * (288472 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19426 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19447 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29216 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29263 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102461 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102471 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19426 / 100000, 19447 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29216 / 100000, 29263 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102461 / 100000, 102471 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨193040 / 1000000, 193247 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981150 / 1000000, 981191 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨288021 / 1000000, 288472 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957488 / 1000000, 957624 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0046 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0046 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102471 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102461 / 100000 : ℝ) * (473253 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102471 / 100000 : ℝ) * (473853 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49298 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49366 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49298 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49366 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102461 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0046`.
...
/-- Sound projection of the B0046 checker instance into the generic
...
/-- Every projected type-(iv) height in B0046 has an equal-area regular
...
/-- Candidate-facing conclusion for B0046.  No stationarity hypothesis is
...
/-- Complete B0046 candidate-facing conclusion.  The checked stationary pair
