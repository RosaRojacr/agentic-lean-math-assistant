...
namespace MiddleFaceCell9

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0009`, spanning `[102091/100000, 102101/100000]`. -/
def brick : Brick where
  lamLo := 102091 / 100000
  lamHi := 102101 / 100000
  centers := ![935900065727733981 / 5000000000000000000,
    1376166261204303139 / 5000000000000000000,
    4245316205812059863 / 10000000000000000000,
    4678842843467374711 / 10000000000000000000]
  slopes := ![65744194103454591 / 31250000000000000,
    1219833949384540421 / 250000000000000000,
    5972386925255381309 / 1000000000000000000,
    7280923130455099587 / 1000000000000000000]
  yXiSlope := 33533431 / 50000000
  vRhoSlope := 89454299 / 100000000
...
/-- Unconditional real-range conclusion for the B0009 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102091 / 100000 : ℝ) ≤ lam → lam ≤ 102101 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18706 / 100000 : ℝ) ≤ q ∧ q ≤ 18730 / 100000) :
    (185970 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (186207 / 1000000 : ℝ) := by
  have hmonoLo : sin (18706 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18730 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18706 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18730 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18706 / 100000 : ℝ) ≤ q ∧ q ≤ 18730 / 100000) :
    (982510 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982556 / 1000000 : ℝ) := by
  have hmonoLo : cos (18730 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18706 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18730 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18706 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27498 / 100000 : ℝ) ≤ q ∧ q ≤ 27549 / 100000) :
    (271527 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (272019 / 1000000 : ℝ) := by
  have hmonoLo : sin (27498 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27549 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27498 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27549 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27498 / 100000 : ℝ) ≤ q ∧ q ≤ 27549 / 100000) :
    (962292 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962431 / 1000000 : ℝ) := by
  have hmonoLo : cos (27549 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27498 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27549 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27498 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42422 / 100000 : ℝ) ≤ q ∧ q ≤ 42485 / 100000) :
    (411610 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (412185 / 1000000 : ℝ) := by
  have hmonoLo : sin (42422 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42485 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42422 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42485 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46751 / 100000 : ℝ) ≤ q ∧ q ≤ 46826 / 100000) :
    (450664 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (451335 / 1000000 : ℝ) := by
  have hmonoLo : sin (46751 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46826 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46751 / 100000)).1
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46751 / 100000 : ℝ) ≤ q ∧ q ≤ 46826 / 100000) :
    (892354 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (892694 / 1000000 : ℝ) := by
  have hmonoLo : cos (46826 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46751 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46826 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46751 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18706000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18730000 / 100000000) :
    (18597000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18620700 / 100000000 : ℝ) ∧
      (98251000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98255600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18706000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18730000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18730000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18706000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27498000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27549000 / 100000000) :
    (27152700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27201900 / 100000000 : ℝ) ∧
      (96229200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96243100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27498000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27549000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27549000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27498000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42422000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42485000 / 100000000) :
    (41161000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41218500 / 100000000 : ℝ) ∧
      (91110000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91136100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42422000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42485000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42485000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42422000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46751000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46826000 / 100000000) :
    (45066400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45133500 / 100000000 : ℝ) ∧
      (89235400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89269400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46751000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46826000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46826000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46751000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0009. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102091 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102101 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18706000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18730000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27498000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27549000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42422000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42485000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46751000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46826000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0009 brick. -/
...
B0009 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0009 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102091 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102101 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18706 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18730 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27498 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42422 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42485 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46751 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46826 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982556 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18706 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18706 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (911100 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42485 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42485 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (451335 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46826 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46826 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (411610 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42422 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42422 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102101 / 100000 : ℝ) * (46826 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102091 / 100000 : ℝ) * (27498 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16176 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16642 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982556 / 1000000 : ℝ) * (16176 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191109 / 100000 : ℝ) * (16642 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191109 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27498 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27549 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102091 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102101 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102091 / 100000 : ℝ) * (271527 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102101 / 100000 : ℝ) * (272019 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18706 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18730 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27498 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27549 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102091 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102101 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18706 / 100000, 18730 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27498 / 100000, 27549 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102091 / 100000, 102101 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨185970 / 1000000, 186207 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982510 / 1000000, 982556 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨271527 / 1000000, 272019 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962292 / 1000000, 962431 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0009 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0009 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102101 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102091 / 100000 : ℝ) * (450664 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102101 / 100000 : ℝ) * (451335 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46751 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46826 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46751 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46826 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102091 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0009`.
...
/-- Sound projection of the B0009 checker instance into the generic
...
/-- Every projected type-(iv) height in B0009 has an equal-area regular
...
/-- Candidate-facing conclusion for B0009.  No stationarity hypothesis is
...
/-- Complete B0009 candidate-facing conclusion.  The checked stationary pair
