...
namespace MiddleFaceCell0

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0000`, spanning `[102001/100000, 102011/100000]`. -/
def brick : Brick where
  lamLo := 102001 / 100000
  lamHi := 102011 / 100000
  centers := ![1852465187781619081 / 10000000000000000000,
    2707826193809187847 / 10000000000000000000,
    2095335723171902431 / 5000000000000000000,
    4612314442061199433 / 10000000000000000000]
  slopes := ![438797283131686507 / 200000000000000000,
    2506253839052346669 / 500000000000000000,
    1234671831318607643 / 200000000000000000,
    7505849097064381361 / 1000000000000000000]
  yXiSlope := 67505189 / 100000000
  vRhoSlope := 4481579 / 5000000
...
/-- Unconditional real-range conclusion for the B0000 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102001 / 100000 : ℝ) ≤ lam → lam ≤ 102011 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18510 / 100000 : ℝ) ≤ q ∧ q ≤ 18540 / 100000) :
    (184040 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (184350 / 1000000 : ℝ) := by
  have hmonoLo : sin (18510 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18540 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18510 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18540 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18510 / 100000 : ℝ) ≤ q ∧ q ≤ 18540 / 100000) :
    (982860 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982920 / 1000000 : ℝ) := by
  have hmonoLo : cos (18540 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18510 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18540 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18510 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27050 / 100000 : ℝ) ≤ q ∧ q ≤ 27110 / 100000) :
    (267210 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (267800 / 1000000 : ℝ) := by
  have hmonoLo : sin (27050 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27110 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27050 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27110 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27050 / 100000 : ℝ) ≤ q ∧ q ≤ 27110 / 100000) :
    (963470 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (963650 / 1000000 : ℝ) := by
  have hmonoLo : cos (27110 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27050 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27110 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27050 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (41870 / 100000 : ℝ) ≤ q ∧ q ≤ 41940 / 100000) :
    (406570 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (407220 / 1000000 : ℝ) := by
  have hmonoLo : sin (41870 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (41940 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (41870 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (41940 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46080 / 100000 : ℝ) ≤ q ∧ q ≤ 46170 / 100000) :
    (444660 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (445480 / 1000000 : ℝ) := by
  have hmonoLo : sin (46080 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46170 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46080 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46170 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46080 / 100000 : ℝ) ≤ q ∧ q ≤ 46170 / 100000) :
    (895290 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (895700 / 1000000 : ℝ) := by
  have hmonoLo : cos (46170 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46080 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46170 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46080 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18512000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18537000 / 100000000) :
    (18404000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18435000 / 100000000 : ℝ) ∧
      (98286000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98292000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18512000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18537000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18537000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18512000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27052000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27105000 / 100000000) :
    (26721000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (26780000 / 100000000 : ℝ) ∧
      (96347000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96365000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27052000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27105000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27105000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27052000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (41874000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 41940000 / 100000000) :
    (40657000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (40722000 / 100000000 : ℝ) ∧
      (91333000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91369000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (41874000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (41940000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (41940000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (41874000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46084000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46162000 / 100000000) :
    (44466000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44548000 / 100000000 : ℝ) ∧
      (89529000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89570000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46084000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46162000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46162000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46084000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0000. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102001 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102011 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18512000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18537000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27052000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27105000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (41874000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 41940000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46084000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46162000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0000 brick. -/
...
B0000 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0000 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102001 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102011 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18512 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (1854 / 10000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (2704 / 10000 : ℝ) ≤ y p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (41874 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (4194 / 10000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (4607 / 10000 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46162 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (98292 / 100000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18512 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18512 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (91333 / 100000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (4194 / 10000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (4194 / 10000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (4454 / 10000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46162 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46162 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (4066 / 10000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (41874 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (41874 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102011 / 100000 : ℝ) * (46162 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102001 / 100000 : ℝ) * (2704 / 10000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16163 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (98292 / 100000 : ℝ) * (16163 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191332 / 100000 : ℝ) * (1661 / 1000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191332 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27050 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27110 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102001 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102011 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102001 / 100000 : ℝ) * (267210 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102011 / 100000 : ℝ) * (267800 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18510 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18540 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27050 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27110 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102001 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102011 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18510 / 100000, 18540 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27050 / 100000, 27110 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102001 / 100000, 102011 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨184040 / 1000000, 184350 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982860 / 1000000, 982920 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨267210 / 1000000, 267800 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨963470 / 1000000, 963650 / 1000000, by norm_num⟩
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102011 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102001 / 100000 : ℝ) * (444660 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102011 / 100000 : ℝ) * (445480 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46080 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46170 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46080 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46170 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102001 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0000`.
...
/-- Sound projection of the B0000 checker instance into the generic
...
private theorem etaRoot_spec {t xi : ℝ}
  ...
  have hlo : C4 (pointOf t (zAt (-radiiReal 1))) ≤ 0 := by
    have h := C4_eta_low_face_margin t (zAt (-radiiReal 1)) ht
      (hz _ ⟨le_rfl, (neg_le_self (radiiReal_pos 1).le)⟩) (by simp [zAt])
    linarith
  have hhi : 0 ≤ C4 (pointOf t (zAt (radiiReal 1))) := by
    have h := C4_eta_high_face_margin t (zAt (radiiReal 1)) ht
      (hz _ ⟨(neg_le_self (radiiReal_pos 1).le), le_rfl⟩) (by simp [zAt])
    linarith
...
private theorem sigmaRoot_spec {t rho : ℝ}
  ...
  have hlo : C3 (pointOf t (zAt (-radiiReal 3))) ≤ 0 := by
    have h := C3_sigma_low_face_margin t (zAt (-radiiReal 3)) ht
      (hz _ ⟨le_rfl, (neg_le_self (radiiReal_pos 3).le)⟩) (by simp [zAt])
    linarith
  have hhi : 0 ≤ C3 (pointOf t (zAt (radiiReal 3))) := by
    have h := C3_sigma_high_face_margin t (zAt (radiiReal 3)) ht
      (hz _ ⟨(neg_le_self (radiiReal_pos 3).le), le_rfl⟩) (by simp [zAt])
    linarith
...
/-- The compact type-(iii) curvature projection of the B0000 cell.  The
...
curvature projection of the B0000 cell. -/
...
/-- The compact type-(iv) curvature projection of the B0000 cell.  The
endpoints are reversed because cosine is decreasing on the certified branch. -/
...
/-- Every type-(iv) curvature in the projected B0000 cell has a
...
theorem projected_typeFour_scalarImprovement_exists
  ...
  have ht' : (MiddleFaceAssembly.tInterval brick).RealContains t := by
    simpa [MiddleFaceAssembly.tInterval, MiddleFaceAssembly.tRadius,
      tInterval, tRadius] using ht
  have hh₄' : h₄ ∈ MiddleFaceAssembly.Model.typeFourCellInterval brick t := by
    simpa [MiddleFaceAssembly.Model.typeFourCellInterval,
      MiddleFaceAssembly.Model.typeFourCellHeight,
      MiddleFaceAssembly.Model.radiiReal, typeFourCellInterval,
      typeFourCellHeight, radiiReal] using hh₄
  rcases
      MiddleFaceAssembly.Conditions.projected_typeFour_scalarImprovement_exists
        checkedConditions ht' hh₄' with
    ⟨h₃, hh₃, _hregular, harea, hperimeter⟩
  refine ⟨h₃, ?_, ?_, ?_⟩
  · simpa [MiddleFaceAssembly.Model.typeThreeCellInterval,
      MiddleFaceAssembly.Model.typeThreeCellHeight,
      MiddleFaceAssembly.Model.radiiReal, typeThreeCellInterval,
      typeThreeCellHeight, radiiReal] using hh₃
  · simpa [MiddleFaceAssembly.lamMid, lamMid] using harea
  · simpa [MiddleFaceAssembly.lamMid, lamMid] using hperimeter
...
/-- The B0000 cell has a checker root by four scalar IVTs.  The
...
theorem triangular_root (t : ℝ) (ht : tInterval.RealContains t) :
  ...
  have ht' : (MiddleFaceAssembly.tInterval brick).RealContains t := by
    change tInterval.RealContains t
    exact ht
  rcases checkedConditions.rootProjection t ht' with ⟨z, projection⟩
  refine ⟨z, ?_, ?_⟩
  · change MiddleFaceAssembly.InSymmetricBox
      (MiddleFaceAssembly.Model.radiiReal brick) z
    exact projection.mem_box
  · intro j
    have h := projection.equations j
    change rootMap t z j = 0 at h
    exact h
...
/-- The B0000-cell root is a genuine stationary equal-area scalar
...
curvature is the unique root in the B0000 cell's compact projection.
...
/-- The exact B0000 cell contains exactly one regular stationary type-(iv)
...
/-- The B0000 certificate supplies a stationary fold with the exact
...
/-- Every regular stationary type-(iv) curvature in the B0000 cell is the
...
/-- Candidate-facing end of the B0000-cell vertical slice for every regular
...
/-- Every modeled type-(iv) candidate whose curvature lies in the exact B0000
...
theorem projectedCandidate_not_isWeightedPerimeterMinimizer
  ...
  have ht' : (MiddleFaceAssembly.tInterval brick).RealContains
    ...
    simpa [MiddleFaceAssembly.tInterval, MiddleFaceAssembly.tRadius,
      tInterval, tRadius] using ht
  have hprojected' :
      candidate.h ∈ MiddleFaceAssembly.Model.typeFourCellInterval brick
        (lam0 - (lamMid : ℝ)) := by
    simpa [MiddleFaceAssembly.Model.typeFourCellInterval,
      MiddleFaceAssembly.Model.typeFourCellHeight,
      MiddleFaceAssembly.Model.radiiReal, typeFourCellInterval,
      typeFourCellHeight, radiiReal] using hprojected
  have hcenter :
      (MiddleFaceAssembly.lamMid brick : ℝ) +
        (lam0 - (lamMid : ℝ)) = lam0 := by
    change (lamMid : ℝ) + (lam0 - (lamMid : ℝ)) = lam0
    ring
  exact
    MiddleFaceAssembly.Conditions.projectedCandidate_not_isWeightedPerimeterMinimizer
      checkedConditions ht' hcenter candidate hcandidate hprojected'

/-- Complete B0000 candidate-facing conclusion.  The checked stationary pair
promotes to every regular or endpoint modeled type-(iv) curvature.  Candidate
stationarity and cell projection are not inputs. -/
