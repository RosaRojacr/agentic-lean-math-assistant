...
namespace MiddleFaceCell108

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0108`, spanning `[103081/100000, 103091/100000]`. -/
def brick : Brick where
  lamLo := 103081 / 100000
  lamHi := 103091 / 100000
  centers := ![2042801560728739917 / 10000000000000000000,
    3179011000414938743 / 10000000000000000000,
    2376334745563493419 / 5000000000000000000,
    5305038255053493111 / 10000000000000000000]
  slopes := ![713875790184405883 / 500000000000000000,
    1923425546657068541 / 500000000000000000,
    4444016893956569979 / 1000000000000000000,
    5552388889747495841 / 1000000000000000000]
  yXiSlope := 62957801 / 100000000
  vRhoSlope := 87728429 / 100000000
...
/-- Unconditional real-range conclusion for the B0108 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103081 / 100000 : ℝ) ≤ lam → lam ≤ 103091 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20419 / 100000 : ℝ) ≤ q ∧ q ≤ 20437 / 100000) :
    (202774 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202951 / 1000000 : ℝ) := by
  have hmonoLo : sin (20419 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20437 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20419 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20437 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20419 / 100000 : ℝ) ≤ q ∧ q ≤ 20437 / 100000) :
    (979189 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979226 / 1000000 : ℝ) := by
  have hmonoLo : cos (20437 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20419 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20437 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20419 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31770 / 100000 : ℝ) ≤ q ∧ q ≤ 31811 / 100000) :
    (312382 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (312772 / 1000000 : ℝ) := by
  have hmonoLo : sin (31770 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31811 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31770 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31811 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31770 / 100000 : ℝ) ≤ q ∧ q ≤ 31811 / 100000) :
    (949828 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (949957 / 1000000 : ℝ) := by
  have hmonoLo : cos (31811 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31770 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31811 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31770 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47503 / 100000 : ℝ) ≤ q ∧ q ≤ 47550 / 100000) :
    (457365 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (457784 / 1000000 : ℝ) := by
  have hmonoLo : sin (47503 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47550 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47503 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47550 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (53021 / 100000 : ℝ) ≤ q ∧ q ≤ 53080 / 100000) :
    (505714 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (506224 / 1000000 : ℝ) := by
  have hmonoLo : sin (53021 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (53080 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (53021 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (53080 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (53021 / 100000 : ℝ) ≤ q ∧ q ≤ 53080 / 100000) :
    (862402 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (862701 / 1000000 : ℝ) := by
  have hmonoLo : cos (53080 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (53021 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (53080 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (53021 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20419000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20437000 / 100000000) :
    (20277400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20295100 / 100000000 : ℝ) ∧
      (97918900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97922600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20419000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20437000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20437000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20419000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31770000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31811000 / 100000000) :
    (31238200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31277200 / 100000000 : ℝ) ∧
      (94982800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (94995700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31770000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31811000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31811000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31770000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47503000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47550000 / 100000000) :
    (45736500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45778400 / 100000000 : ℝ) ∧
      (88906300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88928000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47503000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47550000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47550000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47503000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (53021000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 53080000 / 100000000) :
    (50571400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50622400 / 100000000 : ℝ) ∧
      (86240200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86270100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (53021000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (53080000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (53080000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (53021000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0108. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103081 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103091 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20419000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20437000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31770000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31811000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47503000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47550000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (53021000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 53080000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0108 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (531 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 119 / 250, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 531 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (119 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (531 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (119 / 250)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0108 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103081 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103091 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20419 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20437 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31770 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47503 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47550 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (53021 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (53080 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979226 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20419 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20419 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (889063 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47550 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47550 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (506224 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (53080 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (53080 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (457365 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47503 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47503 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103091 / 100000 : ℝ) * (53080 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103081 / 100000 : ℝ) * (31770 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16314 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16939 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979226 / 1000000 : ℝ) * (16314 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188906 / 100000 : ℝ) * (16939 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188906 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31770 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31811 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103081 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103091 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103081 / 100000 : ℝ) * (312382 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103091 / 100000 : ℝ) * (312772 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20419 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20437 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31770 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31811 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103081 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103091 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20419 / 100000, 20437 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31770 / 100000, 31811 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103081 / 100000, 103091 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202774 / 1000000, 202951 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979189 / 1000000, 979226 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨312382 / 1000000, 312772 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨949828 / 1000000, 949957 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0108 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0108 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103091 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103081 / 100000 : ℝ) * (505714 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103091 / 100000 : ℝ) * (506224 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (53021 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 53080 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (53021 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 53080 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103081 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0108`.
...
/-- Sound projection of the B0108 checker instance into the generic
...
/-- Every projected type-(iv) height in B0108 has an equal-area regular
...
/-- Candidate-facing conclusion for B0108.  No stationarity hypothesis is
...
/-- Complete B0108 candidate-facing conclusion.  The checked stationary pair
