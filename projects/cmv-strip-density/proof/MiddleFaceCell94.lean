...
namespace MiddleFaceCell94

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0094`, spanning `[102941/100000, 102951/100000]`. -/
def brick : Brick where
  lamLo := 102941 / 100000
  lamHi := 102951 / 100000
  centers := ![1011162040160505961 / 5000000000000000000,
    3124383669555266659 / 10000000000000000000,
    4689331733385216183 / 10000000000000000000,
    130650591165128183 / 250000000000000000]
  slopes := ![1498576559772188881 / 1000000000000000000,
    3958427462773870737 / 1000000000000000000,
    4606359029096558953 / 1000000000000000000,
    5737757686159847461 / 1000000000000000000]
  yXiSlope := 31737413 / 50000000
  vRhoSlope := 87952211 / 100000000
...
/-- Unconditional real-range conclusion for the B0094 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102941 / 100000 : ℝ) ≤ lam → lam ≤ 102951 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20214 / 100000 : ℝ) ≤ q ∧ q ≤ 20232 / 100000) :
    (200766 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200943 / 1000000 : ℝ) := by
  have hmonoLo : sin (20214 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20232 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20214 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20232 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20214 / 100000 : ℝ) ≤ q ∧ q ≤ 20232 / 100000) :
    (979603 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979640 / 1000000 : ℝ) := by
  have hmonoLo : cos (20232 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20214 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20232 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20214 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31223 / 100000 : ℝ) ≤ q ∧ q ≤ 31265 / 100000) :
    (307181 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (307582 / 1000000 : ℝ) := by
  have hmonoLo : sin (31223 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31265 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31223 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31265 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31223 / 100000 : ℝ) ≤ q ∧ q ≤ 31265 / 100000) :
    (951521 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951651 / 1000000 : ℝ) := by
  have hmonoLo : cos (31265 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31223 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31265 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31223 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46869 / 100000 : ℝ) ≤ q ∧ q ≤ 46918 / 100000) :
    (451717 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (452156 / 1000000 : ℝ) := by
  have hmonoLo : sin (46869 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46918 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46869 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46918 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52230 / 100000 : ℝ) ≤ q ∧ q ≤ 52290 / 100000) :
    (498874 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (499395 / 1000000 : ℝ) := by
  have hmonoLo : sin (52230 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52290 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52230 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52290 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52230 / 100000 : ℝ) ≤ q ∧ q ≤ 52290 / 100000) :
    (866374 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (866675 / 1000000 : ℝ) := by
  have hmonoLo : cos (52290 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52230 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52290 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52230 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20214000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20232000 / 100000000) :
    (20076600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20094300 / 100000000 : ℝ) ∧
      (97960300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97964000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20214000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20232000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20232000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20214000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31223000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31265000 / 100000000) :
    (30718100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30758200 / 100000000 : ℝ) ∧
      (95152100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95165100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31223000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31265000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31265000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31223000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46869000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46918000 / 100000000) :
    (45171700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45215600 / 100000000 : ℝ) ∧
      (89193900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89216100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46869000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46918000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46918000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46869000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52230000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52290000 / 100000000) :
    (49887400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49939500 / 100000000 : ℝ) ∧
      (86637400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86667500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52230000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52290000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52290000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52230000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0094. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102941 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102951 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20214000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20232000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31223000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31265000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46869000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46918000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52230000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52290000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0094 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (523 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 47 / 100, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 523 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (523 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (47 / 100)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0094 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102941 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102951 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20214 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20232 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31223 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46869 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46918 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52230 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52290 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979640 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20214 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20214 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (891939 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46918 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46918 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (499395 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52290 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52290 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (451717 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46869 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46869 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102951 / 100000 : ℝ) * (52290 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102941 / 100000 : ℝ) * (31223 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16295 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16898 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979640 / 1000000 : ℝ) * (16295 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189193 / 100000 : ℝ) * (16898 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189193 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31223 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31265 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102941 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102951 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102941 / 100000 : ℝ) * (307181 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102951 / 100000 : ℝ) * (307582 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20214 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20232 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31223 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31265 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102941 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102951 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20214 / 100000, 20232 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31223 / 100000, 31265 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102941 / 100000, 102951 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200766 / 1000000, 200943 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979603 / 1000000, 979640 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨307181 / 1000000, 307582 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951521 / 1000000, 951651 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0094 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0094 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102951 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102941 / 100000 : ℝ) * (498874 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102951 / 100000 : ℝ) * (499395 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52230 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52290 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52230 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52290 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102941 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0094`.
...
/-- Sound projection of the B0094 checker instance into the generic
...
/-- Every projected type-(iv) height in B0094 has an equal-area regular
...
/-- Candidate-facing conclusion for B0094.  No stationarity hypothesis is
...
/-- Complete B0094 candidate-facing conclusion.  The checked stationary pair
