...
namespace MiddleFaceCell39

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0039`, spanning `[102391/100000, 102401/100000]`. -/
def brick : Brick where
  lamLo := 102391 / 100000
  lamHi := 102401 / 100000
  centers := ![965454573738503231 / 5000000000000000000,
    1446368175436284273 / 5000000000000000000,
    4415523021665371277 / 10000000000000000000,
    2443602464959041269 / 5000000000000000000]
  slopes := ![923441266267978321 / 500000000000000000,
    2247341287233827153 / 500000000000000000,
    2698257446671989357 / 500000000000000000,
    6633651378208273763 / 1000000000000000000]
  yXiSlope := 16424109 / 25000000
  vRhoSlope := 4444589 / 5000000
...
/-- Unconditional real-range conclusion for the B0039 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102391 / 100000 : ℝ) ≤ lam → lam ≤ 102401 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19298 / 100000 : ℝ) ≤ q ∧ q ≤ 19320 / 100000) :
    (191784 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (192001 / 1000000 : ℝ) := by
  have hmonoLo : sin (19298 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19320 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19298 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19320 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19298 / 100000 : ℝ) ≤ q ∧ q ≤ 19320 / 100000) :
    (981394 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981438 / 1000000 : ℝ) := by
  have hmonoLo : cos (19320 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19298 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19320 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19298 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28904 / 100000 : ℝ) ≤ q ∧ q ≤ 28951 / 100000) :
    (285032 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (285483 / 1000000 : ℝ) := by
  have hmonoLo : sin (28904 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28951 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28904 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28951 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28904 / 100000 : ℝ) ≤ q ∧ q ≤ 28951 / 100000) :
    (958383 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958518 / 1000000 : ℝ) := by
  have hmonoLo : cos (28951 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28904 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28951 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28904 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44127 / 100000 : ℝ) ≤ q ∧ q ≤ 44184 / 100000) :
    (427088 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (427604 / 1000000 : ℝ) := by
  have hmonoLo : sin (44127 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44184 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44127 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44184 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48837 / 100000 : ℝ) ≤ q ∧ q ≤ 48907 / 100000) :
    (469187 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (469806 / 1000000 : ℝ) := by
  have hmonoLo : sin (48837 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48907 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48837 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48907 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48837 / 100000 : ℝ) ≤ q ∧ q ≤ 48907 / 100000) :
    (882770 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (883099 / 1000000 : ℝ) := by
  have hmonoLo : cos (48907 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48837 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48907 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48837 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19298000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19320000 / 100000000) :
    (19178400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19200100 / 100000000 : ℝ) ∧
      (98139400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98143800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19298000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19320000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19320000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19298000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28904000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28951000 / 100000000) :
    (28503200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28548300 / 100000000 : ℝ) ∧
      (95838300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95851800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28904000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28951000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28951000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28904000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44127000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44184000 / 100000000) :
    (42708800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42760400 / 100000000 : ℝ) ∧
      (90396600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90421000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44127000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44184000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44184000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44127000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48837000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48907000 / 100000000) :
    (46918700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46980600 / 100000000 : ℝ) ∧
      (88277000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88309900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48837000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48907000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48907000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48837000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0039. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102391 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102401 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19298000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19320000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28904000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28951000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44127000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44184000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48837000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48907000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0039 brick. -/
...
throughout the B0039 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102391 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102401 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19298 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19320 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28904 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44127 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44184 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48837 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48907 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981438 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19298 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19298 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (903966 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44184 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44184 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (469806 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48907 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48907 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (427088 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44127 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44127 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102401 / 100000 : ℝ) * (48907 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102391 / 100000 : ℝ) * (28904 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16220 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16735 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981438 / 1000000 : ℝ) * (16220 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190396 / 100000 : ℝ) * (16735 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190396 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28904 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28951 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102391 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102401 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102391 / 100000 : ℝ) * (285032 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102401 / 100000 : ℝ) * (285483 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19298 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19320 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28904 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28951 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102391 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102401 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19298 / 100000, 19320 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28904 / 100000, 28951 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102391 / 100000, 102401 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨191784 / 1000000, 192001 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981394 / 1000000, 981438 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨285032 / 1000000, 285483 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958383 / 1000000, 958518 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0039 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0039 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102401 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102391 / 100000 : ℝ) * (469187 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102401 / 100000 : ℝ) * (469806 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48837 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48907 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48837 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48907 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102391 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0039`.
...
/-- Sound projection of the B0039 checker instance into the generic
...
/-- Every projected type-(iv) height in B0039 has an equal-area regular
...
/-- Candidate-facing conclusion for B0039.  No stationarity hypothesis is
...
/-- Complete B0039 candidate-facing conclusion.  The checked stationary pair
