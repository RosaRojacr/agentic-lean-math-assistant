...
namespace MiddleFaceCell91

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0091`, spanning `[102911/100000, 102921/100000]`. -/
def brick : Brick where
  lamLo := 102911 / 100000
  lamHi := 102921 / 100000
  centers := ![2017804468444200083 / 10000000000000000000,
    778117737267038499 / 2500000000000000000,
    1168864509653417143 / 2500000000000000000,
    2604374051347391801 / 5000000000000000000]
  slopes := ![60581648326792171 / 40000000000000000,
    1991723460431481889 / 500000000000000000,
    928572986484683557 / 200000000000000000,
    5779375349199011603 / 1000000000000000000]
  yXiSlope := 63587917 / 100000000
  vRhoSlope := 88000897 / 100000000
...
/-- Unconditional real-range conclusion for the B0091 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102911 / 100000 : ℝ) ≤ lam → lam ≤ 102921 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20169 / 100000 : ℝ) ≤ q ∧ q ≤ 20187 / 100000) :
    (200325 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200502 / 1000000 : ℝ) := by
  have hmonoLo : sin (20169 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20187 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20169 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20187 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20169 / 100000 : ℝ) ≤ q ∧ q ≤ 20187 / 100000) :
    (979693 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979730 / 1000000 : ℝ) := by
  have hmonoLo : cos (20187 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20169 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20187 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20169 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31104 / 100000 : ℝ) ≤ q ∧ q ≤ 31146 / 100000) :
    (306048 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (306449 / 1000000 : ℝ) := by
  have hmonoLo : sin (31104 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31146 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31104 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31146 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31104 / 100000 : ℝ) ≤ q ∧ q ≤ 31146 / 100000) :
    (951887 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952016 / 1000000 : ℝ) := by
  have hmonoLo : cos (31146 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31104 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31146 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31104 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46730 / 100000 : ℝ) ≤ q ∧ q ≤ 46779 / 100000) :
    (450477 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (450915 / 1000000 : ℝ) := by
  have hmonoLo : sin (46730 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46779 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46730 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46779 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52057 / 100000 : ℝ) ≤ q ∧ q ≤ 52118 / 100000) :
    (497374 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (497904 / 1000000 : ℝ) := by
  have hmonoLo : sin (52057 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52118 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52057 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52118 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52057 / 100000 : ℝ) ≤ q ∧ q ≤ 52118 / 100000) :
    (867232 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (867536 / 1000000 : ℝ) := by
  have hmonoLo : cos (52118 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52057 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52118 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52057 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20169000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20187000 / 100000000) :
    (20032500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20050200 / 100000000 : ℝ) ∧
      (97969300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97973000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20169000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20187000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20187000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20169000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31104000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31146000 / 100000000) :
    (30604800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30644900 / 100000000 : ℝ) ∧
      (95188700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95201600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31104000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31146000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31146000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31104000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46730000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46779000 / 100000000) :
    (45047700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45091500 / 100000000 : ℝ) ∧
      (89256600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89278800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46730000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46779000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46779000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46730000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52057000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52118000 / 100000000) :
    (49737400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49790400 / 100000000 : ℝ) ∧
      (86723200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86753600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52057000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52118000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52118000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52057000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0091. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102911 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102921 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20169000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20187000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31104000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31146000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46730000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46779000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52057000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52118000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0091 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 261 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (261 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0091 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102911 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102921 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20169 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20187 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31104 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46730 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46779 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52057 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52118 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979730 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20169 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20169 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (892566 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46779 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46779 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (497904 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52118 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52118 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (450477 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46730 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46730 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102921 / 100000 : ℝ) * (52118 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102911 / 100000 : ℝ) * (31104 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16291 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16890 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979730 / 1000000 : ℝ) * (16291 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189256 / 100000 : ℝ) * (16890 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189256 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31104 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31146 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102911 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102921 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102911 / 100000 : ℝ) * (306048 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102921 / 100000 : ℝ) * (306449 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20169 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20187 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31104 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31146 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102911 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102921 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20169 / 100000, 20187 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31104 / 100000, 31146 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102911 / 100000, 102921 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200325 / 1000000, 200502 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979693 / 1000000, 979730 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨306048 / 1000000, 306449 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951887 / 1000000, 952016 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0091 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0091 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102921 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102911 / 100000 : ℝ) * (497374 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102921 / 100000 : ℝ) * (497904 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52057 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52118 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52057 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52118 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102911 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0091`.
...
/-- Sound projection of the B0091 checker instance into the generic
...
/-- Every projected type-(iv) height in B0091 has an equal-area regular
...
/-- Candidate-facing conclusion for B0091.  No stationarity hypothesis is
...
/-- Complete B0091 candidate-facing conclusion.  The checked stationary pair
