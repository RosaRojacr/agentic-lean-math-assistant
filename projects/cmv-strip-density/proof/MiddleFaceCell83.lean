...
namespace MiddleFaceCell83

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0083`, spanning `[102831/100000, 102841/100000]`. -/
def brick : Brick where
  lamLo := 102831 / 100000
  lamHi := 102841 / 100000
  centers := ![1002756703997691361 / 5000000000000000000,
    3080330260601241193 / 10000000000000000000,
    463791604710263303 / 1000000000000000000,
    103241170283852777 / 200000000000000000]
  slopes := ![77929107346999589 / 50000000000000000,
    1013056949950928241 / 250000000000000000,
    4743413085679231751 / 1000000000000000000,
    2946940613274090869 / 500000000000000000]
  yXiSlope := 12778731 / 20000000
  vRhoSlope := 88132047 / 100000000
...
/-- Unconditional real-range conclusion for the B0083 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102831 / 100000 : ℝ) ≤ lam → lam ≤ 102841 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20046 / 100000 : ℝ) ≤ q ∧ q ≤ 20064 / 100000) :
    (199120 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (199297 / 1000000 : ℝ) := by
  have hmonoLo : sin (20046 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20064 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20046 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20064 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20046 / 100000 : ℝ) ≤ q ∧ q ≤ 20064 / 100000) :
    (979939 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979976 / 1000000 : ℝ) := by
  have hmonoLo : cos (20064 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20046 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20064 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20046 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30782 / 100000 : ℝ) ≤ q ∧ q ≤ 30825 / 100000) :
    (302981 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (303392 / 1000000 : ℝ) := by
  have hmonoLo : sin (30782 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30825 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30782 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30825 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30782 / 100000 : ℝ) ≤ q ∧ q ≤ 30825 / 100000) :
    (952865 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952997 / 1000000 : ℝ) := by
  have hmonoLo : cos (30825 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30782 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30825 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30782 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46354 / 100000 : ℝ) ≤ q ∧ q ≤ 46404 / 100000) :
    (447117 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (447565 / 1000000 : ℝ) := by
  have hmonoLo : sin (46354 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46404 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46354 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46404 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51590 / 100000 : ℝ) ≤ q ∧ q ≤ 51652 / 100000) :
    (493317 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (493858 / 1000000 : ℝ) := by
  have hmonoLo : sin (51590 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51652 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51590 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51652 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51590 / 100000 : ℝ) ≤ q ∧ q ≤ 51652 / 100000) :
    (869543 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (869850 / 1000000 : ℝ) := by
  have hmonoLo : cos (51652 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51590 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51652 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51590 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20046000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20064000 / 100000000) :
    (19912000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19929700 / 100000000 : ℝ) ∧
      (97993900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97997600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20046000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20064000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20064000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20046000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30782000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30825000 / 100000000) :
    (30298100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30339200 / 100000000 : ℝ) ∧
      (95286500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95299700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30782000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30825000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30825000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30782000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46354000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46404000 / 100000000) :
    (44711700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44756500 / 100000000 : ℝ) ∧
      (89425100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89447600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46354000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46404000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46404000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46354000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51590000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51652000 / 100000000) :
    (49331700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49385800 / 100000000 : ℝ) ∧
      (86954300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86985000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51590000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51652000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51652000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51590000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0083. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102831 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102841 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20046000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20064000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30782000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30825000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46354000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46404000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51590000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51652000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0083 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 517 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (517 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0083 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102831 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102841 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20046 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20064 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30782 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46354 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46404 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51590 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51652 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979976 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20046 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20046 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (894251 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46404 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46404 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (493858 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51652 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51652 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (447117 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46354 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46354 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102841 / 100000 : ℝ) * (51652 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102831 / 100000 : ℝ) * (30782 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16280 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16866 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979976 / 1000000 : ℝ) * (16280 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189425 / 100000 : ℝ) * (16866 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189425 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30782 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30825 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102831 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102841 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102831 / 100000 : ℝ) * (302981 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102841 / 100000 : ℝ) * (303392 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20046 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20064 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30782 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30825 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102831 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102841 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20046 / 100000, 20064 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30782 / 100000, 30825 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102831 / 100000, 102841 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨199120 / 1000000, 199297 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979939 / 1000000, 979976 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨302981 / 1000000, 303392 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952865 / 1000000, 952997 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0083 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0083 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102841 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102831 / 100000 : ℝ) * (493317 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102841 / 100000 : ℝ) * (493858 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51590 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51652 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51590 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51652 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102831 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0083`.
...
/-- Sound projection of the B0083 checker instance into the generic
...
/-- Every projected type-(iv) height in B0083 has an equal-area regular
...
/-- Candidate-facing conclusion for B0083.  No stationarity hypothesis is
...
/-- Complete B0083 candidate-facing conclusion.  The checked stationary pair
