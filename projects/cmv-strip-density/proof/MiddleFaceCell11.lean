...
namespace MiddleFaceCell11

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0011`, spanning `[102111/100000, 102121/100000]`. -/
def brick : Brick where
  lamLo := 102111 / 100000
  lamHi := 102121 / 100000
  centers := ![46899715023099963 / 250000000000000000,
    690515697226568177 / 2500000000000000000,
    425721821125713229 / 1000000000000000000,
    4693356765298633723 / 10000000000000000000]
  slopes := ![2084695236683936173 / 1000000000000000000,
    4850984842166195201 / 1000000000000000000,
    592970459474171453 / 100000000000000000,
    3616546214555632031 / 500000000000000000]
  yXiSlope := 33485643 / 50000000
  vRhoSlope := 22353869 / 25000000
...
/-- Unconditional real-range conclusion for the B0011 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102111 / 100000 : ℝ) ≤ lam → lam ≤ 102121 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18748 / 100000 : ℝ) ≤ q ∧ q ≤ 18772 / 100000) :
    (186383 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (186620 / 1000000 : ℝ) := by
  have hmonoLo : sin (18748 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18772 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18748 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18772 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18748 / 100000 : ℝ) ≤ q ∧ q ≤ 18772 / 100000) :
    (982432 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982478 / 1000000 : ℝ) := by
  have hmonoLo : cos (18772 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18748 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18772 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18748 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27595 / 100000 : ℝ) ≤ q ∧ q ≤ 27646 / 100000) :
    (272461 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (272952 / 1000000 : ℝ) := by
  have hmonoLo : sin (27595 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27646 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27595 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27646 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27595 / 100000 : ℝ) ≤ q ∧ q ≤ 27646 / 100000) :
    (962027 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962167 / 1000000 : ℝ) := by
  have hmonoLo : cos (27646 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27595 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27646 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27595 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42541 / 100000 : ℝ) ≤ q ∧ q ≤ 42603 / 100000) :
    (412694 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (413259 / 1000000 : ℝ) := by
  have hmonoLo : sin (42541 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42603 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42541 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42603 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46896 / 100000 : ℝ) ≤ q ∧ q ≤ 46971 / 100000) :
    (451958 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (452628 / 1000000 : ℝ) := by
  have hmonoLo : sin (46896 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46971 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46896 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46971 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46896 / 100000 : ℝ) ≤ q ∧ q ≤ 46971 / 100000) :
    (891699 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (892039 / 1000000 : ℝ) := by
  have hmonoLo : cos (46971 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46896 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46971 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46896 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18748000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18772000 / 100000000) :
    (18638300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18662000 / 100000000 : ℝ) ∧
      (98243200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98247800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18748000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18772000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18772000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18748000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27595000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27646000 / 100000000) :
    (27246100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27295200 / 100000000 : ℝ) ∧
      (96202700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96216700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27595000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27646000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27646000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27595000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42541000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42603000 / 100000000) :
    (41269400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41325900 / 100000000 : ℝ) ∧
      (91061300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91087000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42541000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42603000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42603000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42541000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46896000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46971000 / 100000000) :
    (45195800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45262800 / 100000000 : ℝ) ∧
      (89169900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89203900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46896000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46971000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46971000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46896000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0011. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102111 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102121 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18748000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18772000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27595000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27646000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42541000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42603000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46896000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46971000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0011 brick. -/
...
B0011 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0011 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102111 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102121 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18748 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18772 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27595 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42541 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42603 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46896 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46971 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982478 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18748 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18748 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (910613 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42603 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42603 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (452628 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46971 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46971 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (412694 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42541 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42541 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102121 / 100000 : ℝ) * (46971 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102111 / 100000 : ℝ) * (27595 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16179 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16648 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982478 / 1000000 : ℝ) * (16179 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191061 / 100000 : ℝ) * (16648 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191061 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27595 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27646 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102111 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102121 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102111 / 100000 : ℝ) * (272461 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102121 / 100000 : ℝ) * (272952 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18748 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18772 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27595 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27646 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102111 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102121 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18748 / 100000, 18772 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27595 / 100000, 27646 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102111 / 100000, 102121 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨186383 / 1000000, 186620 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982432 / 1000000, 982478 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨272461 / 1000000, 272952 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962027 / 1000000, 962167 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0011 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0011 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102121 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102111 / 100000 : ℝ) * (451958 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102121 / 100000 : ℝ) * (452628 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46896 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46971 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46896 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46971 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102111 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0011`.
...
/-- Sound projection of the B0011 checker instance into the generic
...
/-- Every projected type-(iv) height in B0011 has an equal-area regular
...
/-- Candidate-facing conclusion for B0011.  No stationarity hypothesis is
...
/-- Complete B0011 candidate-facing conclusion.  The checked stationary pair
