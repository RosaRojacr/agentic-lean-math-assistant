...
namespace MiddleFaceCell10

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0010`, spanning `[102101/100000, 102111/100000]`. -/
def brick : Brick where
  lamLo := 102101 / 100000
  lamHi := 102111 / 100000
  centers := ![1873899145933389893 / 10000000000000000000,
    689301185849070621 / 2500000000000000000,
    4251277879117224493 / 10000000000000000000,
    292881985128646261 / 625000000000000000]
  slopes := ![523553686133329059 / 250000000000000000,
    1216276544453562869 / 250000000000000000,
    1487739921268469823 / 250000000000000000,
    7256914051475830269 / 1000000000000000000]
  yXiSlope := 67018993 / 100000000
  vRhoSlope := 44717431 / 50000000
...
/-- Unconditional real-range conclusion for the B0010 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102101 / 100000 : ℝ) ≤ lam → lam ≤ 102111 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18727 / 100000 : ℝ) ≤ q ∧ q ≤ 18751 / 100000) :
    (186177 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (186414 / 1000000 : ℝ) := by
  have hmonoLo : sin (18727 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18751 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18727 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18751 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18727 / 100000 : ℝ) ≤ q ∧ q ≤ 18751 / 100000) :
    (982471 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982517 / 1000000 : ℝ) := by
  have hmonoLo : cos (18751 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18727 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18751 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18727 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27546 / 100000 : ℝ) ≤ q ∧ q ≤ 27598 / 100000) :
    (271989 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (272490 / 1000000 : ℝ) := by
  have hmonoLo : sin (27546 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27598 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27546 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27598 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27546 / 100000 : ℝ) ≤ q ∧ q ≤ 27598 / 100000) :
    (962158 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962301 / 1000000 : ℝ) := by
  have hmonoLo : cos (27598 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27546 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27598 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27546 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42482 / 100000 : ℝ) ≤ q ∧ q ≤ 42544 / 100000) :
    (412156 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (412722 / 1000000 : ℝ) := by
  have hmonoLo : sin (42482 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42544 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42482 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42544 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46823 / 100000 : ℝ) ≤ q ∧ q ≤ 46899 / 100000) :
    (451307 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (451986 / 1000000 : ℝ) := by
  have hmonoLo : sin (46823 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46899 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46823 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46899 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46823 / 100000 : ℝ) ≤ q ∧ q ≤ 46899 / 100000) :
    (892025 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (892369 / 1000000 : ℝ) := by
  have hmonoLo : cos (46899 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46823 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46899 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46823 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18727000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18751000 / 100000000) :
    (18617700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18641400 / 100000000 : ℝ) ∧
      (98247100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98251700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18727000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18751000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18751000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18727000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27546000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27598000 / 100000000) :
    (27198900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27249000 / 100000000 : ℝ) ∧
      (96215800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96230100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27546000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27598000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27598000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27546000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42482000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42544000 / 100000000) :
    (41215600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41272200 / 100000000 : ℝ) ∧
      (91085700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91111300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42482000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42544000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42544000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42482000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46823000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46899000 / 100000000) :
    (45130700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45198600 / 100000000 : ℝ) ∧
      (89202500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89236900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46823000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46899000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46899000 / 100000000)).1
...
directional derivatives of the equal-area residual on B0010. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102101 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102111 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18727000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18751000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27546000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27598000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42482000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42544000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46823000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46899000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0010 brick. -/
...
B0010 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvHi : v p ≤ (47 / 100 : ℝ) := by
    ...
    linarith
  have hwI :
      (⟨2 / 5, 213 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
  ...
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (213 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (213 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0010 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102101 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102111 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18727 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18751 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27546 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42482 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42544 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46823 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46899 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982517 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18727 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18727 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (910857 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42544 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42544 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (451986 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46899 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46899 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (412156 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42482 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42482 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102111 / 100000 : ℝ) * (46899 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102101 / 100000 : ℝ) * (27546 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16178 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16645 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982517 / 1000000 : ℝ) * (16178 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191085 / 100000 : ℝ) * (16645 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191085 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27546 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27598 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102101 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102111 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102101 / 100000 : ℝ) * (271989 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102111 / 100000 : ℝ) * (272490 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18727 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18751 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27546 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27598 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102101 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102111 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18727 / 100000, 18751 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27546 / 100000, 27598 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102101 / 100000, 102111 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨186177 / 1000000, 186414 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982471 / 1000000, 982517 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨271989 / 1000000, 272490 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962158 / 1000000, 962301 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0010 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0010 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102111 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102101 / 100000 : ℝ) * (451307 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102111 / 100000 : ℝ) * (451986 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46823 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46899 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46823 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46899 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102101 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0010`.
...
/-- Sound projection of the B0010 checker instance into the generic
...
/-- Every projected type-(iv) height in B0010 has an equal-area regular
...
/-- Candidate-facing conclusion for B0010.  No stationarity hypothesis is
...
/-- Complete B0010 candidate-facing conclusion.  The checked stationary pair
