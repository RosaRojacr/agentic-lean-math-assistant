...
namespace MiddleFaceCell27

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0027`, spanning `[102271/100000, 102281/100000]`. -/
def brick : Brick where
  lamLo := 102271 / 100000
  lamHi := 102281 / 100000
  centers := ![1908181647400520081 / 10000000000000000000,
    1418973797086196323 / 5000000000000000000,
    4349494388434526473 / 10000000000000000000,
    480616953690916783 / 1000000000000000000]
  slopes := ![48561776134493843 / 25000000000000000,
    4638744725696453669 / 1000000000000000000,
    2805680893331530819 / 500000000000000000,
    429727521463191181 / 62500000000000000]
  yXiSlope := 66229003 / 100000000
  vRhoSlope := 89111887 / 100000000
...
/-- Unconditional real-range conclusion for the B0027 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102271 / 100000 : ℝ) ≤ lam → lam ≤ 102281 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19071 / 100000 : ℝ) ≤ q ∧ q ≤ 19093 / 100000) :
    (189556 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (189773 / 1000000 : ℝ) := by
  have hmonoLo : sin (19071 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19093 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19071 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19093 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19071 / 100000 : ℝ) ≤ q ∧ q ≤ 19093 / 100000) :
    (981828 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981870 / 1000000 : ℝ) := by
  have hmonoLo : cos (19093 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19071 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19093 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19071 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28355 / 100000 : ℝ) ≤ q ∧ q ≤ 28404 / 100000) :
    (279765 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (280237 / 1000000 : ℝ) := by
  have hmonoLo : sin (28355 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28404 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28355 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28404 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28355 / 100000 : ℝ) ≤ q ∧ q ≤ 28404 / 100000) :
    (959931 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960069 / 1000000 : ℝ) := by
  have hmonoLo : cos (28404 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28355 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28404 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28355 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43465 / 100000 : ℝ) ≤ q ∧ q ≤ 43525 / 100000) :
    (421092 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (421638 / 1000000 : ℝ) := by
  have hmonoLo : sin (43465 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43525 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43465 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43525 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48026 / 100000 : ℝ) ≤ q ∧ q ≤ 48098 / 100000) :
    (462009 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (462649 / 1000000 : ℝ) := by
  have hmonoLo : sin (48026 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48098 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48026 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48098 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48026 / 100000 : ℝ) ≤ q ∧ q ≤ 48098 / 100000) :
    (886541 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (886875 / 1000000 : ℝ) := by
  have hmonoLo : cos (48098 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48026 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48098 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48026 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19071000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19093000 / 100000000) :
    (18955600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18977300 / 100000000 : ℝ) ∧
      (98182800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98187000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19071000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19093000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19093000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19071000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28355000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28404000 / 100000000) :
    (27976500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28023700 / 100000000 : ℝ) ∧
      (95993100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96006900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28355000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28404000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28404000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28355000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43465000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43525000 / 100000000) :
    (42109200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42163800 / 100000000 : ℝ) ∧
      (90676400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90701800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43465000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43525000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43525000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43465000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48026000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48098000 / 100000000) :
    (46200900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46264900 / 100000000 : ℝ) ∧
      (88654100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88687500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48026000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48098000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48098000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48026000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0027. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102271 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102281 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19071000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19093000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28355000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28404000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43465000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43525000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48026000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48098000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0027 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 481 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (481 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0027 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102271 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102281 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19071 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19093 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28355 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43465 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43525 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48026 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48098 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981870 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19071 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19071 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (906764 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43525 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43525 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (462649 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48098 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48098 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (421092 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43465 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43465 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102281 / 100000 : ℝ) * (48098 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102271 / 100000 : ℝ) * (28355 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16203 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16698 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981870 / 1000000 : ℝ) * (16203 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190676 / 100000 : ℝ) * (16698 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190676 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28355 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28404 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102271 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102281 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102271 / 100000 : ℝ) * (279765 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102281 / 100000 : ℝ) * (280237 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19071 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19093 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28355 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28404 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102271 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102281 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19071 / 100000, 19093 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28355 / 100000, 28404 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102271 / 100000, 102281 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨189556 / 1000000, 189773 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981828 / 1000000, 981870 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨279765 / 1000000, 280237 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨959931 / 1000000, 960069 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0027 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0027 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102281 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102271 / 100000 : ℝ) * (462009 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102281 / 100000 : ℝ) * (462649 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48026 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48098 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48026 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48098 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102271 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0027`.
...
/-- Sound projection of the B0027 checker instance into the generic
...
/-- Every projected type-(iv) height in B0027 has an equal-area regular
...
/-- Candidate-facing conclusion for B0027.  No stationarity hypothesis is
...
/-- Complete B0027 candidate-facing conclusion.  The checked stationary pair
