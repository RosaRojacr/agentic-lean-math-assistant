...
namespace MiddleFaceCell111

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0111`, spanning `[103111/100000, 103121/100000]`. -/
def brick : Brick where
  lamLo := 103111 / 100000
  lamHi := 103121 / 100000
  centers := ![204706310710399577 / 1000000000000000000,
    797629295747401661 / 2500000000000000000,
    2382975833666755061 / 5000000000000000000,
    5321638386329238689 / 10000000000000000000]
  slopes := ![1413316336894848877 / 1000000000000000000,
    1911994842505616867 / 500000000000000000,
    4410848075983298437 / 1000000000000000000,
    1102890924263740841 / 200000000000000000]
  yXiSlope := 31424613 / 50000000
  vRhoSlope := 87681181 / 100000000
...
/-- Unconditional real-range conclusion for the B0111 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103111 / 100000 : ℝ) ≤ lam → lam ≤ 103121 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20462 / 100000 : ℝ) ≤ q ∧ q ≤ 20479 / 100000) :
    (203195 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (203362 / 1000000 : ℝ) := by
  have hmonoLo : sin (20462 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20479 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20462 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20479 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20462 / 100000 : ℝ) ≤ q ∧ q ≤ 20479 / 100000) :
    (979103 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979139 / 1000000 : ℝ) := by
  have hmonoLo : cos (20479 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20462 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20479 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20462 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31885 / 100000 : ℝ) ≤ q ∧ q ≤ 31926 / 100000) :
    (313474 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (313865 / 1000000 : ℝ) := by
  have hmonoLo : sin (31885 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31926 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31885 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31926 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31885 / 100000 : ℝ) ≤ q ∧ q ≤ 31926 / 100000) :
    (949467 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (949597 / 1000000 : ℝ) := by
  have hmonoLo : cos (31926 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31885 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31926 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31885 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47636 / 100000 : ℝ) ≤ q ∧ q ≤ 47683 / 100000) :
    (458547 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (458966 / 1000000 : ℝ) := by
  have hmonoLo : sin (47636 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47683 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47636 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47683 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (53187 / 100000 : ℝ) ≤ q ∧ q ≤ 53245 / 100000) :
    (507145 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (507646 / 1000000 : ℝ) := by
  have hmonoLo : sin (53187 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (53245 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (53187 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (53245 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (53187 / 100000 : ℝ) ≤ q ∧ q ≤ 53245 / 100000) :
    (861565 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (861861 / 1000000 : ℝ) := by
  have hmonoLo : cos (53245 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (53187 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (53245 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (53187 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20462000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20479000 / 100000000) :
    (20319500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20336200 / 100000000 : ℝ) ∧
      (97910300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97913900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20462000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20479000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20479000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20462000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31885000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31926000 / 100000000) :
    (31347400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31386500 / 100000000 : ℝ) ∧
      (94946700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (94959700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31885000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31926000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31926000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31885000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47636000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47683000 / 100000000) :
    (45854700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45896600 / 100000000 : ℝ) ∧
      (88845400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88867000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47636000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47683000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47683000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47636000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (53187000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 53245000 / 100000000) :
    (50714500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50764600 / 100000000 : ℝ) ∧
      (86156500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86186100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (53187000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (53245000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (53245000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (53187000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0111. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103111 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103121 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20462000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20479000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31885000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31926000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47636000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47683000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (53187000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 53245000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0111 brick. -/
...
throughout the B0111 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103111 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103121 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20462 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20479 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31885 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47636 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47683 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (53187 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (53245 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979139 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20462 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20462 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (888454 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47683 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47683 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (507646 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (53245 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (53245 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (458547 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47636 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47636 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103121 / 100000 : ℝ) * (53245 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103111 / 100000 : ℝ) * (31885 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16317 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16947 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979139 / 1000000 : ℝ) * (16317 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188845 / 100000 : ℝ) * (16947 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188845 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31885 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31926 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103111 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103121 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103111 / 100000 : ℝ) * (313474 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103121 / 100000 : ℝ) * (313865 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20462 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20479 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31885 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31926 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103111 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103121 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20462 / 100000, 20479 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31885 / 100000, 31926 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103111 / 100000, 103121 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨203195 / 1000000, 203362 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979103 / 1000000, 979139 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨313474 / 1000000, 313865 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨949467 / 1000000, 949597 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0111 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0111 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103121 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103111 / 100000 : ℝ) * (507145 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103121 / 100000 : ℝ) * (507646 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (53187 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 53245 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (53187 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 53245 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103111 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0111`.
...
/-- Sound projection of the B0111 checker instance into the generic
...
/-- Every projected type-(iv) height in B0111 has an equal-area regular
...
/-- Candidate-facing conclusion for B0111.  No stationarity hypothesis is
...
/-- Complete B0111 candidate-facing conclusion.  The checked stationary pair
