...
namespace MiddleFaceCell69

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0069`, spanning `[102691/100000, 102701/100000]`. -/
def brick : Brick where
  lamLo := 102691 / 100000
  lamHi := 102701 / 100000
  centers := ![1983123386805606511 / 10000000000000000000,
    3022713984282015313 / 10000000000000000000,
    4570210458696398403 / 10000000000000000000,
    2539034360043121957 / 5000000000000000000]
  slopes := ![328245336462361503 / 200000000000000000,
    2090196227699906749 / 500000000000000000,
    197259905968842297 / 40000000000000000,
    6107612805428380519 / 1000000000000000000]
  yXiSlope := 64443997 / 100000000
  vRhoSlope := 88366417 / 100000000
...
/-- Unconditional real-range conclusion for the B0069 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102691 / 100000 : ℝ) ≤ lam → lam ≤ 102701 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19822 / 100000 : ℝ) ≤ q ∧ q ≤ 19841 / 100000) :
    (196924 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (197111 / 1000000 : ℝ) := by
  have hmonoLo : sin (19822 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19841 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19822 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19841 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19822 / 100000 : ℝ) ≤ q ∧ q ≤ 19841 / 100000) :
    (980381 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980419 / 1000000 : ℝ) := by
  have hmonoLo : cos (19841 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19822 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19841 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19822 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30205 / 100000 : ℝ) ≤ q ∧ q ≤ 30249 / 100000) :
    (297478 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (297899 / 1000000 : ℝ) := by
  have hmonoLo : sin (30205 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30249 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30205 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30249 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30205 / 100000 : ℝ) ≤ q ∧ q ≤ 30249 / 100000) :
    (954597 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954729 / 1000000 : ℝ) := by
  have hmonoLo : cos (30249 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30205 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30249 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30205 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45676 / 100000 : ℝ) ≤ q ∧ q ≤ 45728 / 100000) :
    (441042 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (441510 / 1000000 : ℝ) := by
  have hmonoLo : sin (45676 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45728 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45676 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45728 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50749 / 100000 : ℝ) ≤ q ∧ q ≤ 50813 / 100000) :
    (485985 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (486545 / 1000000 : ℝ) := by
  have hmonoLo : sin (50749 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50813 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50749 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50813 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50749 / 100000 : ℝ) ≤ q ∧ q ≤ 50813 / 100000) :
    (873655 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (873968 / 1000000 : ℝ) := by
  have hmonoLo : cos (50813 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50749 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50813 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50749 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19822000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19841000 / 100000000) :
    (19692400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19711100 / 100000000 : ℝ) ∧
      (98038100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98041900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19822000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19841000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19841000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19822000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30205000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30249000 / 100000000) :
    (29747800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29789900 / 100000000 : ℝ) ∧
      (95459700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95472900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30205000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30249000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30249000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30205000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45676000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45728000 / 100000000) :
    (44104200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44151000 / 100000000 : ℝ) ∧
      (89725600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89748700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45676000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45728000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45728000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45676000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50749000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50813000 / 100000000) :
    (48598500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48654500 / 100000000 : ℝ) ∧
      (87365500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87396800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50749000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50813000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50813000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50749000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0069. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102691 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102701 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19822000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19841000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30205000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30249000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45676000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45728000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50749000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50813000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0069 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 509 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (509 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0069 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102691 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102701 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19822 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19841 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30205 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45676 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45728 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50749 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50813 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980419 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19822 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19822 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (897256 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45728 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45728 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (486545 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50813 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50813 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (441042 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45676 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45676 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102701 / 100000 : ℝ) * (50813 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102691 / 100000 : ℝ) * (30205 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16261 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16825 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980419 / 1000000 : ℝ) * (16261 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189725 / 100000 : ℝ) * (16825 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189725 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30205 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30249 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102691 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102701 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102691 / 100000 : ℝ) * (297478 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102701 / 100000 : ℝ) * (297899 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19822 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19841 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30205 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30249 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102691 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102701 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19822 / 100000, 19841 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30205 / 100000, 30249 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102691 / 100000, 102701 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨196924 / 1000000, 197111 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980381 / 1000000, 980419 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨297478 / 1000000, 297899 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954597 / 1000000, 954729 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0069 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0069 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102701 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102691 / 100000 : ℝ) * (485985 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102701 / 100000 : ℝ) * (486545 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50749 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50813 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50749 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50813 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102691 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0069`.
...
/-- Sound projection of the B0069 checker instance into the generic
...
/-- Every projected type-(iv) height in B0069 has an equal-area regular
...
/-- Candidate-facing conclusion for B0069.  No stationarity hypothesis is
...
/-- Complete B0069 candidate-facing conclusion.  The checked stationary pair
