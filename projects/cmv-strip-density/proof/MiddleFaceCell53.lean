...
namespace MiddleFaceCell53

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0053`, spanning `[102531/100000, 102541/100000]`. -/
def brick : Brick where
  lamLo := 102531 / 100000
  lamHi := 102541 / 100000
  centers := ![1956044286349315909 / 10000000000000000000,
    2954566976359567693 / 10000000000000000000,
    2244724065742084803 / 5000000000000000000,
    155570010559382033 / 312500000000000000]
  slopes := ![349108338972115767 / 200000000000000000,
    4340592617222243931 / 1000000000000000000,
    1291968424821341779 / 250000000000000000,
    796926673295817577 / 125000000000000000]
  yXiSlope := 65098741 / 100000000
  vRhoSlope := 88642433 / 100000000
...
/-- Unconditional real-range conclusion for the B0053 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102531 / 100000 : ℝ) ≤ lam → lam ≤ 102541 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19550 / 100000 : ℝ) ≤ q ∧ q ≤ 19571 / 100000) :
    (194257 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (194464 / 1000000 : ℝ) := by
  have hmonoLo : sin (19550 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19571 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19550 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19571 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19550 / 100000 : ℝ) ≤ q ∧ q ≤ 19571 / 100000) :
    (980909 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980951 / 1000000 : ℝ) := by
  have hmonoLo : cos (19571 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19550 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19571 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19550 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29523 / 100000 : ℝ) ≤ q ∧ q ≤ 29569 / 100000) :
    (290959 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (291400 / 1000000 : ℝ) := by
  have hmonoLo : sin (29523 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29569 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29523 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29569 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29523 / 100000 : ℝ) ≤ q ∧ q ≤ 29569 / 100000) :
    (956601 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956736 / 1000000 : ℝ) := by
  have hmonoLo : cos (29569 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29523 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29569 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29523 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44867 / 100000 : ℝ) ≤ q ∧ q ≤ 44922 / 100000) :
    (433767 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (434264 / 1000000 : ℝ) := by
  have hmonoLo : sin (44867 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44922 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44867 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44922 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49749 / 100000 : ℝ) ≤ q ∧ q ≤ 49816 / 100000) :
    (477221 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (477810 / 1000000 : ℝ) := by
  have hmonoLo : sin (49749 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49816 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49749 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49816 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49749 / 100000 : ℝ) ≤ q ∧ q ≤ 49816 / 100000) :
    (878463 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (878784 / 1000000 : ℝ) := by
  have hmonoLo : cos (49816 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49749 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49816 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49749 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19550000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19571000 / 100000000) :
    (19425700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19446400 / 100000000 : ℝ) ∧
      (98090900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98095100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19550000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19571000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19571000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19550000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29523000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29569000 / 100000000) :
    (29095900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29140000 / 100000000 : ℝ) ∧
      (95660100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95673600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29523000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29569000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29569000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29523000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44867000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44922000 / 100000000) :
    (43376700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43426400 / 100000000 : ℝ) ∧
      (90078600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90102500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44867000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44922000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44922000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44867000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49749000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49816000 / 100000000) :
    (47722100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47781000 / 100000000 : ℝ) ∧
      (87846300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87878400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49749000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49816000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49816000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49749000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0053. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102531 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102541 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19550000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19571000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29523000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29569000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44867000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44922000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49749000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49816000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0053 brick. -/
...
throughout the B0053 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102531 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102541 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19550 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19571 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29523 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44867 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44922 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49749 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49816 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980951 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19550 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19550 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (900786 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44922 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44922 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (477810 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49816 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49816 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (433767 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44867 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44867 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102541 / 100000 : ℝ) * (49816 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102531 / 100000 : ℝ) * (29523 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16239 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16777 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980951 / 1000000 : ℝ) * (16239 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190078 / 100000 : ℝ) * (16777 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190078 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29523 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29569 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102531 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102541 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102531 / 100000 : ℝ) * (290959 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102541 / 100000 : ℝ) * (291400 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19550 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19571 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29523 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29569 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102531 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102541 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19550 / 100000, 19571 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29523 / 100000, 29569 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102531 / 100000, 102541 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨194257 / 1000000, 194464 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980909 / 1000000, 980951 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨290959 / 1000000, 291400 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956601 / 1000000, 956736 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0053 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0053 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102541 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102531 / 100000 : ℝ) * (477221 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102541 / 100000 : ℝ) * (477810 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49749 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49816 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49749 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49816 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102531 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0053`.
...
/-- Sound projection of the B0053 checker instance into the generic
...
/-- Every projected type-(iv) height in B0053 has an equal-area regular
...
/-- Candidate-facing conclusion for B0053.  No stationarity hypothesis is
...
/-- Complete B0053 candidate-facing conclusion.  The checked stationary pair
