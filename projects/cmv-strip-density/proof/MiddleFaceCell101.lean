...
namespace MiddleFaceCell101

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0101`, spanning `[103011/100000, 103021/100000]`. -/
def brick : Brick where
  lamLo := 103011 / 100000
  lamHi := 103021 / 100000
  centers := ![2032686737553065967 / 10000000000000000000,
    3151892557674880397 / 10000000000000000000,
    4721284653667917413 / 10000000000000000000,
    2632927641960139799 / 5000000000000000000]
  slopes := ![36560751088035763 / 25000000000000000,
    975400867148459929 / 250000000000000000,
    4523586316866062373 / 1000000000000000000,
    1410826347977676641 / 250000000000000000]
  yXiSlope := 12642829 / 20000000
  vRhoSlope := 87839629 / 100000000
...
/-- Unconditional real-range conclusion for the B0101 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103011 / 100000 : ℝ) ≤ lam → lam ≤ 103021 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20318 / 100000 : ℝ) ≤ q ∧ q ≤ 20336 / 100000) :
    (201784 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201962 / 1000000 : ℝ) := by
  have hmonoLo : sin (20318 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20336 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20318 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20336 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20318 / 100000 : ℝ) ≤ q ∧ q ≤ 20336 / 100000) :
    (979393 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979430 / 1000000 : ℝ) := by
  have hmonoLo : cos (20336 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20318 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20336 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20318 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31498 / 100000 : ℝ) ≤ q ∧ q ≤ 31540 / 100000) :
    (309797 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (310197 / 1000000 : ℝ) := by
  have hmonoLo : sin (31498 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31540 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31498 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31540 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31498 / 100000 : ℝ) ≤ q ∧ q ≤ 31540 / 100000) :
    (950672 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950803 / 1000000 : ℝ) := by
  have hmonoLo : cos (31540 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31498 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31540 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31498 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47189 / 100000 : ℝ) ≤ q ∧ q ≤ 47237 / 100000) :
    (454570 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (454999 / 1000000 : ℝ) := by
  have hmonoLo : sin (47189 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47237 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47189 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47237 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52629 / 100000 : ℝ) ≤ q ∧ q ≤ 52688 / 100000) :
    (502328 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (502839 / 1000000 : ℝ) := by
  have hmonoLo : sin (52629 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52688 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52629 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52688 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52629 / 100000 : ℝ) ≤ q ∧ q ≤ 52688 / 100000) :
    (864380 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (864677 / 1000000 : ℝ) := by
  have hmonoLo : cos (52688 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52629 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52688 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52629 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20318000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20336000 / 100000000) :
    (20178400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20196200 / 100000000 : ℝ) ∧
      (97939300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97943000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20318000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20336000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20336000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20318000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31498000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31540000 / 100000000) :
    (30979700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31019700 / 100000000 : ℝ) ∧
      (95067200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95080300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31498000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31540000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31540000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31498000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47189000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47237000 / 100000000) :
    (45457000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45499900 / 100000000 : ℝ) ∧
      (89049200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89071100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47189000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47237000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47237000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47189000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52629000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52688000 / 100000000) :
    (50232800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50283900 / 100000000 : ℝ) ∧
      (86438000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86467700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52629000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52688000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52688000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52629000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0101. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103011 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103021 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20318000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20336000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31498000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31540000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47189000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47237000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52629000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52688000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0101 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (527 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 237 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 527 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (527 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (237 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0101 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103011 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103021 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20318 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20336 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31498 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47189 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47237 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52629 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52688 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979430 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20318 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20318 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (890492 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47237 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47237 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (502839 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52688 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52688 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (454570 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47189 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47189 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103021 / 100000 : ℝ) * (52688 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103011 / 100000 : ℝ) * (31498 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16304 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16919 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979430 / 1000000 : ℝ) * (16304 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189049 / 100000 : ℝ) * (16919 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189049 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31498 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31540 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103011 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103021 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103011 / 100000 : ℝ) * (309797 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103021 / 100000 : ℝ) * (310197 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20318 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20336 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31498 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31540 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103011 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103021 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20318 / 100000, 20336 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31498 / 100000, 31540 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103011 / 100000, 103021 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201784 / 1000000, 201962 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979393 / 1000000, 979430 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨309797 / 1000000, 310197 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950672 / 1000000, 950803 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0101 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0101 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103021 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103011 / 100000 : ℝ) * (502328 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103021 / 100000 : ℝ) * (502839 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52629 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52688 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52629 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52688 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103011 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0101`.
...
/-- Sound projection of the B0101 checker instance into the generic
...
/-- Every projected type-(iv) height in B0101 has an equal-area regular
...
/-- Candidate-facing conclusion for B0101.  No stationarity hypothesis is
...
/-- Complete B0101 candidate-facing conclusion.  The checked stationary pair
