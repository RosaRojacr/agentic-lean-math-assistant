...
namespace MiddleFaceCell18

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0018`, spanning `[102181/100000, 102191/100000]`. -/
def brick : Brick where
  lamLo := 102181 / 100000
  lamHi := 102191 / 100000
  centers := ![945176833775104427 / 5000000000000000000,
    349460133697596247 / 1250000000000000000,
    4298217084190057159 / 10000000000000000000,
    592927189678884201 / 1250000000000000000]
  slopes := ![1010106734236872747 / 500000000000000000,
    4755057946183034549 / 1000000000000000000,
    5785560303338019167 / 1000000000000000000,
    7071397540121900089 / 1000000000000000000]
  yXiSlope := 8330221 / 12500000
  vRhoSlope := 89281159 / 100000000
...
/-- Unconditional real-range conclusion for the B0018 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102181 / 100000 : ℝ) ≤ lam → lam ≤ 102191 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18892 / 100000 : ℝ) ≤ q ∧ q ≤ 18915 / 100000) :
    (187798 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (188025 / 1000000 : ℝ) := by
  have hmonoLo : sin (18892 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18915 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18892 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18915 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18892 / 100000 : ℝ) ≤ q ∧ q ≤ 18915 / 100000) :
    (982164 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982208 / 1000000 : ℝ) := by
  have hmonoLo : cos (18915 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18892 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18915 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18892 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27932 / 100000 : ℝ) ≤ q ∧ q ≤ 27982 / 100000) :
    (275702 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (276183 / 1000000 : ℝ) := by
  have hmonoLo : sin (27932 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27982 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27932 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27982 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27932 / 100000 : ℝ) ≤ q ∧ q ≤ 27982 / 100000) :
    (961105 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961244 / 1000000 : ℝ) := by
  have hmonoLo : cos (27982 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27932 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27982 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27932 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42952 / 100000 : ℝ) ≤ q ∧ q ≤ 43013 / 100000) :
    (416434 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (416989 / 1000000 : ℝ) := by
  have hmonoLo : sin (42952 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43013 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42952 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43013 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47397 / 100000 : ℝ) ≤ q ∧ q ≤ 47471 / 100000) :
    (456422 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (457081 / 1000000 : ℝ) := by
  have hmonoLo : sin (47397 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47471 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47397 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47471 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47397 / 100000 : ℝ) ≤ q ∧ q ≤ 47471 / 100000) :
    (889425 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (889764 / 1000000 : ℝ) := by
  have hmonoLo : cos (47471 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47397 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47471 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47397 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18892000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18915000 / 100000000) :
    (18779800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18802500 / 100000000 : ℝ) ∧
      (98216400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98220800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18892000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18915000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18915000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18892000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27932000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27982000 / 100000000) :
    (27570200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27618300 / 100000000 : ℝ) ∧
      (96110500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96124400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27932000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27982000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27982000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27932000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42952000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43013000 / 100000000) :
    (41643400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41698900 / 100000000 : ℝ) ∧
      (90891100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90916600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42952000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43013000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43013000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42952000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47397000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47471000 / 100000000) :
    (45642200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45708100 / 100000000 : ℝ) ∧
      (88942500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88976400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47397000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47471000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47471000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47397000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0018. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102181 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102191 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18892000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18915000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27932000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27982000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42952000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43013000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47397000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47471000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0018 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 19 / 40, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (19 / 40)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0018 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102181 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102191 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18892 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18915 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27932 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42952 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43013 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47397 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47471 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982208 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18892 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18892 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (908911 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43013 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43013 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (457081 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47471 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47471 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (416434 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42952 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42952 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102191 / 100000 : ℝ) * (47471 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102181 / 100000 : ℝ) * (27932 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16190 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16670 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982208 / 1000000 : ℝ) * (16190 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190891 / 100000 : ℝ) * (16670 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190891 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27932 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27982 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102181 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102191 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102181 / 100000 : ℝ) * (275702 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102191 / 100000 : ℝ) * (276183 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18892 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18915 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27932 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27982 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102181 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102191 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18892 / 100000, 18915 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27932 / 100000, 27982 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102181 / 100000, 102191 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨187798 / 1000000, 188025 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982164 / 1000000, 982208 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨275702 / 1000000, 276183 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961105 / 1000000, 961244 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0018 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0018 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102191 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102181 / 100000 : ℝ) * (456422 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102191 / 100000 : ℝ) * (457081 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47397 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47471 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47397 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47471 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102181 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0018`.
...
/-- Sound projection of the B0018 checker instance into the generic
...
/-- Every projected type-(iv) height in B0018 has an equal-area regular
...
/-- Candidate-facing conclusion for B0018.  No stationarity hypothesis is
...
/-- Complete B0018 candidate-facing conclusion.  The checked stationary pair
