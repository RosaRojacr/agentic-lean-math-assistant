...
namespace MiddleFaceCell20

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0020`, spanning `[102201/100000, 102211/100000]`. -/
def brick : Brick where
  lamLo := 102201 / 100000
  lamHi := 102211 / 100000
  centers := ![947188149721400231 / 5000000000000000000,
    561032926259943573 / 2000000000000000000,
    4309748374753399877 / 10000000000000000000,
    2378757794938181321 / 5000000000000000000]
  slopes := ![2002454088190887531 / 1000000000000000000,
    4728552287813834681 / 1000000000000000000,
    2872903575409068787 / 500000000000000000,
    7026758754904229851 / 1000000000000000000]
  yXiSlope := 66549007 / 100000000
  vRhoSlope := 44621609 / 50000000
...
/-- Unconditional real-range conclusion for the B0020 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102201 / 100000 : ℝ) ≤ lam → lam ≤ 102211 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18932 / 100000 : ℝ) ≤ q ∧ q ≤ 18955 / 100000) :
    (188191 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (188417 / 1000000 : ℝ) := by
  have hmonoLo : sin (18932 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18955 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18932 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18955 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18932 / 100000 : ℝ) ≤ q ∧ q ≤ 18955 / 100000) :
    (982089 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982133 / 1000000 : ℝ) := by
  have hmonoLo : cos (18955 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18932 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18955 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18932 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28027 / 100000 : ℝ) ≤ q ∧ q ≤ 28077 / 100000) :
    (276615 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (277096 / 1000000 : ℝ) := by
  have hmonoLo : sin (28027 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28077 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28027 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28077 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28027 / 100000 : ℝ) ≤ q ∧ q ≤ 28077 / 100000) :
    (960842 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960981 / 1000000 : ℝ) := by
  have hmonoLo : cos (28077 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28027 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28077 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28027 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43067 / 100000 : ℝ) ≤ q ∧ q ≤ 43128 / 100000) :
    (417479 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (418034 / 1000000 : ℝ) := by
  have hmonoLo : sin (43067 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43128 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43067 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43128 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47539 / 100000 : ℝ) ≤ q ∧ q ≤ 47612 / 100000) :
    (457685 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (458335 / 1000000 : ℝ) := by
  have hmonoLo : sin (47539 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47612 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47539 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47612 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47539 / 100000 : ℝ) ≤ q ∧ q ≤ 47612 / 100000) :
    (888779 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (889115 / 1000000 : ℝ) := by
  have hmonoLo : cos (47612 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47539 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47612 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47539 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18932000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18955000 / 100000000) :
    (18819100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18841700 / 100000000 : ℝ) ∧
      (98208900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98213300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18932000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18955000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18955000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18932000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28027000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28077000 / 100000000) :
    (27661500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27709600 / 100000000 : ℝ) ∧
      (96084200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96098100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28027000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28077000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28077000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28027000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43067000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43128000 / 100000000) :
    (41747900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41803400 / 100000000 : ℝ) ∧
      (90843100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90868700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43067000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43128000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43128000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43067000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47539000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47612000 / 100000000) :
    (45768500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45833500 / 100000000 : ℝ) ∧
      (88877900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88911500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47539000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47612000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47612000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47539000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0020. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102201 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102211 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18932000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18955000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28027000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28077000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43067000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43128000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47539000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47612000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0020 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (477 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 54 / 125, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 477 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (54 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (477 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (54 / 125)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0020 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102201 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102211 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18932 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18955 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28027 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43067 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43128 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47539 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47612 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982133 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18932 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18932 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (908431 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43128 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43128 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (458335 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47612 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47612 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (417479 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43067 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43067 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102211 / 100000 : ℝ) * (47612 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102201 / 100000 : ℝ) * (28027 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16193 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16676 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982133 / 1000000 : ℝ) * (16193 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190843 / 100000 : ℝ) * (16676 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190843 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28027 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28077 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102201 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102211 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102201 / 100000 : ℝ) * (276615 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102211 / 100000 : ℝ) * (277096 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18932 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18955 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28027 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28077 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102201 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102211 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18932 / 100000, 18955 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28027 / 100000, 28077 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102201 / 100000, 102211 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨188191 / 1000000, 188417 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982089 / 1000000, 982133 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨276615 / 1000000, 277096 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960842 / 1000000, 960981 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0020 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0020 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102211 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102201 / 100000 : ℝ) * (457685 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102211 / 100000 : ℝ) * (458335 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47539 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47612 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47539 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47612 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102201 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0020`.
...
/-- Sound projection of the B0020 checker instance into the generic
...
/-- Every projected type-(iv) height in B0020 has an equal-area regular
...
/-- Candidate-facing conclusion for B0020.  No stationarity hypothesis is
...
/-- Complete B0020 candidate-facing conclusion.  The checked stationary pair
