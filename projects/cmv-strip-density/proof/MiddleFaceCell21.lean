...
namespace MiddleFaceCell21

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0021`, spanning `[102211/100000, 102221/100000]`. -/
def brick : Brick where
  lamLo := 102211 / 100000
  lamHi := 102221 / 100000
  centers := ![474093591685593307 / 2500000000000000000,
    2809886629370994483 / 10000000000000000000,
    4315484358016066417 / 10000000000000000000,
    4764531313701857801 / 10000000000000000000]
  slopes := ![398736102190928723 / 200000000000000000,
    4715443854739401911 / 1000000000000000000,
    5726159374514943331 / 1000000000000000000,
    3502344448043044093 / 500000000000000000]
  yXiSlope := 16625713 / 25000000
  vRhoSlope := 44612159 / 50000000
...
/-- Unconditional real-range conclusion for the B0021 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102211 / 100000 : ℝ) ≤ lam → lam ≤ 102221 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18952 / 100000 : ℝ) ≤ q ∧ q ≤ 18975 / 100000) :
    (188387 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (188614 / 1000000 : ℝ) := by
  have hmonoLo : sin (18952 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18975 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18952 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18975 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18952 / 100000 : ℝ) ≤ q ∧ q ≤ 18975 / 100000) :
    (982051 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982095 / 1000000 : ℝ) := by
  have hmonoLo : cos (18975 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18952 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18975 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18952 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28074 / 100000 : ℝ) ≤ q ∧ q ≤ 28124 / 100000) :
    (277066 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (277548 / 1000000 : ℝ) := by
  have hmonoLo : sin (28074 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28124 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28074 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28124 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28074 / 100000 : ℝ) ≤ q ∧ q ≤ 28124 / 100000) :
    (960712 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960851 / 1000000 : ℝ) := by
  have hmonoLo : cos (28124 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28074 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28124 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28074 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43125 / 100000 : ℝ) ≤ q ∧ q ≤ 43185 / 100000) :
    (418006 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (418552 / 1000000 : ℝ) := by
  have hmonoLo : sin (43125 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43185 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43125 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43185 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47609 / 100000 : ℝ) ≤ q ∧ q ≤ 47682 / 100000) :
    (458307 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (458957 / 1000000 : ℝ) := by
  have hmonoLo : sin (47609 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47682 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47609 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47682 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47609 / 100000 : ℝ) ≤ q ∧ q ≤ 47682 / 100000) :
    (888458 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (888794 / 1000000 : ℝ) := by
  have hmonoLo : cos (47682 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47609 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47682 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47609 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18952000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18975000 / 100000000) :
    (18838700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18861400 / 100000000 : ℝ) ∧
      (98205100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98209500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18952000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18975000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18975000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18952000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28074000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28124000 / 100000000) :
    (27706600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27754800 / 100000000 : ℝ) ∧
      (96071200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96085100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28074000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28124000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28124000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28074000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43125000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43185000 / 100000000) :
    (41800600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41855200 / 100000000 : ℝ) ∧
      (90819200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90844400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43125000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43185000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43185000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43125000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47609000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47682000 / 100000000) :
    (45830700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45895700 / 100000000 : ℝ) ∧
      (88845800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88879400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47609000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47682000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47682000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47609000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0021. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102211 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102221 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18952000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18975000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28074000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28124000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43125000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43185000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47609000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47682000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0021 brick. -/
...
throughout the B0021 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102211 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102221 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18952 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18975 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28074 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43125 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43185 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47609 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47682 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982095 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18952 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18952 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (908192 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43185 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43185 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (458957 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47682 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47682 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (418006 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43125 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43125 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102221 / 100000 : ℝ) * (47682 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102211 / 100000 : ℝ) * (28074 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16194 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16679 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982095 / 1000000 : ℝ) * (16194 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190819 / 100000 : ℝ) * (16679 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190819 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28074 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28124 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102211 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102221 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102211 / 100000 : ℝ) * (277066 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102221 / 100000 : ℝ) * (277548 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18952 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18975 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28074 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28124 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102211 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102221 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18952 / 100000, 18975 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28074 / 100000, 28124 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102211 / 100000, 102221 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨188387 / 1000000, 188614 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982051 / 1000000, 982095 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨277066 / 1000000, 277548 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960712 / 1000000, 960851 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0021 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0021 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102221 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102211 / 100000 : ℝ) * (458307 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102221 / 100000 : ℝ) * (458957 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47609 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47682 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47609 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47682 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102211 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0021`.
...
/-- Sound projection of the B0021 checker instance into the generic
...
/-- Every projected type-(iv) height in B0021 has an equal-area regular
...
/-- Candidate-facing conclusion for B0021.  No stationarity hypothesis is
...
/-- Complete B0021 candidate-facing conclusion.  The checked stationary pair
