...
namespace MiddleFaceCell76

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0076`, spanning `[102761/100000, 102771/100000]`. -/
def brick : Brick where
  lamLo := 102761 / 100000
  lamHi := 102771 / 100000
  centers := ![997231494247720101 / 5000000000000000000,
    1525873180691261253 / 5000000000000000000,
    4604392321946624987 / 10000000000000000000,
    2560218780925017761 / 5000000000000000000]
  slopes := ![799486993043367559 / 500000000000000000,
    4115010898569828077 / 1000000000000000000,
    967086478247997217 / 200000000000000000,
    2999260938081149889 / 500000000000000000]
  yXiSlope := 32083159 / 50000000
  vRhoSlope := 88248437 / 100000000
...
/-- Unconditional real-range conclusion for the B0076 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102761 / 100000 : ℝ) ≤ lam → lam ≤ 102771 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19935 / 100000 : ℝ) ≤ q ∧ q ≤ 19954 / 100000) :
    (198032 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198219 / 1000000 : ℝ) := by
  have hmonoLo : sin (19935 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19954 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19935 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19954 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19935 / 100000 : ℝ) ≤ q ∧ q ≤ 19954 / 100000) :
    (980157 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980196 / 1000000 : ℝ) := by
  have hmonoLo : cos (19954 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19935 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19954 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19935 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30496 / 100000 : ℝ) ≤ q ∧ q ≤ 30539 / 100000) :
    (300255 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (300666 / 1000000 : ℝ) := by
  have hmonoLo : sin (30496 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30539 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30496 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30539 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30496 / 100000 : ℝ) ≤ q ∧ q ≤ 30539 / 100000) :
    (953729 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953859 / 1000000 : ℝ) := by
  have hmonoLo : cos (30539 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30496 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30539 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30496 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46018 / 100000 : ℝ) ≤ q ∧ q ≤ 46070 / 100000) :
    (444109 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (444576 / 1000000 : ℝ) := by
  have hmonoLo : sin (46018 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46070 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46018 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46070 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51173 / 100000 : ℝ) ≤ q ∧ q ≤ 51236 / 100000) :
    (489686 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (490236 / 1000000 : ℝ) := by
  have hmonoLo : sin (51173 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51236 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51173 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51236 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51173 / 100000 : ℝ) ≤ q ∧ q ≤ 51236 / 100000) :
    (871589 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (871899 / 1000000 : ℝ) := by
  have hmonoLo : cos (51236 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51173 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51236 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51173 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19935000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19954000 / 100000000) :
    (19803200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19821900 / 100000000 : ℝ) ∧
      (98015700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98019600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19935000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19954000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19954000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19935000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30496000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30539000 / 100000000) :
    (30025500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30066600 / 100000000 : ℝ) ∧
      (95372900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95385900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30496000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30539000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30539000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30496000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46018000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46070000 / 100000000) :
    (44410900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44457600 / 100000000 : ℝ) ∧
      (89574100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89597300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46018000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46070000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46070000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46018000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51173000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51236000 / 100000000) :
    (48968600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49023600 / 100000000 : ℝ) ∧
      (87158900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87189900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51173000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51236000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51236000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51173000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0076. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102761 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102771 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19935000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19954000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30496000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30539000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46018000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46070000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51173000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51236000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0076 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 513 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (513 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0076 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102761 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102771 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19935 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19954 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30496 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46018 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46070 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51173 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51236 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980196 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19935 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19935 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (895741 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46070 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46070 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (490236 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51236 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51236 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (444109 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46018 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46018 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102771 / 100000 : ℝ) * (51236 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102761 / 100000 : ℝ) * (30496 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16271 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16846 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980196 / 1000000 : ℝ) * (16271 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189574 / 100000 : ℝ) * (16846 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189574 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30496 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30539 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102761 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102771 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102761 / 100000 : ℝ) * (300255 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102771 / 100000 : ℝ) * (300666 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19935 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19954 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30496 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30539 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102761 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102771 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19935 / 100000, 19954 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30496 / 100000, 30539 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102761 / 100000, 102771 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198032 / 1000000, 198219 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980157 / 1000000, 980196 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨300255 / 1000000, 300666 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953729 / 1000000, 953859 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0076 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0076 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102771 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102761 / 100000 : ℝ) * (489686 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102771 / 100000 : ℝ) * (490236 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51173 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51236 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51173 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51236 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102761 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0076`.
...
/-- Sound projection of the B0076 checker instance into the generic
...
/-- Every projected type-(iv) height in B0076 has an equal-area regular
...
/-- Candidate-facing conclusion for B0076.  No stationarity hypothesis is
...
/-- Complete B0076 candidate-facing conclusion.  The checked stationary pair
