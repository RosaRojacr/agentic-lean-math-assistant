...
namespace MiddleFaceCell103

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0103`, spanning `[103031/100000, 103041/100000]`. -/
def brick : Brick where
  lamLo := 103031 / 100000
  lamHi := 103041 / 100000
  centers := ![8142406115708473 / 40000000000000000,
    3159679894208608487 / 10000000000000000000,
    2365154370826101359 / 5000000000000000000,
    1319278882873590233 / 2500000000000000000]
  slopes := ![1452376168703466377 / 1000000000000000000,
    3885754013037307939 / 1000000000000000000,
    4500534049193992537 / 1000000000000000000,
    140424448261937393 / 25000000000000000]
  yXiSlope := 63140469 / 100000000
  vRhoSlope := 87807719 / 100000000
...
/-- Unconditional real-range conclusion for the B0103 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103031 / 100000 : ℝ) ≤ lam → lam ≤ 103041 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20347 / 100000 : ℝ) ≤ q ∧ q ≤ 20365 / 100000) :
    (202068 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202246 / 1000000 : ℝ) := by
  have hmonoLo : sin (20347 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20365 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20347 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20365 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20347 / 100000 : ℝ) ≤ q ∧ q ≤ 20365 / 100000) :
    (979334 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979372 / 1000000 : ℝ) := by
  have hmonoLo : cos (20365 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20347 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20365 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20347 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31576 / 100000 : ℝ) ≤ q ∧ q ≤ 31617 / 100000) :
    (310538 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (310929 / 1000000 : ℝ) := by
  have hmonoLo : sin (31576 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31617 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31576 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31617 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31576 / 100000 : ℝ) ≤ q ∧ q ≤ 31617 / 100000) :
    (950433 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950561 / 1000000 : ℝ) := by
  have hmonoLo : cos (31617 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31576 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31617 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31576 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47279 / 100000 : ℝ) ≤ q ∧ q ≤ 47327 / 100000) :
    (455371 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (455800 / 1000000 : ℝ) := by
  have hmonoLo : sin (47279 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47327 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47279 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47327 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52742 / 100000 : ℝ) ≤ q ∧ q ≤ 52801 / 100000) :
    (503305 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (503816 / 1000000 : ℝ) := by
  have hmonoLo : sin (52742 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52801 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52742 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52801 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52742 / 100000 : ℝ) ≤ q ∧ q ≤ 52801 / 100000) :
    (863811 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (864109 / 1000000 : ℝ) := by
  have hmonoLo : cos (52801 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52742 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52801 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52742 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20347000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20365000 / 100000000) :
    (20206800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20224600 / 100000000 : ℝ) ∧
      (97933400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97937200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20347000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20365000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20365000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20347000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31576000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31617000 / 100000000) :
    (31053800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31092900 / 100000000 : ℝ) ∧
      (95043300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95056100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31576000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31617000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31617000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31576000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47279000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47327000 / 100000000) :
    (45537100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45580000 / 100000000 : ℝ) ∧
      (89008200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89030200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47279000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47327000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47327000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47279000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52742000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52801000 / 100000000) :
    (50330500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50381600 / 100000000 : ℝ) ∧
      (86381100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86410900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52742000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52801000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52801000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52742000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0103. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103031 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103041 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20347000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20365000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31576000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31617000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47279000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47327000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52742000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52801000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0103 brick. -/
...
throughout the B0103 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103031 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103041 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20347 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20365 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31576 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47279 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47327 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52742 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52801 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979372 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20347 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20347 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (890082 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47327 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47327 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (503816 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52801 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52801 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (455371 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47279 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47279 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103041 / 100000 : ℝ) * (52801 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103031 / 100000 : ℝ) * (31576 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16307 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16924 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979372 / 1000000 : ℝ) * (16307 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189008 / 100000 : ℝ) * (16924 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189008 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31576 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31617 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103031 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103041 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103031 / 100000 : ℝ) * (310538 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103041 / 100000 : ℝ) * (310929 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20347 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20365 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31576 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31617 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103031 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103041 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20347 / 100000, 20365 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31576 / 100000, 31617 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103031 / 100000, 103041 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202068 / 1000000, 202246 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979334 / 1000000, 979372 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨310538 / 1000000, 310929 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950433 / 1000000, 950561 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0103 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0103 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103041 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103031 / 100000 : ℝ) * (503305 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103041 / 100000 : ℝ) * (503816 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52742 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52801 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52742 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52801 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103031 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0103`.
...
/-- Sound projection of the B0103 checker instance into the generic
...
/-- Every projected type-(iv) height in B0103 has an equal-area regular
...
/-- Candidate-facing conclusion for B0103.  No stationarity hypothesis is
...
/-- Complete B0103 candidate-facing conclusion.  The checked stationary pair
