...
namespace MiddleFaceCell90

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0090`, spanning `[102901/100000, 102911/100000]`. -/
def brick : Brick where
  lamLo := 102901 / 100000
  lamHi := 102911 / 100000
  centers := ![2016287233819530019 / 10000000000000000000,
    777120821587992603 / 2500000000000000000,
    2335404509116532241 / 5000000000000000000,
    5202961712654686289 / 10000000000000000000]
  slopes := ![1519928041170324101 / 1000000000000000000,
    249492406969012719 / 62500000000000000,
    232758791439238073 / 50000000000000000,
    579340473099561547 / 100000000000000000]
  yXiSlope := 63625801 / 100000000
  vRhoSlope := 2750537 / 3125000
...
/-- Unconditional real-range conclusion for the B0090 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102901 / 100000 : ℝ) ≤ lam → lam ≤ 102911 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20154 / 100000 : ℝ) ≤ q ∧ q ≤ 20172 / 100000) :
    (200178 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200355 / 1000000 : ℝ) := by
  have hmonoLo : sin (20154 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20172 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20154 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20172 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20154 / 100000 : ℝ) ≤ q ∧ q ≤ 20172 / 100000) :
    (979723 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979760 / 1000000 : ℝ) := by
  have hmonoLo : cos (20172 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20154 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20172 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20154 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31064 / 100000 : ℝ) ≤ q ∧ q ≤ 31106 / 100000) :
    (305668 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (306068 / 1000000 : ℝ) := by
  have hmonoLo : sin (31064 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31106 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31064 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31106 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31064 / 100000 : ℝ) ≤ q ∧ q ≤ 31106 / 100000) :
    (952009 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952139 / 1000000 : ℝ) := by
  have hmonoLo : cos (31106 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31064 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31106 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31064 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46683 / 100000 : ℝ) ≤ q ∧ q ≤ 46733 / 100000) :
    (450057 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (450505 / 1000000 : ℝ) := by
  have hmonoLo : sin (46683 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46733 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46683 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46733 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51999 / 100000 : ℝ) ≤ q ∧ q ≤ 52060 / 100000) :
    (496871 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (497401 / 1000000 : ℝ) := by
  have hmonoLo : sin (51999 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52060 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51999 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52060 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51999 / 100000 : ℝ) ≤ q ∧ q ≤ 52060 / 100000) :
    (867520 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (867825 / 1000000 : ℝ) := by
  have hmonoLo : cos (52060 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51999 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52060 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51999 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20154000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20172000 / 100000000) :
    (20017800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20035500 / 100000000 : ℝ) ∧
      (97972300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97976000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20154000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20172000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20172000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20154000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31064000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31106000 / 100000000) :
    (30566800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30606800 / 100000000 : ℝ) ∧
      (95200900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95213900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31064000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31106000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31106000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31064000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46683000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46733000 / 100000000) :
    (45005700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45050500 / 100000000 : ℝ) ∧
      (89277400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89300000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46683000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46733000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46733000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46683000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51999000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52060000 / 100000000) :
    (49687100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49740100 / 100000000 : ℝ) ∧
      (86752000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86782500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51999000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52060000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52060000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51999000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0090. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102901 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102911 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20154000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20172000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31064000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31106000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46683000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46733000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51999000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52060000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0090 brick. -/
...
throughout the B0090 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102901 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102911 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20154 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20172 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31064 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46683 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46733 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51999 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52060 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979760 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20154 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20154 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (892774 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46733 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46733 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (497401 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52060 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52060 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (450057 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46683 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46683 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102911 / 100000 : ℝ) * (52060 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102901 / 100000 : ℝ) * (31064 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16290 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16887 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979760 / 1000000 : ℝ) * (16290 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189277 / 100000 : ℝ) * (16887 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189277 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31064 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31106 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102901 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102911 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102901 / 100000 : ℝ) * (305668 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102911 / 100000 : ℝ) * (306068 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20154 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20172 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31064 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31106 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102901 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102911 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20154 / 100000, 20172 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31064 / 100000, 31106 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102901 / 100000, 102911 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200178 / 1000000, 200355 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979723 / 1000000, 979760 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨305668 / 1000000, 306068 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952009 / 1000000, 952139 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0090 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0090 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102911 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102901 / 100000 : ℝ) * (496871 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102911 / 100000 : ℝ) * (497401 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51999 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52060 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51999 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52060 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102901 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0090`.
...
/-- Sound projection of the B0090 checker instance into the generic
...
/-- Every projected type-(iv) height in B0090 has an equal-area regular
...
/-- Candidate-facing conclusion for B0090.  No stationarity hypothesis is
...
/-- Complete B0090 candidate-facing conclusion.  The checked stationary pair
