...
namespace MiddleFaceCell44

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0044`, spanning `[102441/100000, 102451/100000]`. -/
def brick : Brick where
  lamLo := 102441 / 100000
  lamHi := 102451 / 100000
  centers := ![485012396047888827 / 2500000000000000000,
    2915067373291483733 / 10000000000000000000,
    4442293892067087821 / 10000000000000000000,
    2460067169882420089 / 5000000000000000000]
  slopes := ![180951074969815449 / 100000000000000000,
    277376685768679417 / 62500000000000000,
    5312306160359549731 / 1000000000000000000,
    1634657517473320483 / 250000000000000000]
  yXiSlope := 65480167 / 100000000
  vRhoSlope := 44400921 / 50000000
...
/-- Unconditional real-range conclusion for the B0044 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102441 / 100000 : ℝ) ≤ lam → lam ≤ 102451 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19390 / 100000 : ℝ) ≤ q ∧ q ≤ 19411 / 100000) :
    (192687 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (192894 / 1000000 : ℝ) := by
  have hmonoLo : sin (19390 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19411 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19390 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19411 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19390 / 100000 : ℝ) ≤ q ∧ q ≤ 19411 / 100000) :
    (981219 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981261 / 1000000 : ℝ) := by
  have hmonoLo : cos (19411 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19390 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19411 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19390 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29127 / 100000 : ℝ) ≤ q ∧ q ≤ 29174 / 100000) :
    (287168 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (287620 / 1000000 : ℝ) := by
  have hmonoLo : sin (29127 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29174 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29127 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29174 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29127 / 100000 : ℝ) ≤ q ∧ q ≤ 29174 / 100000) :
    (957744 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957880 / 1000000 : ℝ) := by
  have hmonoLo : cos (29174 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29127 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29174 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29127 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44395 / 100000 : ℝ) ≤ q ∧ q ≤ 44451 / 100000) :
    (429509 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (430016 / 1000000 : ℝ) := by
  have hmonoLo : sin (44395 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44451 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44395 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44451 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49167 / 100000 : ℝ) ≤ q ∧ q ≤ 49236 / 100000) :
    (472098 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (472707 / 1000000 : ℝ) := by
  have hmonoLo : sin (49167 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49236 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49167 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49236 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49167 / 100000 : ℝ) ≤ q ∧ q ≤ 49236 / 100000) :
    (881219 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (881546 / 1000000 : ℝ) := by
  have hmonoLo : cos (49236 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49167 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49236 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49167 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19390000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19411000 / 100000000) :
    (19268700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19289400 / 100000000 : ℝ) ∧
      (98121900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98126100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19390000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19411000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19411000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19390000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29127000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29174000 / 100000000) :
    (28716800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28762000 / 100000000 : ℝ) ∧
      (95774400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95788000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29127000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29174000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29174000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29127000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44395000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44451000 / 100000000) :
    (42950900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43001600 / 100000000 : ℝ) ∧
      (90282100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90306300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44395000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44451000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44451000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44395000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49167000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49236000 / 100000000) :
    (47209800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47270700 / 100000000 : ℝ) ∧
      (88121900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88154600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49167000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49236000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49236000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49167000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0044. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102441 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102451 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19390000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19411000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29127000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29174000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44395000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44451000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49167000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49236000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0044 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (493 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 223 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 493 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (223 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (493 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (223 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0044 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102441 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102451 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19390 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19411 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29127 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44395 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44451 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49167 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49236 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981261 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19390 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19390 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (902821 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44451 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44451 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (472707 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49236 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49236 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (429509 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44395 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44395 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102451 / 100000 : ℝ) * (49236 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102441 / 100000 : ℝ) * (29127 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16227 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16750 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981261 / 1000000 : ℝ) * (16227 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190282 / 100000 : ℝ) * (16750 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190282 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29127 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29174 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102441 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102451 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102441 / 100000 : ℝ) * (287168 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102451 / 100000 : ℝ) * (287620 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19390 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19411 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29127 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29174 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102441 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102451 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19390 / 100000, 19411 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29127 / 100000, 29174 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102441 / 100000, 102451 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨192687 / 1000000, 192894 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981219 / 1000000, 981261 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨287168 / 1000000, 287620 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957744 / 1000000, 957880 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0044 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0044 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102451 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102441 / 100000 : ℝ) * (472098 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102451 / 100000 : ℝ) * (472707 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49167 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49236 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49167 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49236 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102441 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0044`.
...
/-- Sound projection of the B0044 checker instance into the generic
...
/-- Every projected type-(iv) height in B0044 has an equal-area regular
...
/-- Candidate-facing conclusion for B0044.  No stationarity hypothesis is
...
/-- Complete B0044 candidate-facing conclusion.  The checked stationary pair
