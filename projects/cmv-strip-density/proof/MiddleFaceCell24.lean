...
namespace MiddleFaceCell24

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0024`, spanning `[102241/100000, 102251/100000]`. -/
def brick : Brick where
  lamLo := 102241 / 100000
  lamHi := 102251 / 100000
  centers := ![951158205861795657 / 5000000000000000000,
    2823974632914887251 / 10000000000000000000,
    4332575466202589297 / 10000000000000000000,
    1196361801526297237 / 2500000000000000000]
  slopes := ![1967773897766694703 / 1000000000000000000,
    584585328787910719 / 125000000000000000,
    5668109238148977813 / 1000000000000000000,
    867431720471350441 / 125000000000000000]
  yXiSlope := 33182637 / 50000000
  vRhoSlope := 89167897 / 100000000
...
/-- Unconditional real-range conclusion for the B0024 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102241 / 100000 : ℝ) ≤ lam → lam ≤ 102251 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19012 / 100000 : ℝ) ≤ q ∧ q ≤ 19035 / 100000) :
    (188976 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (189203 / 1000000 : ℝ) := by
  have hmonoLo : sin (19012 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19035 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19012 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19035 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19012 / 100000 : ℝ) ≤ q ∧ q ≤ 19035 / 100000) :
    (981938 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981982 / 1000000 : ℝ) := by
  have hmonoLo : cos (19035 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19012 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19035 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19012 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28215 / 100000 : ℝ) ≤ q ∧ q ≤ 28264 / 100000) :
    (278421 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (278892 / 1000000 : ℝ) := by
  have hmonoLo : sin (28215 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28264 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28215 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28264 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28215 / 100000 : ℝ) ≤ q ∧ q ≤ 28264 / 100000) :
    (960322 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960460 / 1000000 : ℝ) := by
  have hmonoLo : cos (28264 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28215 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28264 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28215 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43296 / 100000 : ℝ) ≤ q ∧ q ≤ 43356 / 100000) :
    (419559 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (420105 / 1000000 : ℝ) := by
  have hmonoLo : sin (43296 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43356 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43296 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43356 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47818 / 100000 : ℝ) ≤ q ∧ q ≤ 47891 / 100000) :
    (460164 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (460813 / 1000000 : ℝ) := by
  have hmonoLo : sin (47818 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47891 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47818 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47891 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47818 / 100000 : ℝ) ≤ q ∧ q ≤ 47891 / 100000) :
    (887497 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (887834 / 1000000 : ℝ) := by
  have hmonoLo : cos (47891 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47818 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47891 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47818 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19012000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19035000 / 100000000) :
    (18897600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18920300 / 100000000 : ℝ) ∧
      (98193800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98198200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19012000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19035000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19035000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19012000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28215000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28264000 / 100000000) :
    (27842100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27889200 / 100000000 : ℝ) ∧
      (96032200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96046000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28215000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28264000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28264000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28215000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43296000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43356000 / 100000000) :
    (41955900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42010500 / 100000000 : ℝ) ∧
      (90747500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90772800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43296000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43356000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43356000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43296000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47818000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47891000 / 100000000) :
    (46016400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46081300 / 100000000 : ℝ) ∧
      (88749700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88783400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47818000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47891000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47891000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47818000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0024. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102241 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102251 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19012000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19035000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28215000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28264000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43296000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43356000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47818000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47891000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0024 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (479 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 217 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 479 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (217 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (479 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (217 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0024 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102241 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102251 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19012 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19035 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28215 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43296 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43356 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47818 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47891 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981982 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19012 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19012 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (907475 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43356 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43356 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (460813 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47891 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47891 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (419559 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43296 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43296 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102251 / 100000 : ℝ) * (47891 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102241 / 100000 : ℝ) * (28215 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16198 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16689 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981982 / 1000000 : ℝ) * (16198 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190747 / 100000 : ℝ) * (16689 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190747 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28215 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28264 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102241 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102251 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102241 / 100000 : ℝ) * (278421 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102251 / 100000 : ℝ) * (278892 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19012 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19035 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28215 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28264 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102241 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102251 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19012 / 100000, 19035 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28215 / 100000, 28264 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102241 / 100000, 102251 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨188976 / 1000000, 189203 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981938 / 1000000, 981982 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨278421 / 1000000, 278892 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960322 / 1000000, 960460 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0024 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0024 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102251 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102241 / 100000 : ℝ) * (460164 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102251 / 100000 : ℝ) * (460813 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47818 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47891 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47818 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47891 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102241 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0024`.
...
/-- Sound projection of the B0024 checker instance into the generic
...
/-- Every projected type-(iv) height in B0024 has an equal-area regular
...
/-- Candidate-facing conclusion for B0024.  No stationarity hypothesis is
...
/-- Complete B0024 candidate-facing conclusion.  The checked stationary pair
