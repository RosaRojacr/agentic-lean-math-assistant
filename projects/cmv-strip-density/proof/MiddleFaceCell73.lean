...
namespace MiddleFaceCell73

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0073`, spanning `[102731/100000, 102741/100000]`. -/
def brick : Brick where
  lamLo := 102731 / 100000
  lamHi := 102741 / 100000
  centers := ![1989639334323450249 / 10000000000000000000,
    121574395907705023 / 400000000000000000,
    4589825203571765369 / 10000000000000000000,
    510237289438225387 / 1000000000000000000]
  slopes := ![1616846830326599919 / 1000000000000000000,
    828540649440192749 / 200000000000000000,
    2438045761585898509 / 500000000000000000,
    6044712567595243983 / 1000000000000000000]
  yXiSlope := 8035587 / 12500000
  vRhoSlope := 88298801 / 100000000
...
/-- Unconditional real-range conclusion for the B0073 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102731 / 100000 : ℝ) ≤ lam → lam ≤ 102741 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19887 / 100000 : ℝ) ≤ q ∧ q ≤ 19906 / 100000) :
    (197561 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (197748 / 1000000 : ℝ) := by
  have hmonoLo : sin (19887 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19906 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19887 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19906 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19887 / 100000 : ℝ) ≤ q ∧ q ≤ 19906 / 100000) :
    (980252 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980291 / 1000000 : ℝ) := by
  have hmonoLo : cos (19906 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19887 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19906 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19887 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30372 / 100000 : ℝ) ≤ q ∧ q ≤ 30416 / 100000) :
    (299072 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (299492 / 1000000 : ℝ) := by
  have hmonoLo : sin (30372 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30416 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30372 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30416 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30372 / 100000 : ℝ) ≤ q ∧ q ≤ 30416 / 100000) :
    (954098 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954231 / 1000000 : ℝ) := by
  have hmonoLo : cos (30416 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30372 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30416 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30372 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45872 / 100000 : ℝ) ≤ q ∧ q ≤ 45924 / 100000) :
    (442800 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (443267 / 1000000 : ℝ) := by
  have hmonoLo : sin (45872 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45924 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45872 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45924 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50992 / 100000 : ℝ) ≤ q ∧ q ≤ 51055 / 100000) :
    (488107 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (488658 / 1000000 : ℝ) := by
  have hmonoLo : sin (50992 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51055 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50992 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51055 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50992 / 100000 : ℝ) ≤ q ∧ q ≤ 51055 / 100000) :
    (872475 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (872784 / 1000000 : ℝ) := by
  have hmonoLo : cos (51055 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50992 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51055 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50992 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19887000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19906000 / 100000000) :
    (19756100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19774800 / 100000000 : ℝ) ∧
      (98025200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98029100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19887000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19906000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19906000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19887000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30372000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30416000 / 100000000) :
    (29907200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29949200 / 100000000 : ℝ) ∧
      (95409800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95423100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30372000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30416000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30416000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30372000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45872000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45924000 / 100000000) :
    (44280000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44326700 / 100000000 : ℝ) ∧
      (89638900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89662100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45872000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45924000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45924000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45872000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50992000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51055000 / 100000000) :
    (48810700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48865800 / 100000000 : ℝ) ∧
      (87247500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87278400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50992000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51055000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51055000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50992000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0073. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102731 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102741 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19887000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19906000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30372000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30416000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45872000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45924000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50992000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51055000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0073 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (511 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 23 / 50, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 511 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (23 / 50)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (511 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (23 / 50)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0073 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102731 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102741 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19887 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19906 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30372 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45872 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45924 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50992 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51055 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980291 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19887 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19887 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (896389 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45924 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45924 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (488658 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51055 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51055 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (442800 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45872 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45872 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102741 / 100000 : ℝ) * (51055 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102731 / 100000 : ℝ) * (30372 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16267 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16837 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980291 / 1000000 : ℝ) * (16267 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189638 / 100000 : ℝ) * (16837 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189638 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30372 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30416 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102731 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102741 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102731 / 100000 : ℝ) * (299072 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102741 / 100000 : ℝ) * (299492 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19887 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19906 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30372 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30416 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102731 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102741 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19887 / 100000, 19906 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30372 / 100000, 30416 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102731 / 100000, 102741 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨197561 / 1000000, 197748 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980252 / 1000000, 980291 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨299072 / 1000000, 299492 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954098 / 1000000, 954231 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0073 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0073 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102741 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102731 / 100000 : ℝ) * (488107 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102741 / 100000 : ℝ) * (488658 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50992 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51055 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50992 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51055 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102731 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0073`.
...
/-- Sound projection of the B0073 checker instance into the generic
...
/-- Every projected type-(iv) height in B0073 has an equal-area regular
...
/-- Candidate-facing conclusion for B0073.  No stationarity hypothesis is
...
/-- Complete B0073 candidate-facing conclusion.  The checked stationary pair
