...
namespace MiddleFaceCell105

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0105`, spanning `[103051/100000, 103061/100000]`. -/
def brick : Brick where
  lamLo := 103051 / 100000
  lamHi := 103061 / 100000
  centers := ![509624082614271231 / 2500000000000000000,
    25339485586688803 / 80000000000000000,
    236964349121844719 / 500000000000000000,
    5288323408263993769 / 10000000000000000000]
  slopes := ![1442439933912176919 / 1000000000000000000,
    3870070704332780429 / 1000000000000000000,
    179109541870881289 / 40000000000000000,
    2795466983638777117 / 500000000000000000]
  yXiSlope := 63067143 / 100000000
  vRhoSlope := 1097199 / 1250000
...
/-- Unconditional real-range conclusion for the B0105 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103051 / 100000 : ℝ) ≤ lam → lam ≤ 103061 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20376 / 100000 : ℝ) ≤ q ∧ q ≤ 20394 / 100000) :
    (202352 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202530 / 1000000 : ℝ) := by
  have hmonoLo : sin (20376 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20394 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20376 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20394 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20376 / 100000 : ℝ) ≤ q ∧ q ≤ 20394 / 100000) :
    (979276 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979313 / 1000000 : ℝ) := by
  have hmonoLo : cos (20394 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20376 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20394 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20376 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31654 / 100000 : ℝ) ≤ q ∧ q ≤ 31695 / 100000) :
    (311280 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (311670 / 1000000 : ℝ) := by
  have hmonoLo : sin (31654 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31695 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31654 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31695 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31654 / 100000 : ℝ) ≤ q ∧ q ≤ 31695 / 100000) :
    (950190 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950319 / 1000000 : ℝ) := by
  have hmonoLo : cos (31695 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31654 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31695 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31654 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47369 / 100000 : ℝ) ≤ q ∧ q ≤ 47417 / 100000) :
    (456173 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (456601 / 1000000 : ℝ) := by
  have hmonoLo : sin (47369 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47417 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47369 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47417 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52854 / 100000 : ℝ) ≤ q ∧ q ≤ 52913 / 100000) :
    (504273 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (504783 / 1000000 : ℝ) := by
  have hmonoLo : sin (52854 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52913 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52854 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52913 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52854 / 100000 : ℝ) ≤ q ∧ q ≤ 52913 / 100000) :
    (863246 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (863545 / 1000000 : ℝ) := by
  have hmonoLo : cos (52913 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52854 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52913 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52854 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20376000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20394000 / 100000000) :
    (20235200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20253000 / 100000000 : ℝ) ∧
      (97927600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97931300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20376000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20394000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20394000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20376000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31654000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31695000 / 100000000) :
    (31128000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31167000 / 100000000 : ℝ) ∧
      (95019000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95031900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31654000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31695000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31695000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31654000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47369000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47417000 / 100000000) :
    (45617300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45660100 / 100000000 : ℝ) ∧
      (88967200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88989200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47369000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47417000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47417000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47369000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52854000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52913000 / 100000000) :
    (50427300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50478300 / 100000000 : ℝ) ∧
      (86324600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86354500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52854000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52913000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52913000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52854000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0105. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103051 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103061 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20376000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20394000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31654000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31695000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47369000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47417000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52854000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52913000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0105 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 53 / 100, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (53 / 100)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0105 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103051 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103061 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20376 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20394 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31654 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47369 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47417 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52854 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52913 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979313 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20376 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20376 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (889672 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47417 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47417 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (504783 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52913 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52913 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (456173 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47369 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47369 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103061 / 100000 : ℝ) * (52913 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103051 / 100000 : ℝ) * (31654 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16310 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16930 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979313 / 1000000 : ℝ) * (16310 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188967 / 100000 : ℝ) * (16930 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188967 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31654 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31695 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103051 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103061 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103051 / 100000 : ℝ) * (311280 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103061 / 100000 : ℝ) * (311670 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20376 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20394 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31654 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31695 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103051 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103061 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20376 / 100000, 20394 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31654 / 100000, 31695 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103051 / 100000, 103061 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202352 / 1000000, 202530 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979276 / 1000000, 979313 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨311280 / 1000000, 311670 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950190 / 1000000, 950319 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0105 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0105 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103061 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103051 / 100000 : ℝ) * (504273 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103061 / 100000 : ℝ) * (504783 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52854 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52913 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52854 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52913 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103051 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0105`.
...
/-- Sound projection of the B0105 checker instance into the generic
...
/-- Every projected type-(iv) height in B0105 has an equal-area regular
...
/-- Candidate-facing conclusion for B0105.  No stationarity hypothesis is
...
/-- Complete B0105 candidate-facing conclusion.  The checked stationary pair
