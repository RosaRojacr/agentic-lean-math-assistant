...
namespace MiddleFaceCell100

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0100`, spanning `[103001/100000, 103011/100000]`. -/
def brick : Brick where
  lamLo := 103001 / 100000
  lamHi := 103011 / 100000
  centers := ![2031221771648348979 / 10000000000000000000,
    3147986960238292773 / 10000000000000000000,
    589594406927619631 / 1250000000000000000,
    42081642741798301 / 80000000000000000]
  slopes := ![146750176591254481 / 100000000000000000,
    488698925572676001 / 125000000000000000,
    566901272131833361 / 125000000000000000,
    5656576999073240217 / 1000000000000000000]
  yXiSlope := 15812779 / 25000000
  vRhoSlope := 87855627 / 100000000
...
/-- Unconditional real-range conclusion for the B0100 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103001 / 100000 : ℝ) ≤ lam → lam ≤ 103011 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20303 / 100000 : ℝ) ≤ q ∧ q ≤ 20321 / 100000) :
    (201638 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201815 / 1000000 : ℝ) := by
  have hmonoLo : sin (20303 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20321 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20303 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20321 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20303 / 100000 : ℝ) ≤ q ∧ q ≤ 20321 / 100000) :
    (979423 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979461 / 1000000 : ℝ) := by
  have hmonoLo : cos (20321 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20303 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20321 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20303 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31459 / 100000 : ℝ) ≤ q ∧ q ≤ 31501 / 100000) :
    (309426 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (309826 / 1000000 : ℝ) := by
  have hmonoLo : sin (31459 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31501 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31459 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31501 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31459 / 100000 : ℝ) ≤ q ∧ q ≤ 31501 / 100000) :
    (950793 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950924 / 1000000 : ℝ) := by
  have hmonoLo : cos (31501 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31459 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31501 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31459 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47143 / 100000 : ℝ) ≤ q ∧ q ≤ 47192 / 100000) :
    (454160 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (454598 / 1000000 : ℝ) := by
  have hmonoLo : sin (47143 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47192 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47143 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47192 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52572 / 100000 : ℝ) ≤ q ∧ q ≤ 52632 / 100000) :
    (501835 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (502355 / 1000000 : ℝ) := by
  have hmonoLo : sin (52572 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52632 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52572 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52632 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52572 / 100000 : ℝ) ≤ q ∧ q ≤ 52632 / 100000) :
    (864661 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (864963 / 1000000 : ℝ) := by
  have hmonoLo : cos (52632 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52572 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52632 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52572 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20303000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20321000 / 100000000) :
    (20163800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20181500 / 100000000 : ℝ) ∧
      (97942300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97946100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20303000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20321000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20321000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20303000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31459000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31501000 / 100000000) :
    (30942600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30982600 / 100000000 : ℝ) ∧
      (95079300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95092400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31459000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31501000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31501000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31459000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47143000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47192000 / 100000000) :
    (45416000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45459800 / 100000000 : ℝ) ∧
      (89069700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89092000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47143000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47192000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47192000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47143000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52572000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52632000 / 100000000) :
    (50183500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50235500 / 100000000 : ℝ) ∧
      (86466100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86496300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52572000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52632000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52632000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52572000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0100. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103001 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103011 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20303000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20321000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31459000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31501000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47143000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47192000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52572000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52632000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0100 brick. -/
...
throughout the B0100 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103001 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103011 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20303 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20321 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31459 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47143 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47192 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52572 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52632 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979461 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20303 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20303 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (890697 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47192 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47192 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (502355 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52632 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52632 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (454160 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47143 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47143 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103011 / 100000 : ℝ) * (52632 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103001 / 100000 : ℝ) * (31459 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16303 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16916 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979461 / 1000000 : ℝ) * (16303 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189069 / 100000 : ℝ) * (16916 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189069 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31459 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31501 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103001 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103011 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103001 / 100000 : ℝ) * (309426 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103011 / 100000 : ℝ) * (309826 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20303 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20321 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31459 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31501 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103001 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103011 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20303 / 100000, 20321 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31459 / 100000, 31501 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103001 / 100000, 103011 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201638 / 1000000, 201815 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979423 / 1000000, 979461 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨309426 / 1000000, 309826 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950793 / 1000000, 950924 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0100 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0100 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103011 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103001 / 100000 : ℝ) * (501835 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103011 / 100000 : ℝ) * (502355 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52572 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52632 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52572 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52632 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103001 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0100`.
...
/-- Sound projection of the B0100 checker instance into the generic
...
/-- Every projected type-(iv) height in B0100 has an equal-area regular
...
/-- Candidate-facing conclusion for B0100.  No stationarity hypothesis is
...
/-- Complete B0100 candidate-facing conclusion.  The checked stationary pair
