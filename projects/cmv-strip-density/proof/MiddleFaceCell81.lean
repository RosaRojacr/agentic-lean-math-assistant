...
namespace MiddleFaceCell81

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0081`, spanning `[102811/100000, 102821/100000]`. -/
def brick : Brick where
  lamLo := 102811 / 100000
  lamHi := 102821 / 100000
  centers := ![2002384903561679861 / 10000000000000000000,
    1536104073648652211 / 5000000000000000000,
    1157100841413348371 / 2500000000000000000,
    5150241334220334861 / 10000000000000000000]
  slopes := ![784970091002322573 / 500000000000000000,
    4069910557837293277 / 1000000000000000000,
    2384653653054665457 / 500000000000000000,
    5923341617147014769 / 1000000000000000000]
  yXiSlope := 63971059 / 100000000
  vRhoSlope := 88165143 / 100000000
...
/-- Unconditional real-range conclusion for the B0081 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102811 / 100000 : ℝ) ≤ lam → lam ≤ 102821 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20014 / 100000 : ℝ) ≤ q ∧ q ≤ 20033 / 100000) :
    (198806 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198993 / 1000000 : ℝ) := by
  have hmonoLo : sin (20014 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20033 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20014 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20033 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20014 / 100000 : ℝ) ≤ q ∧ q ≤ 20033 / 100000) :
    (980000 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980039 / 1000000 : ℝ) := by
  have hmonoLo : cos (20033 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20014 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20033 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20014 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30700 / 100000 : ℝ) ≤ q ∧ q ≤ 30744 / 100000) :
    (302200 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (302620 / 1000000 : ℝ) := by
  have hmonoLo : sin (30700 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30744 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30700 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30744 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30700 / 100000 : ℝ) ≤ q ∧ q ≤ 30744 / 100000) :
    (953111 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953245 / 1000000 : ℝ) := by
  have hmonoLo : cos (30744 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30700 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30744 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30700 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46259 / 100000 : ℝ) ≤ q ∧ q ≤ 46309 / 100000) :
    (446267 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (446715 / 1000000 : ℝ) := by
  have hmonoLo : sin (46259 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46309 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46259 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46309 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51471 / 100000 : ℝ) ≤ q ∧ q ≤ 51534 / 100000) :
    (492282 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (492831 / 1000000 : ℝ) := by
  have hmonoLo : sin (51471 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51534 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51471 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51534 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51471 / 100000 : ℝ) ≤ q ∧ q ≤ 51534 / 100000) :
    (870125 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (870436 / 1000000 : ℝ) := by
  have hmonoLo : cos (51534 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51471 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51534 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51471 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20014000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20033000 / 100000000) :
    (19880600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19899300 / 100000000 : ℝ) ∧
      (98000000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98003900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20014000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20033000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20033000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20014000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30700000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30744000 / 100000000) :
    (30220000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30262000 / 100000000 : ℝ) ∧
      (95311100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95324500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30700000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30744000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30744000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30700000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46259000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46309000 / 100000000) :
    (44626700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44671500 / 100000000 : ℝ) ∧
      (89467600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89490000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46259000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46309000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46309000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46259000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51471000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51534000 / 100000000) :
    (49228200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49283100 / 100000000 : ℝ) ∧
      (87012500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87043600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51471000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51534000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51534000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51471000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0081. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102811 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102821 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20014000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20033000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30700000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30744000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46259000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46309000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51471000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51534000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0081 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (129 / 250 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 58 / 125, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 129 / 250, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (58 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (129 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (58 / 125)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0081 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102811 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102821 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20014 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20033 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30700 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46259 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46309 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51471 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51534 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980039 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20014 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20014 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (894676 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46309 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46309 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (492831 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51534 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51534 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (446267 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46259 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46259 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102821 / 100000 : ℝ) * (51534 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102811 / 100000 : ℝ) * (30700 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16278 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16860 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980039 / 1000000 : ℝ) * (16278 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189467 / 100000 : ℝ) * (16860 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189467 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30700 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30744 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102811 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102821 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102811 / 100000 : ℝ) * (302200 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102821 / 100000 : ℝ) * (302620 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20014 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20033 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30700 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30744 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102811 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102821 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20014 / 100000, 20033 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30700 / 100000, 30744 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102811 / 100000, 102821 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198806 / 1000000, 198993 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980000 / 1000000, 980039 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨302200 / 1000000, 302620 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953111 / 1000000, 953245 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0081 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0081 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102821 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102811 / 100000 : ℝ) * (492282 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102821 / 100000 : ℝ) * (492831 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51471 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51534 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51471 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51534 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102811 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0081`.
...
/-- Sound projection of the B0081 checker instance into the generic
...
/-- Every projected type-(iv) height in B0081 has an equal-area regular
...
/-- Candidate-facing conclusion for B0081.  No stationarity hypothesis is
...
/-- Complete B0081 candidate-facing conclusion.  The checked stationary pair
