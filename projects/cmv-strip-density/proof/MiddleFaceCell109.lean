...
namespace MiddleFaceCell109

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0109`, spanning `[103091/100000, 103101/100000]`. -/
def brick : Brick where
  lamLo := 103091 / 100000
  lamHi := 103101 / 100000
  centers := ![1022113446269794989 / 5000000000000000000,
    3182854021597700293 / 10000000000000000000,
    2378553974764279103 / 5000000000000000000,
    663823036002454199 / 1250000000000000000]
  slopes := ![355728010332827921 / 250000000000000000,
    3839191272208963111 / 1000000000000000000,
    4432899909186166419 / 1000000000000000000,
    2769838521266733317 / 500000000000000000]
  yXiSlope := 2516861 / 4000000
  vRhoSlope := 21928163 / 25000000
...
/-- Unconditional real-range conclusion for the B0109 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103091 / 100000 : ℝ) ≤ lam → lam ≤ 103101 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20434 / 100000 : ℝ) ≤ q ∧ q ≤ 20451 / 100000) :
    (202920 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (203088 / 1000000 : ℝ) := by
  have hmonoLo : sin (20434 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20451 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20434 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20451 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20434 / 100000 : ℝ) ≤ q ∧ q ≤ 20451 / 100000) :
    (979160 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979196 / 1000000 : ℝ) := by
  have hmonoLo : cos (20451 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20434 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20451 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20434 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31808 / 100000 : ℝ) ≤ q ∧ q ≤ 31849 / 100000) :
    (312743 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (313133 / 1000000 : ℝ) := by
  have hmonoLo : sin (31808 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31849 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31808 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31849 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31808 / 100000 : ℝ) ≤ q ∧ q ≤ 31849 / 100000) :
    (949709 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (949838 / 1000000 : ℝ) := by
  have hmonoLo : cos (31849 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31808 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31849 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31808 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47547 / 100000 : ℝ) ≤ q ∧ q ≤ 47595 / 100000) :
    (457756 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (458184 / 1000000 : ℝ) := by
  have hmonoLo : sin (47547 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47595 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47547 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47595 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (53077 / 100000 : ℝ) ≤ q ∧ q ≤ 53135 / 100000) :
    (506197 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (506698 / 1000000 : ℝ) := by
  have hmonoLo : sin (53077 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (53135 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (53077 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (53135 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (53077 / 100000 : ℝ) ≤ q ∧ q ≤ 53135 / 100000) :
    (862123 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (862418 / 1000000 : ℝ) := by
  have hmonoLo : cos (53135 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (53077 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (53135 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (53077 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20434000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20451000 / 100000000) :
    (20292000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20308800 / 100000000 : ℝ) ∧
      (97916000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97919600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20434000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20451000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20451000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20434000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31808000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31849000 / 100000000) :
    (31274300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31313300 / 100000000 : ℝ) ∧
      (94970900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (94983800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31808000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31849000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31849000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31808000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47547000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47595000 / 100000000) :
    (45775600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45818400 / 100000000 : ℝ) ∧
      (88885700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88907800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47547000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47595000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47595000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47547000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (53077000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 53135000 / 100000000) :
    (50619700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50669800 / 100000000 : ℝ) ∧
      (86212300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86241800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (53077000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (53135000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (53135000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (53077000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0109. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103091 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103101 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20434000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20451000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31808000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31849000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47547000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47595000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (53077000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 53135000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0109 brick. -/
...
throughout the B0109 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103091 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103101 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20434 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20451 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31808 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47547 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47595 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (53077 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (53135 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979196 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20434 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20434 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (888857 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47595 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47595 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (506698 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (53135 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (53135 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (457756 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47547 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47547 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103101 / 100000 : ℝ) * (53135 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103091 / 100000 : ℝ) * (31808 / 100000 : ℝ) ≤
      lam p * y p := by
  ...
  have hBLo : (16941 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979196 / 1000000 : ℝ) * (16315 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188885 / 100000 : ℝ) * (16941 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188885 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31808 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31849 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103091 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103101 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103091 / 100000 : ℝ) * (312743 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103101 / 100000 : ℝ) * (313133 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20434 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20451 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31808 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31849 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103091 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103101 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20434 / 100000, 20451 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31808 / 100000, 31849 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103091 / 100000, 103101 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202920 / 1000000, 203088 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979160 / 1000000, 979196 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨312743 / 1000000, 313133 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨949709 / 1000000, 949838 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0109 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0109 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103101 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103091 / 100000 : ℝ) * (506197 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103101 / 100000 : ℝ) * (506698 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (53077 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 53135 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (53077 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 53135 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103091 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0109`.
...
/-- Sound projection of the B0109 checker instance into the generic
...
/-- Every projected type-(iv) height in B0109 has an equal-area regular
...
/-- Candidate-facing conclusion for B0109.  No stationarity hypothesis is
...
/-- Complete B0109 candidate-facing conclusion.  The checked stationary pair
