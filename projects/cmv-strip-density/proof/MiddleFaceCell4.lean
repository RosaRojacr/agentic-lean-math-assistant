...
namespace MiddleFaceCell4

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0004`, spanning `[102041/100000, 102051/100000]`. -/
def brick : Brick where
  lamLo := 102041 / 100000
  lamHi := 102051 / 100000
  centers := ![46528970314686583 / 250000000000000000,
    2727754923029146901 / 10000000000000000000,
    526897697287261667 / 1250000000000000000,
    2321066416079275877 / 5000000000000000000]
  slopes := ![2153048178574159433 / 1000000000000000000,
    1238039151518694249 / 250000000000000000,
    6082184594348186393 / 1000000000000000000,
    1480773103741672853 / 200000000000000000]
  yXiSlope := 67308681 / 100000000
  vRhoSlope := 44776129 / 50000000
...
/-- Unconditional real-range conclusion for the B0004 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102041 / 100000 : ℝ) ≤ lam → lam ≤ 102051 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18599 / 100000 : ℝ) ≤ q ∧ q ≤ 18624 / 100000) :
    (184919 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (185166 / 1000000 : ℝ) := by
  have hmonoLo : sin (18599 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18624 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18599 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18624 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18599 / 100000 : ℝ) ≤ q ∧ q ≤ 18624 / 100000) :
    (982707 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982754 / 1000000 : ℝ) := by
  have hmonoLo : cos (18624 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18599 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18624 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18599 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27252 / 100000 : ℝ) ≤ q ∧ q ≤ 27304 / 100000) :
    (269159 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (269661 / 1000000 : ℝ) := by
  have hmonoLo : sin (27252 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27304 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27252 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27304 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27252 / 100000 : ℝ) ≤ q ∧ q ≤ 27304 / 100000) :
    (962955 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (963096 / 1000000 : ℝ) := by
  have hmonoLo : cos (27304 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27252 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27304 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27252 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42120 / 100000 : ℝ) ≤ q ∧ q ≤ 42184 / 100000) :
    (408855 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (409440 / 1000000 : ℝ) := by
  have hmonoLo : sin (42120 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42184 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42120 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42184 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46383 / 100000 : ℝ) ≤ q ∧ q ≤ 46460 / 100000) :
    (447376 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (448066 / 1000000 : ℝ) := by
  have hmonoLo : sin (46383 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46460 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46383 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46460 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46383 / 100000 : ℝ) ≤ q ∧ q ≤ 46460 / 100000) :
    (894000 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (894346 / 1000000 : ℝ) := by
  have hmonoLo : cos (46460 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46383 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46460 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46383 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18599000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18624000 / 100000000) :
    (18491900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18516600 / 100000000 : ℝ) ∧
      (98270700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98275400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18599000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18624000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18624000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18599000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27252000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27304000 / 100000000) :
    (26915900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (26966100 / 100000000 : ℝ) ∧
      (96295500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96309600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27252000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27304000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27304000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27252000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42120000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42184000 / 100000000) :
    (40885500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (40944000 / 100000000 : ℝ) ∧
      (91233700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91259900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42120000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42184000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42184000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42120000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46383000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46460000 / 100000000) :
    (44737600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44806600 / 100000000 : ℝ) ∧
      (89400000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89434600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46383000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46460000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46460000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46383000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0004. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102041 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102051 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18599000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18624000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27252000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27304000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42120000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42184000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46383000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46460000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0004 brick. -/
...
B0004 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvHi : v p ≤ (47 / 100 : ℝ) := by
    ...
    linarith
  have hwI :
      (⟨2 / 5, 211 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
  ...
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (211 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (211 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0004 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102041 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102051 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18599 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18624 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27252 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42120 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42184 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46383 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46460 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982754 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18599 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18599 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (912337 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42184 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42184 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (448066 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46460 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46460 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (408855 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42120 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42120 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102051 / 100000 : ℝ) * (46460 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102041 / 100000 : ℝ) * (27252 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16169 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16626 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982754 / 1000000 : ℝ) * (16169 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191233 / 100000 : ℝ) * (16626 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191233 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27252 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27304 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102041 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102051 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102041 / 100000 : ℝ) * (269159 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102051 / 100000 : ℝ) * (269661 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18599 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18624 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27252 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27304 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102041 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102051 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18599 / 100000, 18624 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27252 / 100000, 27304 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102041 / 100000, 102051 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨184919 / 1000000, 185166 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982707 / 1000000, 982754 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨269159 / 1000000, 269661 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962955 / 1000000, 963096 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0004 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0004 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102051 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102041 / 100000 : ℝ) * (447376 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102051 / 100000 : ℝ) * (448066 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46383 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46460 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46383 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46460 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102041 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0004`.
...
/-- Sound projection of the B0004 checker instance into the generic
...
/-- Every projected type-(iv) height in B0004 has an equal-area regular
...
/-- Candidate-facing conclusion for B0004.  No stationarity hypothesis is
...
/-- Complete B0004 candidate-facing conclusion.  The checked stationary pair
