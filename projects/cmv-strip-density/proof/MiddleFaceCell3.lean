...
namespace MiddleFaceCell3

abbrev Brick := MiddleFaceAssembly.Brick

/- Exact inventory brick `B0003`, spanning `[102031/100000, 102041/100000]`. -/
def brick : Brick where
  lamLo := 102031 / 100000
  lamHi := 102041 / 100000
  centers := ![1859000713488038621 / 10000000000000000000,
    108911812482160687 / 400000000000000000,
    1052272034895254443 / 2500000000000000000,
    2317358186940613227 / 5000000000000000000]
  slopes := ![432630004055047783 / 200000000000000000,
    2483532672092337079 / 500000000000000000,
    3052346419901470569 / 500000000000000000,
    1857262758985559163 / 250000000000000000]
  yXiSlope := 67357549 / 100000000
  vRhoSlope := 11196501 / 12500000
...
/-- Unconditional real-range conclusion for the B0003 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102031 / 100000 : ℝ) ≤ lam → lam ≤ 102041 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18578 / 100000 : ℝ) ≤ q ∧ q ≤ 18602 / 100000) :
    (184713 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (184950 / 1000000 : ℝ) := by
  have hmonoLo : sin (18578 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18602 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18578 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18602 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18578 / 100000 : ℝ) ≤ q ∧ q ≤ 18602 / 100000) :
    (982748 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982793 / 1000000 : ℝ) := by
  have hmonoLo : cos (18602 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18578 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18602 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18578 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27202 / 100000 : ℝ) ≤ q ∧ q ≤ 27254 / 100000) :
    (268677 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (269179 / 1000000 : ℝ) := by
  have hmonoLo : sin (27202 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27254 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27202 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27254 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27202 / 100000 : ℝ) ≤ q ∧ q ≤ 27254 / 100000) :
    (963090 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (963231 / 1000000 : ℝ) := by
  have hmonoLo : cos (27254 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27202 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27254 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27202 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42059 / 100000 : ℝ) ≤ q ∧ q ≤ 42123 / 100000) :
    (408299 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (408884 / 1000000 : ℝ) := by
  have hmonoLo : sin (42059 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42123 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42059 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42123 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46309 / 100000 : ℝ) ≤ q ∧ q ≤ 46386 / 100000) :
    (446714 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (447404 / 1000000 : ℝ) := by
  have hmonoLo : sin (46309 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46386 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46309 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46386 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46309 / 100000 : ℝ) ≤ q ∧ q ≤ 46386 / 100000) :
    (894332 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (894677 / 1000000 : ℝ) := by
  have hmonoLo : cos (46386 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46309 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46386 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46309 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18578000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18602000 / 100000000) :
    (18471300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18495000 / 100000000 : ℝ) ∧
      (98274800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98279300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18578000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18602000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18602000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18578000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27202000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27254000 / 100000000) :
    (26867700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (26917900 / 100000000 : ℝ) ∧
      (96309000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96323100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27202000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27254000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27254000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27202000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42059000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42123000 / 100000000) :
    (40829900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (40888400 / 100000000 : ℝ) ∧
      (91258600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91284900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42059000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42123000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42123000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42059000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46309000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46386000 / 100000000) :
    (44671400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44740400 / 100000000 : ℝ) ∧
      (89433200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89467700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46309000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46386000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46386000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46309000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0003. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102031 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102041 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18578000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18602000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27202000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27254000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42059000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42123000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46309000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46386000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0003 brick. -/
...
B0003 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0003 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102031 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102041 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18578 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18602 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27202 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42059 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42123 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46309 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46386 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982793 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18578 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18578 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (912586 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42123 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42123 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (447404 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46386 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46386 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (408299 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42059 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42059 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102041 / 100000 : ℝ) * (46386 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102031 / 100000 : ℝ) * (27202 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16168 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16623 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982793 / 1000000 : ℝ) * (16168 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191258 / 100000 : ℝ) * (16623 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191258 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27202 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27254 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102031 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102041 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102031 / 100000 : ℝ) * (268677 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102041 / 100000 : ℝ) * (269179 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18578 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18602 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27202 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27254 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102031 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102041 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18578 / 100000, 18602 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27202 / 100000, 27254 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102031 / 100000, 102041 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨184713 / 1000000, 184950 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982748 / 1000000, 982793 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨268677 / 1000000, 269179 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨963090 / 1000000, 963231 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0003 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0003 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102041 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102031 / 100000 : ℝ) * (446714 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102041 / 100000 : ℝ) * (447404 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46309 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46386 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46309 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46386 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102031 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0003`.
...
/-- Sound projection of the B0003 checker instance into the generic
...
/-- Every projected type-(iv) height in B0003 has an equal-area regular
...
/-- Candidate-facing conclusion for B0003.  No stationarity hypothesis is
...
/-- Complete B0003 candidate-facing conclusion.  The checked stationary pair
