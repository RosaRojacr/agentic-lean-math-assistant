...
namespace MiddleFaceCell59

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0059`, spanning `[102591/100000, 102601/100000]`. -/
def brick : Brick where
  lamLo := 102591 / 100000
  lamHi := 102601 / 100000
  centers := ![393279071221214533 / 2000000000000000000,
    74510590406517837 / 250000000000000000,
    2260089491314856931 / 5000000000000000000,
    1003236011184073103 / 2000000000000000000]
  slopes := ![341017362821276581 / 200000000000000000,
    855732748326194723 / 200000000000000000,
    253816643352783201 / 50000000000000000,
    1567951458700016393 / 250000000000000000]
  yXiSlope := 2026557 / 3125000
  vRhoSlope := 345851 / 390625
...
/-- Unconditional real-range conclusion for the B0059 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102591 / 100000 : ℝ) ≤ lam → lam ≤ 102601 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19654 / 100000 : ℝ) ≤ q ∧ q ≤ 19674 / 100000) :
    (195277 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (195474 / 1000000 : ℝ) := by
  have hmonoLo : sin (19654 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19674 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19654 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19674 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19654 / 100000 : ℝ) ≤ q ∧ q ≤ 19674 / 100000) :
    (980709 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980749 / 1000000 : ℝ) := by
  have hmonoLo : cos (19674 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19654 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19674 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19654 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29782 / 100000 : ℝ) ≤ q ∧ q ≤ 29827 / 100000) :
    (293436 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (293868 / 1000000 : ℝ) := by
  have hmonoLo : sin (29782 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29827 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29782 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29827 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29782 / 100000 : ℝ) ≤ q ∧ q ≤ 29827 / 100000) :
    (955846 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (955979 / 1000000 : ℝ) := by
  have hmonoLo : cos (29827 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29782 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29827 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29782 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45175 / 100000 : ℝ) ≤ q ∧ q ≤ 45229 / 100000) :
    (436540 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (437027 / 1000000 : ℝ) := by
  have hmonoLo : sin (45175 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45229 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45175 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45229 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50129 / 100000 : ℝ) ≤ q ∧ q ≤ 50195 / 100000) :
    (480557 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (481136 / 1000000 : ℝ) := by
  have hmonoLo : sin (50129 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50195 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50129 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50195 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50129 / 100000 : ℝ) ≤ q ∧ q ≤ 50195 / 100000) :
    (876646 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (876964 / 1000000 : ℝ) := by
  have hmonoLo : cos (50195 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50129 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50195 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50129 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19654000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19674000 / 100000000) :
    (19527700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19547400 / 100000000 : ℝ) ∧
      (98070900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98074900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19654000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19674000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19674000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19654000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29782000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29827000 / 100000000) :
    (29343600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29386800 / 100000000 : ℝ) ∧
      (95584600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95597900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29782000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29827000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29827000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29782000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45175000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45229000 / 100000000) :
    (43654000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43702700 / 100000000 : ℝ) ∧
      (89944800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89968500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45175000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45229000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45229000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45175000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50129000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50195000 / 100000000) :
    (48055700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48113600 / 100000000 : ℝ) ∧
      (87664600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87696400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50129000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50195000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50195000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50129000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0059. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102591 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102601 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19654000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19674000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29782000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29827000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45175000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45229000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50129000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50195000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0059 brick. -/
...
throughout the B0059 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102591 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102601 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19654 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19674 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29782 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45175 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45229 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50129 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50195 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980749 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19654 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19654 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (899448 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45229 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45229 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (481136 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50195 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50195 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (436540 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45175 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45175 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102601 / 100000 : ℝ) * (50195 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102591 / 100000 : ℝ) * (29782 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16248 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16795 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980749 / 1000000 : ℝ) * (16248 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189944 / 100000 : ℝ) * (16795 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189944 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29782 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29827 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102591 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102601 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102591 / 100000 : ℝ) * (293436 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102601 / 100000 : ℝ) * (293868 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19654 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19674 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29782 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29827 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102591 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102601 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19654 / 100000, 19674 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29782 / 100000, 29827 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102591 / 100000, 102601 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨195277 / 1000000, 195474 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980709 / 1000000, 980749 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨293436 / 1000000, 293868 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨955846 / 1000000, 955979 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0059 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0059 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102601 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102591 / 100000 : ℝ) * (480557 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102601 / 100000 : ℝ) * (481136 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50129 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50195 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50129 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50195 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102591 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0059`.
...
/-- Sound projection of the B0059 checker instance into the generic
...
/-- Every projected type-(iv) height in B0059 has an equal-area regular
...
/-- Candidate-facing conclusion for B0059.  No stationarity hypothesis is
...
/-- Complete B0059 candidate-facing conclusion.  The checked stationary pair
