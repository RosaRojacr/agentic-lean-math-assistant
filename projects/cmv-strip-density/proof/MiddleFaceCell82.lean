...
namespace MiddleFaceCell82

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0082`, spanning `[102821/100000, 102831/100000]`. -/
def brick : Brick where
  lamLo := 102821 / 100000
  lamHi := 102831 / 100000
  centers := ![400790399057459491 / 2000000000000000000,
    3076273624638781203 / 10000000000000000000,
    2316583089966560391 / 5000000000000000000,
    1289039322326034141 / 2500000000000000000]
  slopes := ![1564243269230542807 / 1000000000000000000,
    812208825023253623 / 200000000000000000,
    4756321253345264811 / 1000000000000000000,
    5908568550456390869 / 1000000000000000000]
  yXiSlope := 63932307 / 100000000
  vRhoSlope := 88148579 / 100000000
...
/-- Unconditional real-range conclusion for the B0082 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102821 / 100000 : ℝ) ≤ lam → lam ≤ 102831 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20030 / 100000 : ℝ) ≤ q ∧ q ≤ 20049 / 100000) :
    (198963 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (199150 / 1000000 : ℝ) := by
  have hmonoLo : sin (20030 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20049 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20030 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20049 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20030 / 100000 : ℝ) ≤ q ∧ q ≤ 20049 / 100000) :
    (979969 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980007 / 1000000 : ℝ) := by
  have hmonoLo : cos (20049 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20030 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20049 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20030 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30741 / 100000 : ℝ) ≤ q ∧ q ≤ 30784 / 100000) :
    (302591 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (303001 / 1000000 : ℝ) := by
  have hmonoLo : sin (30741 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30784 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30741 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30784 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30741 / 100000 : ℝ) ≤ q ∧ q ≤ 30784 / 100000) :
    (952990 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953121 / 1000000 : ℝ) := by
  have hmonoLo : cos (30784 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30741 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30784 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30741 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46306 / 100000 : ℝ) ≤ q ∧ q ≤ 46357 / 100000) :
    (446687 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (447145 / 1000000 : ℝ) := by
  have hmonoLo : sin (46306 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46357 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46306 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46357 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51531 / 100000 : ℝ) ≤ q ∧ q ≤ 51593 / 100000) :
    (492804 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (493345 / 1000000 : ℝ) := by
  have hmonoLo : sin (51531 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51593 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51531 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51593 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51531 / 100000 : ℝ) ≤ q ∧ q ≤ 51593 / 100000) :
    (869834 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (870140 / 1000000 : ℝ) := by
  have hmonoLo : cos (51593 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51531 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51593 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51531 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20030000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20049000 / 100000000) :
    (19896300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19915000 / 100000000 : ℝ) ∧
      (97996900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98000700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20030000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20049000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20049000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20030000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30741000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30784000 / 100000000) :
    (30259100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30300100 / 100000000 : ℝ) ∧
      (95299000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95312100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30741000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30784000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30784000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30741000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46306000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46357000 / 100000000) :
    (44668700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44714500 / 100000000 : ℝ) ∧
      (89446100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89469000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46306000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46357000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46357000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46306000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51531000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51593000 / 100000000) :
    (49280400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49334500 / 100000000 : ℝ) ∧
      (86983400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87014000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51531000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51593000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51593000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51531000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0082. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102821 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102831 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20030000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20049000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30741000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30784000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46306000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46357000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51531000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51593000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0082 brick. -/
...
throughout the B0082 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102821 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102831 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20030 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20049 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30741 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46306 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46357 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51531 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51593 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980007 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20030 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20030 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (894461 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46357 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46357 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (493345 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51593 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51593 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (446687 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46306 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46306 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102831 / 100000 : ℝ) * (51593 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102821 / 100000 : ℝ) * (30741 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16279 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16863 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980007 / 1000000 : ℝ) * (16279 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189446 / 100000 : ℝ) * (16863 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189446 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30741 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30784 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102821 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102831 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102821 / 100000 : ℝ) * (302591 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102831 / 100000 : ℝ) * (303001 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20030 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20049 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30741 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30784 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102821 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102831 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20030 / 100000, 20049 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30741 / 100000, 30784 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102821 / 100000, 102831 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198963 / 1000000, 199150 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979969 / 1000000, 980007 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨302591 / 1000000, 303001 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952990 / 1000000, 953121 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0082 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0082 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102831 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102821 / 100000 : ℝ) * (492804 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102831 / 100000 : ℝ) * (493345 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51531 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51593 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51531 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51593 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102821 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0082`.
...
/-- Sound projection of the B0082 checker instance into the generic
...
/-- Every projected type-(iv) height in B0082 has an equal-area regular
...
/-- Candidate-facing conclusion for B0082.  No stationarity hypothesis is
...
/-- Complete B0082 candidate-facing conclusion.  The checked stationary pair
