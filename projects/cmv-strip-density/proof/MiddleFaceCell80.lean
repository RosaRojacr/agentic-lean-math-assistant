...
namespace MiddleFaceCell80

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0080`, spanning `[102801/100000, 102811/100000]`. -/
def brick : Brick where
  lamLo := 102801 / 100000
  lamHi := 102811 / 100000
  centers := ![2000812096853495167 / 10000000000000000000,
    76703344455895043 / 250000000000000000,
    4623627526004135437 / 10000000000000000000,
    2572155281396311119 / 5000000000000000000]
  slopes := ![3077486785868639 / 1953125000000000,
    815765513033622143 / 200000000000000000,
    149449124762711351 / 31250000000000000,
    5938201238278231477 / 1000000000000000000]
  yXiSlope := 6400991 / 10000000
  vRhoSlope := 44090869 / 50000000
...
/-- Unconditional real-range conclusion for the B0080 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102801 / 100000 : ℝ) ≤ lam → lam ≤ 102811 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19999 / 100000 : ℝ) ≤ q ∧ q ≤ 20017 / 100000) :
    (198659 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198836 / 1000000 : ℝ) := by
  have hmonoLo : sin (19999 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20017 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19999 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20017 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19999 / 100000 : ℝ) ≤ q ∧ q ≤ 20017 / 100000) :
    (980032 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980069 / 1000000 : ℝ) := by
  have hmonoLo : cos (20017 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19999 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20017 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19999 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30660 / 100000 : ℝ) ≤ q ∧ q ≤ 30703 / 100000) :
    (301818 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (302229 / 1000000 : ℝ) := by
  have hmonoLo : sin (30660 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30703 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30660 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30703 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30660 / 100000 : ℝ) ≤ q ∧ q ≤ 30703 / 100000) :
    (953235 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953366 / 1000000 : ℝ) := by
  have hmonoLo : cos (30703 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30660 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30703 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30660 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46211 / 100000 : ℝ) ≤ q ∧ q ≤ 46262 / 100000) :
    (445837 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (446295 / 1000000 : ℝ) := by
  have hmonoLo : sin (46211 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46262 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46211 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46262 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51412 / 100000 : ℝ) ≤ q ∧ q ≤ 51474 / 100000) :
    (491768 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (492309 / 1000000 : ℝ) := by
  have hmonoLo : sin (51412 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51474 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51412 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51474 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51412 / 100000 : ℝ) ≤ q ∧ q ≤ 51474 / 100000) :
    (870420 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (870726 / 1000000 : ℝ) := by
  have hmonoLo : cos (51474 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51412 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51474 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51412 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19999000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20017000 / 100000000) :
    (19865900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19883600 / 100000000 : ℝ) ∧
      (98003200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98006900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19999000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20017000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20017000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19999000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30660000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30703000 / 100000000) :
    (30181800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30222900 / 100000000 : ℝ) ∧
      (95323500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95336600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30660000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30703000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30703000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30660000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46211000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46262000 / 100000000) :
    (44583700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44629500 / 100000000 : ℝ) ∧
      (89488600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89511400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46211000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46262000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46262000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46211000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51412000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51474000 / 100000000) :
    (49176800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49230900 / 100000000 : ℝ) ∧
      (87042000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87072600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51412000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51474000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51474000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51412000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0080. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102801 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102811 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19999000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20017000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30660000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30703000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46211000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46262000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51412000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51474000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0080 brick. -/
...
throughout the B0080 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102801 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102811 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19999 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20017 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30660 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46211 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46262 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51412 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51474 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980069 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19999 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19999 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (894886 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46262 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46262 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (492309 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51474 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51474 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (445837 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46211 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46211 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102811 / 100000 : ℝ) * (51474 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102801 / 100000 : ℝ) * (30660 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16276 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16858 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980069 / 1000000 : ℝ) * (16276 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189488 / 100000 : ℝ) * (16858 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189488 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30660 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30703 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102801 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102811 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102801 / 100000 : ℝ) * (301818 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102811 / 100000 : ℝ) * (302229 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19999 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20017 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30660 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30703 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102801 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102811 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19999 / 100000, 20017 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30660 / 100000, 30703 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102801 / 100000, 102811 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198659 / 1000000, 198836 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980032 / 1000000, 980069 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨301818 / 1000000, 302229 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953235 / 1000000, 953366 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0080 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0080 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102811 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102801 / 100000 : ℝ) * (491768 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102811 / 100000 : ℝ) * (492309 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51412 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51474 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51412 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51474 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102801 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0080`.
...
/-- Sound projection of the B0080 checker instance into the generic
...
/-- Every projected type-(iv) height in B0080 has an equal-area regular
...
/-- Candidate-facing conclusion for B0080.  No stationarity hypothesis is
...
/-- Complete B0080 candidate-facing conclusion.  The checked stationary pair
