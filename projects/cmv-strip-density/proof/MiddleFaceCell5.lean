...
namespace MiddleFaceCell5

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0005`, spanning `[102051/100000, 102061/100000]`. -/
def brick : Brick where
  lamLo := 102051 / 100000
  lamHi := 102061 / 100000
  centers := ![1863306853105232233 / 10000000000000000000,
    273269968367229599 / 1000000000000000000,
    2110626300910184301 / 5000000000000000000,
    2324762103071376309 / 5000000000000000000]
  slopes := ![2143032856963666491 / 1000000000000000000,
    987472936044680487 / 200000000000000000,
    47342675392205833 / 7812500000000000,
    1844720612423340563 / 250000000000000000]
  yXiSlope := 33629991 / 50000000
  vRhoSlope := 44766281 / 50000000
...
/-- Unconditional real-range conclusion for the B0005 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102051 / 100000 : ℝ) ≤ lam → lam ≤ 102061 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18621 / 100000 : ℝ) ≤ q ∧ q ≤ 18645 / 100000) :
    (185135 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (185372 / 1000000 : ℝ) := by
  have hmonoLo : sin (18621 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18645 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18621 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18645 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18621 / 100000 : ℝ) ≤ q ∧ q ≤ 18645 / 100000) :
    (982668 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982713 / 1000000 : ℝ) := by
  have hmonoLo : cos (18645 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18621 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18645 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18621 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27301 / 100000 : ℝ) ≤ q ∧ q ≤ 27353 / 100000) :
    (269631 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (270132 / 1000000 : ℝ) := by
  have hmonoLo : sin (27301 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27353 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27301 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27353 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27301 / 100000 : ℝ) ≤ q ∧ q ≤ 27353 / 100000) :
    (962823 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962964 / 1000000 : ℝ) := by
  have hmonoLo : cos (27353 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27301 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27353 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27301 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42181 / 100000 : ℝ) ≤ q ∧ q ≤ 42244 / 100000) :
    (409412 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (409988 / 1000000 : ℝ) := by
  have hmonoLo : sin (42181 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42244 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42181 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42244 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46457 / 100000 : ℝ) ≤ q ∧ q ≤ 46534 / 100000) :
    (448038 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (448727 / 1000000 : ℝ) := by
  have hmonoLo : sin (46457 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46534 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46457 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46534 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46457 / 100000 : ℝ) ≤ q ∧ q ≤ 46534 / 100000) :
    (893669 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (894015 / 1000000 : ℝ) := by
  have hmonoLo : cos (46534 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46457 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46534 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46457 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18621000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18645000 / 100000000) :
    (18513500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18537200 / 100000000 : ℝ) ∧
      (98266800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98271300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18621000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18645000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18645000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18621000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27301000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27353000 / 100000000) :
    (26963100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27013200 / 100000000 : ℝ) ∧
      (96282300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96296400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27301000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27353000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27353000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27301000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42181000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42244000 / 100000000) :
    (40941200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (40998800 / 100000000 : ℝ) ∧
      (91209100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91235000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42181000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42244000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42244000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42181000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46457000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46534000 / 100000000) :
    (44803800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44872700 / 100000000 : ℝ) ∧
      (89366900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89401500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46457000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46534000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46534000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46457000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0005. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102051 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102061 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18621000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18645000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27301000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27353000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42181000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42244000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46457000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46534000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0005 brick. -/
...
B0005 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0005 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102051 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102061 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18621 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18645 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27301 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42181 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42244 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46457 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46534 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982713 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18621 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18621 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (912091 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42244 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42244 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (448727 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46534 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46534 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (409412 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42181 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42181 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102061 / 100000 : ℝ) * (46534 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102051 / 100000 : ℝ) * (27301 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16171 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16629 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982713 / 1000000 : ℝ) * (16171 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191209 / 100000 : ℝ) * (16629 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191209 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27301 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27353 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102051 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102061 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102051 / 100000 : ℝ) * (269631 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102061 / 100000 : ℝ) * (270132 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18621 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18645 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27301 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27353 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102051 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102061 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18621 / 100000, 18645 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27301 / 100000, 27353 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102051 / 100000, 102061 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨185135 / 1000000, 185372 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982668 / 1000000, 982713 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨269631 / 1000000, 270132 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962823 / 1000000, 962964 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0005 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0005 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102061 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102051 / 100000 : ℝ) * (448038 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102061 / 100000 : ℝ) * (448727 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46457 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46534 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46457 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46534 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102051 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0005`.
...
/-- Sound projection of the B0005 checker instance into the generic
...
/-- Every projected type-(iv) height in B0005 has an equal-area regular
...
/-- Candidate-facing conclusion for B0005.  No stationarity hypothesis is
...
/-- Complete B0005 candidate-facing conclusion.  The checked stationary pair
