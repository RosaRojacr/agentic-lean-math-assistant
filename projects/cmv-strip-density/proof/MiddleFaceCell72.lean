...
namespace MiddleFaceCell72

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0072`, spanning `[102721/100000, 102731/100000]`. -/
def brick : Brick where
  lamLo := 102721 / 100000
  lamHi := 102731 / 100000
  centers := ![994009734918677737 / 5000000000000000000,
    379401565607468483 / 1250000000000000000,
    458494225108826953 / 1000000000000000000,
    5096320390519573677 / 10000000000000000000]
  slopes := ![324576428372590061 / 200000000000000000,
    4054728924369589 / 976562500000000,
    1222453360954970429 / 250000000000000000,
    6060295157765142983 / 1000000000000000000]
  yXiSlope := 16081091 / 25000000
  vRhoSlope := 17663131 / 20000000
...
/-- Unconditional real-range conclusion for the B0072 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102721 / 100000 : ℝ) ≤ lam → lam ≤ 102731 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19871 / 100000 : ℝ) ≤ q ∧ q ≤ 19890 / 100000) :
    (197404 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (197592 / 1000000 : ℝ) := by
  have hmonoLo : sin (19871 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19890 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19871 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19890 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19871 / 100000 : ℝ) ≤ q ∧ q ≤ 19890 / 100000) :
    (980284 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980323 / 1000000 : ℝ) := by
  have hmonoLo : cos (19890 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19871 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19890 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19871 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30330 / 100000 : ℝ) ≤ q ∧ q ≤ 30374 / 100000) :
    (298671 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (299092 / 1000000 : ℝ) := by
  have hmonoLo : sin (30330 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30374 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30330 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30374 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30330 / 100000 : ℝ) ≤ q ∧ q ≤ 30374 / 100000) :
    (954224 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954357 / 1000000 : ℝ) := by
  have hmonoLo : cos (30374 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30330 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30374 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30330 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45823 / 100000 : ℝ) ≤ q ∧ q ≤ 45875 / 100000) :
    (442361 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (442828 / 1000000 : ℝ) := by
  have hmonoLo : sin (45823 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45875 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45823 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45875 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50931 / 100000 : ℝ) ≤ q ∧ q ≤ 50995 / 100000) :
    (487574 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (488134 / 1000000 : ℝ) := by
  have hmonoLo : sin (50931 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50995 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50931 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50995 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50931 / 100000 : ℝ) ≤ q ∧ q ≤ 50995 / 100000) :
    (872768 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (873082 / 1000000 : ℝ) := by
  have hmonoLo : cos (50995 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50931 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50995 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50931 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19871000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19890000 / 100000000) :
    (19740400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19759200 / 100000000 : ℝ) ∧
      (98028400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98032300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19871000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19890000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19890000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19871000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30330000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30374000 / 100000000) :
    (29867100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29909200 / 100000000 : ℝ) ∧
      (95422400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95435700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30330000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30374000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30374000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30330000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45823000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45875000 / 100000000) :
    (44236100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44282800 / 100000000 : ℝ) ∧
      (89660600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89683700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45823000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45875000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45875000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45823000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50931000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50995000 / 100000000) :
    (48757400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48813400 / 100000000 : ℝ) ∧
      (87276800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87308200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50931000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50995000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50995000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50931000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0072. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102721 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102731 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19871000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19890000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30330000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30374000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45823000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45875000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50931000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50995000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0072 brick. -/
...
throughout the B0072 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102721 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102731 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19871 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19890 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30330 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45823 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45875 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50931 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50995 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980323 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19871 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19871 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (896606 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45875 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45875 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (488134 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50995 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50995 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (442361 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45823 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45823 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102731 / 100000 : ℝ) * (50995 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102721 / 100000 : ℝ) * (30330 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16266 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16834 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980323 / 1000000 : ℝ) * (16266 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189660 / 100000 : ℝ) * (16834 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189660 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30330 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30374 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102721 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102731 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102721 / 100000 : ℝ) * (298671 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102731 / 100000 : ℝ) * (299092 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19871 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19890 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30330 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30374 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102721 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102731 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19871 / 100000, 19890 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30330 / 100000, 30374 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102721 / 100000, 102731 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨197404 / 1000000, 197592 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980284 / 1000000, 980323 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨298671 / 1000000, 299092 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954224 / 1000000, 954357 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0072 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0072 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102731 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102721 / 100000 : ℝ) * (487574 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102731 / 100000 : ℝ) * (488134 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50931 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50995 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50931 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50995 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102721 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0072`.
...
/-- Sound projection of the B0072 checker instance into the generic
...
/-- Every projected type-(iv) height in B0072 has an equal-area regular
...
/-- Candidate-facing conclusion for B0072.  No stationarity hypothesis is
...
/-- Complete B0072 candidate-facing conclusion.  The checked stationary pair
