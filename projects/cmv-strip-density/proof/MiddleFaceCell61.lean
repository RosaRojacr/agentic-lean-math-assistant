...
namespace MiddleFaceCell61

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0061`, spanning `[102611/100000, 102621/100000]`. -/
def brick : Brick where
  lamLo := 102611 / 100000
  lamHi := 102621 / 100000
  centers := ![492448097210955947 / 2500000000000000000,
    93405024292561901 / 312500000000000000,
    4530301880845210457 / 10000000000000000000,
    5028689950190717381 / 10000000000000000000]
  slopes := ![1691968263025762161 / 1000000000000000000,
    4258528337103675273 / 1000000000000000000,
    1261653451928691029 / 250000000000000000,
    6238141614391711513 / 1000000000000000000]
  yXiSlope := 64767771 / 100000000
  vRhoSlope := 88503287 / 100000000
...
/-- Unconditional real-range conclusion for the B0061 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102611 / 100000 : ℝ) ≤ lam → lam ≤ 102621 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19688 / 100000 : ℝ) ≤ q ∧ q ≤ 19708 / 100000) :
    (195610 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (195807 / 1000000 : ℝ) := by
  have hmonoLo : sin (19688 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19708 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19688 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19708 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19688 / 100000 : ℝ) ≤ q ∧ q ≤ 19708 / 100000) :
    (980642 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980682 / 1000000 : ℝ) := by
  have hmonoLo : cos (19708 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19688 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19708 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19688 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29867 / 100000 : ℝ) ≤ q ∧ q ≤ 29912 / 100000) :
    (294249 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (294680 / 1000000 : ℝ) := by
  have hmonoLo : sin (29867 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29912 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29867 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29912 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29867 / 100000 : ℝ) ≤ q ∧ q ≤ 29912 / 100000) :
    (955596 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (955729 / 1000000 : ℝ) := by
  have hmonoLo : cos (29912 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29867 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29912 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29867 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45276 / 100000 : ℝ) ≤ q ∧ q ≤ 45330 / 100000) :
    (437449 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (437935 / 1000000 : ℝ) := by
  have hmonoLo : sin (45276 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45330 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45276 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45330 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50254 / 100000 : ℝ) ≤ q ∧ q ≤ 50320 / 100000) :
    (481653 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (482232 / 1000000 : ℝ) := by
  have hmonoLo : sin (50254 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50320 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50254 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50320 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50254 / 100000 : ℝ) ≤ q ∧ q ≤ 50320 / 100000) :
    (876043 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (876362 / 1000000 : ℝ) := by
  have hmonoLo : cos (50320 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50254 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50320 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50254 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19688000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19708000 / 100000000) :
    (19561000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19580700 / 100000000 : ℝ) ∧
      (98064200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98068200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19688000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19708000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19708000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19688000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29867000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29912000 / 100000000) :
    (29424900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29468000 / 100000000 : ℝ) ∧
      (95559600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95572900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29867000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29912000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29912000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29867000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45276000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45330000 / 100000000) :
    (43744900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43793500 / 100000000 : ℝ) ∧
      (89900600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89924400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45276000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45330000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45330000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45276000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50254000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50320000 / 100000000) :
    (48165300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48223200 / 100000000 : ℝ) ∧
      (87604300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87636200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50254000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50320000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50320000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50254000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0061. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102611 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102621 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19688000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19708000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29867000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29912000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45276000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45330000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50254000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50320000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0061 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 63 / 125, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (63 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0061 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102611 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102621 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19688 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19708 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29867 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45276 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45330 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50254 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50320 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980682 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19688 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19688 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (899006 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45330 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45330 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (482232 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50320 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50320 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (437449 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45276 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45276 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102621 / 100000 : ℝ) * (50320 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102611 / 100000 : ℝ) * (29867 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16251 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16801 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980682 / 1000000 : ℝ) * (16251 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189900 / 100000 : ℝ) * (16801 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189900 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29867 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29912 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102611 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102621 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102611 / 100000 : ℝ) * (294249 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102621 / 100000 : ℝ) * (294680 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19688 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19708 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29867 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29912 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102611 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102621 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19688 / 100000, 19708 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29867 / 100000, 29912 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102611 / 100000, 102621 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨195610 / 1000000, 195807 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980642 / 1000000, 980682 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨294249 / 1000000, 294680 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨955596 / 1000000, 955729 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0061 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0061 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102621 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102611 / 100000 : ℝ) * (481653 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102621 / 100000 : ℝ) * (482232 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50254 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50320 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50254 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50320 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102611 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0061`.
...
/-- Sound projection of the B0061 checker instance into the generic
...
/-- Every projected type-(iv) height in B0061 has an equal-area regular
...
/-- Candidate-facing conclusion for B0061.  No stationarity hypothesis is
...
/-- Complete B0061 candidate-facing conclusion.  The checked stationary pair
