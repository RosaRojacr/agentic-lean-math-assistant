...
namespace MiddleFaceCell96

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0096`, spanning `[102961/100000, 102971/100000]`. -/
def brick : Brick where
  lamLo := 102961 / 100000
  lamHi := 102971 / 100000
  centers := ![2025310734711411823 / 10000000000000000000,
    3132284047944149153 / 10000000000000000000,
    4698520428859012147 / 10000000000000000000,
    5237471763861735829 / 10000000000000000000]
  slopes := ![1488093651684202201 / 1000000000000000000,
    3941973197239233211 / 1000000000000000000,
    4582370937316877299 / 1000000000000000000,
    713799701534584021 / 125000000000000000]
  yXiSlope := 31699947 / 50000000
  vRhoSlope := 87919901 / 100000000
...
/-- Unconditional real-range conclusion for the B0096 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102961 / 100000 : ℝ) ≤ lam → lam ≤ 102971 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20244 / 100000 : ℝ) ≤ q ∧ q ≤ 20262 / 100000) :
    (201060 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201237 / 1000000 : ℝ) := by
  have hmonoLo : sin (20244 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20262 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20244 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20262 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20244 / 100000 : ℝ) ≤ q ∧ q ≤ 20262 / 100000) :
    (979542 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979579 / 1000000 : ℝ) := by
  have hmonoLo : cos (20262 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20244 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20262 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20244 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31302 / 100000 : ℝ) ≤ q ∧ q ≤ 31344 / 100000) :
    (307933 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (308333 / 1000000 : ℝ) := by
  have hmonoLo : sin (31302 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31344 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31302 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31344 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31302 / 100000 : ℝ) ≤ q ∧ q ≤ 31344 / 100000) :
    (951278 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951408 / 1000000 : ℝ) := by
  have hmonoLo : cos (31344 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31302 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31344 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31302 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46961 / 100000 : ℝ) ≤ q ∧ q ≤ 47010 / 100000) :
    (452538 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (452976 / 1000000 : ℝ) := by
  have hmonoLo : sin (46961 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47010 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46961 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47010 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52345 / 100000 : ℝ) ≤ q ∧ q ≤ 52405 / 100000) :
    (499871 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (500391 / 1000000 : ℝ) := by
  have hmonoLo : sin (52345 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52405 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52345 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52405 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52345 / 100000 : ℝ) ≤ q ∧ q ≤ 52405 / 100000) :
    (865799 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (866100 / 1000000 : ℝ) := by
  have hmonoLo : cos (52405 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52345 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52405 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52345 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20244000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20262000 / 100000000) :
    (20106000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20123700 / 100000000 : ℝ) ∧
      (97954200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97957900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20244000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20262000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20262000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20244000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31302000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31344000 / 100000000) :
    (30793300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30833300 / 100000000 : ℝ) ∧
      (95127800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95140800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31302000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31344000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31344000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31302000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46961000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47010000 / 100000000) :
    (45253800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45297600 / 100000000 : ℝ) ∧
      (89152200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89174500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46961000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47010000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47010000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46961000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52345000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52405000 / 100000000) :
    (49987100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50039100 / 100000000 : ℝ) ∧
      (86579900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86610000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52345000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52405000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52405000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52345000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0096. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102961 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102971 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20244000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20262000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31302000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31344000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46961000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47010000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52345000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52405000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0096 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (21 / 40 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 59 / 125, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 21 / 40, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (21 / 40)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (59 / 125)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0096 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102961 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102971 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20244 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20262 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31302 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46961 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47010 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52345 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52405 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979579 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20244 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20244 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (891522 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47010 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47010 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (500391 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52405 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52405 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (452538 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46961 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46961 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102971 / 100000 : ℝ) * (52405 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102961 / 100000 : ℝ) * (31302 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16298 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16904 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979579 / 1000000 : ℝ) * (16298 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189152 / 100000 : ℝ) * (16904 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189152 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31302 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31344 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102961 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102971 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102961 / 100000 : ℝ) * (307933 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102971 / 100000 : ℝ) * (308333 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20244 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20262 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31302 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31344 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102961 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102971 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20244 / 100000, 20262 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31302 / 100000, 31344 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102961 / 100000, 102971 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201060 / 1000000, 201237 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979542 / 1000000, 979579 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨307933 / 1000000, 308333 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951278 / 1000000, 951408 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0096 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0096 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102971 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102961 / 100000 : ℝ) * (499871 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102971 / 100000 : ℝ) * (500391 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52345 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52405 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52345 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52405 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102961 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0096`.
...
/-- Sound projection of the B0096 checker instance into the generic
...
/-- Every projected type-(iv) height in B0096 has an equal-area regular
...
/-- Candidate-facing conclusion for B0096.  No stationarity hypothesis is
...
/-- Complete B0096 candidate-facing conclusion.  The checked stationary pair
