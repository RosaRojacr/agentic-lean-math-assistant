...
namespace MiddleFaceCell99

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0099`, spanning `[102991/100000, 103001/100000]`. -/
def brick : Brick where
  lamLo := 102991 / 100000
  lamHi := 103001 / 100000
  centers := ![2029751718910922497 / 10000000000000000000,
    3144073353551111527 / 10000000000000000000,
    294513387521713899 / 625000000000000000,
    5254542093538442223 / 10000000000000000000]
  slopes := ![92037731808776271 / 62500000000000000,
    1958810984890541523 / 500000000000000000,
    4546899970014660433 / 1000000000000000000,
    5669921373617563807 / 1000000000000000000]
  yXiSlope := 3955511 / 6250000
  vRhoSlope := 21967913 / 25000000
...
/-- Unconditional real-range conclusion for the B0099 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102991 / 100000 : ℝ) ≤ lam → lam ≤ 103001 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20289 / 100000 : ℝ) ≤ q ∧ q ≤ 20306 / 100000) :
    (201500 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201668 / 1000000 : ℝ) := by
  have hmonoLo : sin (20289 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20306 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20289 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20306 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20289 / 100000 : ℝ) ≤ q ∧ q ≤ 20306 / 100000) :
    (979454 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979489 / 1000000 : ℝ) := by
  have hmonoLo : cos (20306 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20289 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20306 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20289 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31420 / 100000 : ℝ) ≤ q ∧ q ≤ 31462 / 100000) :
    (309055 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (309456 / 1000000 : ℝ) := by
  have hmonoLo : sin (31420 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31462 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31420 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31462 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31420 / 100000 : ℝ) ≤ q ∧ q ≤ 31462 / 100000) :
    (950914 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951044 / 1000000 : ℝ) := by
  have hmonoLo : cos (31462 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31420 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31462 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31420 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47098 / 100000 : ℝ) ≤ q ∧ q ≤ 47146 / 100000) :
    (453759 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (454188 / 1000000 : ℝ) := by
  have hmonoLo : sin (47098 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47146 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47098 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47146 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52516 / 100000 : ℝ) ≤ q ∧ q ≤ 52575 / 100000) :
    (501351 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (501862 / 1000000 : ℝ) := by
  have hmonoLo : sin (52516 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52575 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52516 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52575 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52516 / 100000 : ℝ) ≤ q ∧ q ≤ 52575 / 100000) :
    (864947 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (865244 / 1000000 : ℝ) := by
  have hmonoLo : cos (52575 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52516 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52575 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52516 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20289000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20306000 / 100000000) :
    (20150000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20166800 / 100000000 : ℝ) ∧
      (97945400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97948900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20289000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20306000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20306000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20289000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31420000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31462000 / 100000000) :
    (30905500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30945600 / 100000000 : ℝ) ∧
      (95091400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95104400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31420000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31462000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31462000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31420000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47098000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47146000 / 100000000) :
    (45375900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45418800 / 100000000 : ℝ) ∧
      (89090600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89112500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47098000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47146000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47146000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47098000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52516000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52575000 / 100000000) :
    (50135100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50186200 / 100000000 : ℝ) ∧
      (86494700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86524400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52516000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52575000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52575000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52516000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0099. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102991 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103001 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20289000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20306000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31420000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31462000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47098000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47146000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52516000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52575000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0099 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 263 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (263 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0099 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102991 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103001 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20289 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20306 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31420 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47098 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47146 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52516 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52575 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979489 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20289 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20289 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (890906 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47146 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47146 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (501862 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52575 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52575 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (453759 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47098 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47098 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103001 / 100000 : ℝ) * (52575 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102991 / 100000 : ℝ) * (31420 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16302 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16913 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979489 / 1000000 : ℝ) * (16302 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189090 / 100000 : ℝ) * (16913 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189090 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31420 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31462 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102991 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103001 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102991 / 100000 : ℝ) * (309055 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103001 / 100000 : ℝ) * (309456 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20289 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20306 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31420 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31462 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102991 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103001 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20289 / 100000, 20306 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31420 / 100000, 31462 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102991 / 100000, 103001 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201500 / 1000000, 201668 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979454 / 1000000, 979489 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨309055 / 1000000, 309456 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950914 / 1000000, 951044 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0099 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0099 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103001 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102991 / 100000 : ℝ) * (501351 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103001 / 100000 : ℝ) * (501862 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52516 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52575 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52516 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52575 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102991 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0099`.
...
/-- Sound projection of the B0099 checker instance into the generic
...
/-- Every projected type-(iv) height in B0099 has an equal-area regular
...
/-- Candidate-facing conclusion for B0099.  No stationarity hypothesis is
...
/-- Complete B0099 candidate-facing conclusion.  The checked stationary pair
