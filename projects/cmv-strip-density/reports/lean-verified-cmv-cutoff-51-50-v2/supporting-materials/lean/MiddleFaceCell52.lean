...
namespace MiddleFaceCell52

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0052`, spanning `[102521/100000, 102531/100000]`. -/
def brick : Brick where
  lamLo := 102521 / 100000
  lamHi := 102531 / 100000
  centers := ![390859058132536709 / 2000000000000000000,
    1475110554264148427 / 5000000000000000000,
    4484272450015448709 / 10000000000000000000,
    2485928046935877111 / 5000000000000000000]
  slopes := ![350489935680829633 / 200000000000000000,
    4351143045319434977 / 1000000000000000000,
    2591744619078214093 / 500000000000000000,
    6393074670575127141 / 1000000000000000000]
  yXiSlope := 65140637 / 100000000
  vRhoSlope := 88659993 / 100000000
...
/-- Unconditional real-range conclusion for the B0052 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102521 / 100000 : ℝ) ≤ lam → lam ≤ 102531 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19533 / 100000 : ℝ) ≤ q ∧ q ≤ 19553 / 100000) :
    (194090 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (194287 / 1000000 : ℝ) := by
  have hmonoLo : sin (19533 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19553 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19533 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19553 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19533 / 100000 : ℝ) ≤ q ∧ q ≤ 19553 / 100000) :
    (980944 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980984 / 1000000 : ℝ) := by
  have hmonoLo : cos (19553 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19533 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19553 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19533 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29479 / 100000 : ℝ) ≤ q ∧ q ≤ 29525 / 100000) :
    (290538 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (290980 / 1000000 : ℝ) := by
  have hmonoLo : sin (29479 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29525 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29479 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29525 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29479 / 100000 : ℝ) ≤ q ∧ q ≤ 29525 / 100000) :
    (956729 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956864 / 1000000 : ℝ) := by
  have hmonoLo : cos (29525 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29479 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29525 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29479 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44815 / 100000 : ℝ) ≤ q ∧ q ≤ 44870 / 100000) :
    (433298 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (433795 / 1000000 : ℝ) := by
  have hmonoLo : sin (44815 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44870 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44815 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44870 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49685 / 100000 : ℝ) ≤ q ∧ q ≤ 49752 / 100000) :
    (476658 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (477248 / 1000000 : ℝ) := by
  have hmonoLo : sin (49685 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49752 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49685 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49752 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49685 / 100000 : ℝ) ≤ q ∧ q ≤ 49752 / 100000) :
    (878768 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (879089 / 1000000 : ℝ) := by
  have hmonoLo : cos (49752 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49685 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49752 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49685 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19533000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19553000 / 100000000) :
    (19409000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19428700 / 100000000 : ℝ) ∧
      (98094400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98098400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19533000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19553000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19553000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19533000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29479000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29525000 / 100000000) :
    (29053800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29098000 / 100000000 : ℝ) ∧
      (95672900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95686400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29479000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29525000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29525000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29479000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44815000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44870000 / 100000000) :
    (43329800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43379500 / 100000000 : ℝ) ∧
      (90101100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90125100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44815000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44870000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44870000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44815000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49685000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49752000 / 100000000) :
    (47665800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47724800 / 100000000 : ℝ) ∧
      (87876800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87908900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49685000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49752000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49752000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49685000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0052. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102521 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102531 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19533000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19553000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29479000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29525000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44815000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44870000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49685000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49752000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0052 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 249 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (249 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0052 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102521 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102531 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19533 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19553 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29479 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44815 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44870 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49685 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49752 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980984 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19533 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19533 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (901011 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44870 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44870 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (477248 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49752 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49752 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (433298 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44815 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44815 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102531 / 100000 : ℝ) * (49752 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102521 / 100000 : ℝ) * (29479 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16238 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16774 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980984 / 1000000 : ℝ) * (16238 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190101 / 100000 : ℝ) * (16774 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190101 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29479 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29525 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102521 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102531 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102521 / 100000 : ℝ) * (290538 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102531 / 100000 : ℝ) * (290980 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19533 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19553 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29479 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29525 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102521 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102531 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19533 / 100000, 19553 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29479 / 100000, 29525 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102521 / 100000, 102531 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨194090 / 1000000, 194287 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980944 / 1000000, 980984 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨290538 / 1000000, 290980 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956729 / 1000000, 956864 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0052 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0052 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102531 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102521 / 100000 : ℝ) * (476658 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102531 / 100000 : ℝ) * (477248 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49685 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49752 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49685 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49752 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102521 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0052`.
...
/-- Sound projection of the B0052 checker instance into the generic
...
/-- Every projected type-(iv) height in B0052 has an equal-area regular
...
/-- Candidate-facing conclusion for B0052.  No stationarity hypothesis is
...
/-- Complete B0052 candidate-facing conclusion.  The checked stationary pair
