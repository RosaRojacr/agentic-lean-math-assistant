...
namespace MiddleFaceCell54

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0054`, spanning `[102541/100000, 102551/100000]`. -/
def brick : Brick where
  lamLo := 102541 / 100000
  lamHi := 102551 / 100000
  centers := ![391557279623791097 / 2000000000000000000,
    2958902327030483159 / 10000000000000000000,
    898921649913276591 / 2000000000000000000,
    4984606977816668251 / 10000000000000000000]
  slopes := ![1738681844418573637 / 1000000000000000000,
    4330108724608687087 / 1000000000000000000,
    5152362465141330777 / 1000000000000000000,
    3178933223259924623 / 500000000000000000]
  yXiSlope := 65056963 / 100000000
  vRhoSlope := 5539057 / 6250000
...
/-- Unconditional real-range conclusion for the B0054 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102541 / 100000 : ℝ) ≤ lam → lam ≤ 102551 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19568 / 100000 : ℝ) ≤ q ∧ q ≤ 19588 / 100000) :
    (194433 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (194630 / 1000000 : ℝ) := by
  have hmonoLo : sin (19568 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19588 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19568 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19588 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19568 / 100000 : ℝ) ≤ q ∧ q ≤ 19588 / 100000) :
    (980876 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980916 / 1000000 : ℝ) := by
  have hmonoLo : cos (19588 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19568 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19588 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19568 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29566 / 100000 : ℝ) ≤ q ∧ q ≤ 29612 / 100000) :
    (291371 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (291812 / 1000000 : ℝ) := by
  have hmonoLo : sin (29566 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29612 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29566 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29612 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29566 / 100000 : ℝ) ≤ q ∧ q ≤ 29612 / 100000) :
    (956475 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956611 / 1000000 : ℝ) := by
  have hmonoLo : cos (29612 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29566 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29612 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29566 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44919 / 100000 : ℝ) ≤ q ∧ q ≤ 44973 / 100000) :
    (434236 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (434723 / 1000000 : ℝ) := by
  have hmonoLo : sin (44919 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44973 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44919 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44973 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49813 / 100000 : ℝ) ≤ q ∧ q ≤ 49879 / 100000) :
    (477783 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (478364 / 1000000 : ℝ) := by
  have hmonoLo : sin (49813 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49879 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49813 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49879 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49813 / 100000 : ℝ) ≤ q ∧ q ≤ 49879 / 100000) :
    (878162 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (878478 / 1000000 : ℝ) := by
  have hmonoLo : cos (49879 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49813 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49879 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49813 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19568000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19588000 / 100000000) :
    (19443300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19463000 / 100000000 : ℝ) ∧
      (98087600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98091600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19568000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19588000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19588000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19568000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29566000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29612000 / 100000000) :
    (29137100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29181200 / 100000000 : ℝ) ∧
      (95647500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95661100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29566000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29612000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29612000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29566000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44919000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44973000 / 100000000) :
    (43423600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43472300 / 100000000 : ℝ) ∧
      (90056400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90080000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44919000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44973000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44973000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44919000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49813000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49879000 / 100000000) :
    (47778300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47836400 / 100000000 : ℝ) ∧
      (87816200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87847800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49813000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49879000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49879000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49813000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0054. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102541 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102551 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19568000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19588000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29566000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29612000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44919000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44973000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49813000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49879000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0054 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 499 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (499 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0054 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102541 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102551 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19568 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19588 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29566 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44919 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44973 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49813 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49879 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980916 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19568 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19568 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (900564 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44973 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44973 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (478364 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49879 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49879 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (434236 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44919 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44919 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102551 / 100000 : ℝ) * (49879 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102541 / 100000 : ℝ) * (29566 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16241 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16780 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980916 / 1000000 : ℝ) * (16241 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190056 / 100000 : ℝ) * (16780 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190056 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29566 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29612 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102541 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102551 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102541 / 100000 : ℝ) * (291371 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102551 / 100000 : ℝ) * (291812 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19568 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19588 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29566 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29612 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102541 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102551 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19568 / 100000, 19588 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29566 / 100000, 29612 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102541 / 100000, 102551 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨194433 / 1000000, 194630 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980876 / 1000000, 980916 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨291371 / 1000000, 291812 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956475 / 1000000, 956611 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0054 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0054 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102551 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102541 / 100000 : ℝ) * (477783 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102551 / 100000 : ℝ) * (478364 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49813 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49879 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49813 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49879 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102541 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0054`.
...
/-- Sound projection of the B0054 checker instance into the generic
...
/-- Every projected type-(iv) height in B0054 has an equal-area regular
...
/-- Candidate-facing conclusion for B0054.  No stationarity hypothesis is
...
/-- Complete B0054 candidate-facing conclusion.  The checked stationary pair
