...
namespace MiddleFaceCell71

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0071`, spanning `[102711/100000, 102721/100000]`. -/
def brick : Brick where
  lamLo := 102711 / 100000
  lamHi := 102721 / 100000
  centers := ![248299193786184417 / 1250000000000000000,
    1515527892661690479 / 5000000000000000000,
    4580045533766559273 / 10000000000000000000,
    1272563064221703379 / 2500000000000000000]
  slopes := ![1628956953897325127 / 1000000000000000000,
    4161436654179353 / 1000000000000000,
    4903621199600632391 / 1000000000000000000,
    759496513469397433 / 125000000000000000]
  yXiSlope := 8045517 / 12500000
  vRhoSlope := 44166271 / 50000000
...
/-- Unconditional real-range conclusion for the B0071 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102711 / 100000 : ℝ) ≤ lam → lam ≤ 102721 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19854 / 100000 : ℝ) ≤ q ∧ q ≤ 19874 / 100000) :
    (197238 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (197435 / 1000000 : ℝ) := by
  have hmonoLo : sin (19854 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19874 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19854 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19874 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19854 / 100000 : ℝ) ≤ q ∧ q ≤ 19874 / 100000) :
    (980316 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980356 / 1000000 : ℝ) := by
  have hmonoLo : cos (19874 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19854 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19874 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19854 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30289 / 100000 : ℝ) ≤ q ∧ q ≤ 30333 / 100000) :
    (298279 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (298700 / 1000000 : ℝ) := by
  have hmonoLo : sin (30289 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30333 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30289 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30333 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30289 / 100000 : ℝ) ≤ q ∧ q ≤ 30333 / 100000) :
    (954347 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954479 / 1000000 : ℝ) := by
  have hmonoLo : cos (30333 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30289 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30333 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30289 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45774 / 100000 : ℝ) ≤ q ∧ q ≤ 45826 / 100000) :
    (441921 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (442389 / 1000000 : ℝ) := by
  have hmonoLo : sin (45774 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45826 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45774 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45826 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50871 / 100000 : ℝ) ≤ q ∧ q ≤ 50934 / 100000) :
    (487051 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (487602 / 1000000 : ℝ) := by
  have hmonoLo : sin (50871 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50934 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50871 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50934 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50871 / 100000 : ℝ) ≤ q ∧ q ≤ 50934 / 100000) :
    (873066 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (873374 / 1000000 : ℝ) := by
  have hmonoLo : cos (50934 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50871 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50934 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50871 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19854000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19874000 / 100000000) :
    (19723800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19743500 / 100000000 : ℝ) ∧
      (98031600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98035600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19854000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19874000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19874000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19854000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30289000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30333000 / 100000000) :
    (29827900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29870000 / 100000000 : ℝ) ∧
      (95434700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95447900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30289000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30333000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30333000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30289000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45774000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45826000 / 100000000) :
    (44192100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44238900 / 100000000 : ℝ) ∧
      (89682300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89705400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45774000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45826000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45826000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45774000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50871000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50934000 / 100000000) :
    (48705100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48760200 / 100000000 : ℝ) ∧
      (87306600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87337400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50871000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50934000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50934000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50871000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0071. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102711 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102721 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19854000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19874000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30289000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30333000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45774000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45826000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50871000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50934000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0071 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 51 / 100, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (51 / 100)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0071 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102711 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102721 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19854 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19874 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30289 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45774 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45826 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50871 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50934 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980356 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19854 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19854 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (896823 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45826 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45826 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (487602 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50934 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50934 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (441921 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45774 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45774 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102721 / 100000 : ℝ) * (50934 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102711 / 100000 : ℝ) * (30289 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16264 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16831 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980356 / 1000000 : ℝ) * (16264 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189682 / 100000 : ℝ) * (16831 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189682 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30289 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30333 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102711 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102721 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102711 / 100000 : ℝ) * (298279 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102721 / 100000 : ℝ) * (298700 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19854 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19874 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30289 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30333 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102711 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102721 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19854 / 100000, 19874 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30289 / 100000, 30333 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102711 / 100000, 102721 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨197238 / 1000000, 197435 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980316 / 1000000, 980356 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨298279 / 1000000, 298700 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954347 / 1000000, 954479 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0071 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0071 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102721 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102711 / 100000 : ℝ) * (487051 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102721 / 100000 : ℝ) * (487602 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50871 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50934 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50871 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50934 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102711 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0071`.
...
/-- Sound projection of the B0071 checker instance into the generic
...
/-- Every projected type-(iv) height in B0071 has an equal-area regular
...
/-- Candidate-facing conclusion for B0071.  No stationarity hypothesis is
...
/-- Complete B0071 candidate-facing conclusion.  The checked stationary pair
