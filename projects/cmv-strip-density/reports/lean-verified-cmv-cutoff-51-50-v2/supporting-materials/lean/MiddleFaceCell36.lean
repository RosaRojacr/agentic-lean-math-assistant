...
namespace MiddleFaceCell36

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0036`, spanning `[102361/100000, 102371/100000]`. -/
def brick : Brick where
  lamLo := 102361 / 100000
  lamHi := 102371 / 100000
  centers := ![1925333975189129483 / 10000000000000000000,
    2879200090100679549 / 10000000000000000000,
    439925576404204793 / 1000000000000000000,
    950628193438149 / 1953125000000000]
  slopes := ![1869975247173771297 / 1000000000000000000,
    4529595931230461247 / 1000000000000000000,
    5448488386342243867 / 1000000000000000000,
    1673062151639897631 / 250000000000000000]
  yXiSlope := 13165551 / 20000000
  vRhoSlope := 88946233 / 100000000
...
/-- Unconditional real-range conclusion for the B0036 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102361 / 100000 : ℝ) ≤ lam → lam ≤ 102371 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19242 / 100000 : ℝ) ≤ q ∧ q ≤ 19264 / 100000) :
    (191234 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (191451 / 1000000 : ℝ) := by
  have hmonoLo : sin (19242 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19264 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19242 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19264 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19242 / 100000 : ℝ) ≤ q ∧ q ≤ 19264 / 100000) :
    (981502 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981545 / 1000000 : ℝ) := by
  have hmonoLo : cos (19264 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19242 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19264 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19242 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28768 / 100000 : ℝ) ≤ q ∧ q ≤ 28816 / 100000) :
    (283728 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (284189 / 1000000 : ℝ) := by
  have hmonoLo : sin (28768 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28816 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28768 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28816 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28768 / 100000 : ℝ) ≤ q ∧ q ≤ 28816 / 100000) :
    (958768 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958905 / 1000000 : ℝ) := by
  have hmonoLo : cos (28816 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28768 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28816 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28768 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43964 / 100000 : ℝ) ≤ q ∧ q ≤ 44021 / 100000) :
    (425613 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (426130 / 1000000 : ℝ) := by
  have hmonoLo : sin (43964 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44021 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43964 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44021 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48637 / 100000 : ℝ) ≤ q ∧ q ≤ 48707 / 100000) :
    (467419 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (468039 / 1000000 : ℝ) := by
  have hmonoLo : sin (48637 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48707 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48637 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48707 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48637 / 100000 : ℝ) ≤ q ∧ q ≤ 48707 / 100000) :
    (883708 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (884036 / 1000000 : ℝ) := by
  have hmonoLo : cos (48707 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48637 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48707 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48637 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19242000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19264000 / 100000000) :
    (19123400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19145100 / 100000000 : ℝ) ∧
      (98150200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98154500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19242000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19264000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19264000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19242000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28768000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28816000 / 100000000) :
    (28372800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28418900 / 100000000 : ℝ) ∧
      (95876800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95890500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28768000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28816000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28816000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28768000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43964000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44021000 / 100000000) :
    (42561300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42613000 / 100000000 : ℝ) ∧
      (90466200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90490500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43964000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44021000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44021000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43964000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48637000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48707000 / 100000000) :
    (46741900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46803900 / 100000000 : ℝ) ∧
      (88370800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88403600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48637000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48707000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48707000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48637000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0036. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102361 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102371 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19242000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19264000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28768000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28816000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43964000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44021000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48637000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48707000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0036 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 61 / 125, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (61 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0036 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102361 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102371 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19242 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19264 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28768 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43964 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44021 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48637 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48707 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981545 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19242 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19242 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (904662 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44021 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44021 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (468039 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48707 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48707 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (425613 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43964 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43964 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102371 / 100000 : ℝ) * (48707 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102361 / 100000 : ℝ) * (28768 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16215 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16726 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981545 / 1000000 : ℝ) * (16215 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190466 / 100000 : ℝ) * (16726 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190466 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28768 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28816 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102361 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102371 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102361 / 100000 : ℝ) * (283728 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102371 / 100000 : ℝ) * (284189 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19242 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19264 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28768 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28816 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102361 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102371 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19242 / 100000, 19264 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28768 / 100000, 28816 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102361 / 100000, 102371 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨191234 / 1000000, 191451 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981502 / 1000000, 981545 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨283728 / 1000000, 284189 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958768 / 1000000, 958905 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0036 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0036 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102371 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102361 / 100000 : ℝ) * (467419 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102371 / 100000 : ℝ) * (468039 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48637 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48707 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48637 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48707 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102361 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0036`.
...
/-- Sound projection of the B0036 checker instance into the generic
...
/-- Every projected type-(iv) height in B0036 has an equal-area regular
...
/-- Candidate-facing conclusion for B0036.  No stationarity hypothesis is
...
/-- Complete B0036 candidate-facing conclusion.  The checked stationary pair
