...
namespace MiddleFaceCell23

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0023`, spanning `[102231/100000, 102241/100000]`. -/
def brick : Brick where
  lamLo := 102231 / 100000
  lamHi := 102241 / 100000
  centers := ![1900344354145248241 / 10000000000000000000,
    2819291536535264877 / 10000000000000000000,
    4326897755476402437 / 10000000000000000000,
    4778496960056158271 / 10000000000000000000]
  slopes := ![988170629459726173 / 500000000000000000,
    293094383058841339 / 62500000000000000,
    2843656107112371319 / 500000000000000000,
    1392207666858110333 / 200000000000000000]
  yXiSlope := 33205493 / 50000000
  vRhoSlope := 44593329 / 50000000
...
/-- Unconditional real-range conclusion for the B0023 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102231 / 100000 : ℝ) ≤ lam → lam ≤ 102241 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18992 / 100000 : ℝ) ≤ q ∧ q ≤ 19015 / 100000) :
    (188780 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (189007 / 1000000 : ℝ) := by
  have hmonoLo : sin (18992 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19015 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18992 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19015 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18992 / 100000 : ℝ) ≤ q ∧ q ≤ 19015 / 100000) :
    (981975 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982020 / 1000000 : ℝ) := by
  have hmonoLo : cos (19015 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18992 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19015 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18992 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28168 / 100000 : ℝ) ≤ q ∧ q ≤ 28218 / 100000) :
    (277969 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (278451 / 1000000 : ℝ) := by
  have hmonoLo : sin (28168 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28218 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28168 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28218 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28168 / 100000 : ℝ) ≤ q ∧ q ≤ 28218 / 100000) :
    (960450 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960590 / 1000000 : ℝ) := by
  have hmonoLo : cos (28218 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28168 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28218 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28168 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43239 / 100000 : ℝ) ≤ q ∧ q ≤ 43299 / 100000) :
    (419042 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (419587 / 1000000 : ℝ) := by
  have hmonoLo : sin (43239 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43299 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43239 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43299 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47749 / 100000 : ℝ) ≤ q ∧ q ≤ 47821 / 100000) :
    (459551 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (460191 / 1000000 : ℝ) := by
  have hmonoLo : sin (47749 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47821 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47749 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47821 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47749 / 100000 : ℝ) ≤ q ∧ q ≤ 47821 / 100000) :
    (887820 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (888152 / 1000000 : ℝ) := by
  have hmonoLo : cos (47821 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47749 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47821 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47749 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18992000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19015000 / 100000000) :
    (18878000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18900700 / 100000000 : ℝ) ∧
      (98197500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98202000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18992000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19015000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19015000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18992000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28168000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28218000 / 100000000) :
    (27796900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27845100 / 100000000 : ℝ) ∧
      (96045000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96059000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28168000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28218000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28218000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28168000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43239000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43299000 / 100000000) :
    (41904200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41958700 / 100000000 : ℝ) ∧
      (90771500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90796700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43239000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43299000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43299000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43239000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47749000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47821000 / 100000000) :
    (45955100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46019100 / 100000000 : ℝ) ∧
      (88782000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88815200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47749000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47821000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47821000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47749000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0023. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102231 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102241 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18992000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19015000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28168000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28218000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43239000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43299000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47749000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47821000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0023 brick. -/
...
throughout the B0023 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102231 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102241 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18992 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19015 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28168 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43239 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43299 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47749 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47821 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982020 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18992 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18992 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (907715 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43299 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43299 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (460191 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47821 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47821 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (419042 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43239 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43239 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102241 / 100000 : ℝ) * (47821 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102231 / 100000 : ℝ) * (28168 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16197 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16686 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982020 / 1000000 : ℝ) * (16197 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190771 / 100000 : ℝ) * (16686 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190771 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28168 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28218 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102231 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102241 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102231 / 100000 : ℝ) * (277969 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102241 / 100000 : ℝ) * (278451 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18992 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19015 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28168 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28218 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102231 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102241 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18992 / 100000, 19015 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28168 / 100000, 28218 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102231 / 100000, 102241 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨188780 / 1000000, 189007 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981975 / 1000000, 982020 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨277969 / 1000000, 278451 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960450 / 1000000, 960590 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0023 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0023 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102241 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102231 / 100000 : ℝ) * (459551 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102241 / 100000 : ℝ) * (460191 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47749 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47821 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47749 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47821 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102231 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0023`.
...
/-- Sound projection of the B0023 checker instance into the generic
...
/-- Every projected type-(iv) height in B0023 has an equal-area regular
...
/-- Candidate-facing conclusion for B0023.  No stationarity hypothesis is
...
/-- Complete B0023 candidate-facing conclusion.  The checked stationary pair
