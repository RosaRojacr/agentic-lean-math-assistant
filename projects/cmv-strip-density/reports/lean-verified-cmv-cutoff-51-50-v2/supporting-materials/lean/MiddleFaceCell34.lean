...
namespace MiddleFaceCell34

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0034`, spanning `[102341/100000, 102351/100000]`. -/
def brick : Brick where
  lamLo := 102341 / 100000
  lamHi := 102351 / 100000
  centers := ![192157836914824053 / 1000000000000000000,
    2870117265440496139 / 10000000000000000000,
    438832357536139637 / 1000000000000000000,
    4853792172823507521 / 10000000000000000000]
  slopes := ![942830112611733803 / 500000000000000000,
    4553269075661193253 / 1000000000000000000,
    5483763902175376171 / 1000000000000000000,
    1346399702589422837 / 200000000000000000]
  yXiSlope := 16478991 / 25000000
  vRhoSlope := 11122843 / 12500000
...
/-- Unconditional real-range conclusion for the B0034 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102341 / 100000 : ℝ) ≤ lam → lam ≤ 102351 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19205 / 100000 : ℝ) ≤ q ∧ q ≤ 19227 / 100000) :
    (190871 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (191088 / 1000000 : ℝ) := by
  have hmonoLo : sin (19205 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19227 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19205 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19227 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19205 / 100000 : ℝ) ≤ q ∧ q ≤ 19227 / 100000) :
    (981572 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981616 / 1000000 : ℝ) := by
  have hmonoLo : cos (19227 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19205 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19227 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19205 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28677 / 100000 : ℝ) ≤ q ∧ q ≤ 28725 / 100000) :
    (282855 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (283316 / 1000000 : ℝ) := by
  have hmonoLo : sin (28677 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28725 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28677 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28725 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28677 / 100000 : ℝ) ≤ q ∧ q ≤ 28725 / 100000) :
    (959026 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (959163 / 1000000 : ℝ) := by
  have hmonoLo : cos (28725 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28677 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28725 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28677 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43854 / 100000 : ℝ) ≤ q ∧ q ≤ 43912 / 100000) :
    (424618 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (425144 / 1000000 : ℝ) := by
  have hmonoLo : sin (43854 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43912 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43854 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43912 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48503 / 100000 : ℝ) ≤ q ∧ q ≤ 48573 / 100000) :
    (466234 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (466855 / 1000000 : ℝ) := by
  have hmonoLo : sin (48503 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48573 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48503 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48573 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48503 / 100000 : ℝ) ≤ q ∧ q ≤ 48573 / 100000) :
    (884334 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (884661 / 1000000 : ℝ) := by
  have hmonoLo : cos (48573 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48503 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48573 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48503 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19205000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19227000 / 100000000) :
    (19087100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19108800 / 100000000 : ℝ) ∧
      (98157200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98161600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19205000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19227000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19227000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19205000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28677000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28725000 / 100000000) :
    (28285500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28331600 / 100000000 : ℝ) ∧
      (95902600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95916300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28677000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28725000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28725000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28677000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43854000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43912000 / 100000000) :
    (42461800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42514400 / 100000000 : ℝ) ∧
      (90512600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90537300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43854000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43912000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43912000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43854000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48503000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48573000 / 100000000) :
    (46623400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46685500 / 100000000 : ℝ) ∧
      (88433400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88466100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48503000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48573000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48573000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48503000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0034. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102341 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102351 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19205000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19227000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28677000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28725000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43854000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43912000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48503000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48573000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0034 brick. -/
...
throughout the B0034 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102341 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102351 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19205 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19227 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28677 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43854 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43912 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48503 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48573 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981616 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19205 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19205 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (905126 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43912 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43912 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (466855 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48573 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48573 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (424618 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43854 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43854 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102351 / 100000 : ℝ) * (48573 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102341 / 100000 : ℝ) * (28677 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16213 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16720 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981616 / 1000000 : ℝ) * (16213 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190512 / 100000 : ℝ) * (16720 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190512 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28677 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28725 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102341 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102351 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102341 / 100000 : ℝ) * (282855 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102351 / 100000 : ℝ) * (283316 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19205 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19227 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28677 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28725 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102341 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102351 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19205 / 100000, 19227 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28677 / 100000, 28725 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102341 / 100000, 102351 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨190871 / 1000000, 191088 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981572 / 1000000, 981616 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨282855 / 1000000, 283316 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨959026 / 1000000, 959163 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0034 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0034 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102351 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102341 / 100000 : ℝ) * (466234 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102351 / 100000 : ℝ) * (466855 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48503 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48573 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48503 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48573 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102341 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0034`.
...
/-- Sound projection of the B0034 checker instance into the generic
...
/-- Every projected type-(iv) height in B0034 has an equal-area regular
...
/-- Candidate-facing conclusion for B0034.  No stationarity hypothesis is
...
/-- Complete B0034 candidate-facing conclusion.  The checked stationary pair
