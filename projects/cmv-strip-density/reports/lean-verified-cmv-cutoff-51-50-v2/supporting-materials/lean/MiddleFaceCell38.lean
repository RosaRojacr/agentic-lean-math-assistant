...
namespace MiddleFaceCell38

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0038`, spanning `[102381/100000, 102391/100000]`. -/
def brick : Brick where
  lamLo := 102381 / 100000
  lamHi := 102391 / 100000
  centers := ![385811688939884659 / 2000000000000000000,
    722058972144993253 / 2500000000000000000,
    882023581246106851 / 2000000000000000000,
    4880561579824838421 / 10000000000000000000]
  slopes := ![927261511315189247 / 500000000000000000,
    225312100536170701 / 50000000000000000,
    5413715976330065767 / 1000000000000000000,
    6653048808279960043 / 1000000000000000000]
  yXiSlope := 65740077 / 100000000
  vRhoSlope := 88909889 / 100000000
...
/-- Unconditional real-range conclusion for the B0038 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102381 / 100000 : ℝ) ≤ lam → lam ≤ 102391 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19280 / 100000 : ℝ) ≤ q ∧ q ≤ 19301 / 100000) :
    (191607 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (191814 / 1000000 : ℝ) := by
  have hmonoLo : sin (19280 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19301 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19280 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19301 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19280 / 100000 : ℝ) ≤ q ∧ q ≤ 19301 / 100000) :
    (981431 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981472 / 1000000 : ℝ) := by
  have hmonoLo : cos (19301 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19280 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19301 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19280 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28859 / 100000 : ℝ) ≤ q ∧ q ≤ 28906 / 100000) :
    (284600 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (285052 / 1000000 : ℝ) := by
  have hmonoLo : sin (28859 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28906 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28859 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28906 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28859 / 100000 : ℝ) ≤ q ∧ q ≤ 28906 / 100000) :
    (958512 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958647 / 1000000 : ℝ) := by
  have hmonoLo : cos (28906 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28859 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28906 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28859 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44073 / 100000 : ℝ) ≤ q ∧ q ≤ 44130 / 100000) :
    (426599 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (427116 / 1000000 : ℝ) := by
  have hmonoLo : sin (44073 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44130 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44073 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44130 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48771 / 100000 : ℝ) ≤ q ∧ q ≤ 48840 / 100000) :
    (468604 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (469214 / 1000000 : ℝ) := by
  have hmonoLo : sin (48771 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48840 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48771 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48840 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48771 / 100000 : ℝ) ≤ q ∧ q ≤ 48840 / 100000) :
    (883084 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (883409 / 1000000 : ℝ) := by
  have hmonoLo : cos (48840 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48771 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48840 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48771 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19280000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19301000 / 100000000) :
    (19160700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19181400 / 100000000 : ℝ) ∧
      (98143100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98147200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19280000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19301000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19301000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19280000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28859000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28906000 / 100000000) :
    (28460000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28505200 / 100000000 : ℝ) ∧
      (95851200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95864700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28859000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28906000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28906000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28859000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44073000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44130000 / 100000000) :
    (42659900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42711600 / 100000000 : ℝ) ∧
      (90419700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90444100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44073000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44130000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44130000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44073000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48771000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48840000 / 100000000) :
    (46860400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46921400 / 100000000 : ℝ) ∧
      (88308400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88340900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48771000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48840000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48840000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48771000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0038. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102381 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102391 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19280000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19301000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28859000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28906000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44073000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44130000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48771000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48840000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0038 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (489 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 221 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 489 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (221 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (489 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (221 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0038 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102381 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102391 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19280 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19301 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28859 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44073 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44130 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48771 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48840 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981472 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19280 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19280 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (904197 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44130 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44130 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (469214 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48840 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48840 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (426599 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44073 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44073 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102391 / 100000 : ℝ) * (48840 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102381 / 100000 : ℝ) * (28859 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16218 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16732 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981472 / 1000000 : ℝ) * (16218 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190419 / 100000 : ℝ) * (16732 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190419 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28859 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28906 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102381 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102391 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102381 / 100000 : ℝ) * (284600 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102391 / 100000 : ℝ) * (285052 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19280 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19301 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28859 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28906 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102381 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102391 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19280 / 100000, 19301 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28859 / 100000, 28906 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102381 / 100000, 102391 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨191607 / 1000000, 191814 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981431 / 1000000, 981472 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨284600 / 1000000, 285052 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958512 / 1000000, 958647 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0038 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0038 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102391 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102381 / 100000 : ℝ) * (468604 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102391 / 100000 : ℝ) * (469214 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48771 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48840 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48771 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48840 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102381 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0038`.
...
/-- Sound projection of the B0038 checker instance into the generic
...
/-- Every projected type-(iv) height in B0038 has an equal-area regular
...
/-- Candidate-facing conclusion for B0038.  No stationarity hypothesis is
...
/-- Complete B0038 candidate-facing conclusion.  The checked stationary pair
