...
namespace MiddleFaceCell41

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0041`, spanning `[102411/100000, 102421/100000]`. -/
def brick : Brick where
  lamLo := 102411 / 100000
  lamHi := 102421 / 100000
  centers := ![1934587771784945889 / 10000000000000000000,
    2901702789755875677 / 10000000000000000000,
    2213140976264584879 / 5000000000000000000,
    4900433769551389611 / 10000000000000000000]
  slopes := ![457942391379872477 / 250000000000000000,
    4471794494949144479 / 1000000000000000000,
    2681238037952355261 / 500000000000000000,
    164881350409765411 / 25000000000000000]
  yXiSlope := 8201193 / 12500000
  vRhoSlope := 88855683 / 100000000
...
/-- Unconditional real-range conclusion for the B0041 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102411 / 100000 : ℝ) ≤ lam → lam ≤ 102421 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19335 / 100000 : ℝ) ≤ q ∧ q ≤ 19357 / 100000) :
    (192147 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (192364 / 1000000 : ℝ) := by
  have hmonoLo : sin (19335 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19357 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19335 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19357 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19335 / 100000 : ℝ) ≤ q ∧ q ≤ 19357 / 100000) :
    (981323 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981367 / 1000000 : ℝ) := by
  have hmonoLo : cos (19357 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19335 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19357 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19335 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28993 / 100000 : ℝ) ≤ q ∧ q ≤ 29041 / 100000) :
    (285885 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (286346 / 1000000 : ℝ) := by
  have hmonoLo : sin (28993 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29041 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28993 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29041 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28993 / 100000 : ℝ) ≤ q ∧ q ≤ 29041 / 100000) :
    (958126 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958264 / 1000000 : ℝ) := by
  have hmonoLo : cos (29041 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28993 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29041 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28993 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44235 / 100000 : ℝ) ≤ q ∧ q ≤ 44291 / 100000) :
    (428064 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (428571 / 1000000 : ℝ) := by
  have hmonoLo : sin (44235 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44291 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44235 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44291 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48970 / 100000 : ℝ) ≤ q ∧ q ≤ 49039 / 100000) :
    (470361 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (470970 / 1000000 : ℝ) := by
  have hmonoLo : sin (48970 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49039 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48970 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49039 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48970 / 100000 : ℝ) ≤ q ∧ q ≤ 49039 / 100000) :
    (882149 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (882475 / 1000000 : ℝ) := by
  have hmonoLo : cos (49039 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48970 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49039 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48970 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19335000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19357000 / 100000000) :
    (19214700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19236400 / 100000000 : ℝ) ∧
      (98132300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98136700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19335000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19357000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19357000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19335000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28993000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29041000 / 100000000) :
    (28588500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28634600 / 100000000 : ℝ) ∧
      (95812600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95826400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28993000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29041000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29041000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28993000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44235000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44291000 / 100000000) :
    (42806400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42857100 / 100000000 : ℝ) ∧
      (90350800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90374900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44235000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44291000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44291000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44235000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48970000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49039000 / 100000000) :
    (47036100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47097000 / 100000000 : ℝ) ∧
      (88214900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88247500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48970000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49039000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49039000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48970000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0041. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102411 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102421 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19335000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19357000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28993000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29041000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44235000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44291000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48970000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49039000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0041 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (491 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 111 / 250, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 491 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (111 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (491 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (111 / 250)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0041 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102411 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102421 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19335 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19357 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28993 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44235 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44291 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48970 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49039 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981367 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19335 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19335 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (903508 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44291 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44291 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (470970 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49039 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49039 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (428064 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44235 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44235 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102421 / 100000 : ℝ) * (49039 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102411 / 100000 : ℝ) * (28993 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16223 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16741 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981367 / 1000000 : ℝ) * (16223 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190350 / 100000 : ℝ) * (16741 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190350 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28993 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29041 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102411 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102421 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102411 / 100000 : ℝ) * (285885 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102421 / 100000 : ℝ) * (286346 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19335 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19357 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28993 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29041 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102411 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102421 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19335 / 100000, 19357 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28993 / 100000, 29041 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102411 / 100000, 102421 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨192147 / 1000000, 192364 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981323 / 1000000, 981367 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨285885 / 1000000, 286346 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958126 / 1000000, 958264 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0041 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0041 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102421 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102411 / 100000 : ℝ) * (470361 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102421 / 100000 : ℝ) * (470970 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48970 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49039 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48970 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49039 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102411 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0041`.
...
/-- Sound projection of the B0041 checker instance into the generic
...
/-- Every projected type-(iv) height in B0041 has an equal-area regular
...
/-- Candidate-facing conclusion for B0041.  No stationarity hypothesis is
...
/-- Complete B0041 candidate-facing conclusion.  The checked stationary pair
