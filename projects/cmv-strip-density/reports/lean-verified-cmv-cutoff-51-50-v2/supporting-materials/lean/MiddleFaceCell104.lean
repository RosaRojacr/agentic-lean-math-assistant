...
namespace MiddleFaceCell104

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0104`, spanning `[103041/100000, 103051/100000]`. -/
def brick : Brick where
  lamLo := 103041 / 100000
  lamHi := 103051 / 100000
  centers := ![2037051413750799409 / 10000000000000000000,
    3163561717099530563 / 10000000000000000000,
    4734803560920154039 / 10000000000000000000,
    660340747608747167 / 1250000000000000000]
  slopes := ![723696739329425701 / 500000000000000000,
    775578353761368731 / 200000000000000000,
    1122276121677162441 / 250000000000000000,
    2801960410377656129 / 500000000000000000]
  yXiSlope := 31551881 / 50000000
  vRhoSlope := 43895903 / 50000000
...
/-- Unconditional real-range conclusion for the B0104 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103041 / 100000 : ℝ) ≤ lam → lam ≤ 103051 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20362 / 100000 : ℝ) ≤ q ∧ q ≤ 20379 / 100000) :
    (202215 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202383 / 1000000 : ℝ) := by
  have hmonoLo : sin (20362 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20379 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20362 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20379 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20362 / 100000 : ℝ) ≤ q ∧ q ≤ 20379 / 100000) :
    (979306 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979341 / 1000000 : ℝ) := by
  have hmonoLo : cos (20379 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20362 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20379 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20362 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31615 / 100000 : ℝ) ≤ q ∧ q ≤ 31656 / 100000) :
    (310909 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (311300 / 1000000 : ℝ) := by
  have hmonoLo : sin (31615 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31656 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31615 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31656 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31615 / 100000 : ℝ) ≤ q ∧ q ≤ 31656 / 100000) :
    (950311 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950440 / 1000000 : ℝ) := by
  have hmonoLo : cos (31656 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31615 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31656 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31615 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47324 / 100000 : ℝ) ≤ q ∧ q ≤ 47372 / 100000) :
    (455772 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (456200 / 1000000 : ℝ) := by
  have hmonoLo : sin (47324 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47372 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47324 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47372 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52798 / 100000 : ℝ) ≤ q ∧ q ≤ 52857 / 100000) :
    (503789 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (504300 / 1000000 : ℝ) := by
  have hmonoLo : sin (52798 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52857 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52798 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52857 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52798 / 100000 : ℝ) ≤ q ∧ q ≤ 52857 / 100000) :
    (863529 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (863827 / 1000000 : ℝ) := by
  have hmonoLo : cos (52857 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52798 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52857 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52798 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20362000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20379000 / 100000000) :
    (20221500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20238300 / 100000000 : ℝ) ∧
      (97930600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97934100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20362000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20379000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20379000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20362000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31615000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31656000 / 100000000) :
    (31090900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31130000 / 100000000 : ℝ) ∧
      (95031100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95044000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31615000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31656000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31656000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31615000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47324000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47372000 / 100000000) :
    (45577200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45620000 / 100000000 : ℝ) ∧
      (88987700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89009700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47324000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47372000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47372000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47324000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52798000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52857000 / 100000000) :
    (50378900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50430000 / 100000000 : ℝ) ∧
      (86352900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86382700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52798000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52857000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52857000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52798000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0104. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103041 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103051 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20362000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20379000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31615000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31656000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47324000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47372000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52798000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52857000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0104 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 529 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (529 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0104 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103041 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103051 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20362 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20379 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31615 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47324 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47372 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52798 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52857 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979341 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20362 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20362 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (889877 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47372 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47372 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (504300 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52857 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52857 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (455772 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47324 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47324 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103051 / 100000 : ℝ) * (52857 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103041 / 100000 : ℝ) * (31615 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16308 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16927 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979341 / 1000000 : ℝ) * (16308 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188987 / 100000 : ℝ) * (16927 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188987 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31615 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31656 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103041 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103051 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103041 / 100000 : ℝ) * (310909 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103051 / 100000 : ℝ) * (311300 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20362 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20379 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31615 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31656 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103041 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103051 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20362 / 100000, 20379 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31615 / 100000, 31656 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103041 / 100000, 103051 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202215 / 1000000, 202383 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979306 / 1000000, 979341 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨310909 / 1000000, 311300 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950311 / 1000000, 950440 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0104 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0104 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103051 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103041 / 100000 : ℝ) * (503789 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103051 / 100000 : ℝ) * (504300 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52798 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52857 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52798 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52857 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103041 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0104`.
...
/-- Sound projection of the B0104 checker instance into the generic
...
/-- Every projected type-(iv) height in B0104 has an equal-area regular
...
/-- Candidate-facing conclusion for B0104.  No stationarity hypothesis is
...
/-- Complete B0104 candidate-facing conclusion.  The checked stationary pair
