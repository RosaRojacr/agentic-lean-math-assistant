...
namespace MiddleFaceCell79

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0079`, spanning `[102791/100000, 102801/100000]`. -/
def brick : Brick where
  lamLo := 102791 / 100000
  lamHi := 102801 / 100000
  centers := ![999616769423140871 / 5000000000000000000,
    3064050466643036503 / 10000000000000000000,
    4618838581972651569 / 10000000000000000000,
    2569182444027707163 / 5000000000000000000]
  slopes := ![316288556012421353 / 200000000000000000,
    2043897810181161867 / 500000000000000000,
    4795516070560971981 / 1000000000000000000,
    148828705903439821 / 25000000000000000]
  yXiSlope := 3202443 / 5000000
  vRhoSlope := 22049591 / 25000000
...
/-- Unconditional real-range conclusion for the B0079 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102791 / 100000 : ℝ) ≤ lam → lam ≤ 102801 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19983 / 100000 : ℝ) ≤ q ∧ q ≤ 20002 / 100000) :
    (198502 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198689 / 1000000 : ℝ) := by
  have hmonoLo : sin (19983 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20002 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19983 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20002 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19983 / 100000 : ℝ) ≤ q ∧ q ≤ 20002 / 100000) :
    (980062 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980101 / 1000000 : ℝ) := by
  have hmonoLo : cos (20002 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19983 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20002 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19983 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30619 / 100000 : ℝ) ≤ q ∧ q ≤ 30662 / 100000) :
    (301428 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (301839 / 1000000 : ℝ) := by
  have hmonoLo : sin (30619 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30662 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30619 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30662 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30619 / 100000 : ℝ) ≤ q ∧ q ≤ 30662 / 100000) :
    (953359 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953489 / 1000000 : ℝ) := by
  have hmonoLo : cos (30662 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30619 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30662 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30619 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46163 / 100000 : ℝ) ≤ q ∧ q ≤ 46214 / 100000) :
    (445408 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (445865 / 1000000 : ℝ) := by
  have hmonoLo : sin (46163 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46214 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46163 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46214 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51352 / 100000 : ℝ) ≤ q ∧ q ≤ 51415 / 100000) :
    (491246 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (491795 / 1000000 : ℝ) := by
  have hmonoLo : sin (51352 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51415 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51352 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51415 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51352 / 100000 : ℝ) ≤ q ∧ q ≤ 51415 / 100000) :
    (870711 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (871021 / 1000000 : ℝ) := by
  have hmonoLo : cos (51415 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51352 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51415 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51352 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19983000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20002000 / 100000000) :
    (19850200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19868900 / 100000000 : ℝ) ∧
      (98006200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98010100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19983000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20002000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20002000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19983000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30619000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30662000 / 100000000) :
    (30142800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30183900 / 100000000 : ℝ) ∧
      (95335900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95348900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30619000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30662000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30662000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30619000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46163000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46214000 / 100000000) :
    (44540800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44586500 / 100000000 : ℝ) ∧
      (89510000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89532800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46163000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46214000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46214000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46163000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51352000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51415000 / 100000000) :
    (49124600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49179500 / 100000000 : ℝ) ∧
      (87071100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87102100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51352000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51415000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51415000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51352000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0079. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102791 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102801 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19983000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20002000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30619000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30662000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46163000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46214000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51352000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51415000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0079 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 103 / 200, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (103 / 200)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0079 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102791 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102801 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19983 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20002 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30619 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46163 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46214 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51352 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51415 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980101 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19983 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19983 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (895100 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46214 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46214 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (491795 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51415 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51415 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (445408 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46163 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46163 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102801 / 100000 : ℝ) * (51415 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102791 / 100000 : ℝ) * (30619 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16275 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16855 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980101 / 1000000 : ℝ) * (16275 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189509 / 100000 : ℝ) * (16855 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189509 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30619 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30662 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102791 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102801 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102791 / 100000 : ℝ) * (301428 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102801 / 100000 : ℝ) * (301839 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19983 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20002 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30619 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30662 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102791 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102801 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19983 / 100000, 20002 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30619 / 100000, 30662 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102791 / 100000, 102801 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198502 / 1000000, 198689 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980062 / 1000000, 980101 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨301428 / 1000000, 301839 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953359 / 1000000, 953489 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0079 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0079 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102801 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102791 / 100000 : ℝ) * (491246 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102801 / 100000 : ℝ) * (491795 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51352 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51415 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51352 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51415 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102791 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0079`.
...
/-- Sound projection of the B0079 checker instance into the generic
...
/-- Every projected type-(iv) height in B0079 has an equal-area regular
...
/-- Candidate-facing conclusion for B0079.  No stationarity hypothesis is
...
/-- Complete B0079 candidate-facing conclusion.  The checked stationary pair
