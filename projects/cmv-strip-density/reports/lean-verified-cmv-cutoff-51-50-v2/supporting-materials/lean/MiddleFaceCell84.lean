...
namespace MiddleFaceCell84

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0084`, spanning `[102841/100000, 102851/100000]`. -/
def brick : Brick where
  lamLo := 102841 / 100000
  lamHi := 102851 / 100000
  centers := ![40141383546083077 / 200000000000000000,
    3084378105061469101 / 10000000000000000000,
    92853060893553461 / 200000000000000000,
    103358901884560451 / 200000000000000000]
  slopes := ![310591294120452747 / 200000000000000000,
    2021730560326051219 / 500000000000000000,
    18478836189065653 / 3906250000000000,
    1175855768843843313 / 200000000000000000]
  yXiSlope := 638551 / 1000000
  vRhoSlope := 44057773 / 50000000
...
/-- Unconditional real-range conclusion for the B0084 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102841 / 100000 : ℝ) ≤ lam → lam ≤ 102851 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20061 / 100000 : ℝ) ≤ q ∧ q ≤ 20080 / 100000) :
    (199267 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (199454 / 1000000 : ℝ) := by
  have hmonoLo : sin (20061 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20080 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20061 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20080 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20061 / 100000 : ℝ) ≤ q ∧ q ≤ 20080 / 100000) :
    (979907 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979946 / 1000000 : ℝ) := by
  have hmonoLo : cos (20080 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20061 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20080 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20061 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30822 / 100000 : ℝ) ≤ q ∧ q ≤ 30865 / 100000) :
    (303363 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (303773 / 1000000 : ℝ) := by
  have hmonoLo : sin (30822 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30865 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30822 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30865 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30822 / 100000 : ℝ) ≤ q ∧ q ≤ 30865 / 100000) :
    (952744 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952876 / 1000000 : ℝ) := by
  have hmonoLo : cos (30865 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30822 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30865 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30822 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46401 / 100000 : ℝ) ≤ q ∧ q ≤ 46452 / 100000) :
    (447537 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (447994 / 1000000 : ℝ) := by
  have hmonoLo : sin (46401 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46452 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46401 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46452 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51649 / 100000 : ℝ) ≤ q ∧ q ≤ 51710 / 100000) :
    (493831 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (494362 / 1000000 : ℝ) := by
  have hmonoLo : sin (51649 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51710 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51649 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51710 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51649 / 100000 : ℝ) ≤ q ∧ q ≤ 51710 / 100000) :
    (869256 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (869558 / 1000000 : ℝ) := by
  have hmonoLo : cos (51710 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51649 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51710 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51649 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20061000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20080000 / 100000000) :
    (19926700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19945400 / 100000000 : ℝ) ∧
      (97990700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97994600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20061000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20080000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20080000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20061000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30822000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30865000 / 100000000) :
    (30336300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30377300 / 100000000 : ℝ) ∧
      (95274400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95287600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30822000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30865000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30865000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30822000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46401000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46452000 / 100000000) :
    (44753700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44799400 / 100000000 : ℝ) ∧
      (89403600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89426600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46401000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46452000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46452000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46401000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51649000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51710000 / 100000000) :
    (49383100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49436200 / 100000000 : ℝ) ∧
      (86925600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86955800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51649000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51710000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51710000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51649000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0084. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102841 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102851 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20061000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20080000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30822000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30865000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46401000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46452000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51649000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51710000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0084 brick. -/
...
throughout the B0084 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102841 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102851 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20061 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20080 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30822 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46401 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46452 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51649 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51710 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979946 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20061 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20061 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (894036 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46452 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46452 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (494362 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51710 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51710 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (447537 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46401 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46401 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102851 / 100000 : ℝ) * (51710 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102841 / 100000 : ℝ) * (30822 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16282 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16869 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979946 / 1000000 : ℝ) * (16282 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189403 / 100000 : ℝ) * (16869 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189403 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30822 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30865 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102841 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102851 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102841 / 100000 : ℝ) * (303363 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102851 / 100000 : ℝ) * (303773 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20061 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20080 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30822 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30865 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102841 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102851 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20061 / 100000, 20080 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30822 / 100000, 30865 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102841 / 100000, 102851 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨199267 / 1000000, 199454 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979907 / 1000000, 979946 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨303363 / 1000000, 303773 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952744 / 1000000, 952876 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0084 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0084 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102851 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102841 / 100000 : ℝ) * (493831 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102851 / 100000 : ℝ) * (494362 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51649 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51710 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51649 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51710 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102841 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0084`.
...
/-- Sound projection of the B0084 checker instance into the generic
...
/-- Every projected type-(iv) height in B0084 has an equal-area regular
...
/-- Candidate-facing conclusion for B0084.  No stationarity hypothesis is
...
/-- Complete B0084 candidate-facing conclusion.  The checked stationary pair
