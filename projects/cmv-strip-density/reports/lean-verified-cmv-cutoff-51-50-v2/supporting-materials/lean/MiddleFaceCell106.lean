...
namespace MiddleFaceCell106

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0106`, spanning `[103061/100000, 103071/100000]`. -/
def brick : Brick where
  lamLo := 103061 / 100000
  lamHi := 103071 / 100000
  centers := ![407987261612186111 / 2000000000000000000,
    1585650939461117201 / 5000000000000000000,
    2371879534772439411 / 5000000000000000000,
    661738485453514707 / 1250000000000000000]
  slopes := ![359378818444771713 / 250000000000000000,
    1931145233967637091 / 500000000000000000,
    1116608917299212777 / 250000000000000000,
    69725209512127741 / 12500000000000000]
  yXiSlope := 6303061 / 10000000
  vRhoSlope := 43880031 / 50000000
...
/-- Unconditional real-range conclusion for the B0106 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103061 / 100000 : ℝ) ≤ lam → lam ≤ 103071 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20391 / 100000 : ℝ) ≤ q ∧ q ≤ 20408 / 100000) :
    (202499 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (202667 / 1000000 : ℝ) := by
  have hmonoLo : sin (20391 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20408 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20391 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20408 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20391 / 100000 : ℝ) ≤ q ∧ q ≤ 20408 / 100000) :
    (979247 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979283 / 1000000 : ℝ) := by
  have hmonoLo : cos (20408 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20391 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20408 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20391 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31692 / 100000 : ℝ) ≤ q ∧ q ≤ 31734 / 100000) :
    (311641 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (312041 / 1000000 : ℝ) := by
  have hmonoLo : sin (31692 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31734 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31692 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31734 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31692 / 100000 : ℝ) ≤ q ∧ q ≤ 31734 / 100000) :
    (950068 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (950200 / 1000000 : ℝ) := by
  have hmonoLo : cos (31734 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31692 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31734 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31692 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47414 / 100000 : ℝ) ≤ q ∧ q ≤ 47461 / 100000) :
    (456573 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (456992 / 1000000 : ℝ) := by
  have hmonoLo : sin (47414 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47461 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47414 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47461 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52910 / 100000 : ℝ) ≤ q ∧ q ≤ 52968 / 100000) :
    (504756 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (505258 / 1000000 : ℝ) := by
  have hmonoLo : sin (52910 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52968 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52910 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52968 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52910 / 100000 : ℝ) ≤ q ∧ q ≤ 52968 / 100000) :
    (862968 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (863262 / 1000000 : ℝ) := by
  have hmonoLo : cos (52968 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52910 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52968 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52910 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20391000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20408000 / 100000000) :
    (20249900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20266700 / 100000000 : ℝ) ∧
      (97924700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97928300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20391000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20408000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20408000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20391000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31692000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31734000 / 100000000) :
    (31164100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31204100 / 100000000 : ℝ) ∧
      (95006800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95020000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31692000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31734000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31734000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31692000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47414000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47461000 / 100000000) :
    (45657300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45699200 / 100000000 : ℝ) ∧
      (88947100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88968600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47414000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47461000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47461000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47414000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52910000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52968000 / 100000000) :
    (50475600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50525800 / 100000000 : ℝ) ∧
      (86296800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86326200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52910000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52968000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52968000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52910000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0106. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103061 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103071 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20391000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20408000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31692000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31734000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47414000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47461000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52910000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52968000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0106 brick. -/
...
throughout the B0106 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103061 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103071 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20391 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20408 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31692 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47414 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47461 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52910 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52968 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979283 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20391 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20391 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (889471 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47461 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47461 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (505258 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52968 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52968 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (456573 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47414 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47414 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103071 / 100000 : ℝ) * (52968 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103061 / 100000 : ℝ) * (31692 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16311 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16933 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979283 / 1000000 : ℝ) * (16311 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188947 / 100000 : ℝ) * (16933 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188947 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31692 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31734 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103061 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103071 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103061 / 100000 : ℝ) * (311641 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103071 / 100000 : ℝ) * (312041 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20391 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20408 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31692 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31734 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103061 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103071 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20391 / 100000, 20408 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31692 / 100000, 31734 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103061 / 100000, 103071 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨202499 / 1000000, 202667 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979247 / 1000000, 979283 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨311641 / 1000000, 312041 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨950068 / 1000000, 950200 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0106 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0106 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103071 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103061 / 100000 : ℝ) * (504756 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103071 / 100000 : ℝ) * (505258 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52910 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52968 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52910 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52968 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103061 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0106`.
...
/-- Sound projection of the B0106 checker instance into the generic
...
/-- Every projected type-(iv) height in B0106 has an equal-area regular
...
/-- Candidate-facing conclusion for B0106.  No stationarity hypothesis is
...
/-- Complete B0106 candidate-facing conclusion.  The checked stationary pair
