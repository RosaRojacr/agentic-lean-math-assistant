...
namespace MiddleFaceCell35

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0035`, spanning `[102351/100000, 102361/100000]`. -/
def brick : Brick where
  lamLo := 102351 / 100000
  lamHi := 102361 / 100000
  centers := ![1923460093413197431 / 10000000000000000000,
    2874664596056695527 / 10000000000000000000,
    4393798488580680433 / 10000000000000000000,
    4860514199090012081 / 10000000000000000000]
  slopes := ![375557660938066827 / 200000000000000000,
    4541392156737582527 / 1000000000000000000,
    2733031268196374863 / 500000000000000000,
    3356027010031003263 / 500000000000000000]
  yXiSlope := 4116987 / 6250000
  vRhoSlope := 88964467 / 100000000
...
/-- Unconditional real-range conclusion for the B0035 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102351 / 100000 : ℝ) ≤ lam → lam ≤ 102361 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19224 / 100000 : ℝ) ≤ q ∧ q ≤ 19245 / 100000) :
    (191058 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (191265 / 1000000 : ℝ) := by
  have hmonoLo : sin (19224 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19245 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19224 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19245 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19224 / 100000 : ℝ) ≤ q ∧ q ≤ 19245 / 100000) :
    (981538 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981579 / 1000000 : ℝ) := by
  have hmonoLo : cos (19245 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19224 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19245 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19224 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28723 / 100000 : ℝ) ≤ q ∧ q ≤ 28771 / 100000) :
    (283296 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (283758 / 1000000 : ℝ) := by
  have hmonoLo : sin (28723 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28771 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28723 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28771 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28723 / 100000 : ℝ) ≤ q ∧ q ≤ 28771 / 100000) :
    (958896 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (959033 / 1000000 : ℝ) := by
  have hmonoLo : cos (28771 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28723 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28771 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28723 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43909 / 100000 : ℝ) ≤ q ∧ q ≤ 43967 / 100000) :
    (425115 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (425641 / 1000000 : ℝ) := by
  have hmonoLo : sin (43909 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43967 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43909 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43967 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48570 / 100000 : ℝ) ≤ q ∧ q ≤ 48640 / 100000) :
    (466827 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (467447 / 1000000 : ℝ) := by
  have hmonoLo : sin (48570 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48640 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48570 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48640 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48570 / 100000 : ℝ) ≤ q ∧ q ≤ 48640 / 100000) :
    (884021 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (884349 / 1000000 : ℝ) := by
  have hmonoLo : cos (48640 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48570 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48640 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48570 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19224000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19245000 / 100000000) :
    (19105800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19126500 / 100000000 : ℝ) ∧
      (98153800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98157900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19224000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19245000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19245000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19224000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28723000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28771000 / 100000000) :
    (28329600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28375800 / 100000000 : ℝ) ∧
      (95889600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95903300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28723000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28771000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28771000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28723000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43909000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43967000 / 100000000) :
    (42511500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42564100 / 100000000 : ℝ) ∧
      (90489200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90513900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43909000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43967000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43967000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43909000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48570000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48640000 / 100000000) :
    (46682700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46744700 / 100000000 : ℝ) ∧
      (88402100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88434900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48570000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48640000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48640000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48570000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0035. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102351 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102361 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19224000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19245000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28723000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28771000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43909000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43967000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48570000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48640000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0035 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (487 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 11 / 25, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 487 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (11 / 25)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (487 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (11 / 25)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0035 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102351 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102361 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19224 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19245 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28723 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43909 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43967 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48570 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48640 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981579 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19224 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19224 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (904892 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43967 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43967 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (467447 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48640 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48640 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (425115 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43909 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43909 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102361 / 100000 : ℝ) * (48640 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102351 / 100000 : ℝ) * (28723 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16214 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16723 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981579 / 1000000 : ℝ) * (16214 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190489 / 100000 : ℝ) * (16723 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190489 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28723 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28771 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102351 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102361 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102351 / 100000 : ℝ) * (283296 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102361 / 100000 : ℝ) * (283758 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19224 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19245 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28723 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28771 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102351 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102361 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19224 / 100000, 19245 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28723 / 100000, 28771 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102351 / 100000, 102361 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨191058 / 1000000, 191265 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981538 / 1000000, 981579 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨283296 / 1000000, 283758 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958896 / 1000000, 959033 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0035 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0035 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102361 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102351 / 100000 : ℝ) * (466827 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102361 / 100000 : ℝ) * (467447 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48570 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48640 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48570 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48640 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102351 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0035`.
...
/-- Sound projection of the B0035 checker instance into the generic
...
/-- Every projected type-(iv) height in B0035 has an equal-area regular
...
/-- Candidate-facing conclusion for B0035.  No stationarity hypothesis is
...
/-- Complete B0035 candidate-facing conclusion.  The checked stationary pair
