...
namespace MiddleFaceCell47

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0047`, spanning `[102471/100000, 102481/100000]`. -/
def brick : Brick where
  lamLo := 102471 / 100000
  lamHi := 102481 / 100000
  centers := ![972722670532172809 / 5000000000000000000,
    2928331646490653963 / 10000000000000000000,
    139317402559347667 / 312500000000000000,
    2469833372950441177 / 5000000000000000000]
  slopes := ![223466270953584781 / 125000000000000000,
    4404917802580552431 / 1000000000000000000,
    131579279995188641 / 25000000000000000,
    6483139155181422127 / 1000000000000000000]
  yXiSlope := 32675961 / 50000000
  vRhoSlope := 44374179 / 50000000
...
/-- Unconditional real-range conclusion for the B0047 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102471 / 100000 : ℝ) ≤ lam → lam ≤ 102481 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19444 / 100000 : ℝ) ≤ q ∧ q ≤ 19465 / 100000) :
    (193217 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (193424 / 1000000 : ℝ) := by
  have hmonoLo : sin (19444 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19465 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19444 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19465 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19444 / 100000 : ℝ) ≤ q ∧ q ≤ 19465 / 100000) :
    (981115 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981157 / 1000000 : ℝ) := by
  have hmonoLo : cos (19465 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19444 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19465 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19444 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29260 / 100000 : ℝ) ≤ q ∧ q ≤ 29307 / 100000) :
    (288442 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (288893 / 1000000 : ℝ) := by
  have hmonoLo : sin (29260 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29307 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29260 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29307 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29260 / 100000 : ℝ) ≤ q ∧ q ≤ 29307 / 100000) :
    (957361 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957498 / 1000000 : ℝ) := by
  have hmonoLo : cos (29307 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29260 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29307 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29260 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44554 / 100000 : ℝ) ≤ q ∧ q ≤ 44609 / 100000) :
    (430945 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (431442 / 1000000 : ℝ) := by
  have hmonoLo : sin (44554 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44609 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44554 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44609 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49363 / 100000 : ℝ) ≤ q ∧ q ≤ 49431 / 100000) :
    (473825 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (474425 / 1000000 : ℝ) := by
  have hmonoLo : sin (49363 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49431 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49363 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49431 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49363 / 100000 : ℝ) ≤ q ∧ q ≤ 49431 / 100000) :
    (880296 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (880619 / 1000000 : ℝ) := by
  have hmonoLo : cos (49431 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49363 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49431 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49363 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19444000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19465000 / 100000000) :
    (19321700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19342400 / 100000000 : ℝ) ∧
      (98111500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98115700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19444000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19465000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19465000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19444000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29260000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29307000 / 100000000) :
    (28844200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28889300 / 100000000 : ℝ) ∧
      (95736100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95749800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29260000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29307000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29307000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29260000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44554000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44609000 / 100000000) :
    (43094500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43144200 / 100000000 : ℝ) ∧
      (90214000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90237900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44554000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44609000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44609000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44554000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49363000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49431000 / 100000000) :
    (47382500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47442500 / 100000000 : ℝ) ∧
      (88029600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88061900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49363000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49431000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49431000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49363000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0047. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102471 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102481 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19444000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19465000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29260000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29307000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44554000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44609000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49363000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49431000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0047 brick. -/
...
throughout the B0047 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102471 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102481 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19444 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19465 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29260 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44554 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44609 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49363 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49431 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981157 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19444 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19444 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (902140 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44609 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44609 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (474425 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49431 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49431 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (430945 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44554 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44554 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102481 / 100000 : ℝ) * (49431 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102471 / 100000 : ℝ) * (29260 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16231 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16759 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981157 / 1000000 : ℝ) * (16231 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190213 / 100000 : ℝ) * (16759 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190213 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29260 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29307 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102471 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102481 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102471 / 100000 : ℝ) * (288442 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102481 / 100000 : ℝ) * (288893 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19444 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19465 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29260 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29307 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102471 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102481 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19444 / 100000, 19465 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29260 / 100000, 29307 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102471 / 100000, 102481 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨193217 / 1000000, 193424 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981115 / 1000000, 981157 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨288442 / 1000000, 288893 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957361 / 1000000, 957498 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0047 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0047 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102481 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102471 / 100000 : ℝ) * (473825 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102481 / 100000 : ℝ) * (474425 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49363 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49431 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49363 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49431 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102471 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0047`.
...
/-- Sound projection of the B0047 checker instance into the generic
...
/-- Every projected type-(iv) height in B0047 has an equal-area regular
...
/-- Candidate-facing conclusion for B0047.  No stationarity hypothesis is
...
/-- Complete B0047 candidate-facing conclusion.  The checked stationary pair
