...
namespace MiddleFaceCell88

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0088`, spanning `[102881/100000, 102891/100000]`. -/
def brick : Brick where
  lamLo := 102881 / 100000
  lamHi := 102891 / 100000
  centers := ![503309130255924393 / 2500000000000000000,
    3100482549495947063 / 10000000000000000000,
    4661473863858625691 / 10000000000000000000,
    1297836661258224547 / 2500000000000000000]
  slopes := ![1530801489985302263 / 1000000000000000000,
    4008881843733968031 / 1000000000000000000,
    1170003750114915993 / 250000000000000000,
    2910851531540505581 / 500000000000000000]
  yXiSlope := 63701851 / 100000000
  vRhoSlope := 1760997 / 2000000
...
/-- Unconditional real-range conclusion for the B0088 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102881 / 100000 : ℝ) ≤ lam → lam ≤ 102891 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20123 / 100000 : ℝ) ≤ q ∧ q ≤ 20142 / 100000) :
    (199874 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200061 / 1000000 : ℝ) := by
  have hmonoLo : sin (20123 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20142 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20123 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20142 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20123 / 100000 : ℝ) ≤ q ∧ q ≤ 20142 / 100000) :
    (979783 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979822 / 1000000 : ℝ) := by
  have hmonoLo : cos (20142 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20123 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20142 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20123 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30984 / 100000 : ℝ) ≤ q ∧ q ≤ 31026 / 100000) :
    (304906 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (305307 / 1000000 : ℝ) := by
  have hmonoLo : sin (30984 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31026 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30984 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31026 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30984 / 100000 : ℝ) ≤ q ∧ q ≤ 31026 / 100000) :
    (952254 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952383 / 1000000 : ℝ) := by
  have hmonoLo : cos (31026 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30984 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31026 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30984 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46590 / 100000 : ℝ) ≤ q ∧ q ≤ 46640 / 100000) :
    (449227 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (449674 / 1000000 : ℝ) := by
  have hmonoLo : sin (46590 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46640 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46590 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46640 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51883 / 100000 : ℝ) ≤ q ∧ q ≤ 51944 / 100000) :
    (495864 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (496395 / 1000000 : ℝ) := by
  have hmonoLo : sin (51883 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51944 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51883 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51944 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51883 / 100000 : ℝ) ≤ q ∧ q ≤ 51944 / 100000) :
    (868097 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (868400 / 1000000 : ℝ) := by
  have hmonoLo : cos (51944 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51883 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51944 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51883 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20123000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20142000 / 100000000) :
    (19987400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20006100 / 100000000 : ℝ) ∧
      (97978300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97982200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20123000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20142000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20142000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20123000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30984000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31026000 / 100000000) :
    (30490600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30530700 / 100000000 : ℝ) ∧
      (95225400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95238300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30984000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31026000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31026000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30984000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46590000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46640000 / 100000000) :
    (44922700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44967400 / 100000000 : ℝ) ∧
      (89319200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89341800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46590000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46640000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46640000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46590000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51883000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51944000 / 100000000) :
    (49586400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49639500 / 100000000 : ℝ) ∧
      (86809700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86840000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51883000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51944000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51944000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51883000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0088. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102881 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102891 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20123000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20142000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30984000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31026000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46590000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46640000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51883000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51944000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0088 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 13 / 25, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (13 / 25)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0088 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102881 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102891 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20123 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20142 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30984 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46590 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46640 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51883 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51944 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979822 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20123 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20123 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (893192 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46640 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46640 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (496395 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51944 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51944 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (449227 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46590 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46590 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102891 / 100000 : ℝ) * (51944 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102881 / 100000 : ℝ) * (30984 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16287 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16881 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979822 / 1000000 : ℝ) * (16287 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189319 / 100000 : ℝ) * (16881 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189319 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30984 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31026 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102881 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102891 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102881 / 100000 : ℝ) * (304906 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102891 / 100000 : ℝ) * (305307 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20123 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20142 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30984 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31026 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102881 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102891 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20123 / 100000, 20142 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30984 / 100000, 31026 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102881 / 100000, 102891 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨199874 / 1000000, 200061 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979783 / 1000000, 979822 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨304906 / 1000000, 305307 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952254 / 1000000, 952383 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0088 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0088 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102891 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102881 / 100000 : ℝ) * (495864 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102891 / 100000 : ℝ) * (496395 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51883 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51944 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51883 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51944 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102881 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0088`.
...
/-- Sound projection of the B0088 checker instance into the generic
...
/-- Every projected type-(iv) height in B0088 has an equal-area regular
...
/-- Candidate-facing conclusion for B0088.  No stationarity hypothesis is
...
/-- Complete B0088 candidate-facing conclusion.  The checked stationary pair
