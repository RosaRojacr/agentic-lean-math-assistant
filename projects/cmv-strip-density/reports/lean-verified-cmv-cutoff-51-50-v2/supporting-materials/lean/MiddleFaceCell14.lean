...
namespace MiddleFaceCell14

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0014`, spanning `[102141/100000, 102151/100000]`. -/
def brick : Brick where
  lamLo := 102141 / 100000
  lamHi := 102151 / 100000
  centers := ![376440079670710807 / 2000000000000000000,
    2776552942120723113 / 10000000000000000000,
    2137456430234286157 / 5000000000000000000,
    589368766766911313 / 1250000000000000000]
  slopes := ![1028303142836317439 / 500000000000000000,
    4809257283360818707 / 1000000000000000000,
    5866950563900781269 / 1000000000000000000,
    7162729015433904953 / 1000000000000000000]
  yXiSlope := 534633 / 800000
  vRhoSlope := 89357617 / 100000000
...
/-- Unconditional real-range conclusion for the B0014 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102141 / 100000 : ℝ) ≤ lam → lam ≤ 102151 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18810 / 100000 : ℝ) ≤ q ∧ q ≤ 18834 / 100000) :
    (186992 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (187229 / 1000000 : ℝ) := by
  have hmonoLo : sin (18810 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18834 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18810 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18834 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18810 / 100000 : ℝ) ≤ q ∧ q ≤ 18834 / 100000) :
    (982316 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982362 / 1000000 : ℝ) := by
  have hmonoLo : cos (18834 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18810 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18834 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18810 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27740 / 100000 : ℝ) ≤ q ∧ q ≤ 27791 / 100000) :
    (273855 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (274347 / 1000000 : ℝ) := by
  have hmonoLo : sin (27740 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27791 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27740 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27791 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27740 / 100000 : ℝ) ≤ q ∧ q ≤ 27791 / 100000) :
    (961630 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961771 / 1000000 : ℝ) := by
  have hmonoLo : cos (27791 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27740 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27791 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27740 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42718 / 100000 : ℝ) ≤ q ∧ q ≤ 42780 / 100000) :
    (414305 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (414871 / 1000000 : ℝ) := by
  have hmonoLo : sin (42718 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42780 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42718 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42780 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47112 / 100000 : ℝ) ≤ q ∧ q ≤ 47187 / 100000) :
    (453884 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (454553 / 1000000 : ℝ) := by
  have hmonoLo : sin (47112 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47187 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47112 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47187 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47112 / 100000 : ℝ) ≤ q ∧ q ≤ 47187 / 100000) :
    (890719 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (891061 / 1000000 : ℝ) := by
  have hmonoLo : cos (47187 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47112 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47187 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47112 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18810000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18834000 / 100000000) :
    (18699200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18722900 / 100000000 : ℝ) ∧
      (98231600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98236200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18810000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18834000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18834000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18810000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27740000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27791000 / 100000000) :
    (27385500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27434700 / 100000000 : ℝ) ∧
      (96163000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96177100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27740000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27791000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27791000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27740000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42718000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42780000 / 100000000) :
    (41430500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41487100 / 100000000 : ℝ) ∧
      (90988000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91013800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42718000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42780000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42780000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42718000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47112000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47187000 / 100000000) :
    (45388400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45455300 / 100000000 : ℝ) ∧
      (89071900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89106100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47112000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47187000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47187000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47112000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0014. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102141 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102151 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18810000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18834000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27740000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27791000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42718000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42780000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47112000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47187000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0014 brick. -/
...
B0014 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 59 / 125, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (59 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0014 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102141 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102151 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18810 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18834 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27740 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42718 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42780 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47112 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47187 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982362 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18810 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18810 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (909880 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42780 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42780 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (454553 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47187 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47187 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (414305 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42718 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42718 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102151 / 100000 : ℝ) * (47187 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102141 / 100000 : ℝ) * (27740 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16184 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16657 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982362 / 1000000 : ℝ) * (16184 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190987 / 100000 : ℝ) * (16657 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190987 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27740 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27791 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102141 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102151 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102141 / 100000 : ℝ) * (273855 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102151 / 100000 : ℝ) * (274347 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18810 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18834 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27740 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27791 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102141 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102151 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18810 / 100000, 18834 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27740 / 100000, 27791 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102141 / 100000, 102151 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨186992 / 1000000, 187229 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982316 / 1000000, 982362 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨273855 / 1000000, 274347 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961630 / 1000000, 961771 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0014 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0014 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102151 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102141 / 100000 : ℝ) * (453884 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102151 / 100000 : ℝ) * (454553 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47112 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47187 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47112 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47187 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102141 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0014`.
...
/-- Sound projection of the B0014 checker instance into the generic
...
/-- Every projected type-(iv) height in B0014 has an equal-area regular
...
/-- Candidate-facing conclusion for B0014.  No stationarity hypothesis is
...
/-- Complete B0014 candidate-facing conclusion.  The checked stationary pair
