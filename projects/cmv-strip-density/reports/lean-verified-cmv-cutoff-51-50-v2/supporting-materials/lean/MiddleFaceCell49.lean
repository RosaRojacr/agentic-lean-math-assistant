...
namespace MiddleFaceCell49

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0049`, spanning `[102491/100000, 102501/100000]`. -/
def brick : Brick where
  lamLo := 102491 / 100000
  lamHi := 102501 / 100000
  centers := ![487251628378486059 / 2500000000000000000,
    2937119729759454997 / 10000000000000000000,
    4468650971009902339 / 10000000000000000000,
    2476298290765251219 / 5000000000000000000]
  slopes := ![443366923807726833 / 250000000000000000,
    4383200515680004433 / 1000000000000000000,
    2615486470528262261 / 500000000000000000,
    644675675606703449 / 100000000000000000]
  yXiSlope := 16316761 / 25000000
  vRhoSlope := 88712897 / 100000000
...
/-- Unconditional real-range conclusion for the B0049 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102491 / 100000 : ℝ) ≤ lam → lam ≤ 102501 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19480 / 100000 : ℝ) ≤ q ∧ q ≤ 19500 / 100000) :
    (193570 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (193767 / 1000000 : ℝ) := by
  have hmonoLo : sin (19480 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19500 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19480 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19500 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19480 / 100000 : ℝ) ≤ q ∧ q ≤ 19500 / 100000) :
    (981047 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981087 / 1000000 : ℝ) := by
  have hmonoLo : cos (19500 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19480 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19500 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19480 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29348 / 100000 : ℝ) ≤ q ∧ q ≤ 29394 / 100000) :
    (289285 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (289726 / 1000000 : ℝ) := by
  have hmonoLo : sin (29348 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29394 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29348 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29394 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29348 / 100000 : ℝ) ≤ q ∧ q ≤ 29394 / 100000) :
    (957109 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957243 / 1000000 : ℝ) := by
  have hmonoLo : cos (29394 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29348 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29394 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29348 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44659 / 100000 : ℝ) ≤ q ∧ q ≤ 44714 / 100000) :
    (431892 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (432389 / 1000000 : ℝ) := by
  have hmonoLo : sin (44659 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44714 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44659 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44714 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49492 / 100000 : ℝ) ≤ q ∧ q ≤ 49560 / 100000) :
    (474961 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (475560 / 1000000 : ℝ) := by
  have hmonoLo : sin (49492 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49560 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49492 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49560 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49492 / 100000 : ℝ) ≤ q ∧ q ≤ 49560 / 100000) :
    (879683 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (880007 / 1000000 : ℝ) := by
  have hmonoLo : cos (49560 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49492 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49560 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49492 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19480000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19500000 / 100000000) :
    (19357000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19376700 / 100000000 : ℝ) ∧
      (98104700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98108700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19480000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19500000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19500000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19480000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29348000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29394000 / 100000000) :
    (28928500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28972600 / 100000000 : ℝ) ∧
      (95710900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95724300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29348000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29394000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29394000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29348000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44659000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44714000 / 100000000) :
    (43189200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43238900 / 100000000 : ℝ) ∧
      (90168700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90192600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44659000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44714000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44714000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44659000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49492000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49560000 / 100000000) :
    (47496100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47556000 / 100000000 : ℝ) ∧
      (87968300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88000700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49492000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49560000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49560000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49492000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0049. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102491 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102501 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19480000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19500000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29348000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29394000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44659000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44714000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49492000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49560000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0049 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 62 / 125, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (62 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0049 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102491 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102501 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19480 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19500 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29348 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44659 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44714 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49492 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49560 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981087 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19480 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19480 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (901687 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44714 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44714 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (475560 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49560 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49560 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (431892 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44659 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44659 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102501 / 100000 : ℝ) * (49560 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102491 / 100000 : ℝ) * (29348 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16234 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16765 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981087 / 1000000 : ℝ) * (16234 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190168 / 100000 : ℝ) * (16765 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190168 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29348 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29394 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102491 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102501 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102491 / 100000 : ℝ) * (289285 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102501 / 100000 : ℝ) * (289726 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19480 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19500 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29348 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29394 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102491 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102501 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19480 / 100000, 19500 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29348 / 100000, 29394 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102491 / 100000, 102501 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨193570 / 1000000, 193767 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981047 / 1000000, 981087 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨289285 / 1000000, 289726 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957109 / 1000000, 957243 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0049 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0049 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102501 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102491 / 100000 : ℝ) * (474961 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102501 / 100000 : ℝ) * (475560 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49492 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49560 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49492 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49560 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102491 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0049`.
...
/-- Sound projection of the B0049 checker instance into the generic
...
/-- Every projected type-(iv) height in B0049 has an equal-area regular
...
/-- Candidate-facing conclusion for B0049.  No stationarity hypothesis is
...
/-- Complete B0049 candidate-facing conclusion.  The checked stationary pair
