...
namespace MiddleFaceCell12

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0012`, spanning `[102121/100000, 102131/100000]`. -/
def brick : Brick where
  lamLo := 102121 / 100000
  lamHi := 102131 / 100000
  centers := ![939034287936358639 / 5000000000000000000,
    1383453383277089763 / 5000000000000000000,
    1065784343322318863 / 2500000000000000000,
    4700578039470515947 / 10000000000000000000]
  slopes := ![1037627330376790291 / 500000000000000000,
    4836970453647441019 / 1000000000000000000,
    5908619469544610007 / 1000000000000000000,
    7209455914653183981 / 1000000000000000000]
  yXiSlope := 3346187 / 5000000
  vRhoSlope := 4469807 / 5000000
...
/-- Unconditional real-range conclusion for the B0012 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102121 / 100000 : ℝ) ≤ lam → lam ≤ 102131 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18769 / 100000 : ℝ) ≤ q ∧ q ≤ 18793 / 100000) :
    (186589 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (186826 / 1000000 : ℝ) := by
  have hmonoLo : sin (18769 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18793 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18769 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18793 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18769 / 100000 : ℝ) ≤ q ∧ q ≤ 18793 / 100000) :
    (982393 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982438 / 1000000 : ℝ) := by
  have hmonoLo : cos (18793 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18769 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18793 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18769 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27644 / 100000 : ℝ) ≤ q ∧ q ≤ 27695 / 100000) :
    (272932 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (273424 / 1000000 : ℝ) := by
  have hmonoLo : sin (27644 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27695 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27644 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27695 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27644 / 100000 : ℝ) ≤ q ∧ q ≤ 27695 / 100000) :
    (961893 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962034 / 1000000 : ℝ) := by
  have hmonoLo : cos (27695 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27644 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27695 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27644 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42600 / 100000 : ℝ) ≤ q ∧ q ≤ 42662 / 100000) :
    (413231 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (413797 / 1000000 : ℝ) := by
  have hmonoLo : sin (42600 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42662 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42600 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42662 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46968 / 100000 : ℝ) ≤ q ∧ q ≤ 47043 / 100000) :
    (452600 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (453270 / 1000000 : ℝ) := by
  have hmonoLo : sin (46968 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47043 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46968 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47043 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46968 / 100000 : ℝ) ≤ q ∧ q ≤ 47043 / 100000) :
    (891373 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (891714 / 1000000 : ℝ) := by
  have hmonoLo : cos (47043 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46968 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47043 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46968 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18769000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18793000 / 100000000) :
    (18658900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18682600 / 100000000 : ℝ) ∧
      (98239300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98243800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18769000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18793000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18793000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18769000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27644000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27695000 / 100000000) :
    (27293200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27342400 / 100000000 : ℝ) ∧
      (96189300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96203400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27644000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27695000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27695000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27644000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42600000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42662000 / 100000000) :
    (41323100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41379700 / 100000000 : ℝ) ∧
      (91036900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91062600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42600000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42662000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42662000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42600000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46968000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47043000 / 100000000) :
    (45260000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45327000 / 100000000 : ℝ) ∧
      (89137300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89171400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46968000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47043000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47043000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46968000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0012. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102121 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102131 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18769000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18793000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27644000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27695000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42600000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42662000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46968000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47043000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0012 brick. -/
...
B0012 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (471 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 107 / 250, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 471 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (107 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (471 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (107 / 250)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0012 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102121 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102131 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18769 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18793 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27644 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42600 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42662 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46968 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47043 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982438 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18769 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18769 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (910369 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42662 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42662 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (453270 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47043 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47043 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (413231 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42600 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42600 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102131 / 100000 : ℝ) * (47043 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102121 / 100000 : ℝ) * (27644 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16181 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16651 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982438 / 1000000 : ℝ) * (16181 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191036 / 100000 : ℝ) * (16651 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191036 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27644 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27695 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102121 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102131 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102121 / 100000 : ℝ) * (272932 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102131 / 100000 : ℝ) * (273424 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18769 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18793 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27644 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27695 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102121 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102131 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18769 / 100000, 18793 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27644 / 100000, 27695 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102121 / 100000, 102131 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨186589 / 1000000, 186826 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982393 / 1000000, 982438 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨272932 / 1000000, 273424 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961893 / 1000000, 962034 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0012 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0012 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102131 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102121 / 100000 : ℝ) * (452600 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102131 / 100000 : ℝ) * (453270 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46968 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47043 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46968 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47043 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102121 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0012`.
...
/-- Sound projection of the B0012 checker instance into the generic
...
/-- Every projected type-(iv) height in B0012 has an equal-area regular
...
/-- Candidate-facing conclusion for B0012.  No stationarity hypothesis is
...
/-- Complete B0012 candidate-facing conclusion.  The checked stationary pair
