...
namespace MiddleFaceCell110

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0110`, spanning `[103101/100000, 103111/100000]`. -/
def brick : Brick where
  lamLo := 103101 / 100000
  lamHi := 103111 / 100000
  centers := ![204564739874790199 / 1000000000000000000,
    3186689402690452901 / 10000000000000000000,
    4761535321389334881 / 10000000000000000000,
    5316117642779739831 / 10000000000000000000]
  slopes := ![1418100375292711159 / 1000000000000000000,
    3831570913296252073 / 1000000000000000000,
    4421843812367183217 / 1000000000000000000,
    5527032477679011511 / 1000000000000000000]
  yXiSlope := 31442667 / 50000000
  vRhoSlope := 87696903 / 100000000
...
/-- Unconditional real-range conclusion for the B0110 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103101 / 100000 : ℝ) ≤ lam → lam ≤ 103111 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20448 / 100000 : ℝ) ≤ q ∧ q ≤ 20465 / 100000) :
    (203058 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (203225 / 1000000 : ℝ) := by
  have hmonoLo : sin (20448 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20465 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20448 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20465 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20448 / 100000 : ℝ) ≤ q ∧ q ≤ 20465 / 100000) :
    (979132 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979167 / 1000000 : ℝ) := by
  have hmonoLo : cos (20465 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20448 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20465 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20448 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31847 / 100000 : ℝ) ≤ q ∧ q ≤ 31887 / 100000) :
    (313113 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (313494 / 1000000 : ℝ) := by
  have hmonoLo : sin (31847 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31887 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31847 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31887 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31847 / 100000 : ℝ) ≤ q ∧ q ≤ 31887 / 100000) :
    (949590 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (949716 / 1000000 : ℝ) := by
  have hmonoLo : cos (31887 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31847 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31887 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31847 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47592 / 100000 : ℝ) ≤ q ∧ q ≤ 47639 / 100000) :
    (458156 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (458575 / 1000000 : ℝ) := by
  have hmonoLo : sin (47592 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47639 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47592 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47639 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (53132 / 100000 : ℝ) ≤ q ∧ q ≤ 53190 / 100000) :
    (506671 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (507172 / 1000000 : ℝ) := by
  have hmonoLo : sin (53132 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (53190 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (53132 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (53190 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (53132 / 100000 : ℝ) ≤ q ∧ q ≤ 53190 / 100000) :
    (861845 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (862140 / 1000000 : ℝ) := by
  have hmonoLo : cos (53190 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (53132 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (53190 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (53132 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20448000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20465000 / 100000000) :
    (20305800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20322500 / 100000000 : ℝ) ∧
      (97913200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97916700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20448000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20465000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20465000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20448000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31847000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31887000 / 100000000) :
    (31311300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31349400 / 100000000 : ℝ) ∧
      (94959000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (94971600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31847000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31887000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31887000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31847000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47592000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47639000 / 100000000) :
    (45815600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45857500 / 100000000 : ℝ) ∧
      (88865600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88887200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47592000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47639000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47639000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47592000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (53132000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 53190000 / 100000000) :
    (50667100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50717200 / 100000000 : ℝ) ∧
      (86184500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86214000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (53132000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (53190000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (53190000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (53132000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0110. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103101 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103111 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20448000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20465000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31847000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31887000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47592000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47639000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (53132000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 53190000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0110 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 133 / 250, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (133 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0110 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103101 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (103111 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20448 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20465 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31847 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47592 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47639 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (53132 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (53190 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979167 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20448 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20448 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (888656 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47639 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47639 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (507172 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (53190 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (53190 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (458156 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47592 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47592 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (103111 / 100000 : ℝ) * (53190 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103101 / 100000 : ℝ) * (31847 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16316 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16944 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979167 / 1000000 : ℝ) * (16316 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188865 / 100000 : ℝ) * (16944 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188865 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31847 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31887 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103101 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (103111 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103101 / 100000 : ℝ) * (313113 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (103111 / 100000 : ℝ) * (313494 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20448 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20465 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31847 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31887 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103101 / 100000 : ℝ) ≤ ll ∧ ll ≤ 103111 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20448 / 100000, 20465 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31847 / 100000, 31887 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103101 / 100000, 103111 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨203058 / 1000000, 203225 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979132 / 1000000, 979167 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨313113 / 1000000, 313494 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨949590 / 1000000, 949716 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0110 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0110 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (103111 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103101 / 100000 : ℝ) * (506671 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (103111 / 100000 : ℝ) * (507172 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (53132 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 53190 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (53132 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 53190 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103101 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0110`.
...
/-- Sound projection of the B0110 checker instance into the generic
...
/-- Every projected type-(iv) height in B0110 has an equal-area regular
...
/-- Candidate-facing conclusion for B0110.  No stationarity hypothesis is
...
/-- Complete B0110 candidate-facing conclusion.  The checked stationary pair
