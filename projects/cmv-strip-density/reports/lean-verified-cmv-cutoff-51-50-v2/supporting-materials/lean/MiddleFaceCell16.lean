...
namespace MiddleFaceCell16

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0016`, spanning `[102161/100000, 102171/100000]`. -/
def brick : Brick where
  lamLo := 102161 / 100000
  lamHi := 102171 / 100000
  centers := ![1886295228893794039 / 10000000000000000000,
    2786144104910390343 / 10000000000000000000,
    133956427077068637 / 312500000000000000,
    2364614745226047627 / 5000000000000000000]
  slopes := ![254782719252571033 / 125000000000000000,
    956391283439077071 / 200000000000000000,
    2912968115905262769 / 500000000000000000,
    1423343071052741627 / 200000000000000000]
  yXiSlope := 33367569 / 50000000
  vRhoSlope := 89319291 / 100000000
...
/-- Unconditional real-range conclusion for the B0016 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102161 / 100000 : ℝ) ≤ lam → lam ≤ 102171 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18851 / 100000 : ℝ) ≤ q ∧ q ≤ 18875 / 100000) :
    (187395 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (187632 / 1000000 : ℝ) := by
  have hmonoLo : sin (18851 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18875 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18851 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18875 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18851 / 100000 : ℝ) ≤ q ∧ q ≤ 18875 / 100000) :
    (982239 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982285 / 1000000 : ℝ) := by
  have hmonoLo : cos (18875 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18851 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18875 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18851 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27836 / 100000 : ℝ) ≤ q ∧ q ≤ 27887 / 100000) :
    (274779 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (275270 / 1000000 : ℝ) := by
  have hmonoLo : sin (27836 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27887 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27836 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27887 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27836 / 100000 : ℝ) ≤ q ∧ q ≤ 27887 / 100000) :
    (961367 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961508 / 1000000 : ℝ) := by
  have hmonoLo : cos (27887 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27836 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27887 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27836 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42835 / 100000 : ℝ) ≤ q ∧ q ≤ 42897 / 100000) :
    (415370 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (415935 / 1000000 : ℝ) := by
  have hmonoLo : sin (42835 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42897 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42835 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42897 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47255 / 100000 : ℝ) ≤ q ∧ q ≤ 47329 / 100000) :
    (455158 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (455818 / 1000000 : ℝ) := by
  have hmonoLo : sin (47255 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47329 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47255 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47329 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47255 / 100000 : ℝ) ≤ q ∧ q ≤ 47329 / 100000) :
    (890073 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (890411 / 1000000 : ℝ) := by
  have hmonoLo : cos (47329 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47255 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47329 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47255 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18851000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18875000 / 100000000) :
    (18739500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18763200 / 100000000 : ℝ) ∧
      (98223900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98228500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18851000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18875000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18875000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18851000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27836000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27887000 / 100000000) :
    (27477900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27527000 / 100000000 : ℝ) ∧
      (96136700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96150800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27836000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27887000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27887000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27836000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42835000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42897000 / 100000000) :
    (41537000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41593500 / 100000000 : ℝ) ∧
      (90939400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90965300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42835000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42897000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42897000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42835000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47255000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47329000 / 100000000) :
    (45515800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45581800 / 100000000 : ℝ) ∧
      (89007300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89041100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47255000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47329000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47329000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47255000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0016. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102161 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102171 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18851000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18875000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27836000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27887000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42835000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42897000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47255000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47329000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0016 brick. -/
...
B0016 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 237 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (237 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0016 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102161 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102171 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18851 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18875 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27836 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42835 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42897 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47255 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47329 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982285 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18851 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18851 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (909394 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42897 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42897 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (455818 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47329 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47329 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (415370 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42835 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42835 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102171 / 100000 : ℝ) * (47329 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102161 / 100000 : ℝ) * (27836 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16187 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16664 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982285 / 1000000 : ℝ) * (16187 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190939 / 100000 : ℝ) * (16664 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190939 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27836 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27887 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102161 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102171 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102161 / 100000 : ℝ) * (274779 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102171 / 100000 : ℝ) * (275270 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18851 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18875 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27836 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27887 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102161 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102171 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18851 / 100000, 18875 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27836 / 100000, 27887 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102161 / 100000, 102171 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨187395 / 1000000, 187632 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982239 / 1000000, 982285 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨274779 / 1000000, 275270 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961367 / 1000000, 961508 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0016 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0016 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102171 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102161 / 100000 : ℝ) * (455158 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102171 / 100000 : ℝ) * (455818 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47255 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47329 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47255 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47329 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102161 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0016`.
...
/-- Sound projection of the B0016 checker instance into the generic
...
/-- Every projected type-(iv) height in B0016 has an equal-area regular
...
/-- Candidate-facing conclusion for B0016.  No stationarity hypothesis is
...
/-- Complete B0016 candidate-facing conclusion.  The checked stationary pair
