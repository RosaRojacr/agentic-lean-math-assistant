...
namespace MiddleFaceCell87

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0087`, spanning `[102871/100000, 102881/100000]`. -/
def brick : Brick where
  lamLo := 102871 / 100000
  lamHi := 102881 / 100000
  centers := ![2011702975909205869 / 10000000000000000000,
    3096469381356589823 / 10000000000000000000,
    931357516808246719 / 2000000000000000000,
    1037103561351477959 / 2000000000000000000]
  slopes := ![192036092374763013 / 125000000000000000,
    4017454434980511933 / 1000000000000000000,
    4692544634324528131 / 1000000000000000000,
    364748342995985881 / 62500000000000000]
  yXiSlope := 63740019 / 100000000
  vRhoSlope := 22016557 / 25000000
...
/-- Unconditional real-range conclusion for the B0087 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102871 / 100000 : ℝ) ≤ lam → lam ≤ 102881 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20108 / 100000 : ℝ) ≤ q ∧ q ≤ 20126 / 100000) :
    (199727 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (199905 / 1000000 : ℝ) := by
  have hmonoLo : sin (20108 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20126 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20108 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20126 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20108 / 100000 : ℝ) ≤ q ∧ q ≤ 20126 / 100000) :
    (979815 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979852 / 1000000 : ℝ) := by
  have hmonoLo : cos (20126 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20108 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20126 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20108 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30943 / 100000 : ℝ) ≤ q ∧ q ≤ 30986 / 100000) :
    (304515 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (304926 / 1000000 : ℝ) := by
  have hmonoLo : sin (30943 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30986 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30943 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30986 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30943 / 100000 : ℝ) ≤ q ∧ q ≤ 30986 / 100000) :
    (952376 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952508 / 1000000 : ℝ) := by
  have hmonoLo : cos (30986 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30943 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30986 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30943 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46543 / 100000 : ℝ) ≤ q ∧ q ≤ 46593 / 100000) :
    (448807 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (449254 / 1000000 : ℝ) := by
  have hmonoLo : sin (46543 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46593 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46543 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46593 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51825 / 100000 : ℝ) ≤ q ∧ q ≤ 51886 / 100000) :
    (495360 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (495891 / 1000000 : ℝ) := by
  have hmonoLo : sin (51825 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51886 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51825 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51886 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51825 / 100000 : ℝ) ≤ q ∧ q ≤ 51886 / 100000) :
    (868385 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (868688 / 1000000 : ℝ) := by
  have hmonoLo : cos (51886 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51825 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51886 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51825 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20108000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20126000 / 100000000) :
    (19972700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19990500 / 100000000 : ℝ) ∧
      (97981500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97985200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20108000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20126000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20126000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20108000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30943000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30986000 / 100000000) :
    (30451500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30492600 / 100000000 : ℝ) ∧
      (95237600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95250800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30943000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30986000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30986000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30943000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46543000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46593000 / 100000000) :
    (44880700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44925400 / 100000000 : ℝ) ∧
      (89340400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89362900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46543000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46593000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46593000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46543000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51825000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51886000 / 100000000) :
    (49536000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49589100 / 100000000 : ℝ) ∧
      (86838500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86868800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51825000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51886000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51886000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51825000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0087. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102871 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102881 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20108000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20126000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30943000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30986000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46543000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46593000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51825000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51886000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0087 brick. -/
...
throughout the B0087 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102871 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102881 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20108 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20126 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30943 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46543 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46593 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51825 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51886 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979852 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20108 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20108 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (893404 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46593 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46593 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (495891 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51886 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51886 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (448807 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46543 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46543 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102881 / 100000 : ℝ) * (51886 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102871 / 100000 : ℝ) * (30943 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16286 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16878 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979852 / 1000000 : ℝ) * (16286 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189340 / 100000 : ℝ) * (16878 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189340 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30943 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30986 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102871 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102881 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102871 / 100000 : ℝ) * (304515 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102881 / 100000 : ℝ) * (304926 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20108 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20126 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30943 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30986 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102871 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102881 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20108 / 100000, 20126 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30943 / 100000, 30986 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102871 / 100000, 102881 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨199727 / 1000000, 199905 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979815 / 1000000, 979852 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨304515 / 1000000, 304926 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952376 / 1000000, 952508 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0087 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0087 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102881 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102871 / 100000 : ℝ) * (495360 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102881 / 100000 : ℝ) * (495891 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51825 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51886 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51825 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51886 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102871 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0087`.
...
/-- Sound projection of the B0087 checker instance into the generic
...
/-- Every projected type-(iv) height in B0087 has an equal-area regular
...
/-- Candidate-facing conclusion for B0087.  No stationarity hypothesis is
...
/-- Complete B0087 candidate-facing conclusion.  The checked stationary pair
