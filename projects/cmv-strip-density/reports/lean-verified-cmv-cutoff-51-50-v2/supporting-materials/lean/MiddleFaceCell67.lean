...
namespace MiddleFaceCell67

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0067`, spanning `[102671/100000, 102681/100000]`. -/
def brick : Brick where
  lamLo := 102671 / 100000
  lamHi := 102681 / 100000
  centers := ![989914260705978301 / 5000000000000000000,
    602866809089599787 / 2000000000000000000,
    1140079819463755221 / 2500000000000000000,
    5065821514127514243 / 10000000000000000000]
  slopes := ![1653659276991346643 / 1000000000000000000,
    4199574997465237493 / 1000000000000000000,
    4959727855757233979 / 1000000000000000000,
    1534910556056009611 / 250000000000000000]
  yXiSlope := 32262143 / 50000000
  vRhoSlope := 88400427 / 100000000
...
/-- Unconditional real-range conclusion for the B0067 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102671 / 100000 : ℝ) ≤ lam → lam ≤ 102681 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19789 / 100000 : ℝ) ≤ q ∧ q ≤ 19808 / 100000) :
    (196600 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (196788 / 1000000 : ℝ) := by
  have hmonoLo : sin (19789 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19808 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19789 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19808 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19789 / 100000 : ℝ) ≤ q ∧ q ≤ 19808 / 100000) :
    (980446 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980484 / 1000000 : ℝ) := by
  have hmonoLo : cos (19808 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19789 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19808 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19789 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30121 / 100000 : ℝ) ≤ q ∧ q ≤ 30166 / 100000) :
    (296675 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (297106 / 1000000 : ℝ) := by
  have hmonoLo : sin (30121 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30166 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30121 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30166 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30121 / 100000 : ℝ) ≤ q ∧ q ≤ 30166 / 100000) :
    (954844 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954979 / 1000000 : ℝ) := by
  have hmonoLo : cos (30166 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30121 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30166 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30121 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45577 / 100000 : ℝ) ≤ q ∧ q ≤ 45629 / 100000) :
    (440153 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (440621 / 1000000 : ℝ) := by
  have hmonoLo : sin (45577 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45629 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45577 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45629 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50626 / 100000 : ℝ) ≤ q ∧ q ≤ 50690 / 100000) :
    (484909 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (485470 / 1000000 : ℝ) := by
  have hmonoLo : sin (50626 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50690 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50626 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50690 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50626 / 100000 : ℝ) ≤ q ∧ q ≤ 50690 / 100000) :
    (874253 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (874565 / 1000000 : ℝ) := by
  have hmonoLo : cos (50690 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50626 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50690 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50626 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19789000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19808000 / 100000000) :
    (19660000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19678800 / 100000000 : ℝ) ∧
      (98044600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98048400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19789000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19808000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19808000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19789000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30121000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30166000 / 100000000) :
    (29667500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29710600 / 100000000 : ℝ) ∧
      (95484400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95497900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30121000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30166000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30166000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30121000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45577000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45629000 / 100000000) :
    (44015300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44062100 / 100000000 : ℝ) ∧
      (89769300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89792300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45577000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45629000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45629000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45577000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50626000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50690000 / 100000000) :
    (48490900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48547000 / 100000000 : ℝ) ∧
      (87425300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87456500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50626000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50690000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50690000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50626000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0067. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102671 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102681 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19789000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19808000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30121000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30166000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45577000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45629000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50626000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50690000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0067 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (507 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 229 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 507 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (229 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (507 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (229 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0067 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102671 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102681 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19789 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19808 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30121 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45577 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45629 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50626 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50690 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980484 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19789 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19789 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (897693 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45629 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45629 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (485470 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50690 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50690 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (440153 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45577 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45577 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102681 / 100000 : ℝ) * (50690 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102671 / 100000 : ℝ) * (30121 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16259 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16819 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980484 / 1000000 : ℝ) * (16259 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189769 / 100000 : ℝ) * (16819 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189769 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30121 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30166 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102671 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102681 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102671 / 100000 : ℝ) * (296675 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102681 / 100000 : ℝ) * (297106 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19789 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19808 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30121 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30166 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102671 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102681 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19789 / 100000, 19808 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30121 / 100000, 30166 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102671 / 100000, 102681 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨196600 / 1000000, 196788 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980446 / 1000000, 980484 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨296675 / 1000000, 297106 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954844 / 1000000, 954979 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0067 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0067 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102681 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102671 / 100000 : ℝ) * (484909 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102681 / 100000 : ℝ) * (485470 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50626 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50690 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50626 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50690 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102671 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0067`.
...
/-- Sound projection of the B0067 checker instance into the generic
...
/-- Every projected type-(iv) height in B0067 has an equal-area regular
...
/-- Candidate-facing conclusion for B0067.  No stationarity hypothesis is
...
/-- Complete B0067 candidate-facing conclusion.  The checked stationary pair
