...
namespace MiddleFaceCell112

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0112`, spanning `[103121/100000, 25781/25000]`. -/
def brick : Brick where
  lamLo := 103121 / 100000
  lamHi := 25781 / 25000
  centers := ![2047981298329424359 / 10000000000000000000,
    3193002040019877679 / 10000000000000000000,
    2384408825489172341 / 5000000000000000000,
    2662610780221764269 / 5000000000000000000]
  slopes := ![1410220379874433567 / 1000000000000000000,
    3819081251769458811 / 1000000000000000000,
    68808292379469873 / 15625000000000000,
    1101262404840662309 / 200000000000000000]
  yXiSlope := 31412901 / 50000000
  vRhoSlope := 1369859 / 1562500
...
/-- Unconditional real-range conclusion for the B0112 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (103121 / 100000 : ℝ) ≤ lam → lam ≤ 25781 / 25000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20476 / 100000 : ℝ) ≤ q ∧ q ≤ 20483 / 100000) :
    (203332 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (203401 / 1000000 : ℝ) := by
  have hmonoLo : sin (20476 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20483 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20476 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20483 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20476 / 100000 : ℝ) ≤ q ∧ q ≤ 20483 / 100000) :
    (979095 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979110 / 1000000 : ℝ) := by
  have hmonoLo : cos (20483 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20476 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20483 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20476 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31923 / 100000 : ℝ) ≤ q ∧ q ≤ 31937 / 100000) :
    (313835 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (313969 / 1000000 : ℝ) := by
  have hmonoLo : sin (31923 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31937 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31923 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31937 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31923 / 100000 : ℝ) ≤ q ∧ q ≤ 31937 / 100000) :
    (949433 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (949478 / 1000000 : ℝ) := by
  have hmonoLo : cos (31937 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31923 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31937 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31923 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47680 / 100000 : ℝ) ≤ q ∧ q ≤ 47696 / 100000) :
    (458938 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (459081 / 1000000 : ℝ) := by
  have hmonoLo : sin (47680 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47696 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47680 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47696 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (53242 / 100000 : ℝ) ≤ q ∧ q ≤ 53262 / 100000) :
    (507619 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (507793 / 1000000 : ℝ) := by
  have hmonoLo : sin (53242 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (53262 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (53242 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (53262 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (53242 / 100000 : ℝ) ≤ q ∧ q ≤ 53262 / 100000) :
    (861479 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (861582 / 1000000 : ℝ) := by
  have hmonoLo : cos (53262 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (53242 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (53262 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (53242 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20476000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20483000 / 100000000) :
    (20333200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20340100 / 100000000 : ℝ) ∧
      (97909500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97911000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20476000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20483000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20483000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20476000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31923000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31937000 / 100000000) :
    (31383500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (31396900 / 100000000 : ℝ) ∧
      (94943300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (94947800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31923000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31937000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31937000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31923000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47680000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47696000 / 100000000) :
    (45893800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45908100 / 100000000 : ℝ) ∧
      (88839400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88846900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47680000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47696000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47696000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47680000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (53242000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 53262000 / 100000000) :
    (50761900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50779300 / 100000000 : ℝ) ∧
      (86147900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86158200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (53242000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (53262000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (53262000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (53242000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0112. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (103121 / 100000 : ℝ) ≤ ll ∧ ll ≤ 25781 / 25000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20476000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20483000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31923000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31937000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47680000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47696000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (53242000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 53262000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0112 brick. -/
...
throughout the B0112 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (103121 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (25781 / 25000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20476 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20483 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31923 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47680 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47696 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (53242 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (53262 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979110 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20476 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20476 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (888394 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47696 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47696 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (507793 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (53262 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (53262 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (458938 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47680 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47680 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (25781 / 25000 : ℝ) * (53262 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (103121 / 100000 : ℝ) * (31923 / 100000 : ℝ) ≤
      lam p * y p := by
  ...
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979110 / 1000000 : ℝ) * (16315 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (188839 / 100000 : ℝ) * (16951 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (188839 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
    MiddleFaceAssembly.C4Residual.DerivativeBoundsOn brick (3 / 200000 : ℝ) := by
  ...
  have hyArg :
      (31923 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31937 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (103121 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (25781 / 25000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (103121 / 100000 : ℝ) * (313835 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (25781 / 25000 : ℝ) * (313969 / 1000000 : ℝ) :=
...
theorem C4_eta_low_face_margin :
  ...
  have ht' : -(3 / 200000 : ℝ) ≤ t ∧ t ≤ 3 / 200000 := by
    norm_num [tInterval, tRadius, brick,
      LeanSuffixReflective.QInterval.RealContains] at ht
    exact ht
  have hxi := hz 0
  ...
  rw [heta']
  exact MiddleFaceAssembly.C4Residual.low_face_margin_on (R := (3 / 200000 : ℝ)) brick
...
theorem C4_eta_high_face_margin :
  ...
  rw [heta']
  exact MiddleFaceAssembly.C4Residual.high_face_margin_on (R := (3 / 200000 : ℝ)) brick
    (by norm_num) (by norm_num)
    c4Reduced_derivativeBounds c4Reduced_origin_abs_lt ht' hxi
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20476 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20483 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31923 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31937 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (103121 / 100000 : ℝ) ≤ ll ∧ ll ≤ 25781 / 25000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20476 / 100000, 20483 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31923 / 100000, 31937 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨103121 / 100000, 25781 / 25000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨203332 / 1000000, 203401 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979095 / 1000000, 979110 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨313835 / 1000000, 313969 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨949433 / 1000000, 949478 / 1000000, by norm_num⟩
...
private theorem fReduced_derivativeBounds :
    MiddleFaceAssembly.FResidual.DerivativeBoundsOn brick (3 / 200000 : ℝ) := by
  intro t xi eta ht hxi heta
...
margin `88 · 10⁻⁹` over the complete B0112 brick. -/
...
theorem F_xi_high_face_margin :
  ...
  rw [hxi]
  exact MiddleFaceAssembly.FResidual.high_face_margin_on (R := (3 / 200000 : ℝ)) brick
    (by norm_num) (by norm_num)
...
private theorem c3Reduced_derivativeBounds :
    MiddleFaceAssembly.C3Residual.DerivativeBoundsOn brick (3 / 200000 : ℝ) := by
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (25781 / 25000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (103121 / 100000 : ℝ) * (507619 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (25781 / 25000 : ℝ) * (507793 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (53242 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 53262 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (53242 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 53262 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (103121 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
theorem C3_sigma_low_face_margin :
  ...
  rw [hsigma']
  exact MiddleFaceAssembly.C3Residual.low_face_margin_on (R := (3 / 200000 : ℝ)) brick
    (by norm_num) (by norm_num)
...
theorem C3_sigma_high_face_margin :
  ...
  rw [hsigma']
  exact MiddleFaceAssembly.C3Residual.high_face_margin_on (R := (3 / 200000 : ℝ)) brick
    (by norm_num) (by norm_num)
    c3Reduced_derivativeBounds c3Reduced_origin_abs_lt ht' hrho
...
theorem E_rho_low_face_margin :
  ...
  have hrho : z 2 = -(1 / 100000 : ℝ) := by
    norm_num [radiiReal, brick, Matrix.cons_val_two, Matrix.cons_val_three]
      at hrhoFace
    exact hrhoFace
  have h := low_face_margin_on (R := (3 / 200000 : ℝ)) brick
    (by norm_num) (by norm_num) eReduced_deriv_bounds
...
theorem E_rho_high_face_margin :
  ...
  have hrho : z 2 = (1 / 100000 : ℝ) := by
    norm_num [radiiReal, brick, Matrix.cons_val_two, Matrix.cons_val_three]
      at hrhoFace
    exact hrhoFace
  have h := high_face_margin_on (R := (3 / 200000 : ℝ)) brick
    (by norm_num) (by norm_num) eReduced_deriv_bounds
    eReduced_origin_abs_lt ht' hxi heta hsigma
  rw [show E (pointOf t z) = eReduced t (z 0) (z 1) (z 2) (z 3) by rfl,
    hrho]
...
/-- Proof-producing checker instance for inventory brick `B0112`.
...
/-- Sound projection of the B0112 checker instance into the generic
...
/-- Every projected type-(iv) height in B0112 has an equal-area regular
...
/-- Candidate-facing conclusion for B0112.  No stationarity hypothesis is
...
/-- Complete B0112 candidate-facing conclusion.  The checked stationary pair
