...
namespace MiddleFaceCell50

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0050`, spanning `[102501/100000, 102511/100000]`. -/
def brick : Brick where
  lamLo := 102501 / 100000
  lamHi := 102511 / 100000
  centers := ![1950776453433564523 / 10000000000000000000,
    1470748776580434567 / 5000000000000000000,
    4473873976338759509 / 10000000000000000000,
    4959034332469022819 / 10000000000000000000]
  slopes := ![441603036002416299 / 250000000000000000,
    2186223143574135309 / 500000000000000000,
    2607518858328908439 / 500000000000000000,
    6428745120973726149 / 1000000000000000000]
  yXiSlope := 16306197 / 25000000
  vRhoSlope := 11086903 / 12500000
...
/-- Unconditional real-range conclusion for the B0050 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102501 / 100000 : ℝ) ≤ lam → lam ≤ 102511 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19497 / 100000 : ℝ) ≤ q ∧ q ≤ 19518 / 100000) :
    (193737 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (193944 / 1000000 : ℝ) := by
  have hmonoLo : sin (19497 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19518 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19497 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19518 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19497 / 100000 : ℝ) ≤ q ∧ q ≤ 19518 / 100000) :
    (981012 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981054 / 1000000 : ℝ) := by
  have hmonoLo : cos (19518 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19497 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19518 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19497 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29392 / 100000 : ℝ) ≤ q ∧ q ≤ 29438 / 100000) :
    (289706 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (290147 / 1000000 : ℝ) := by
  have hmonoLo : sin (29392 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29438 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29392 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29438 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29392 / 100000 : ℝ) ≤ q ∧ q ≤ 29438 / 100000) :
    (956982 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957116 / 1000000 : ℝ) := by
  have hmonoLo : cos (29438 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29392 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29438 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29392 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44711 / 100000 : ℝ) ≤ q ∧ q ≤ 44766 / 100000) :
    (432361 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (432858 / 1000000 : ℝ) := by
  have hmonoLo : sin (44711 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44766 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44711 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44766 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49557 / 100000 : ℝ) ≤ q ∧ q ≤ 49624 / 100000) :
    (475533 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (476123 / 1000000 : ℝ) := by
  have hmonoLo : sin (49557 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49624 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49557 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49624 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49557 / 100000 : ℝ) ≤ q ∧ q ≤ 49624 / 100000) :
    (879378 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (879698 / 1000000 : ℝ) := by
  have hmonoLo : cos (49624 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49557 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49624 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49557 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19497000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19518000 / 100000000) :
    (19373700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19394400 / 100000000 : ℝ) ∧
      (98101200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98105400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19497000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19518000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19518000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19497000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29392000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29438000 / 100000000) :
    (28970600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29014700 / 100000000 : ℝ) ∧
      (95698200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95711600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29392000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29438000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29438000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29392000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44711000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44766000 / 100000000) :
    (43236100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43285800 / 100000000 : ℝ) ∧
      (90146200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90170100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44711000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44766000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44766000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44711000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49557000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49624000 / 100000000) :
    (47553300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47612300 / 100000000 : ℝ) ∧
      (87937800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87969800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49557000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49624000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49624000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49557000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0050. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102501 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102511 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19497000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19518000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29392000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29438000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44711000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44766000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49557000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49624000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0050 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (497 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 56 / 125, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 497 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (56 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (497 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (56 / 125)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0050 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102501 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102511 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19497 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19518 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29392 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44711 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44766 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49557 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49624 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981054 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19497 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19497 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (901462 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44766 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44766 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (476123 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49624 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49624 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (432361 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44711 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44711 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102511 / 100000 : ℝ) * (49624 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102501 / 100000 : ℝ) * (29392 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16235 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16768 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981054 / 1000000 : ℝ) * (16235 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190146 / 100000 : ℝ) * (16768 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190146 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29392 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29438 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102501 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102511 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102501 / 100000 : ℝ) * (289706 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102511 / 100000 : ℝ) * (290147 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19497 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19518 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29392 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29438 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102501 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102511 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19497 / 100000, 19518 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29392 / 100000, 29438 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102501 / 100000, 102511 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨193737 / 1000000, 193944 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981012 / 1000000, 981054 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨289706 / 1000000, 290147 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956982 / 1000000, 957116 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0050 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0050 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102511 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102501 / 100000 : ℝ) * (475533 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102511 / 100000 : ℝ) * (476123 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49557 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49624 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49557 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49624 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102501 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0050`.
...
/-- Sound projection of the B0050 checker instance into the generic
...
/-- Every projected type-(iv) height in B0050 has an equal-area regular
...
/-- Candidate-facing conclusion for B0050.  No stationarity hypothesis is
...
/-- Complete B0050 candidate-facing conclusion.  The checked stationary pair
