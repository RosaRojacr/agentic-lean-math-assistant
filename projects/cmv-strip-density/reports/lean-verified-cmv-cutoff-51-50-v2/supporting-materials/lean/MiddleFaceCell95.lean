...
namespace MiddleFaceCell95

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0095`, spanning `[102951/100000, 102961/100000]`. -/
def brick : Brick where
  lamLo := 102951 / 100000
  lamHi := 102961 / 100000
  centers := ![2023820028243233869 / 10000000000000000000,
    1564168986158045783 / 5000000000000000000,
    938786415629011817 / 2000000000000000000,
    163492329539121949 / 312500000000000000]
  slopes := ![149331928467170551 / 100000000000000000,
    3950178058875941519 / 1000000000000000000,
    2297165245294623027 / 500000000000000000,
    5724039607390249157 / 1000000000000000000]
  yXiSlope := 31718657 / 50000000
  vRhoSlope := 43968021 / 50000000
...
/-- Unconditional real-range conclusion for the B0095 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102951 / 100000 : ℝ) ≤ lam → lam ≤ 102961 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20229 / 100000 : ℝ) ≤ q ∧ q ≤ 20247 / 100000) :
    (200913 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201090 / 1000000 : ℝ) := by
  have hmonoLo : sin (20229 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20247 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20229 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20247 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20229 / 100000 : ℝ) ≤ q ∧ q ≤ 20247 / 100000) :
    (979572 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979610 / 1000000 : ℝ) := by
  have hmonoLo : cos (20247 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20229 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20247 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20229 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31262 / 100000 : ℝ) ≤ q ∧ q ≤ 31304 / 100000) :
    (307552 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (307953 / 1000000 : ℝ) := by
  have hmonoLo : sin (31262 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31304 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31262 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31304 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31262 / 100000 : ℝ) ≤ q ∧ q ≤ 31304 / 100000) :
    (951401 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951532 / 1000000 : ℝ) := by
  have hmonoLo : cos (31304 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31262 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31304 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31262 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46915 / 100000 : ℝ) ≤ q ∧ q ≤ 46964 / 100000) :
    (452128 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (452566 / 1000000 : ℝ) := by
  have hmonoLo : sin (46915 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46964 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46915 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46964 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52287 / 100000 : ℝ) ≤ q ∧ q ≤ 52348 / 100000) :
    (499368 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (499898 / 1000000 : ℝ) := by
  have hmonoLo : sin (52287 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52348 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52287 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52348 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52287 / 100000 : ℝ) ≤ q ∧ q ≤ 52348 / 100000) :
    (866084 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (866390 / 1000000 : ℝ) := by
  have hmonoLo : cos (52348 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52287 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52348 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52287 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20229000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20247000 / 100000000) :
    (20091300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20109000 / 100000000 : ℝ) ∧
      (97957200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97961000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20229000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20247000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20247000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20229000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31262000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31304000 / 100000000) :
    (30755200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30795300 / 100000000 : ℝ) ∧
      (95140100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95153200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31262000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31304000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31304000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31262000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46915000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46964000 / 100000000) :
    (45212800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45256600 / 100000000 : ℝ) ∧
      (89173100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89195300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46915000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46964000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46964000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46915000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52287000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52348000 / 100000000) :
    (49936800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49989800 / 100000000 : ℝ) ∧
      (86608400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86639000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52287000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52348000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52348000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52287000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0095. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102951 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102961 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20229000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20247000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31262000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31304000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46915000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46964000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52287000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52348000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0095 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 131 / 250, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (131 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0095 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102951 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102961 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20229 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20247 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31262 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46915 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46964 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52287 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52348 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979610 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20229 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20229 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (891731 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46964 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46964 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (499898 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52348 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52348 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (452128 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46915 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46915 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102961 / 100000 : ℝ) * (52348 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102951 / 100000 : ℝ) * (31262 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16296 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16901 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979610 / 1000000 : ℝ) * (16296 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189173 / 100000 : ℝ) * (16901 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189173 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31262 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31304 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102951 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102961 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102951 / 100000 : ℝ) * (307552 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102961 / 100000 : ℝ) * (307953 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20229 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20247 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31262 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31304 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102951 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102961 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20229 / 100000, 20247 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31262 / 100000, 31304 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102951 / 100000, 102961 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200913 / 1000000, 201090 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979572 / 1000000, 979610 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨307552 / 1000000, 307953 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951401 / 1000000, 951532 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0095 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0095 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102961 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102951 / 100000 : ℝ) * (499368 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102961 / 100000 : ℝ) * (499898 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52287 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52348 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52287 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52348 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102951 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0095`.
...
/-- Sound projection of the B0095 checker instance into the generic
...
/-- Every projected type-(iv) height in B0095 has an equal-area regular
...
/-- Candidate-facing conclusion for B0095.  No stationarity hypothesis is
...
/-- Complete B0095 candidate-facing conclusion.  The checked stationary pair
