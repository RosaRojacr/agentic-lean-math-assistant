...
namespace MiddleFaceCell42

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0042`, spanning `[102421/100000, 102431/100000]`. -/
def brick : Brick where
  lamLo := 102421 / 100000
  lamHi := 102431 / 100000
  centers := ![484103951120162179 / 2500000000000000000,
    181635557443580961 / 625000000000000000,
    4431636008390278811 / 10000000000000000000,
    4907019522147695297 / 10000000000000000000]
  slopes := ![912147912943082177 / 500000000000000000,
    4460464187890253799 / 1000000000000000000,
    5345635646313395339 / 1000000000000000000,
    3288125588110377381 / 500000000000000000]
  yXiSlope := 65566291 / 100000000
  vRhoSlope := 1388089 / 1562500
...
/-- Unconditional real-range conclusion for the B0042 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102421 / 100000 : ℝ) ≤ lam → lam ≤ 102431 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19354 / 100000 : ℝ) ≤ q ∧ q ≤ 19375 / 100000) :
    (192333 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (192541 / 1000000 : ℝ) := by
  have hmonoLo : sin (19354 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19375 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19354 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19375 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19354 / 100000 : ℝ) ≤ q ∧ q ≤ 19375 / 100000) :
    (981289 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981330 / 1000000 : ℝ) := by
  have hmonoLo : cos (19375 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19354 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19375 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19354 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29038 / 100000 : ℝ) ≤ q ∧ q ≤ 29085 / 100000) :
    (286316 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (286767 / 1000000 : ℝ) := by
  have hmonoLo : sin (29038 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29085 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29038 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29085 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29038 / 100000 : ℝ) ≤ q ∧ q ≤ 29085 / 100000) :
    (958000 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958136 / 1000000 : ℝ) := by
  have hmonoLo : cos (29085 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29038 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29085 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29038 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44288 / 100000 : ℝ) ≤ q ∧ q ≤ 44345 / 100000) :
    (428543 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (429059 / 1000000 : ℝ) := by
  have hmonoLo : sin (44288 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44345 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44288 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44345 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49036 / 100000 : ℝ) ≤ q ∧ q ≤ 49105 / 100000) :
    (470943 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (471553 / 1000000 : ℝ) := by
  have hmonoLo : sin (49036 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49105 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49036 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49105 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49036 / 100000 : ℝ) ≤ q ∧ q ≤ 49105 / 100000) :
    (881838 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (882164 / 1000000 : ℝ) := by
  have hmonoLo : cos (49105 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49036 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49105 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49036 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19354000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19375000 / 100000000) :
    (19233300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19254100 / 100000000 : ℝ) ∧
      (98128900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98133000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19354000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19375000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19375000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19354000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29038000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29085000 / 100000000) :
    (28631600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28676700 / 100000000 : ℝ) ∧
      (95800000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95813600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29038000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29085000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29085000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29038000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44288000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44345000 / 100000000) :
    (42854300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42905900 / 100000000 : ℝ) ∧
      (90327600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90352200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44288000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44345000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44345000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44288000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49036000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49105000 / 100000000) :
    (47094300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47155300 / 100000000 : ℝ) ∧
      (88183800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88216400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49036000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49105000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49105000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49036000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0042. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102421 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102431 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19354000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19375000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29038000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29085000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44288000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44345000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49036000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49105000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0042 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 123 / 250, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (123 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0042 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102421 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102431 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19354 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19375 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29038 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44288 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44345 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49036 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49105 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981330 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19354 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19354 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (903276 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44345 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44345 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (471553 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49105 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49105 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (428543 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44288 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44288 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102431 / 100000 : ℝ) * (49105 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102421 / 100000 : ℝ) * (29038 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16224 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16744 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981330 / 1000000 : ℝ) * (16224 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190327 / 100000 : ℝ) * (16744 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190327 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29038 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29085 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102421 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102431 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102421 / 100000 : ℝ) * (286316 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102431 / 100000 : ℝ) * (286767 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19354 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19375 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29038 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29085 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102421 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102431 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19354 / 100000, 19375 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29038 / 100000, 29085 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102421 / 100000, 102431 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨192333 / 1000000, 192541 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981289 / 1000000, 981330 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨286316 / 1000000, 286767 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958000 / 1000000, 958136 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0042 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0042 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102431 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102421 / 100000 : ℝ) * (470943 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102431 / 100000 : ℝ) * (471553 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49036 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49105 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49036 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49105 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102421 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0042`.
...
/-- Sound projection of the B0042 checker instance into the generic
...
/-- Every projected type-(iv) height in B0042 has an equal-area regular
...
/-- Candidate-facing conclusion for B0042.  No stationarity hypothesis is
...
/-- Complete B0042 candidate-facing conclusion.  The checked stationary pair
