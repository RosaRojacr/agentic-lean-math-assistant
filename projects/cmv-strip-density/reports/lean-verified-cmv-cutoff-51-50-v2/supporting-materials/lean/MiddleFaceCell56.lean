...
namespace MiddleFaceCell56

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0056`, spanning `[102561/100000, 102571/100000]`. -/
def brick : Brick where
  lamLo := 102561 / 100000
  lamHi := 102571 / 100000
  centers := ![1961250160897670641 / 10000000000000000000,
    741885435247652491 / 2500000000000000000,
    563110276186755427 / 1250000000000000000,
    999457579825594987 / 2000000000000000000]
  slopes := ![431276122335761677 / 250000000000000000,
    538667228202397841 / 125000000000000000,
    5121648521455272619 / 1000000000000000000,
    6323110854990496019 / 1000000000000000000]
  yXiSlope := 203043 / 312500
  vRhoSlope := 88589979 / 100000000
...
/-- Unconditional real-range conclusion for the B0056 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102561 / 100000 : ℝ) ≤ lam → lam ≤ 102571 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19602 / 100000 : ℝ) ≤ q ∧ q ≤ 19623 / 100000) :
    (194767 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (194974 / 1000000 : ℝ) := by
  have hmonoLo : sin (19602 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19623 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19602 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19623 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19602 / 100000 : ℝ) ≤ q ∧ q ≤ 19623 / 100000) :
    (980808 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980850 / 1000000 : ℝ) := by
  have hmonoLo : cos (19623 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19602 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19623 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19602 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29653 / 100000 : ℝ) ≤ q ∧ q ≤ 29698 / 100000) :
    (292203 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (292634 / 1000000 : ℝ) := by
  have hmonoLo : sin (29653 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29698 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29653 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29698 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29653 / 100000 : ℝ) ≤ q ∧ q ≤ 29698 / 100000) :
    (956224 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956357 / 1000000 : ℝ) := by
  have hmonoLo : cos (29698 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29653 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29698 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29653 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45022 / 100000 : ℝ) ≤ q ∧ q ≤ 45076 / 100000) :
    (435163 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (435650 / 1000000 : ℝ) := by
  have hmonoLo : sin (45022 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45076 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45022 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45076 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49940 / 100000 : ℝ) ≤ q ∧ q ≤ 50006 / 100000) :
    (478898 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (479479 / 1000000 : ℝ) := by
  have hmonoLo : sin (49940 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50006 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49940 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50006 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49940 / 100000 : ℝ) ≤ q ∧ q ≤ 50006 / 100000) :
    (877553 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (877871 / 1000000 : ℝ) := by
  have hmonoLo : cos (50006 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49940 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50006 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49940 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19602000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19623000 / 100000000) :
    (19476700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19497400 / 100000000 : ℝ) ∧
      (98080800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98085000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19602000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19623000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19623000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19602000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29653000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29698000 / 100000000) :
    (29220300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29263400 / 100000000 : ℝ) ∧
      (95622400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95635700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29653000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29698000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29698000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29653000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45022000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45076000 / 100000000) :
    (43516300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43565000 / 100000000 : ℝ) ∧
      (90011600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90035200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45022000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45076000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45076000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45022000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49940000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50006000 / 100000000) :
    (47889800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47947900 / 100000000 : ℝ) ∧
      (87755300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87787100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49940000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50006000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50006000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49940000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0056. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102561 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102571 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19602000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19623000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29653000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29698000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45022000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45076000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49940000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50006000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0056 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 501 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (501 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0056 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102561 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102571 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19602 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19623 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29653 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45022 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45076 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49940 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50006 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980850 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19602 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19602 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (900116 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45076 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45076 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (479479 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50006 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50006 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (435163 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45022 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45022 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102571 / 100000 : ℝ) * (50006 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102561 / 100000 : ℝ) * (29653 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16244 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16786 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980850 / 1000000 : ℝ) * (16244 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190011 / 100000 : ℝ) * (16786 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190011 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29653 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29698 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102561 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102571 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102561 / 100000 : ℝ) * (292203 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102571 / 100000 : ℝ) * (292634 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19602 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19623 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29653 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29698 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102561 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102571 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19602 / 100000, 19623 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29653 / 100000, 29698 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102561 / 100000, 102571 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨194767 / 1000000, 194974 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980808 / 1000000, 980850 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨292203 / 1000000, 292634 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956224 / 1000000, 956357 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0056 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0056 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102571 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102561 / 100000 : ℝ) * (478898 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102571 / 100000 : ℝ) * (479479 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49940 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50006 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49940 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50006 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102561 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0056`.
...
/-- Sound projection of the B0056 checker instance into the generic
...
/-- Every projected type-(iv) height in B0056 has an equal-area regular
...
/-- Candidate-facing conclusion for B0056.  No stationarity hypothesis is
...
/-- Complete B0056 candidate-facing conclusion.  The checked stationary pair
