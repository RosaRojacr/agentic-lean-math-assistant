...
cd "$here"
source="$here/lean-verified-cmv-cutoff.md"
style="$here/lean-verified-cmv-cutoff.css"
html="$here/lean-verified-cmv-cutoff.html"
pdf="$here/lean-verified-cmv-cutoff.pdf"
...
pandoc "$source" \
  ...
  --mathml \
  --css="$style" \
  --metadata title-prefix="Lean-verified CMV cutoff" \
  --output="$html"
