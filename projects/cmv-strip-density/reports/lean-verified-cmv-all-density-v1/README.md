# A Lean-Verified All-Density Exclusion for CMV Four-Arc Minimizers
...
primary declaration is `CMVSuffixModel.FourArcCandidate.not_isWeightedPerimeterMinimizer_of_density_gt_one`. A successful Lean build establishes
