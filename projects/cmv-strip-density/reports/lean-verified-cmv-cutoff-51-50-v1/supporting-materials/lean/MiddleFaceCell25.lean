...
namespace MiddleFaceCell25

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0025`, spanning `[102251/100000, 102261/100000]`. -/
def brick : Brick where
  lamLo := 102251 / 100000
  lamHi := 102261 / 100000
  centers := ![952139967739272759 / 5000000000000000000,
    2828644947530113413 / 10000000000000000000,
    2169117023157277483 / 5000000000000000000,
    2396187973278758333 / 5000000000000000000]
  slopes := ![979636806070856351 / 500000000000000000,
    4663946600149037419 / 1000000000000000000,
    5649050985782358891 / 1000000000000000000,
    6918027140884631739 / 1000000000000000000]
  yXiSlope := 33159853 / 50000000
  vRhoSlope := 44574591 / 50000000
...
/-- Unconditional real-range conclusion for the B0025 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102251 / 100000 : ℝ) ≤ lam → lam ≤ 102261 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19032 / 100000 : ℝ) ≤ q ∧ q ≤ 19054 / 100000) :
    (189173 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (189390 / 1000000 : ℝ) := by
  have hmonoLo : sin (19032 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19054 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19032 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19054 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19032 / 100000 : ℝ) ≤ q ∧ q ≤ 19054 / 100000) :
    (981902 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981944 / 1000000 : ℝ) := by
  have hmonoLo : cos (19054 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19032 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19054 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19032 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28262 / 100000 : ℝ) ≤ q ∧ q ≤ 28311 / 100000) :
    (278872 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (279344 / 1000000 : ℝ) := by
  have hmonoLo : sin (28262 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28311 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28262 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28311 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28262 / 100000 : ℝ) ≤ q ∧ q ≤ 28311 / 100000) :
    (960191 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960329 / 1000000 : ℝ) := by
  have hmonoLo : cos (28311 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28262 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28311 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28262 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43353 / 100000 : ℝ) ≤ q ∧ q ≤ 43412 / 100000) :
    (420076 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (420613 / 1000000 : ℝ) := by
  have hmonoLo : sin (43353 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43412 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43353 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43412 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47888 / 100000 : ℝ) ≤ q ∧ q ≤ 47960 / 100000) :
    (460785 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (461425 / 1000000 : ℝ) := by
  have hmonoLo : sin (47888 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47960 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47888 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47960 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47888 / 100000 : ℝ) ≤ q ∧ q ≤ 47960 / 100000) :
    (887179 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (887512 / 1000000 : ℝ) := by
  have hmonoLo : cos (47960 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47888 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47960 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47888 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19032000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19054000 / 100000000) :
    (18917300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18939000 / 100000000 : ℝ) ∧
      (98190200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98194400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19032000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19054000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19054000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19032000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28262000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28311000 / 100000000) :
    (27887200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27934400 / 100000000 : ℝ) ∧
      (96019100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96032900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28262000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28311000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28311000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28262000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43353000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43412000 / 100000000) :
    (42007600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42061300 / 100000000 : ℝ) ∧
      (90724000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90748900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43353000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43412000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43412000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43353000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47888000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47960000 / 100000000) :
    (46078500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46142500 / 100000000 : ℝ) ∧
      (88717900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88751200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47888000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47960000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47960000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47888000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0025. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102251 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102261 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19032000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19054000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28262000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28311000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43353000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43412000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47888000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47960000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0025 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 12 / 25, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (12 / 25)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0025 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102251 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102261 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19032 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19054 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28262 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43353 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43412 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47888 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47960 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981944 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19032 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19032 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (907240 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43412 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43412 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (461425 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47960 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47960 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (420076 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43353 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43353 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102261 / 100000 : ℝ) * (47960 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102251 / 100000 : ℝ) * (28262 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16200 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16692 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981944 / 1000000 : ℝ) * (16200 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190723 / 100000 : ℝ) * (16692 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190723 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28262 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28311 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102251 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102261 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102251 / 100000 : ℝ) * (278872 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102261 / 100000 : ℝ) * (279344 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19032 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19054 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28262 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28311 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102251 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102261 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19032 / 100000, 19054 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28262 / 100000, 28311 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102251 / 100000, 102261 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨189173 / 1000000, 189390 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981902 / 1000000, 981944 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨278872 / 1000000, 279344 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960191 / 1000000, 960329 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0025 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0025 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102261 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102251 / 100000 : ℝ) * (460785 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102261 / 100000 : ℝ) * (461425 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47888 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47960 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47888 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47960 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102251 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0025`.
...
/-- Sound projection of the B0025 checker instance into the generic
...
/-- Every projected type-(iv) height in B0025 has an equal-area regular
...
/-- Candidate-facing conclusion for B0025.  No stationarity hypothesis is
...
/-- Complete B0025 candidate-facing conclusion.  The checked stationary pair
