...
namespace MiddleFaceCell37

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0037`, spanning `[102371/100000, 102381/100000]`. -/
def brick : Brick where
  lamLo := 102371 / 100000
  lamHi := 102381 / 100000
  centers := ![1927200073000412237 / 10000000000000000000,
    1441861913910226521 / 5000000000000000000,
    4404695528238794137 / 10000000000000000000,
    2436949382531825279 / 5000000000000000000]
  slopes := ![186222037539173657 / 100000000000000000,
    564734938539565587 / 125000000000000000,
    678880000893771273 / 125000000000000000,
    3336290357047882881 / 500000000000000000]
  yXiSlope := 1315677 / 2000000
  vRhoSlope := 2223201 / 2500000
...
/-- Unconditional real-range conclusion for the B0037 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102371 / 100000 : ℝ) ≤ lam → lam ≤ 102381 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19261 / 100000 : ℝ) ≤ q ∧ q ≤ 19283 / 100000) :
    (191421 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (191638 / 1000000 : ℝ) := by
  have hmonoLo : sin (19261 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19283 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19261 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19283 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19261 / 100000 : ℝ) ≤ q ∧ q ≤ 19283 / 100000) :
    (981465 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981508 / 1000000 : ℝ) := by
  have hmonoLo : cos (19283 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19261 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19283 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19261 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28813 / 100000 : ℝ) ≤ q ∧ q ≤ 28861 / 100000) :
    (284159 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (284620 / 1000000 : ℝ) := by
  have hmonoLo : sin (28813 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28861 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28813 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28861 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28813 / 100000 : ℝ) ≤ q ∧ q ≤ 28861 / 100000) :
    (958640 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958777 / 1000000 : ℝ) := by
  have hmonoLo : cos (28861 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28813 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28861 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28813 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44018 / 100000 : ℝ) ≤ q ∧ q ≤ 44076 / 100000) :
    (426102 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (426627 / 1000000 : ℝ) := by
  have hmonoLo : sin (44018 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44076 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44018 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44076 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48704 / 100000 : ℝ) ≤ q ∧ q ≤ 48774 / 100000) :
    (468012 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (468631 / 1000000 : ℝ) := by
  have hmonoLo : sin (48704 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48774 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48704 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48774 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48704 / 100000 : ℝ) ≤ q ∧ q ≤ 48774 / 100000) :
    (883394 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (883723 / 1000000 : ℝ) := by
  have hmonoLo : cos (48774 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48704 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48774 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48704 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19261000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19283000 / 100000000) :
    (19142100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19163800 / 100000000 : ℝ) ∧
      (98146500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98150800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19261000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19283000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19283000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19261000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28813000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28861000 / 100000000) :
    (28415900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28462000 / 100000000 : ℝ) ∧
      (95864000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95877700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28813000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28861000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28861000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28813000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44018000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44076000 / 100000000) :
    (42610200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42662700 / 100000000 : ℝ) ∧
      (90442700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90467500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44018000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44076000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44076000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44018000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48704000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48774000 / 100000000) :
    (46801200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46863100 / 100000000 : ℝ) ∧
      (88339400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88372300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48704000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48774000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48774000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48704000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0037. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102371 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102381 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19261000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19283000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28813000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28861000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44018000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44076000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48704000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48774000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0037 brick. -/
...
throughout the B0037 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102371 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102381 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19261 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19283 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28813 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44018 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44076 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48704 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48774 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981508 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19261 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19261 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (904427 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44076 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44076 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (468631 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48774 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48774 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (426102 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44018 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44018 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102381 / 100000 : ℝ) * (48774 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102371 / 100000 : ℝ) * (28813 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16217 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16729 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981508 / 1000000 : ℝ) * (16217 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190442 / 100000 : ℝ) * (16729 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190442 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28813 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28861 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102371 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102381 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102371 / 100000 : ℝ) * (284159 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102381 / 100000 : ℝ) * (284620 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19261 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19283 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28813 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28861 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102371 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102381 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19261 / 100000, 19283 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28813 / 100000, 28861 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102371 / 100000, 102381 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨191421 / 1000000, 191638 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981465 / 1000000, 981508 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨284159 / 1000000, 284620 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨958640 / 1000000, 958777 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0037 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0037 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102381 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102371 / 100000 : ℝ) * (468012 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102381 / 100000 : ℝ) * (468631 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48704 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48774 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48704 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48774 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102371 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0037`.
...
/-- Sound projection of the B0037 checker instance into the generic
...
/-- Every projected type-(iv) height in B0037 has an equal-area regular
...
/-- Candidate-facing conclusion for B0037.  No stationarity hypothesis is
...
/-- Complete B0037 candidate-facing conclusion.  The checked stationary pair
