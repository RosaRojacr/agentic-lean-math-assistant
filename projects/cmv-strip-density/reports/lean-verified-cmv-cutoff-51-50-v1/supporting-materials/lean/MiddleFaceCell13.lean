...
namespace MiddleFaceCell13

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0013`, spanning `[102131/100000, 102141/100000]`. -/
def brick : Brick where
  lamLo := 102131 / 100000
  lamHi := 102141 / 100000
  centers := ![1880139149206905893 / 10000000000000000000,
    110869471305200919 / 400000000000000000,
    106725888352633371 / 250000000000000000,
    941555153705541609 / 2000000000000000000]
  slopes := ![2065892007623649537 / 1000000000000000000,
    602882712254932187 / 125000000000000000,
    2943851081287083007 / 500000000000000000,
    3593001099865506079 / 500000000000000000]
  yXiSlope := 33438177 / 50000000
  vRhoSlope := 44688427 / 50000000
...
/-- Unconditional real-range conclusion for the B0013 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102131 / 100000 : ℝ) ≤ lam → lam ≤ 102141 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18790 / 100000 : ℝ) ≤ q ∧ q ≤ 18813 / 100000) :
    (186796 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (187023 / 1000000 : ℝ) := by
  have hmonoLo : sin (18790 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18813 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18790 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18813 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18790 / 100000 : ℝ) ≤ q ∧ q ≤ 18813 / 100000) :
    (982355 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982399 / 1000000 : ℝ) := by
  have hmonoLo : cos (18813 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18790 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18813 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18790 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27692 / 100000 : ℝ) ≤ q ∧ q ≤ 27743 / 100000) :
    (273394 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (273885 / 1000000 : ℝ) := by
  have hmonoLo : sin (27692 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27743 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27692 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27743 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27692 / 100000 : ℝ) ≤ q ∧ q ≤ 27743 / 100000) :
    (961762 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961903 / 1000000 : ℝ) := by
  have hmonoLo : cos (27743 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27692 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27743 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27692 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42659 / 100000 : ℝ) ≤ q ∧ q ≤ 42721 / 100000) :
    (413768 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (414334 / 1000000 : ℝ) := by
  have hmonoLo : sin (42659 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42721 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42659 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42721 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47040 / 100000 : ℝ) ≤ q ∧ q ≤ 47115 / 100000) :
    (453242 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (453912 / 1000000 : ℝ) := by
  have hmonoLo : sin (47040 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47115 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47040 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47115 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47040 / 100000 : ℝ) ≤ q ∧ q ≤ 47115 / 100000) :
    (891046 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (891388 / 1000000 : ℝ) := by
  have hmonoLo : cos (47115 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47040 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47115 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47040 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18790000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18813000 / 100000000) :
    (18679600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18702300 / 100000000 : ℝ) ∧
      (98235500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98239900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18790000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18813000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18813000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18790000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27692000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27743000 / 100000000) :
    (27339400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27388500 / 100000000 : ℝ) ∧
      (96176200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96190300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27692000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27743000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27743000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27692000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42659000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42721000 / 100000000) :
    (41376800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41433400 / 100000000 : ℝ) ∧
      (91012500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91038200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42659000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42721000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42721000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42659000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47040000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47115000 / 100000000) :
    (45324200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45391200 / 100000000 : ℝ) ∧
      (89104600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89138800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47040000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47115000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47115000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47040000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0013. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102131 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102141 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18790000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18813000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27692000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27743000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42659000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42721000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47040000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47115000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0013 brick. -/
...
B0013 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0013 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102131 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102141 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18790 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18813 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27692 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42659 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42721 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47040 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47115 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982399 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18790 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18790 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (910125 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42721 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42721 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (453912 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47115 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47115 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (413768 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42659 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42659 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102141 / 100000 : ℝ) * (47115 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102131 / 100000 : ℝ) * (27692 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16182 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16654 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982399 / 1000000 : ℝ) * (16182 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191012 / 100000 : ℝ) * (16654 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191012 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27692 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27743 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102131 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102141 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102131 / 100000 : ℝ) * (273394 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102141 / 100000 : ℝ) * (273885 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18790 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18813 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27692 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27743 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102131 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102141 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18790 / 100000, 18813 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27692 / 100000, 27743 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102131 / 100000, 102141 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨186796 / 1000000, 187023 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982355 / 1000000, 982399 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨273394 / 1000000, 273885 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨961762 / 1000000, 961903 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0013 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0013 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102141 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102131 / 100000 : ℝ) * (453242 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102141 / 100000 : ℝ) * (453912 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47040 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47115 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47040 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47115 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102131 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0013`.
...
/-- Sound projection of the B0013 checker instance into the generic
...
/-- Every projected type-(iv) height in B0013 has an equal-area regular
...
/-- Candidate-facing conclusion for B0013.  No stationarity hypothesis is
...
/-- Complete B0013 candidate-facing conclusion.  The checked stationary pair
