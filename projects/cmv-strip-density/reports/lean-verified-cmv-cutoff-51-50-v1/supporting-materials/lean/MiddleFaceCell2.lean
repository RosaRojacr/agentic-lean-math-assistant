...
namespace MiddleFaceCell2

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0002`, spanning `[102021/100000, 102031/100000]`. -/
def brick : Brick where
  lamLo := 102021 / 100000
  lamHi := 102031 / 100000
  centers := ![371366493740953841 / 2000000000000000000,
    67945518329479253 / 250000000000000000,
    4202972098330581939 / 10000000000000000000,
    4627274627533680317 / 10000000000000000000]
  slopes := ![271667443282949147 / 125000000000000000,
    4982092405509436517 / 1000000000000000000,
    6127389661068726023 / 1000000000000000000,
    745444165915003771 / 100000000000000000]
  yXiSlope := 67406589 / 100000000
  vRhoSlope := 89591811 / 100000000
...
/-- Unconditional real-range conclusion for the B0002 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102021 / 100000 : ℝ) ≤ lam → lam ≤ 102031 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18556 / 100000 : ℝ) ≤ q ∧ q ≤ 18581 / 100000) :
    (184496 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (184743 / 1000000 : ℝ) := by
  have hmonoLo : sin (18556 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18581 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18556 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18581 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18556 / 100000 : ℝ) ≤ q ∧ q ≤ 18581 / 100000) :
    (982786 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982834 / 1000000 : ℝ) := by
  have hmonoLo : cos (18581 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18556 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18581 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18556 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27152 / 100000 : ℝ) ≤ q ∧ q ≤ 27204 / 100000) :
    (268196 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (268697 / 1000000 : ℝ) := by
  have hmonoLo : sin (27152 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27204 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27152 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27204 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27152 / 100000 : ℝ) ≤ q ∧ q ≤ 27204 / 100000) :
    (963224 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (963365 / 1000000 : ℝ) := by
  have hmonoLo : cos (27204 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27152 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27204 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27152 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (41998 / 100000 : ℝ) ≤ q ∧ q ≤ 42062 / 100000) :
    (407742 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (408327 / 1000000 : ℝ) := by
  have hmonoLo : sin (41998 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42062 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (41998 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42062 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46234 / 100000 : ℝ) ≤ q ∧ q ≤ 46312 / 100000) :
    (446043 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (446742 / 1000000 : ℝ) := by
  have hmonoLo : sin (46234 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46312 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46234 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46312 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46234 / 100000 : ℝ) ≤ q ∧ q ≤ 46312 / 100000) :
    (894663 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (895012 / 1000000 : ℝ) := by
  have hmonoLo : cos (46312 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46234 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46312 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46234 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18556000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18581000 / 100000000) :
    (18449600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18474300 / 100000000 : ℝ) ∧
      (98278600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98283400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18556000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18581000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18581000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18556000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27152000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27204000 / 100000000) :
    (26819600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (26869700 / 100000000 : ℝ) ∧
      (96322400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96336500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27152000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27204000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27204000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27152000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (41998000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42062000 / 100000000) :
    (40774200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (40832700 / 100000000 : ℝ) ∧
      (91283500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91309800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (41998000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42062000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42062000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (41998000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46234000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46312000 / 100000000) :
    (44604300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44674200 / 100000000 : ℝ) ∧
      (89466300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89501200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46234000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46312000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46312000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46234000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0002. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102021 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102031 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18556000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18581000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27152000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27204000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (41998000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42062000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46234000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46312000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0002 brick. -/
...
B0002 cell.  Coarse rational ranges suffice, but every trigonometric
...
theorem descendingK3 :
  ...
  have hvHi : v p ≤ (47 / 100 : ℝ) := by
    ...
    linarith
  have hwI :
      (⟨2 / 5, 421 / 1000, by norm_num⟩ : QInterval).RealContains (w p) := by
  ...
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (421 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (421 / 1000)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0002 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102021 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102031 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18556 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18581 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27152 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (41998 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42062 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46234 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46312 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982834 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18556 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18556 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (912835 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42062 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42062 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (446742 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46312 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46312 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (407742 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (41998 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (41998 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102031 / 100000 : ℝ) * (46312 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102021 / 100000 : ℝ) * (27152 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16166 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16619 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982834 / 1000000 : ℝ) * (16166 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191283 / 100000 : ℝ) * (16619 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191283 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27152 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27204 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102021 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102031 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102021 / 100000 : ℝ) * (268196 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102031 / 100000 : ℝ) * (268697 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18556 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18581 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27152 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27204 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102021 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102031 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18556 / 100000, 18581 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27152 / 100000, 27204 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102021 / 100000, 102031 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨184496 / 1000000, 184743 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982786 / 1000000, 982834 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨268196 / 1000000, 268697 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨963224 / 1000000, 963365 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0002 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0002 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102031 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102021 / 100000 : ℝ) * (446043 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102031 / 100000 : ℝ) * (446742 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46234 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46312 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46234 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46312 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102021 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0002`.
...
/-- Sound projection of the B0002 checker instance into the generic
...
/-- Every projected type-(iv) height in B0002 has an equal-area regular
...
/-- Candidate-facing conclusion for B0002.  No stationarity hypothesis is
...
/-- Complete B0002 candidate-facing conclusion.  The checked stationary pair
