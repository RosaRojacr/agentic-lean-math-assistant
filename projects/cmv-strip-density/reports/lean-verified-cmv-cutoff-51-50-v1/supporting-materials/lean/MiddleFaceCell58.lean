...
namespace MiddleFaceCell58

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0058`, spanning `[102581/100000, 102591/100000]`. -/
def brick : Brick where
  lamLo := 102581 / 100000
  lamHi := 102591 / 100000
  centers := ![1964686955908941701 / 10000000000000000000,
    2976139871888203151 / 10000000000000000000,
    2257547573401866367 / 5000000000000000000,
    1252474938428938197 / 2500000000000000000]
  slopes := ![427928395038886487 / 250000000000000000,
    2144412501694842147 / 500000000000000000,
    1272834696226648137 / 250000000000000000,
    3144399287212694311 / 500000000000000000]
  yXiSlope := 64891021 / 100000000
  vRhoSlope := 44277597 / 50000000
...
/-- Unconditional real-range conclusion for the B0058 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102581 / 100000 : ℝ) ≤ lam → lam ≤ 102591 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19637 / 100000 : ℝ) ≤ q ∧ q ≤ 19657 / 100000) :
    (195110 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (195307 / 1000000 : ℝ) := by
  have hmonoLo : sin (19637 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19657 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19637 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19657 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19637 / 100000 : ℝ) ≤ q ∧ q ≤ 19657 / 100000) :
    (980742 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980782 / 1000000 : ℝ) := by
  have hmonoLo : cos (19657 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19637 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19657 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19637 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29739 / 100000 : ℝ) ≤ q ∧ q ≤ 29784 / 100000) :
    (293025 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (293456 / 1000000 : ℝ) := by
  have hmonoLo : sin (29739 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29784 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29739 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29784 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29739 / 100000 : ℝ) ≤ q ∧ q ≤ 29784 / 100000) :
    (955972 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956105 / 1000000 : ℝ) := by
  have hmonoLo : cos (29784 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29739 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29784 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29739 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45124 / 100000 : ℝ) ≤ q ∧ q ≤ 45178 / 100000) :
    (436081 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (436568 / 1000000 : ℝ) := by
  have hmonoLo : sin (45124 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45178 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45124 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45178 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50066 / 100000 : ℝ) ≤ q ∧ q ≤ 50132 / 100000) :
    (480004 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (480584 / 1000000 : ℝ) := by
  have hmonoLo : sin (50066 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50132 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50066 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50132 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50066 / 100000 : ℝ) ≤ q ∧ q ≤ 50132 / 100000) :
    (876948 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (877266 / 1000000 : ℝ) := by
  have hmonoLo : cos (50132 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50066 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50132 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50066 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19637000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19657000 / 100000000) :
    (19511000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19530700 / 100000000 : ℝ) ∧
      (98074200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98078200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19637000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19657000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19657000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19637000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29739000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29784000 / 100000000) :
    (29302500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29345600 / 100000000 : ℝ) ∧
      (95597200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95610500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29739000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29784000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29784000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29739000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45124000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45178000 / 100000000) :
    (43608100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43656800 / 100000000 : ℝ) ∧
      (89967100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89990800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45124000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45178000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45178000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45124000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50066000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50132000 / 100000000) :
    (48000400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48058400 / 100000000 : ℝ) ∧
      (87694800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87726600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50066000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50132000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50132000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50066000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0058. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102581 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102591 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19637000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19657000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29739000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29784000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45124000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45178000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50066000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50132000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0058 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (251 / 500 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 113 / 250, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 251 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (113 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (251 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (113 / 250)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0058 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102581 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102591 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19637 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19657 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29739 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45124 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45178 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50066 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50132 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980782 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19637 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19637 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (899671 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45178 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45178 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (480584 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50132 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50132 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (436081 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45124 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45124 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102591 / 100000 : ℝ) * (50132 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102581 / 100000 : ℝ) * (29739 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16246 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16792 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980782 / 1000000 : ℝ) * (16246 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189967 / 100000 : ℝ) * (16792 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189967 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29739 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29784 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102581 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102591 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102581 / 100000 : ℝ) * (293025 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102591 / 100000 : ℝ) * (293456 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19637 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19657 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29739 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29784 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102581 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102591 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19637 / 100000, 19657 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29739 / 100000, 29784 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102581 / 100000, 102591 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨195110 / 1000000, 195307 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980742 / 1000000, 980782 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨293025 / 1000000, 293456 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨955972 / 1000000, 956105 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0058 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0058 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102591 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102581 / 100000 : ℝ) * (480004 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102591 / 100000 : ℝ) * (480584 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50066 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50132 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50066 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50132 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102581 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0058`.
...
/-- Sound projection of the B0058 checker instance into the generic
...
/-- Every projected type-(iv) height in B0058 has an equal-area regular
...
/-- Candidate-facing conclusion for B0058.  No stationarity hypothesis is
...
/-- Complete B0058 candidate-facing conclusion.  The checked stationary pair
