...
namespace MiddleFaceCell26

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0026`, spanning `[102261/100000, 102271/100000]`. -/
def brick : Brick where
  lamLo := 102261 / 100000
  lamHi := 102271 / 100000
  centers := ![1906234992081223289 / 10000000000000000000,
    113332102852794647 / 400000000000000000,
    135746051239822517 / 312500000000000000,
    4799283338432710641 / 10000000000000000000]
  slopes := ![39016791864276607 / 20000000000000000,
    4651300979356488061 / 1000000000000000000,
    1126027146749759433 / 200000000000000000,
    6896756609503318919 / 1000000000000000000]
  yXiSlope := 66274283 / 100000000
  vRhoSlope := 5570657 / 6250000
...
/-- Unconditional real-range conclusion for the B0026 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102261 / 100000 : ℝ) ≤ lam → lam ≤ 102271 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19051 / 100000 : ℝ) ≤ q ∧ q ≤ 19074 / 100000) :
    (189359 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (189586 / 1000000 : ℝ) := by
  have hmonoLo : sin (19051 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19074 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19051 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19074 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19051 / 100000 : ℝ) ≤ q ∧ q ≤ 19074 / 100000) :
    (981864 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981908 / 1000000 : ℝ) := by
  have hmonoLo : cos (19074 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19051 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19074 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19051 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28309 / 100000 : ℝ) ≤ q ∧ q ≤ 28358 / 100000) :
    (279323 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (279795 / 1000000 : ℝ) := by
  have hmonoLo : sin (28309 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28358 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28309 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28358 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28309 / 100000 : ℝ) ≤ q ∧ q ≤ 28358 / 100000) :
    (960059 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (960197 / 1000000 : ℝ) := by
  have hmonoLo : cos (28358 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28309 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28358 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28309 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43409 / 100000 : ℝ) ≤ q ∧ q ≤ 43468 / 100000) :
    (420584 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (421121 / 1000000 : ℝ) := by
  have hmonoLo : sin (43409 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43468 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43409 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43468 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47957 / 100000 : ℝ) ≤ q ∧ q ≤ 48029 / 100000) :
    (461397 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (462037 / 1000000 : ℝ) := by
  have hmonoLo : sin (47957 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48029 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47957 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48029 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47957 / 100000 : ℝ) ≤ q ∧ q ≤ 48029 / 100000) :
    (886860 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (887194 / 1000000 : ℝ) := by
  have hmonoLo : cos (48029 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47957 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48029 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47957 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19051000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19074000 / 100000000) :
    (18935900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18958600 / 100000000 : ℝ) ∧
      (98186400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98190800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19051000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19074000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19074000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19051000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28309000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28358000 / 100000000) :
    (27932300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27979500 / 100000000 : ℝ) ∧
      (96005900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96019700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28309000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28358000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28358000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28309000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43409000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43468000 / 100000000) :
    (42058400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42112100 / 100000000 : ℝ) ∧
      (90700400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90725400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43409000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43468000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43468000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43409000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47957000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48029000 / 100000000) :
    (46139700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46203700 / 100000000 : ℝ) ∧
      (88686000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88719400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47957000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48029000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48029000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47957000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0026. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102261 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102271 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19051000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19074000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28309000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28358000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43409000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43468000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47957000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48029000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0026 brick. -/
...
throughout the B0026 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102261 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102271 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19051 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19074 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28309 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43409 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43468 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47957 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48029 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981908 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19051 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19051 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (907004 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43468 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43468 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (462037 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48029 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48029 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (420584 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43409 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43409 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102271 / 100000 : ℝ) * (48029 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102261 / 100000 : ℝ) * (28309 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16201 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16695 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981908 / 1000000 : ℝ) * (16201 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190700 / 100000 : ℝ) * (16695 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190700 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28309 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28358 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102261 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102271 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102261 / 100000 : ℝ) * (279323 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102271 / 100000 : ℝ) * (279795 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19051 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19074 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28309 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28358 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102261 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102271 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19051 / 100000, 19074 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28309 / 100000, 28358 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102261 / 100000, 102271 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨189359 / 1000000, 189586 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981864 / 1000000, 981908 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨279323 / 1000000, 279795 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960059 / 1000000, 960197 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0026 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0026 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102271 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102261 / 100000 : ℝ) * (461397 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102271 / 100000 : ℝ) * (462037 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47957 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48029 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47957 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48029 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102261 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0026`.
...
/-- Sound projection of the B0026 checker instance into the generic
...
/-- Every projected type-(iv) height in B0026 has an equal-area regular
...
/-- Candidate-facing conclusion for B0026.  No stationarity hypothesis is
...
/-- Complete B0026 candidate-facing conclusion.  The checked stationary pair
