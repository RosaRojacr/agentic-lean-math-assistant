...
namespace MiddleFaceCell19

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0019`, spanning `[102191/100000, 102201/100000]`. -/
def brick : Brick where
  lamLo := 102191 / 100000
  lamHi := 102201 / 100000
  centers := ![473092355835393843 / 2500000000000000000,
    140021473842741811 / 500000000000000000,
    537999083469982311 / 1250000000000000000,
    4750477713350022543 / 10000000000000000000]
  slopes := ![2011298114259291977 / 1000000000000000000,
    948351320389890829 / 200000000000000000,
    5765606836264639467 / 1000000000000000000,
    1409798859555193673 / 200000000000000000]
  yXiSlope := 4162207 / 6250000
  vRhoSlope := 17852433 / 20000000
...
/-- Unconditional real-range conclusion for the B0019 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102191 / 100000 : ℝ) ≤ lam → lam ≤ 102201 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18912 / 100000 : ℝ) ≤ q ∧ q ≤ 18935 / 100000) :
    (187994 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (188221 / 1000000 : ℝ) := by
  have hmonoLo : sin (18912 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18935 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18912 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18935 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18912 / 100000 : ℝ) ≤ q ∧ q ≤ 18935 / 100000) :
    (982126 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982171 / 1000000 : ℝ) := by
  have hmonoLo : cos (18935 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18912 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18935 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18912 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27979 / 100000 : ℝ) ≤ q ∧ q ≤ 28029 / 100000) :
    (276153 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (276635 / 1000000 : ℝ) := by
  have hmonoLo : sin (27979 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28029 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27979 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28029 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27979 / 100000 : ℝ) ≤ q ∧ q ≤ 28029 / 100000) :
    (960975 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (961114 / 1000000 : ℝ) := by
  have hmonoLo : cos (28029 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27979 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28029 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27979 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43010 / 100000 : ℝ) ≤ q ∧ q ≤ 43070 / 100000) :
    (416961 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (417507 / 1000000 : ℝ) := by
  have hmonoLo : sin (43010 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43070 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43010 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43070 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (47468 / 100000 : ℝ) ≤ q ∧ q ≤ 47542 / 100000) :
    (457053 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (457712 / 1000000 : ℝ) := by
  have hmonoLo : sin (47468 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47542 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47468 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47542 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (47468 / 100000 : ℝ) ≤ q ∧ q ≤ 47542 / 100000) :
    (889100 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (889440 / 1000000 : ℝ) := by
  have hmonoLo : cos (47542 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (47468 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (47542 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (47468 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18912000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18935000 / 100000000) :
    (18799400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18822100 / 100000000 : ℝ) ∧
      (98212600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98217100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18912000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18935000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18935000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18912000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27979000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28029000 / 100000000) :
    (27615300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27663500 / 100000000 : ℝ) ∧
      (96097500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96111400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27979000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28029000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28029000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27979000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43010000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43070000 / 100000000) :
    (41696100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41750700 / 100000000 : ℝ) ∧
      (90867300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90892500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43010000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43070000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43070000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43010000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (47468000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47542000 / 100000000) :
    (45705300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45771200 / 100000000 : ℝ) ∧
      (88910000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88944000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47468000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47542000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47542000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47468000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0019. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102191 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102201 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18912000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18935000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27979000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28029000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43010000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43070000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (47468000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 47542000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0019 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 119 / 250, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
...
throughout the B0019 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102191 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102201 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18912 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18935 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27979 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43010 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43070 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (47468 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (47542 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982171 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18912 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18912 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (908673 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43070 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43070 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (457712 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (47542 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (47542 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (416961 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43010 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43010 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102201 / 100000 : ℝ) * (47542 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102191 / 100000 : ℝ) * (27979 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16191 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16673 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982171 / 1000000 : ℝ) * (16191 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190867 / 100000 : ℝ) * (16673 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190867 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27979 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28029 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102191 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102201 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102191 / 100000 : ℝ) * (276153 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102201 / 100000 : ℝ) * (276635 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18912 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18935 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27979 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28029 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102191 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102201 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18912 / 100000, 18935 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27979 / 100000, 28029 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102191 / 100000, 102201 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨187994 / 1000000, 188221 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982126 / 1000000, 982171 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨276153 / 1000000, 276635 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨960975 / 1000000, 961114 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0019 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0019 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102201 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102191 / 100000 : ℝ) * (457053 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102201 / 100000 : ℝ) * (457712 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (47468 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 47542 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (47468 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 47542 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102191 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0019`.
...
/-- Sound projection of the B0019 checker instance into the generic
...
/-- Every projected type-(iv) height in B0019 has an equal-area regular
...
/-- Candidate-facing conclusion for B0019.  No stationarity hypothesis is
...
/-- Complete B0019 candidate-facing conclusion.  The checked stationary pair
