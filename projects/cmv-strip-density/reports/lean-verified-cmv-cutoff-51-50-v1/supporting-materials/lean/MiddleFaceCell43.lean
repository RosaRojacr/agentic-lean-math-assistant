...
namespace MiddleFaceCell43

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0043`, spanning `[102431/100000, 102441/100000]`. -/
def brick : Brick where
  lamLo := 102431 / 100000
  lamHi := 102441 / 100000
  centers := ![969118195302574507 / 5000000000000000000,
    14553118777491437 / 50000000000000000,
    2218486641300085889 / 5000000000000000000,
    2456793168116424803 / 5000000000000000000]
  slopes := ![1816876423114432049 / 1000000000000000000,
    4449208614093793949 / 1000000000000000000,
    2664456386736268889 / 500000000000000000,
    3278688497043931307 / 500000000000000000]
  yXiSlope := 13104633 / 20000000
  vRhoSlope := 88819749 / 100000000
...
/-- Unconditional real-range conclusion for the B0043 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102431 / 100000 : ℝ) ≤ lam → lam ≤ 102441 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19372 / 100000 : ℝ) ≤ q ∧ q ≤ 19393 / 100000) :
    (192510 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (192717 / 1000000 : ℝ) := by
  have hmonoLo : sin (19372 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19393 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19372 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19393 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19372 / 100000 : ℝ) ≤ q ∧ q ≤ 19393 / 100000) :
    (981254 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981295 / 1000000 : ℝ) := by
  have hmonoLo : cos (19393 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19372 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19393 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19372 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29083 / 100000 : ℝ) ≤ q ∧ q ≤ 29130 / 100000) :
    (286747 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (287198 / 1000000 : ℝ) := by
  have hmonoLo : sin (29083 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29130 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29083 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29130 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29083 / 100000 : ℝ) ≤ q ∧ q ≤ 29130 / 100000) :
    (957871 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (958007 / 1000000 : ℝ) := by
  have hmonoLo : cos (29130 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29083 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29130 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29083 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44342 / 100000 : ℝ) ≤ q ∧ q ≤ 44398 / 100000) :
    (429031 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (429537 / 1000000 : ℝ) := by
  have hmonoLo : sin (44342 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44398 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44342 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44398 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49102 / 100000 : ℝ) ≤ q ∧ q ≤ 49170 / 100000) :
    (471525 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (472126 / 1000000 : ℝ) := by
  have hmonoLo : sin (49102 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49170 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49102 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49170 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49102 / 100000 : ℝ) ≤ q ∧ q ≤ 49170 / 100000) :
    (881531 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (881853 / 1000000 : ℝ) := by
  have hmonoLo : cos (49170 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49102 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49170 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49102 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19372000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19393000 / 100000000) :
    (19251000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19271700 / 100000000 : ℝ) ∧
      (98125400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98129500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19372000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19393000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19393000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19372000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29083000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29130000 / 100000000) :
    (28674700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28719800 / 100000000 : ℝ) ∧
      (95787100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95800700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29083000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29130000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29130000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29083000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44342000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44398000 / 100000000) :
    (42903100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42953700 / 100000000 : ℝ) ∧
      (90304900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90329000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44342000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44398000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44398000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44342000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49102000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49170000 / 100000000) :
    (47152500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47212600 / 100000000 : ℝ) ∧
      (88153100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88185300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49102000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49170000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49170000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49102000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0043. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102431 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102441 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19372000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19393000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29083000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29130000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44342000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44398000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49102000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49170000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0043 brick. -/
...
throughout the B0043 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102431 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102441 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19372 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19393 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29083 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44342 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44398 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49102 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49170 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981295 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19372 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19372 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (903049 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44398 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44398 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (472126 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49170 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49170 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (429031 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44342 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44342 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102441 / 100000 : ℝ) * (49170 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102431 / 100000 : ℝ) * (29083 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16225 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16747 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981295 / 1000000 : ℝ) * (16225 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190304 / 100000 : ℝ) * (16747 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190304 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29083 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29130 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102431 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102441 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102431 / 100000 : ℝ) * (286747 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102441 / 100000 : ℝ) * (287198 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19372 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19393 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29083 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29130 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102431 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102441 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19372 / 100000, 19393 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29083 / 100000, 29130 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102431 / 100000, 102441 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨192510 / 1000000, 192717 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981254 / 1000000, 981295 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨286747 / 1000000, 287198 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957871 / 1000000, 958007 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0043 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0043 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102441 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102431 / 100000 : ℝ) * (471525 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102441 / 100000 : ℝ) * (472126 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49102 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49170 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49102 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49170 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102431 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0043`.
...
/-- Sound projection of the B0043 checker instance into the generic
...
/-- Every projected type-(iv) height in B0043 has an equal-area regular
...
/-- Candidate-facing conclusion for B0043.  No stationarity hypothesis is
...
/-- Complete B0043 candidate-facing conclusion.  The checked stationary pair
