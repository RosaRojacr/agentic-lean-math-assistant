...
namespace MiddleFaceCell89

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0089`, spanning `[102891/100000, 102901/100000]`. -/
def brick : Brick where
  lamLo := 102891 / 100000
  lamHi := 102901 / 100000
  centers := ![100738229789190877 / 500000000000000000,
    3104487168757016179 / 10000000000000000000,
    1166536912709690953 / 2500000000000000000,
    5197161253426813587 / 10000000000000000000]
  slopes := ![381337007563658531 / 250000000000000000,
    7813196637508327 / 1953125000000000,
    4667558959816578659 / 1000000000000000000,
    5807513724749787691 / 1000000000000000000]
  yXiSlope := 63663779 / 100000000
  vRhoSlope := 44016751 / 50000000
...
/-- Unconditional real-range conclusion for the B0089 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102891 / 100000 : ℝ) ≤ lam → lam ≤ 102901 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20139 / 100000 : ℝ) ≤ q ∧ q ≤ 20157 / 100000) :
    (200031 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200208 / 1000000 : ℝ) := by
  have hmonoLo : sin (20139 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20157 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20139 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20157 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20139 / 100000 : ℝ) ≤ q ∧ q ≤ 20157 / 100000) :
    (979753 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979790 / 1000000 : ℝ) := by
  have hmonoLo : cos (20157 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20139 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20157 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20139 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31024 / 100000 : ℝ) ≤ q ∧ q ≤ 31066 / 100000) :
    (305287 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (305688 / 1000000 : ℝ) := by
  have hmonoLo : sin (31024 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31066 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31024 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31066 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31024 / 100000 : ℝ) ≤ q ∧ q ≤ 31066 / 100000) :
    (952132 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952261 / 1000000 : ℝ) := by
  have hmonoLo : cos (31066 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31024 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31066 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31024 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46637 / 100000 : ℝ) ≤ q ∧ q ≤ 46686 / 100000) :
    (449646 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (450085 / 1000000 : ℝ) := by
  have hmonoLo : sin (46637 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46686 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46637 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46686 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51941 / 100000 : ℝ) ≤ q ∧ q ≤ 52002 / 100000) :
    (496368 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (496898 / 1000000 : ℝ) := by
  have hmonoLo : sin (51941 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52002 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51941 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52002 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51941 / 100000 : ℝ) ≤ q ∧ q ≤ 52002 / 100000) :
    (867809 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (868113 / 1000000 : ℝ) := by
  have hmonoLo : cos (52002 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51941 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52002 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51941 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20139000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20157000 / 100000000) :
    (20003100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20020800 / 100000000 : ℝ) ∧
      (97975300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97979000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20139000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20157000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20157000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20139000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31024000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31066000 / 100000000) :
    (30528700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30568800 / 100000000 : ℝ) ∧
      (95213200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95226100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31024000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31066000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31066000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31024000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46637000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46686000 / 100000000) :
    (44964600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45008500 / 100000000 : ℝ) ∧
      (89298500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89320700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46637000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46686000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46686000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46637000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51941000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52002000 / 100000000) :
    (49636800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49689800 / 100000000 : ℝ) ∧
      (86780900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86811300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51941000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52002000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52002000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51941000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0089. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102891 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102901 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20139000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20157000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31024000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31066000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46637000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46686000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51941000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52002000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0089 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (521 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 117 / 250, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 521 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (117 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (521 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (117 / 250)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0089 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102891 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102901 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20139 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20157 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31024 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46637 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46686 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51941 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52002 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979790 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20139 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20139 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (892985 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46686 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46686 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (496898 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52002 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52002 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (449646 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46637 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46637 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102901 / 100000 : ℝ) * (52002 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102891 / 100000 : ℝ) * (31024 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16288 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16884 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979790 / 1000000 : ℝ) * (16288 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189298 / 100000 : ℝ) * (16884 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189298 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31024 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31066 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102891 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102901 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102891 / 100000 : ℝ) * (305287 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102901 / 100000 : ℝ) * (305688 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20139 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20157 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31024 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31066 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102891 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102901 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20139 / 100000, 20157 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31024 / 100000, 31066 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102891 / 100000, 102901 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200031 / 1000000, 200208 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979753 / 1000000, 979790 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨305287 / 1000000, 305688 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952132 / 1000000, 952261 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0089 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0089 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102901 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102891 / 100000 : ℝ) * (496368 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102901 / 100000 : ℝ) * (496898 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51941 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52002 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51941 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52002 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102891 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0089`.
...
/-- Sound projection of the B0089 checker instance into the generic
...
/-- Every projected type-(iv) height in B0089 has an equal-area regular
...
/-- Candidate-facing conclusion for B0089.  No stationarity hypothesis is
...
/-- Complete B0089 candidate-facing conclusion.  The checked stationary pair
