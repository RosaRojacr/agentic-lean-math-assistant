...
namespace MiddleFaceCell57

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0057`, spanning `[102571/100000, 102581/100000]`. -/
def brick : Brick where
  lamLo := 102571 / 100000
  lamHi := 102581 / 100000
  centers := ![981485953065301523 / 5000000000000000000,
    742961483661240983 / 2500000000000000000,
    901999251116605049 / 2000000000000000000,
    2501801202246002569 / 5000000000000000000]
  slopes := ![859192988260881691 / 500000000000000000,
    4299049483088753341 / 1000000000000000000,
    5106443656508385063 / 1000000000000000000,
    24632421379179339 / 3906250000000000]
  yXiSlope := 64932333 / 100000000
  vRhoSlope := 11071571 / 12500000
...
/-- Unconditional real-range conclusion for the B0057 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102571 / 100000 : ℝ) ≤ lam → lam ≤ 102581 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19620 / 100000 : ℝ) ≤ q ∧ q ≤ 19640 / 100000) :
    (194943 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (195140 / 1000000 : ℝ) := by
  have hmonoLo : sin (19620 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19640 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19620 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19640 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19620 / 100000 : ℝ) ≤ q ∧ q ≤ 19640 / 100000) :
    (980775 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980815 / 1000000 : ℝ) := by
  have hmonoLo : cos (19640 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19620 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19640 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19620 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29696 / 100000 : ℝ) ≤ q ∧ q ≤ 29741 / 100000) :
    (292614 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (293045 / 1000000 : ℝ) := by
  have hmonoLo : sin (29696 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29741 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29696 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29741 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29696 / 100000 : ℝ) ≤ q ∧ q ≤ 29741 / 100000) :
    (956098 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956231 / 1000000 : ℝ) := by
  have hmonoLo : cos (29741 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29696 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29741 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29696 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45073 / 100000 : ℝ) ≤ q ∧ q ≤ 45127 / 100000) :
    (435622 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (436109 / 1000000 : ℝ) := by
  have hmonoLo : sin (45073 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45127 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45073 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45127 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50003 / 100000 : ℝ) ≤ q ∧ q ≤ 50069 / 100000) :
    (479451 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (480031 / 1000000 : ℝ) := by
  have hmonoLo : sin (50003 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50069 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50003 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50069 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50003 / 100000 : ℝ) ≤ q ∧ q ≤ 50069 / 100000) :
    (877251 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (877569 / 1000000 : ℝ) := by
  have hmonoLo : cos (50069 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50003 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50069 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50003 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19620000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19640000 / 100000000) :
    (19494300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19514000 / 100000000 : ℝ) ∧
      (98077500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98081500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19620000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19640000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19640000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19620000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29696000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29741000 / 100000000) :
    (29261400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29304500 / 100000000 : ℝ) ∧
      (95609800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95623100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29696000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29741000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29741000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29696000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45073000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45127000 / 100000000) :
    (43562200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43610900 / 100000000 : ℝ) ∧
      (89989300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90013000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45073000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45127000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45127000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45073000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50003000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50069000 / 100000000) :
    (47945100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48003100 / 100000000 : ℝ) ∧
      (87725100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87756900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50003000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50069000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50069000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50003000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0057. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102571 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102581 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19620000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19640000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29696000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29741000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45073000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45127000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50003000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50069000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0057 brick. -/
...
throughout the B0057 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102571 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102581 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19620 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19640 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29696 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45073 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45127 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50003 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50069 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980815 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19620 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19620 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (899893 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45127 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45127 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (480031 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50069 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50069 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (435622 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45073 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45073 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102581 / 100000 : ℝ) * (50069 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102571 / 100000 : ℝ) * (29696 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16245 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16789 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980815 / 1000000 : ℝ) * (16245 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189989 / 100000 : ℝ) * (16789 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189989 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29696 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29741 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102571 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102581 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102571 / 100000 : ℝ) * (292614 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102581 / 100000 : ℝ) * (293045 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19620 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19640 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29696 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29741 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102571 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102581 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19620 / 100000, 19640 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29696 / 100000, 29741 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102571 / 100000, 102581 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨194943 / 1000000, 195140 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980775 / 1000000, 980815 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨292614 / 1000000, 293045 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956098 / 1000000, 956231 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0057 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0057 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102581 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102571 / 100000 : ℝ) * (479451 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102581 / 100000 : ℝ) * (480031 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50003 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50069 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50003 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50069 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102571 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0057`.
...
/-- Sound projection of the B0057 checker instance into the generic
...
/-- Every projected type-(iv) height in B0057 has an equal-area regular
...
/-- Candidate-facing conclusion for B0057.  No stationarity hypothesis is
...
/-- Complete B0057 candidate-facing conclusion.  The checked stationary pair
