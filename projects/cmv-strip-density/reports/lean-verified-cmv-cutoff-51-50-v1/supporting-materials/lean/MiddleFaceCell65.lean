...
namespace MiddleFaceCell65

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0065`, spanning `[102651/100000, 102661/100000]`. -/
def brick : Brick where
  lamLo := 102651 / 100000
  lamHi := 102661 / 100000
  centers := ![494127156258708031 / 2500000000000000000,
    3005915510889622621 / 10000000000000000000,
    4550371276575435851 / 10000000000000000000,
    5053509853822849381 / 10000000000000000000]
  slopes := ![1666258090720638789 / 1000000000000000000,
    2109494372730398473 / 500000000000000000,
    1247079749264729293 / 250000000000000000,
    6172068136179152487 / 1000000000000000000]
  yXiSlope := 64605007 / 100000000
  vRhoSlope := 44217287 / 50000000
...
/-- Unconditional real-range conclusion for the B0065 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102651 / 100000 : ℝ) ≤ lam → lam ≤ 102661 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19755 / 100000 : ℝ) ≤ q ∧ q ≤ 19775 / 100000) :
    (196267 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (196464 / 1000000 : ℝ) := by
  have hmonoLo : sin (19755 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19775 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19755 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19775 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19755 / 100000 : ℝ) ≤ q ∧ q ≤ 19775 / 100000) :
    (980511 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980551 / 1000000 : ℝ) := by
  have hmonoLo : cos (19775 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19755 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19775 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19755 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30037 / 100000 : ℝ) ≤ q ∧ q ≤ 30081 / 100000) :
    (295873 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (296294 / 1000000 : ℝ) := by
  have hmonoLo : sin (30037 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30081 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30037 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30081 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30037 / 100000 : ℝ) ≤ q ∧ q ≤ 30081 / 100000) :
    (955096 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (955228 / 1000000 : ℝ) := by
  have hmonoLo : cos (30081 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30037 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30081 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30037 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45477 / 100000 : ℝ) ≤ q ∧ q ≤ 45530 / 100000) :
    (439255 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (439732 / 1000000 : ℝ) := by
  have hmonoLo : sin (45477 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45530 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45477 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45530 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50503 / 100000 : ℝ) ≤ q ∧ q ≤ 50567 / 100000) :
    (483833 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (484394 / 1000000 : ℝ) := by
  have hmonoLo : sin (50503 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50567 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50503 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50567 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50503 / 100000 : ℝ) ≤ q ∧ q ≤ 50567 / 100000) :
    (874850 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (875160 / 1000000 : ℝ) := by
  have hmonoLo : cos (50567 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50503 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50567 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50503 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19755000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19775000 / 100000000) :
    (19626700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19646400 / 100000000 : ℝ) ∧
      (98051100 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98055100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19755000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19775000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19775000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19755000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30037000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30081000 / 100000000) :
    (29587300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29629400 / 100000000 : ℝ) ∧
      (95509600 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95522800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30037000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30081000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30081000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30037000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45477000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45530000 / 100000000) :
    (43925500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43973200 / 100000000 : ℝ) ∧
      (89812900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89836300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45477000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45530000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45530000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45477000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50503000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50567000 / 100000000) :
    (48383300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48439400 / 100000000 : ℝ) ∧
      (87485000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87516000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50503000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50567000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50567000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50503000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0065. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102651 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102661 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19755000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19775000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30037000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30081000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45477000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45530000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50503000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50567000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0065 brick. -/
...
throughout the B0065 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102651 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102661 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19755 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19775 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30037 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45477 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45530 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50503 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50567 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980551 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19755 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19755 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (898129 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45530 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45530 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (484394 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50567 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50567 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (439255 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45477 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45477 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102661 / 100000 : ℝ) * (50567 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102651 / 100000 : ℝ) * (30037 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16256 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16813 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980551 / 1000000 : ℝ) * (16256 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189812 / 100000 : ℝ) * (16813 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189812 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30037 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30081 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102651 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102661 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102651 / 100000 : ℝ) * (295873 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102661 / 100000 : ℝ) * (296294 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19755 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19775 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30037 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30081 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102651 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102661 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19755 / 100000, 19775 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30037 / 100000, 30081 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102651 / 100000, 102661 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨196267 / 1000000, 196464 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980511 / 1000000, 980551 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨295873 / 1000000, 296294 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨955096 / 1000000, 955228 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0065 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0065 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102661 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102651 / 100000 : ℝ) * (483833 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102661 / 100000 : ℝ) * (484394 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50503 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50567 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50503 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50567 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102651 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0065`.
...
/-- Sound projection of the B0065 checker instance into the generic
...
/-- Every projected type-(iv) height in B0065 has an equal-area regular
...
/-- Candidate-facing conclusion for B0065.  No stationarity hypothesis is
...
/-- Complete B0065 candidate-facing conclusion.  The checked stationary pair
