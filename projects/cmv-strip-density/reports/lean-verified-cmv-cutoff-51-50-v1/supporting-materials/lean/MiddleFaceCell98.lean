...
namespace MiddleFaceCell98

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0098`, spanning `[102981/100000, 102991/100000]`. -/
def brick : Brick where
  lamLo := 102981 / 100000
  lamHi := 102991 / 100000
  centers := ![63383642155672753 / 312500000000000000,
    1570075847398717321 / 5000000000000000000,
    4707661422216806329 / 10000000000000000000,
    2624432731635160637 / 5000000000000000000]
  slopes := ![369434037462095231 / 250000000000000000,
    1962847768786343963 / 500000000000000000,
    4558656291217449409 / 1000000000000000000,
    2841669581312166907 / 500000000000000000]
  yXiSlope := 2533013 / 4000000
  vRhoSlope := 87887707 / 100000000
...
/-- Unconditional real-range conclusion for the B0098 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102981 / 100000 : ℝ) ≤ lam → lam ≤ 102991 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20274 / 100000 : ℝ) ≤ q ∧ q ≤ 20292 / 100000) :
    (201353 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (201531 / 1000000 : ℝ) := by
  have hmonoLo : sin (20274 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20292 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20274 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20292 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20274 / 100000 : ℝ) ≤ q ∧ q ≤ 20292 / 100000) :
    (979482 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979519 / 1000000 : ℝ) := by
  have hmonoLo : cos (20292 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20274 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20292 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20274 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31381 / 100000 : ℝ) ≤ q ∧ q ≤ 31422 / 100000) :
    (308684 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (309075 / 1000000 : ℝ) := by
  have hmonoLo : sin (31381 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31422 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31381 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31422 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31381 / 100000 : ℝ) ≤ q ∧ q ≤ 31422 / 100000) :
    (951037 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951165 / 1000000 : ℝ) := by
  have hmonoLo : cos (31422 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31381 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31422 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31381 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (47052 / 100000 : ℝ) ≤ q ∧ q ≤ 47101 / 100000) :
    (453349 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (453787 / 1000000 : ℝ) := by
  have hmonoLo : sin (47052 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (47101 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (47052 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (47101 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52459 / 100000 : ℝ) ≤ q ∧ q ≤ 52519 / 100000) :
    (500858 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (501378 / 1000000 : ℝ) := by
  have hmonoLo : sin (52459 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52519 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52459 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52519 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52459 / 100000 : ℝ) ≤ q ∧ q ≤ 52519 / 100000) :
    (865228 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (865530 / 1000000 : ℝ) := by
  have hmonoLo : cos (52519 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52459 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52519 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52459 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20274000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20292000 / 100000000) :
    (20135300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20153100 / 100000000 : ℝ) ∧
      (97948200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97951900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20274000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20292000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20292000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20274000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31381000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31422000 / 100000000) :
    (30868400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30907500 / 100000000 : ℝ) ∧
      (95103700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95116500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31381000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31422000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31422000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31381000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (47052000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 47101000 / 100000000) :
    (45334900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45378700 / 100000000 : ℝ) ∧
      (89111000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89133300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (47052000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (47101000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (47101000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (47052000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52459000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52519000 / 100000000) :
    (50085800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (50137800 / 100000000 : ℝ) ∧
      (86522800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86553000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52459000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52519000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52519000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52459000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0098. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102981 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102991 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20274000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20292000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31381000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31422000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (47052000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 47101000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52459000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52519000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0098 brick. -/
...
throughout the B0098 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102981 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102991 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20274 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20292 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31381 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (47052 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (47101 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52459 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52519 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979519 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20274 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20274 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (891110 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (47101 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (47101 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (501378 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52519 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52519 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (453349 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (47052 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (47052 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102991 / 100000 : ℝ) * (52519 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102981 / 100000 : ℝ) * (31381 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16301 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16910 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979519 / 1000000 : ℝ) * (16301 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189110 / 100000 : ℝ) * (16910 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189110 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31381 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31422 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102981 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102991 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102981 / 100000 : ℝ) * (308684 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102991 / 100000 : ℝ) * (309075 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20274 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20292 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31381 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31422 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102981 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102991 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20274 / 100000, 20292 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31381 / 100000, 31422 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102981 / 100000, 102991 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨201353 / 1000000, 201531 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979482 / 1000000, 979519 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨308684 / 1000000, 309075 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951037 / 1000000, 951165 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0098 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0098 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102991 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102981 / 100000 : ℝ) * (500858 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102991 / 100000 : ℝ) * (501378 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52459 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52519 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52459 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52519 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102981 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0098`.
...
/-- Sound projection of the B0098 checker instance into the generic
...
/-- Every projected type-(iv) height in B0098 has an equal-area regular
...
/-- Candidate-facing conclusion for B0098.  No stationarity hypothesis is
...
/-- Complete B0098 candidate-facing conclusion.  The checked stationary pair
