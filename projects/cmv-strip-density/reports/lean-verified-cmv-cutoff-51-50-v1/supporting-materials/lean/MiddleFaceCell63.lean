...
namespace MiddleFaceCell63

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0063`, spanning `[102631/100000, 102641/100000]`. -/
def brick : Brick where
  lamLo := 102631 / 100000
  lamHi := 102641 / 100000
  centers := ![1973163361800757353 / 10000000000000000000,
    599491582724579957 / 2000000000000000000,
    2270182862817402013 / 5000000000000000000,
    630141617278192937 / 1250000000000000000]
  slopes := ![52469580341071157 / 31250000000000000,
    423863828710904887 / 100000000000000000,
    2508639226003133857 / 500000000000000000,
    6204898529128202141 / 1000000000000000000]
  yXiSlope := 64686167 / 100000000
  vRhoSlope := 4423443 / 5000000
...
/-- Unconditional real-range conclusion for the B0063 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102631 / 100000 : ℝ) ≤ lam → lam ≤ 102641 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19722 / 100000 : ℝ) ≤ q ∧ q ≤ 19742 / 100000) :
    (195943 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (196141 / 1000000 : ℝ) := by
  have hmonoLo : sin (19722 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19742 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19722 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19742 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19722 / 100000 : ℝ) ≤ q ∧ q ≤ 19742 / 100000) :
    (980575 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980616 / 1000000 : ℝ) := by
  have hmonoLo : cos (19742 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19722 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19742 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19722 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29952 / 100000 : ℝ) ≤ q ∧ q ≤ 29997 / 100000) :
    (295061 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (295492 / 1000000 : ℝ) := by
  have hmonoLo : sin (29952 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29997 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29952 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29997 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29952 / 100000 : ℝ) ≤ q ∧ q ≤ 29997 / 100000) :
    (955345 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (955479 / 1000000 : ℝ) := by
  have hmonoLo : cos (29997 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29952 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29997 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29952 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45377 / 100000 : ℝ) ≤ q ∧ q ≤ 45430 / 100000) :
    (438357 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (438834 / 1000000 : ℝ) := by
  have hmonoLo : sin (45377 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45430 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45377 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45430 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50379 / 100000 : ℝ) ≤ q ∧ q ≤ 50444 / 100000) :
    (482748 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (483318 / 1000000 : ℝ) := by
  have hmonoLo : sin (50379 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50444 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50379 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50444 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50379 / 100000 : ℝ) ≤ q ∧ q ≤ 50444 / 100000) :
    (875445 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (875760 / 1000000 : ℝ) := by
  have hmonoLo : cos (50444 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50379 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50444 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50379 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19722000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19742000 / 100000000) :
    (19594300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19614100 / 100000000 : ℝ) ∧
      (98057500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98061600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19722000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19742000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19742000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19722000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29952000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29997000 / 100000000) :
    (29506100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29549200 / 100000000 : ℝ) ∧
      (95534500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95547900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29952000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29997000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29997000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29952000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45377000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45430000 / 100000000) :
    (43835700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43883400 / 100000000 : ℝ) ∧
      (89856800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89880100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45377000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45430000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45430000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45377000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50379000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50444000 / 100000000) :
    (48274800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48331800 / 100000000 : ℝ) ∧
      (87544500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87576000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50379000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50444000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50444000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50379000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0063. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102631 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102641 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19722000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19742000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29952000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29997000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45377000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45430000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50379000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50444000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0063 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 101 / 200, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (101 / 200)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0063 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102631 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102641 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19722 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19742 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29952 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45377 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45430 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50379 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50444 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980616 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19722 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19722 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (898568 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45430 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45430 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (483318 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50444 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50444 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (438357 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45377 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45377 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102641 / 100000 : ℝ) * (50444 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102631 / 100000 : ℝ) * (29952 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16253 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16807 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980616 / 1000000 : ℝ) * (16253 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189856 / 100000 : ℝ) * (16807 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189856 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29952 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29997 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102631 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102641 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102631 / 100000 : ℝ) * (295061 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102641 / 100000 : ℝ) * (295492 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19722 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19742 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29952 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29997 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102631 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102641 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19722 / 100000, 19742 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29952 / 100000, 29997 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102631 / 100000, 102641 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨195943 / 1000000, 196141 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980575 / 1000000, 980616 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨295061 / 1000000, 295492 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨955345 / 1000000, 955479 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0063 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0063 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102641 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102631 / 100000 : ℝ) * (482748 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102641 / 100000 : ℝ) * (483318 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50379 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50444 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50379 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50444 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102631 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0063`.
...
/-- Sound projection of the B0063 checker instance into the generic
...
/-- Every projected type-(iv) height in B0063 has an equal-area regular
...
/-- Candidate-facing conclusion for B0063.  No stationarity hypothesis is
...
/-- Complete B0063 candidate-facing conclusion.  The checked stationary pair
