...
namespace MiddleFaceCell70

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0070`, spanning `[102701/100000, 102711/100000]`. -/
def brick : Brick where
  lamLo := 102701 / 100000
  lamHi := 102711 / 100000
  centers := ![15505949499840973 / 78125000000000000,
    12107558495012013 / 40000000000000000,
    571891870667985493 / 1250000000000000000,
    1016833679732189403 / 2000000000000000000]
  slopes := ![1635071665764258889 / 1000000000000000000,
    4170886486576061997 / 1000000000000000000,
    1229378911437506283 / 250000000000000000,
    761468042997227697 / 125000000000000000]
  yXiSlope := 64404013 / 100000000
  vRhoSlope := 88349463 / 100000000
...
/-- Unconditional real-range conclusion for the B0070 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102701 / 100000 : ℝ) ≤ lam → lam ≤ 102711 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19838 / 100000 : ℝ) ≤ q ∧ q ≤ 19857 / 100000) :
    (197081 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (197268 / 1000000 : ℝ) := by
  have hmonoLo : sin (19838 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19857 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19838 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19857 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19838 / 100000 : ℝ) ≤ q ∧ q ≤ 19857 / 100000) :
    (980349 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980388 / 1000000 : ℝ) := by
  have hmonoLo : cos (19857 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19838 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19857 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19838 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30247 / 100000 : ℝ) ≤ q ∧ q ≤ 30291 / 100000) :
    (297878 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (298299 / 1000000 : ℝ) := by
  have hmonoLo : sin (30247 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30291 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30247 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30291 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30247 / 100000 : ℝ) ≤ q ∧ q ≤ 30291 / 100000) :
    (954472 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954604 / 1000000 : ℝ) := by
  have hmonoLo : cos (30291 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30247 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30291 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30247 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45725 / 100000 : ℝ) ≤ q ∧ q ≤ 45777 / 100000) :
    (441482 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (441949 / 1000000 : ℝ) := by
  have hmonoLo : sin (45725 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45777 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45725 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45777 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50810 / 100000 : ℝ) ≤ q ∧ q ≤ 50874 / 100000) :
    (486518 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (487078 / 1000000 : ℝ) := by
  have hmonoLo : sin (50810 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50874 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50810 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50874 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50810 / 100000 : ℝ) ≤ q ∧ q ≤ 50874 / 100000) :
    (873358 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (873671 / 1000000 : ℝ) := by
  have hmonoLo : cos (50874 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50810 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50874 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50810 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19838000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19857000 / 100000000) :
    (19708100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19726800 / 100000000 : ℝ) ∧
      (98034900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98038800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19838000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19857000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19857000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19838000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30247000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30291000 / 100000000) :
    (29787800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29829900 / 100000000 : ℝ) ∧
      (95447200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95460400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30247000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30291000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30291000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30247000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45725000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45777000 / 100000000) :
    (44148200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44194900 / 100000000 : ℝ) ∧
      (89704000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89727000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45725000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45777000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45777000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45725000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50810000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50874000 / 100000000) :
    (48651800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48707800 / 100000000 : ℝ) ∧
      (87335800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87367100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50810000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50874000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50874000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50810000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0070. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102701 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102711 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19838000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19857000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30247000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30291000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45725000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45777000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50810000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50874000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0070 brick. -/
...
throughout the B0070 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102701 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102711 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19838 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19857 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30247 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45725 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45777 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50810 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50874 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980388 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19838 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19838 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (897040 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45777 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45777 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (487078 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50874 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50874 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (441482 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45725 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45725 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102711 / 100000 : ℝ) * (50874 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102701 / 100000 : ℝ) * (30247 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16263 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16828 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980388 / 1000000 : ℝ) * (16263 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189703 / 100000 : ℝ) * (16828 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189703 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30247 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30291 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102701 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102711 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102701 / 100000 : ℝ) * (297878 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102711 / 100000 : ℝ) * (298299 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19838 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19857 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30247 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30291 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102701 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102711 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19838 / 100000, 19857 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30247 / 100000, 30291 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102701 / 100000, 102711 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨197081 / 1000000, 197268 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980349 / 1000000, 980388 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨297878 / 1000000, 298299 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954472 / 1000000, 954604 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0070 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0070 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102711 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102701 / 100000 : ℝ) * (486518 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102711 / 100000 : ℝ) * (487078 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50810 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50874 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50810 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50874 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102701 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0070`.
...
/-- Sound projection of the B0070 checker instance into the generic
...
/-- Every projected type-(iv) height in B0070 has an equal-area regular
...
/-- Candidate-facing conclusion for B0070.  No stationarity hypothesis is
...
/-- Complete B0070 candidate-facing conclusion.  The checked stationary pair
