...
namespace MiddleFaceCell28

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0028`, spanning `[102281/100000, 102291/100000]`. -/
def brick : Brick where
  lamLo := 102281 / 100000
  lamHi := 102291 / 100000
  centers := ![1910119966516205281 / 10000000000000000000,
    2842580104941986037 / 10000000000000000000,
    1088774108266533987 / 2500000000000000000,
    4813034695353720289 / 10000000000000000000]
  slopes := ![1934167185990645823 / 1000000000000000000,
    2313138406745164051 / 500000000000000000,
    5592727476555887439 / 1000000000000000000,
    1713669136423464609 / 250000000000000000]
  yXiSlope := 13236773 / 20000000
  vRhoSlope := 44546653 / 50000000
...
/-- Unconditional real-range conclusion for the B0028 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102281 / 100000 : ℝ) ≤ lam → lam ≤ 102291 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19090 / 100000 : ℝ) ≤ q ∧ q ≤ 19112 / 100000) :
    (189742 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (189959 / 1000000 : ℝ) := by
  have hmonoLo : sin (19090 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19112 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19090 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19112 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19090 / 100000 : ℝ) ≤ q ∧ q ≤ 19112 / 100000) :
    (981792 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981834 / 1000000 : ℝ) := by
  have hmonoLo : cos (19112 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19090 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19112 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19090 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28401 / 100000 : ℝ) ≤ q ∧ q ≤ 28450 / 100000) :
    (280207 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (280678 / 1000000 : ℝ) := by
  have hmonoLo : sin (28401 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28450 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28401 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28450 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28401 / 100000 : ℝ) ≤ q ∧ q ≤ 28450 / 100000) :
    (959802 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (959940 / 1000000 : ℝ) := by
  have hmonoLo : cos (28450 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28401 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28450 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28401 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43522 / 100000 : ℝ) ≤ q ∧ q ≤ 43580 / 100000) :
    (421609 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (422136 / 1000000 : ℝ) := by
  have hmonoLo : sin (43522 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43580 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43522 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43580 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48095 / 100000 : ℝ) ≤ q ∧ q ≤ 48166 / 100000) :
    (462621 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (463251 / 1000000 : ℝ) := by
  have hmonoLo : sin (48095 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48166 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48095 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48166 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48095 / 100000 : ℝ) ≤ q ∧ q ≤ 48166 / 100000) :
    (886227 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (886556 / 1000000 : ℝ) := by
  have hmonoLo : cos (48166 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48095 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48166 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48095 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19090000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19112000 / 100000000) :
    (18974200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18995900 / 100000000 : ℝ) ∧
      (98179200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98183400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19090000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19112000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19112000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19090000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28401000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28450000 / 100000000) :
    (28020700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28067800 / 100000000 : ℝ) ∧
      (95980200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95994000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28401000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28450000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28450000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28401000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43522000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43580000 / 100000000) :
    (42160900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42213600 / 100000000 : ℝ) ∧
      (90653200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90677800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43522000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43580000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43580000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43522000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48095000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48166000 / 100000000) :
    (46262100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46325100 / 100000000 : ℝ) ∧
      (88622700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88655600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48095000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48166000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48166000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48095000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0028. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102281 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102291 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19090000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19112000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28401000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28450000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43522000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43580000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48095000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48166000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0028 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (241 / 500 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 109 / 250, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 241 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (109 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (241 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (109 / 250)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0028 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102281 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102291 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19090 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19112 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28401 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43522 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43580 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48095 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48166 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981834 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19090 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19090 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (906532 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43580 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43580 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (463251 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48166 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48166 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (421609 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43522 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43522 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102291 / 100000 : ℝ) * (48166 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102281 / 100000 : ℝ) * (28401 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16204 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16701 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981834 / 1000000 : ℝ) * (16204 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190653 / 100000 : ℝ) * (16701 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190653 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28401 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28450 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102281 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102291 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102281 / 100000 : ℝ) * (280207 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102291 / 100000 : ℝ) * (280678 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19090 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19112 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28401 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28450 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102281 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102291 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19090 / 100000, 19112 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28401 / 100000, 28450 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102281 / 100000, 102291 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨189742 / 1000000, 189959 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981792 / 1000000, 981834 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨280207 / 1000000, 280678 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨959802 / 1000000, 959940 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0028 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0028 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102291 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102281 / 100000 : ℝ) * (462621 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102291 / 100000 : ℝ) * (463251 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48095 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48166 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48095 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48166 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102281 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0028`.
...
/-- Sound projection of the B0028 checker instance into the generic
...
/-- Every projected type-(iv) height in B0028 has an equal-area regular
...
/-- Candidate-facing conclusion for B0028.  No stationarity hypothesis is
...
/-- Complete B0028 candidate-facing conclusion.  The checked stationary pair
