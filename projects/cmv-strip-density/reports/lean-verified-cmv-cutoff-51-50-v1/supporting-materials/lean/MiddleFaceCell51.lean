...
namespace MiddleFaceCell51

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0051`, spanning `[102511/100000, 102521/100000]`. -/
def brick : Brick where
  lamLo := 102511 / 100000
  lamHi := 102521 / 100000
  centers := ![1952539362664525413 / 10000000000000000000,
    2945864656655040203 / 10000000000000000000,
    279942568768545591 / 625000000000000000,
    496545413078298817 / 1000000000000000000]
  slopes := ![1759406317912115859 / 1000000000000000000,
    2180880350596933419 / 500000000000000000,
    2599605099641038427 / 500000000000000000,
    6410851506956977091 / 1000000000000000000]
  yXiSlope := 65182653 / 100000000
  vRhoSlope := 88677589 / 100000000
...
/-- Unconditional real-range conclusion for the B0051 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102511 / 100000 : ℝ) ≤ lam → lam ≤ 102521 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19515 / 100000 : ℝ) ≤ q ∧ q ≤ 19536 / 100000) :
    (193913 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (194120 / 1000000 : ℝ) := by
  have hmonoLo : sin (19515 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19536 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19515 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19536 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19515 / 100000 : ℝ) ≤ q ∧ q ≤ 19536 / 100000) :
    (980977 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981019 / 1000000 : ℝ) := by
  have hmonoLo : cos (19536 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19515 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19536 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19515 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29436 / 100000 : ℝ) ≤ q ∧ q ≤ 29482 / 100000) :
    (290127 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (290568 / 1000000 : ℝ) := by
  have hmonoLo : sin (29436 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29482 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29436 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29482 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29436 / 100000 : ℝ) ≤ q ∧ q ≤ 29482 / 100000) :
    (956854 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (956989 / 1000000 : ℝ) := by
  have hmonoLo : cos (29482 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29436 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29482 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29436 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44763 / 100000 : ℝ) ≤ q ∧ q ≤ 44818 / 100000) :
    (432830 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (433327 / 1000000 : ℝ) := by
  have hmonoLo : sin (44763 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44818 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44763 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44818 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49621 / 100000 : ℝ) ≤ q ∧ q ≤ 49688 / 100000) :
    (476096 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (476686 / 1000000 : ℝ) := by
  have hmonoLo : sin (49621 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49688 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49621 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49688 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49621 / 100000 : ℝ) ≤ q ∧ q ≤ 49688 / 100000) :
    (879074 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (879394 / 1000000 : ℝ) := by
  have hmonoLo : cos (49688 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49621 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49688 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49621 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19515000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19536000 / 100000000) :
    (19391300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19412000 / 100000000 : ℝ) ∧
      (98097700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98101900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19515000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19536000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19536000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19515000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29436000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29482000 / 100000000) :
    (29012700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29056800 / 100000000 : ℝ) ∧
      (95685400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95698900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29436000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29482000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29482000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29436000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44763000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44818000 / 100000000) :
    (43283000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43332700 / 100000000 : ℝ) ∧
      (90123700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90147600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44763000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44818000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44818000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44763000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49621000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49688000 / 100000000) :
    (47609600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47668600 / 100000000 : ℝ) ∧
      (87907400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87939400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49621000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49688000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49688000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49621000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0051. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102511 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102521 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19515000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19536000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29436000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29482000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44763000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44818000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49621000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49688000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0051 brick. -/
...
theorem descendingK3 :
  ...
  have hvHi : v p ≤ (497 / 1000 : ℝ) := by
    ...
    linarith
  have hwI :
      (⟨2 / 5, 9 / 20, by norm_num⟩ : QInterval).RealContains (w p) := by
  ...
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (9 / 20)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (9 / 20)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0051 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102511 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102521 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19515 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19536 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29436 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44763 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44818 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49621 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49688 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981019 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19515 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19515 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (901237 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44818 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44818 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (476686 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49688 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49688 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (432830 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44763 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44763 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102521 / 100000 : ℝ) * (49688 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102511 / 100000 : ℝ) * (29436 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16237 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16771 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981019 / 1000000 : ℝ) * (16237 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190123 / 100000 : ℝ) * (16771 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190123 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29436 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29482 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102511 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102521 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102511 / 100000 : ℝ) * (290127 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102521 / 100000 : ℝ) * (290568 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19515 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19536 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29436 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29482 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102511 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102521 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19515 / 100000, 19536 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29436 / 100000, 29482 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102511 / 100000, 102521 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨193913 / 1000000, 194120 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980977 / 1000000, 981019 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨290127 / 1000000, 290568 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨956854 / 1000000, 956989 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0051 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0051 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102521 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102511 / 100000 : ℝ) * (476096 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102521 / 100000 : ℝ) * (476686 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49621 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49688 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49621 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49688 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102511 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0051`.
...
/-- Sound projection of the B0051 checker instance into the generic
...
/-- Every projected type-(iv) height in B0051 has an equal-area regular
...
/-- Candidate-facing conclusion for B0051.  No stationarity hypothesis is
...
/-- Complete B0051 candidate-facing conclusion.  The checked stationary pair
