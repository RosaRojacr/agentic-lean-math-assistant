...
namespace MiddleFaceCell32

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0032`, spanning `[102321/100000, 102331/100000]`. -/
def brick : Brick where
  lamLo := 102321 / 100000
  lamHi := 102331 / 100000
  centers := ![383558231125899167 / 2000000000000000000,
    2860986768996810333 / 10000000000000000000,
    4377320322371370637 / 10000000000000000000,
    2420143967176299091 / 5000000000000000000]
  slopes := ![1901583418592783579 / 1000000000000000000,
    2288634313211289631 / 500000000000000000,
    275977708753761333 / 50000000000000000,
    1693077773222533103 / 250000000000000000]
  yXiSlope := 33002357 / 50000000
  vRhoSlope := 3560777 / 4000000
...
/-- Unconditional real-range conclusion for the B0032 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102321 / 100000 : ℝ) ≤ lam → lam ≤ 102331 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19167 / 100000 : ℝ) ≤ q ∧ q ≤ 19189 / 100000) :
    (190498 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (190715 / 1000000 : ℝ) := by
  have hmonoLo : sin (19167 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19189 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19167 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19189 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19167 / 100000 : ℝ) ≤ q ∧ q ≤ 19189 / 100000) :
    (981645 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981688 / 1000000 : ℝ) := by
  have hmonoLo : cos (19189 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19167 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19189 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19167 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (28586 / 100000 : ℝ) ≤ q ∧ q ≤ 28634 / 100000) :
    (281982 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (282444 / 1000000 : ℝ) := by
  have hmonoLo : sin (28586 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (28634 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (28586 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (28634 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (28586 / 100000 : ℝ) ≤ q ∧ q ≤ 28634 / 100000) :
    (959284 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (959420 / 1000000 : ℝ) := by
  have hmonoLo : cos (28634 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (28586 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (28634 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (28586 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (43744 / 100000 : ℝ) ≤ q ∧ q ≤ 43802 / 100000) :
    (423621 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (424148 / 1000000 : ℝ) := by
  have hmonoLo : sin (43744 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (43802 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (43744 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (43802 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (48368 / 100000 : ℝ) ≤ q ∧ q ≤ 48438 / 100000) :
    (465040 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (465660 / 1000000 : ℝ) := by
  have hmonoLo : sin (48368 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (48438 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (48368 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (48438 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (48368 / 100000 : ℝ) ≤ q ∧ q ≤ 48438 / 100000) :
    (884963 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (885290 / 1000000 : ℝ) := by
  have hmonoLo : cos (48438 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (48368 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (48438 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (48368 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19167000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19189000 / 100000000) :
    (19049800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19071500 / 100000000 : ℝ) ∧
      (98164500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98168800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19167000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19189000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19189000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19167000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (28586000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 28634000 / 100000000) :
    (28198200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28244400 / 100000000 : ℝ) ∧
      (95928400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95942000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (28586000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (28634000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (28634000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (28586000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (43744000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 43802000 / 100000000) :
    (42362100 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (42414800 / 100000000 : ℝ) ∧
      (90559300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90584000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (43744000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (43802000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (43802000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (43744000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (48368000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 48438000 / 100000000) :
    (46504000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (46566000 / 100000000 : ℝ) ∧
      (88496300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88529000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (48368000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (48438000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (48438000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (48368000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0032. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102321 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102331 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19167000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19189000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28586000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 28634000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (43744000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 43802000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (48368000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 48438000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0032 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 97 / 200, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (97 / 200)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0032 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102321 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102331 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19167 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19189 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (28586 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (43744 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (43802 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (48368 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (48438 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981688 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19167 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19167 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (905593 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (43802 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (43802 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (465660 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (48438 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (48438 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (423621 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (43744 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (43744 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102331 / 100000 : ℝ) * (48438 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102321 / 100000 : ℝ) * (28586 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16210 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16714 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981688 / 1000000 : ℝ) * (16210 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190559 / 100000 : ℝ) * (16714 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190559 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (28586 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 28634 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102321 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102331 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102321 / 100000 : ℝ) * (281982 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102331 / 100000 : ℝ) * (282444 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19167 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19189 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (28586 / 100000 : ℝ) ≤ yy ∧ yy ≤ 28634 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102321 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102331 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19167 / 100000, 19189 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨28586 / 100000, 28634 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102321 / 100000, 102331 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨190498 / 1000000, 190715 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981645 / 1000000, 981688 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨281982 / 1000000, 282444 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨959284 / 1000000, 959420 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0032 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0032 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102331 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102321 / 100000 : ℝ) * (465040 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102331 / 100000 : ℝ) * (465660 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (48368 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 48438 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (48368 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 48438 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102321 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0032`.
...
/-- Sound projection of the B0032 checker instance into the generic
...
/-- Every projected type-(iv) height in B0032 has an equal-area regular
...
/-- Candidate-facing conclusion for B0032.  No stationarity hypothesis is
...
/-- Complete B0032 candidate-facing conclusion.  The checked stationary pair
