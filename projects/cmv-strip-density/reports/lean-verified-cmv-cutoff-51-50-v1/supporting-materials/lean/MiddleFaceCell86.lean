...
namespace MiddleFaceCell86

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0086`, spanning `[102861/100000, 102871/100000]`. -/
def brick : Brick where
  lamLo := 102861 / 100000
  lamHi := 102871 / 100000
  centers := ![2010163926489672289 / 10000000000000000000,
    3092447616696582943 / 10000000000000000000,
    290755546090447167 / 625000000000000000,
    5179674657138052247 / 10000000000000000000]
  slopes := ![1541810100069054619 / 1000000000000000000,
    2013037442516624089 / 500000000000000000,
    941029710766663493 / 200000000000000000,
    5850325750739323339 / 1000000000000000000]
  yXiSlope := 63778283 / 100000000
  vRhoSlope := 88082637 / 100000000
...
/-- Unconditional real-range conclusion for the B0086 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102861 / 100000 : ℝ) ≤ lam → lam ≤ 102871 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20092 / 100000 : ℝ) ≤ q ∧ q ≤ 20111 / 100000) :
    (199570 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (199758 / 1000000 : ℝ) := by
  have hmonoLo : sin (20092 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20111 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20092 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20111 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20092 / 100000 : ℝ) ≤ q ∧ q ≤ 20111 / 100000) :
    (979845 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979884 / 1000000 : ℝ) := by
  have hmonoLo : cos (20111 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20092 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20111 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20092 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30903 / 100000 : ℝ) ≤ q ∧ q ≤ 30946 / 100000) :
    (304134 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (304545 / 1000000 : ℝ) := by
  have hmonoLo : sin (30903 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30946 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30903 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30946 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30903 / 100000 : ℝ) ≤ q ∧ q ≤ 30946 / 100000) :
    (952498 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (952630 / 1000000 : ℝ) := by
  have hmonoLo : cos (30946 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30903 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30946 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30903 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46496 / 100000 : ℝ) ≤ q ∧ q ≤ 46546 / 100000) :
    (448387 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (448834 / 1000000 : ℝ) := by
  have hmonoLo : sin (46496 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46546 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46496 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46546 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51766 / 100000 : ℝ) ≤ q ∧ q ≤ 51827 / 100000) :
    (494848 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (495379 / 1000000 : ℝ) := by
  have hmonoLo : sin (51766 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51827 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51766 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51827 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51766 / 100000 : ℝ) ≤ q ∧ q ≤ 51827 / 100000) :
    (868677 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (868980 / 1000000 : ℝ) := by
  have hmonoLo : cos (51827 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51766 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51827 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51766 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20092000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20111000 / 100000000) :
    (19957000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19975800 / 100000000 : ℝ) ∧
      (97984500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97988400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20092000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20111000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20111000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20092000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30903000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30946000 / 100000000) :
    (30413400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30454500 / 100000000 : ℝ) ∧
      (95249800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95263000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30903000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30946000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30946000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30903000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46496000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46546000 / 100000000) :
    (44838700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44883400 / 100000000 : ℝ) ∧
      (89361500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89384000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46496000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46546000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46546000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46496000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51766000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51827000 / 100000000) :
    (49484800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49537900 / 100000000 : ℝ) ∧
      (86867700 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86898000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51766000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51827000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51827000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51766000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0086. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102861 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102871 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20092000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20111000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30903000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30946000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46496000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46546000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51766000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51827000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0086 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (519 / 1000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 233 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 519 / 1000, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (233 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (519 / 1000)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (233 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0086 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102861 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102871 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20092 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20111 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30903 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46496 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46546 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51766 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51827 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979884 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20092 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20092 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (893615 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46546 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46546 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (495379 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51827 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51827 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (448387 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46496 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46496 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102871 / 100000 : ℝ) * (51827 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102861 / 100000 : ℝ) * (30903 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16284 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16875 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979884 / 1000000 : ℝ) * (16284 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189361 / 100000 : ℝ) * (16875 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189361 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30903 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30946 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102861 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102871 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102861 / 100000 : ℝ) * (304134 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102871 / 100000 : ℝ) * (304545 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20092 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20111 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30903 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30946 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102861 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102871 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20092 / 100000, 20111 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30903 / 100000, 30946 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102861 / 100000, 102871 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨199570 / 1000000, 199758 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979845 / 1000000, 979884 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨304134 / 1000000, 304545 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨952498 / 1000000, 952630 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0086 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0086 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102871 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102861 / 100000 : ℝ) * (494848 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102871 / 100000 : ℝ) * (495379 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51766 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51827 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51766 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51827 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102861 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0086`.
...
/-- Sound projection of the B0086 checker instance into the generic
...
/-- Every projected type-(iv) height in B0086 has an equal-area regular
...
/-- Candidate-facing conclusion for B0086.  No stationarity hypothesis is
...
/-- Complete B0086 candidate-facing conclusion.  The checked stationary pair
