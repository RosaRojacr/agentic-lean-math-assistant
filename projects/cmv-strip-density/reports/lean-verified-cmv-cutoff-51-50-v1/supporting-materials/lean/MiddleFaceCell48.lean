...
namespace MiddleFaceCell48

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0048`, spanning `[102481/100000, 102491/100000]`. -/
def brick : Brick where
  lamLo := 102481 / 100000
  lamHi := 102491 / 100000
  centers := ![194722949290724437 / 1000000000000000000,
    2932731117446779617 / 10000000000000000000,
    4463411976019201597 / 10000000000000000000,
    4946140759315470993 / 10000000000000000000]
  slopes := ![1780573518168825857 / 1000000000000000000,
    878804821934151049 / 200000000000000000,
    524701704034495939 / 100000000000000000,
    1292977534799171209 / 200000000000000000]
  yXiSlope := 32654711 / 50000000
  vRhoSlope := 5545663 / 6250000
...
/-- Unconditional real-range conclusion for the B0048 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102481 / 100000 : ℝ) ≤ lam → lam ≤ 102491 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19462 / 100000 : ℝ) ≤ q ∧ q ≤ 19483 / 100000) :
    (193393 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (193600 / 1000000 : ℝ) := by
  have hmonoLo : sin (19462 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19483 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19462 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19483 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19462 / 100000 : ℝ) ≤ q ∧ q ≤ 19483 / 100000) :
    (981080 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (981122 / 1000000 : ℝ) := by
  have hmonoLo : cos (19483 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19462 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19483 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19462 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (29304 / 100000 : ℝ) ≤ q ∧ q ≤ 29351 / 100000) :
    (288863 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (289314 / 1000000 : ℝ) := by
  have hmonoLo : sin (29304 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (29351 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (29304 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (29351 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (29304 / 100000 : ℝ) ≤ q ∧ q ≤ 29351 / 100000) :
    (957234 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (957371 / 1000000 : ℝ) := by
  have hmonoLo : cos (29351 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (29304 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (29351 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (29304 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (44606 / 100000 : ℝ) ≤ q ∧ q ≤ 44662 / 100000) :
    (431414 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (431920 / 1000000 : ℝ) := by
  have hmonoLo : sin (44606 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (44662 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (44606 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (44662 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (49428 / 100000 : ℝ) ≤ q ∧ q ≤ 49495 / 100000) :
    (474397 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (474988 / 1000000 : ℝ) := by
  have hmonoLo : sin (49428 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (49495 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (49428 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (49495 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (49428 / 100000 : ℝ) ≤ q ∧ q ≤ 49495 / 100000) :
    (879992 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (880311 / 1000000 : ℝ) := by
  have hmonoLo : cos (49495 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (49428 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (49495 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (49428 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19462000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19483000 / 100000000) :
    (19339300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19360000 / 100000000 : ℝ) ∧
      (98108000 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98112200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19462000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19483000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19483000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19462000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (29304000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 29351000 / 100000000) :
    (28886300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (28931400 / 100000000 : ℝ) ∧
      (95723400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95737100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (29304000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (29351000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (29351000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (29304000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (44606000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 44662000 / 100000000) :
    (43141400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (43192000 / 100000000 : ℝ) ∧
      (90191200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (90215400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (44606000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (44662000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (44662000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (44606000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (49428000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 49495000 / 100000000) :
    (47439700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (47498800 / 100000000 : ℝ) ∧
      (87999200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (88031100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (49428000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (49495000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (49495000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (49428000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0048. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102481 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102491 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19462000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19483000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29304000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 29351000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (44606000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 44662000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (49428000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 49495000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0048 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 99 / 200, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (99 / 200)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0048 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102481 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102491 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19462 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19483 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (29304 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (44606 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (44662 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (49428 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (49495 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (981122 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19462 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19462 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (901912 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (44662 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (44662 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (474988 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (49495 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (49495 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (431414 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (44606 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (44606 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102491 / 100000 : ℝ) * (49495 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102481 / 100000 : ℝ) * (29304 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16232 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16762 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (981122 / 1000000 : ℝ) * (16232 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (190191 / 100000 : ℝ) * (16762 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (190191 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (29304 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 29351 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102481 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102491 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102481 / 100000 : ℝ) * (288863 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102491 / 100000 : ℝ) * (289314 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19462 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19483 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (29304 / 100000 : ℝ) ≤ yy ∧ yy ≤ 29351 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102481 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102491 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19462 / 100000, 19483 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨29304 / 100000, 29351 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102481 / 100000, 102491 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨193393 / 1000000, 193600 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨981080 / 1000000, 981122 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨288863 / 1000000, 289314 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨957234 / 1000000, 957371 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0048 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0048 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102491 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102481 / 100000 : ℝ) * (474397 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102491 / 100000 : ℝ) * (474988 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (49428 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 49495 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (49428 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 49495 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102481 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0048`.
...
/-- Sound projection of the B0048 checker instance into the generic
...
/-- Every projected type-(iv) height in B0048 has an equal-area regular
...
/-- Candidate-facing conclusion for B0048.  No stationarity hypothesis is
...
/-- Complete B0048 candidate-facing conclusion.  The checked stationary pair
