...
namespace MiddleFaceCell75

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0075`, spanning `[102751/100000, 102761/100000]`. -/
def brick : Brick where
  lamLo := 102751 / 100000
  lamHi := 102761 / 100000
  centers := ![996430527466595719 / 5000000000000000000,
    761906690483014529 / 2500000000000000000,
    1149887538709786663 / 2500000000000000000,
    5114431387500603891 / 10000000000000000000]
  slopes := ![100305821150674591 / 62500000000000000,
    4124188002358952209 / 1000000000000000000,
    2424450911858342003 / 500000000000000000,
    1202765364540192429 / 200000000000000000]
  yXiSlope := 32102837 / 50000000
  vRhoSlope := 11033149 / 12500000
...
/-- Unconditional real-range conclusion for the B0075 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102751 / 100000 : ℝ) ≤ lam → lam ≤ 102761 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19919 / 100000 : ℝ) ≤ q ∧ q ≤ 19938 / 100000) :
    (197875 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198062 / 1000000 : ℝ) := by
  have hmonoLo : sin (19919 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19938 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19919 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19938 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19919 / 100000 : ℝ) ≤ q ∧ q ≤ 19938 / 100000) :
    (980189 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980228 / 1000000 : ℝ) := by
  have hmonoLo : cos (19938 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19919 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19938 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19919 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30454 / 100000 : ℝ) ≤ q ∧ q ≤ 30498 / 100000) :
    (299854 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (300275 / 1000000 : ℝ) := by
  have hmonoLo : sin (30454 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30498 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30454 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30498 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30454 / 100000 : ℝ) ≤ q ∧ q ≤ 30498 / 100000) :
    (953852 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953985 / 1000000 : ℝ) := by
  have hmonoLo : cos (30498 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30454 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30498 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30454 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45970 / 100000 : ℝ) ≤ q ∧ q ≤ 46021 / 100000) :
    (443679 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (444137 / 1000000 : ℝ) := by
  have hmonoLo : sin (45970 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46021 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45970 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46021 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51113 / 100000 : ℝ) ≤ q ∧ q ≤ 51176 / 100000) :
    (489163 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (489713 / 1000000 : ℝ) := by
  have hmonoLo : sin (51113 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51176 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51113 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51176 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51113 / 100000 : ℝ) ≤ q ∧ q ≤ 51176 / 100000) :
    (871883 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (872193 / 1000000 : ℝ) := by
  have hmonoLo : cos (51176 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51113 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51176 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51113 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19919000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19938000 / 100000000) :
    (19787500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19806200 / 100000000 : ℝ) ∧
      (98018900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98022800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19919000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19938000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19938000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19919000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30454000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30498000 / 100000000) :
    (29985400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30027500 / 100000000 : ℝ) ∧
      (95385200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95398500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30454000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30498000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30498000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30454000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45970000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46021000 / 100000000) :
    (44367900 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44413700 / 100000000 : ℝ) ∧
      (89595900 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89618600 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45970000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46021000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46021000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45970000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51113000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51176000 / 100000000) :
    (48916300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48971300 / 100000000 : ℝ) ∧
      (87188300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87219300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51113000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51176000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51176000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51113000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0075. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102751 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102761 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19919000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19938000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30454000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30498000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45970000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46021000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51113000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51176000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0075 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 64 / 125, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (64 / 125)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0075 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102751 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102761 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19919 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19938 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30454 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45970 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46021 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51113 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51176 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980228 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19919 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19919 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (895959 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46021 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46021 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (489713 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51176 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51176 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (443679 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45970 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45970 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102761 / 100000 : ℝ) * (51176 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102751 / 100000 : ℝ) * (30454 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16270 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16843 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980228 / 1000000 : ℝ) * (16270 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189595 / 100000 : ℝ) * (16843 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189595 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30454 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30498 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102751 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102761 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102751 / 100000 : ℝ) * (299854 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102761 / 100000 : ℝ) * (300275 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19919 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19938 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30454 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30498 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102751 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102761 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19919 / 100000, 19938 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30454 / 100000, 30498 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102751 / 100000, 102761 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨197875 / 1000000, 198062 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980189 / 1000000, 980228 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨299854 / 1000000, 300275 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953852 / 1000000, 953985 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0075 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0075 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102761 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102751 / 100000 : ℝ) * (489163 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102761 / 100000 : ℝ) * (489713 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51113 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51176 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51113 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51176 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102751 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0075`.
...
/-- Sound projection of the B0075 checker instance into the generic
...
/-- Every projected type-(iv) height in B0075 has an equal-area regular
...
/-- Candidate-facing conclusion for B0075.  No stationarity hypothesis is
...
/-- Complete B0075 candidate-facing conclusion.  The checked stationary pair
