...
namespace MiddleFaceCell92

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0092`, spanning `[102921/100000, 102931/100000]`. -/
def brick : Brick where
  lamLo := 102921 / 100000
  lamHi := 102931 / 100000
  centers := ![1009658166329316991 / 5000000000000000000,
    1558225101636678227 / 5000000000000000000,
    4680094783882041437 / 10000000000000000000,
    5214520502797342451 / 10000000000000000000]
  slopes := ![754593610348996193 / 500000000000000000,
    795012297908390671 / 200000000000000000,
    4630625604322312079 / 1000000000000000000,
    2882712427959342939 / 500000000000000000]
  yXiSlope := 3971883 / 6250000
  vRhoSlope := 87984639 / 100000000
...
/-- Unconditional real-range conclusion for the B0092 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102921 / 100000 : ℝ) ≤ lam → lam ≤ 102931 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (20184 / 100000 : ℝ) ≤ q ∧ q ≤ 20202 / 100000) :
    (200472 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (200649 / 1000000 : ℝ) := by
  have hmonoLo : sin (20184 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (20202 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (20184 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (20202 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (20184 / 100000 : ℝ) ≤ q ∧ q ≤ 20202 / 100000) :
    (979663 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (979700 / 1000000 : ℝ) := by
  have hmonoLo : cos (20202 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (20184 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (20202 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (20184 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (31143 / 100000 : ℝ) ≤ q ∧ q ≤ 31186 / 100000) :
    (306420 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (306830 / 1000000 : ℝ) := by
  have hmonoLo : sin (31143 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (31186 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (31143 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (31186 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (31143 / 100000 : ℝ) ≤ q ∧ q ≤ 31186 / 100000) :
    (951764 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (951897 / 1000000 : ℝ) := by
  have hmonoLo : cos (31186 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (31143 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (31186 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (31143 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46776 / 100000 : ℝ) ≤ q ∧ q ≤ 46826 / 100000) :
    (450888 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (451335 / 1000000 : ℝ) := by
  have hmonoLo : sin (46776 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46826 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46776 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46826 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (52115 / 100000 : ℝ) ≤ q ∧ q ≤ 52176 / 100000) :
    (497877 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (498407 / 1000000 : ℝ) := by
  have hmonoLo : sin (52115 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (52176 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (52115 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (52176 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (52115 / 100000 : ℝ) ≤ q ∧ q ≤ 52176 / 100000) :
    (866943 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (867248 / 1000000 : ℝ) := by
  have hmonoLo : cos (52176 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (52115 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (52176 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (52115 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (20184000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 20202000 / 100000000) :
    (20047200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (20064900 / 100000000 : ℝ) ∧
      (97966300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (97970000 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (20184000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (20202000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (20202000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (20184000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (31143000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 31186000 / 100000000) :
    (30642000 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30683000 / 100000000 : ℝ) ∧
      (95176400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95189700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (31143000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (31186000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (31186000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (31143000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46776000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46826000 / 100000000) :
    (45088800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45133500 / 100000000 : ℝ) ∧
      (89235400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89258100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46776000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46826000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46826000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46776000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (52115000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 52176000 / 100000000) :
    (49787700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49840700 / 100000000 : ℝ) ∧
      (86694300 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (86724800 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (52115000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (52176000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (52176000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (52115000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0092. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102921 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102931 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (20184000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 20202000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31143000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 31186000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46776000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46826000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (52115000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 52176000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0092 brick. -/
...
throughout the B0092 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102921 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102931 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (20184 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (20202 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (31143 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46776 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46826 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (52115 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (52176 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (979700 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (20184 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (20184 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (892354 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46826 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46826 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (498407 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (52176 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (52176 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (450888 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46776 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46776 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102931 / 100000 : ℝ) * (52176 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102921 / 100000 : ℝ) * (31143 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16293 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16893 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (979700 / 1000000 : ℝ) * (16293 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189235 / 100000 : ℝ) * (16893 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189235 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (31143 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 31186 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102921 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102931 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102921 / 100000 : ℝ) * (306420 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102931 / 100000 : ℝ) * (306830 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (20184 / 100000 : ℝ) ≤ xx ∧ xx ≤ 20202 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (31143 / 100000 : ℝ) ≤ yy ∧ yy ≤ 31186 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102921 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102931 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨20184 / 100000, 20202 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨31143 / 100000, 31186 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102921 / 100000, 102931 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨200472 / 1000000, 200649 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨979663 / 1000000, 979700 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨306420 / 1000000, 306830 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨951764 / 1000000, 951897 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0092 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0092 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102931 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102921 / 100000 : ℝ) * (497877 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102931 / 100000 : ℝ) * (498407 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (52115 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 52176 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (52115 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 52176 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102921 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0092`.
...
/-- Sound projection of the B0092 checker instance into the generic
...
/-- Every projected type-(iv) height in B0092 has an equal-area regular
...
/-- Candidate-facing conclusion for B0092.  No stationarity hypothesis is
...
/-- Complete B0092 candidate-facing conclusion.  The checked stationary pair
