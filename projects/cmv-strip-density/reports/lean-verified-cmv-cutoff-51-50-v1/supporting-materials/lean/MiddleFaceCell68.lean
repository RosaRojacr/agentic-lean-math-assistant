...
namespace MiddleFaceCell68

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0068`, spanning `[102681/100000, 102691/100000]`. -/
def brick : Brick where
  lamLo := 102681 / 100000
  lamHi := 102691 / 100000
  centers := ![1981479062257451441 / 10000000000000000000,
    75463220262513087 / 250000000000000000,
    570658990728417961 / 1250000000000000000,
    5071953124461577993 / 10000000000000000000]
  slopes := ![411855603499582977 / 250000000000000000,
    4189955107583852187 / 1000000000000000000,
    24727840444441863 / 5000000000000000,
    382723652743966349 / 62500000000000000]
  yXiSlope := 8060511 / 12500000
  vRhoSlope := 17676681 / 20000000
...
/-- Unconditional real-range conclusion for the B0068 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102681 / 100000 : ℝ) ≤ lam → lam ≤ 102691 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19805 / 100000 : ℝ) ≤ q ∧ q ≤ 19825 / 100000) :
    (196757 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (196954 / 1000000 : ℝ) := by
  have hmonoLo : sin (19805 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19825 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19805 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19825 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19805 / 100000 : ℝ) ≤ q ∧ q ≤ 19825 / 100000) :
    (980412 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980453 / 1000000 : ℝ) := by
  have hmonoLo : cos (19825 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19805 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19825 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19805 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30163 / 100000 : ℝ) ≤ q ∧ q ≤ 30207 / 100000) :
    (297077 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (297498 / 1000000 : ℝ) := by
  have hmonoLo : sin (30163 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30207 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30163 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30207 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30163 / 100000 : ℝ) ≤ q ∧ q ≤ 30207 / 100000) :
    (954722 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (954854 / 1000000 : ℝ) := by
  have hmonoLo : cos (30207 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30163 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30207 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30163 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (45626 / 100000 : ℝ) ≤ q ∧ q ≤ 45679 / 100000) :
    (440593 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (441070 / 1000000 : ℝ) := by
  have hmonoLo : sin (45626 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (45679 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (45626 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (45679 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (50687 / 100000 : ℝ) ≤ q ∧ q ≤ 50752 / 100000) :
    (485443 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (486012 / 1000000 : ℝ) := by
  have hmonoLo : sin (50687 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (50752 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (50687 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (50752 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (50687 / 100000 : ℝ) ≤ q ∧ q ≤ 50752 / 100000) :
    (873952 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (874269 / 1000000 : ℝ) := by
  have hmonoLo : cos (50752 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (50687 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (50752 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (50687 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19805000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19825000 / 100000000) :
    (19675700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19695400 / 100000000 : ℝ) ∧
      (98041200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98045300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19805000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19825000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19825000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19805000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30163000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30207000 / 100000000) :
    (29707700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (29749800 / 100000000 : ℝ) ∧
      (95472200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95485400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30163000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30207000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30207000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30163000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (45626000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 45679000 / 100000000) :
    (44059300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44107000 / 100000000 : ℝ) ∧
      (89747200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89770700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (45626000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (45679000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (45679000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (45626000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (50687000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 50752000 / 100000000) :
    (48544300 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (48601200 / 100000000 : ℝ) ∧
      (87395200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87426900 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (50687000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (50752000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (50752000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (50687000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0068. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102681 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102691 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19805000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19825000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30163000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30207000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (45626000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 45679000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (50687000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 50752000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0068 brick. -/
...
theorem descendingK3 :
  ...
  have hvI :
      (⟨9 / 20, 127 / 250, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
  ...
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (127 / 250)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0068 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102681 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102691 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19805 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19825 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30163 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (45626 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (45679 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (50687 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (50752 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980453 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19805 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19805 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (897472 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (45679 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (45679 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (486012 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (50752 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (50752 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (440593 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (45626 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (45626 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102691 / 100000 : ℝ) * (50752 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102681 / 100000 : ℝ) * (30163 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16260 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16822 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980453 / 1000000 : ℝ) * (16260 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189747 / 100000 : ℝ) * (16822 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189747 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30163 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30207 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102681 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102691 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102681 / 100000 : ℝ) * (297077 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102691 / 100000 : ℝ) * (297498 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19805 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19825 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30163 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30207 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102681 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102691 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19805 / 100000, 19825 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30163 / 100000, 30207 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102681 / 100000, 102691 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨196757 / 1000000, 196954 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980412 / 1000000, 980453 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨297077 / 1000000, 297498 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨954722 / 1000000, 954854 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0068 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0068 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102691 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102681 / 100000 : ℝ) * (485443 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102691 / 100000 : ℝ) * (486012 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (50687 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 50752 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (50687 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 50752 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102681 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0068`.
...
/-- Sound projection of the B0068 checker instance into the generic
...
/-- Every projected type-(iv) height in B0068 has an equal-area regular
...
/-- Candidate-facing conclusion for B0068.  No stationarity hypothesis is
...
/-- Complete B0068 candidate-facing conclusion.  The checked stationary pair
