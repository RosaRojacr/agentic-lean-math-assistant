...
namespace MiddleFaceCell7

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0007`, spanning `[102071/100000, 102081/100000]`. -/
def brick : Brick where
  lamLo := 102071 / 100000
  lamHi := 102081 / 100000
  centers := ![933786550528354709 / 5000000000000000000,
    685636279192870323 / 2500000000000000000,
    4233328140416689233 / 10000000000000000000,
    4664232503216043577 / 10000000000000000000]
  slopes := ![530814305392352179 / 250000000000000000,
    2454062676839245573 / 500000000000000000,
    1203153357634777339 / 200000000000000000,
    366475663010691847 / 50000000000000000]
  yXiSlope := 6716309 / 10000000
  vRhoSlope := 44746663 / 50000000
...
/-- Unconditional real-range conclusion for the B0007 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102071 / 100000 : ℝ) ≤ lam → lam ≤ 102081 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (18664 / 100000 : ℝ) ≤ q ∧ q ≤ 18688 / 100000) :
    (185558 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (185795 / 1000000 : ℝ) := by
  have hmonoLo : sin (18664 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (18688 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (18664 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (18688 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (18664 / 100000 : ℝ) ≤ q ∧ q ≤ 18688 / 100000) :
    (982588 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (982634 / 1000000 : ℝ) := by
  have hmonoLo : cos (18688 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (18664 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (18688 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (18664 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (27400 / 100000 : ℝ) ≤ q ∧ q ≤ 27451 / 100000) :
    (270584 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (271076 / 1000000 : ℝ) := by
  have hmonoLo : sin (27400 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (27451 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (27400 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (27451 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (27400 / 100000 : ℝ) ≤ q ∧ q ≤ 27451 / 100000) :
    (962558 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (962697 / 1000000 : ℝ) := by
  have hmonoLo : cos (27451 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (27400 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (27451 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (27400 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (42302 / 100000 : ℝ) ≤ q ∧ q ≤ 42365 / 100000) :
    (410516 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (411091 / 1000000 : ℝ) := by
  have hmonoLo : sin (42302 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (42365 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (42302 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (42365 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (46604 / 100000 : ℝ) ≤ q ∧ q ≤ 46680 / 100000) :
    (449352 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (450031 / 1000000 : ℝ) := by
  have hmonoLo : sin (46604 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46680 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46604 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46680 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (46604 / 100000 : ℝ) ≤ q ∧ q ≤ 46680 / 100000) :
    (893012 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (893355 / 1000000 : ℝ) := by
  have hmonoLo : cos (46680 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (46604 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (46680 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (46604 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (18664000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 18688000 / 100000000) :
    (18555800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (18579500 / 100000000 : ℝ) ∧
      (98258800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98263400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (18664000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (18688000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (18688000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (18664000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (27400000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 27451000 / 100000000) :
    (27058400 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (27107600 / 100000000 : ℝ) ∧
      (96255800 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (96269700 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (27400000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (27451000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (27451000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (27400000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (42302000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 42365000 / 100000000) :
    (41051600 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (41109100 / 100000000 : ℝ) ∧
      (91159400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (91185400 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (42302000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (42365000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (42365000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (42302000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (46604000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46680000 / 100000000) :
    (44935200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (45003100 / 100000000 : ℝ) ∧
      (89301200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89335500 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46604000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46680000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46680000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46604000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0007. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102071 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102081 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (18664000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 18688000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27400000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 27451000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (42302000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 42365000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (46604000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 46680000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0007 brick. -/
...
B0007 cell.  Coarse rational ranges suffice, but every trigonometric
...
throughout the B0007 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102071 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102081 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (18664 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (18688 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (27400 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (42302 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (42365 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (46604 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (46680 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (982634 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (18664 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (18664 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (911594 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (42365 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (42365 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (450031 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (46680 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (46680 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (410516 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (42302 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (42302 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102081 / 100000 : ℝ) * (46680 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102071 / 100000 : ℝ) * (27400 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16174 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16635 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (982634 / 1000000 : ℝ) * (16174 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (191159 / 100000 : ℝ) * (16635 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (191159 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (27400 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 27451 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102071 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102081 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102071 / 100000 : ℝ) * (270584 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102081 / 100000 : ℝ) * (271076 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (18664 / 100000 : ℝ) ≤ xx ∧ xx ≤ 18688 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (27400 / 100000 : ℝ) ≤ yy ∧ yy ≤ 27451 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102071 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102081 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨18664 / 100000, 18688 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨27400 / 100000, 27451 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102071 / 100000, 102081 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨185558 / 1000000, 185795 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨982588 / 1000000, 982634 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨270584 / 1000000, 271076 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨962558 / 1000000, 962697 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0007 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0007 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102081 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102071 / 100000 : ℝ) * (449352 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102081 / 100000 : ℝ) * (450031 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (46604 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 46680 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (46604 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 46680 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102071 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0007`.
...
/-- Sound projection of the B0007 checker instance into the generic
...
/-- Every projected type-(iv) height in B0007 has an equal-area regular
...
/-- Candidate-facing conclusion for B0007.  No stationarity hypothesis is
...
/-- Complete B0007 candidate-facing conclusion.  The checked stationary pair
