...
namespace MiddleFaceCell78

abbrev Brick := MiddleFaceAssembly.Brick

/-- Exact inventory brick `B0078`, spanning `[102781/100000, 102791/100000]`. -/
def brick : Brick where
  lamLo := 102781 / 100000
  lamHi := 102791 / 100000
  centers := ![124853074554216433 / 625000000000000000,
    764989540307860549 / 2500000000000000000,
    4614036453782896111 / 10000000000000000000,
    2566202111107717781 / 5000000000000000000]
  slopes := ![1587249177575521427 / 1000000000000000000,
    4096815202826289933 / 1000000000000000000,
    4808740308949944641 / 1000000000000000000,
    5968183443819935673 / 1000000000000000000]
  yXiSlope := 64087911 / 100000000
  vRhoSlope := 88215023 / 100000000
...
/-- Unconditional real-range conclusion for the B0078 cell. -/
...
theorem brick_real_range :
    ∀ lam : ℝ, (102781 / 100000 : ℝ) ≤ lam → lam ≤ 102791 / 100000 →
      LeanSuffixAnalytic.InRetainedSuffix lam := by
  intro lam hlo hhi
...
private theorem c4_sin_x_range {q : ℝ}
    (hq : (19967 / 100000 : ℝ) ≤ q ∧ q ≤ 19986 / 100000) :
    (198345 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (198533 / 1000000 : ℝ) := by
  have hmonoLo : sin (19967 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (19986 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (19967 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (19986 / 100000)).2
...
private theorem c4_cos_x_range {q : ℝ}
    (hq : (19967 / 100000 : ℝ) ≤ q ∧ q ≤ 19986 / 100000) :
    (980094 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (980133 / 1000000 : ℝ) := by
  have hmonoLo : cos (19986 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (19967 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (19986 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (19967 / 100000)).2
...
private theorem c4_sin_y_range {q : ℝ}
    (hq : (30578 / 100000 : ℝ) ≤ q ∧ q ≤ 30621 / 100000) :
    (301037 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (301448 / 1000000 : ℝ) := by
  have hmonoLo : sin (30578 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (30621 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (30578 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (30621 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c4_cos_y_range {q : ℝ}
    (hq : (30578 / 100000 : ℝ) ≤ q ∧ q ≤ 30621 / 100000) :
    (953482 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (953613 / 1000000 : ℝ) := by
  have hmonoLo : cos (30621 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (30578 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (30621 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (30578 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_w_range {q : ℝ}
    (hq : (46115 / 100000 : ℝ) ≤ q ∧ q ≤ 46166 / 100000) :
    (444978 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (445435 / 1000000 : ℝ) := by
  have hmonoLo : sin (46115 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (46166 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (46115 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (46166 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_sin_v_range {q : ℝ}
    (hq : (51293 / 100000 : ℝ) ≤ q ∧ q ≤ 51355 / 100000) :
    (490732 / 1000000 : ℝ) ≤ sin q ∧
      sin q ≤ (491273 / 1000000 : ℝ) := by
  have hmonoLo : sin (51293 / 100000 : ℝ) ≤ sin q :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hmonoHi : sin q ≤ sin (51355 / 100000 : ℝ) :=
    Real.sin_le_sin_of_le_of_le_pi_div_two
      (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
  have hlo := (sinTaylor27Interval_sound (51293 / 100000)).1
  have hhi := (sinTaylor27Interval_sound (51355 / 100000)).2
  norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem c3_cos_v_range {q : ℝ}
    (hq : (51293 / 100000 : ℝ) ≤ q ∧ q ≤ 51355 / 100000) :
    (871005 / 1000000 : ℝ) ≤ cos q ∧
      cos q ≤ (871311 / 1000000 : ℝ) := by
  have hmonoLo : cos (51355 / 100000 : ℝ) ≤ cos q :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by linarith) (by linarith [Real.pi_gt_d6]) hq.2
  have hmonoHi : cos q ≤ cos (51293 / 100000 : ℝ) :=
    Real.cos_le_cos_of_nonneg_of_le_pi
      (by norm_num) (by linarith [Real.pi_gt_d6]) hq.1
  have hlo := (cosTaylor26Interval_sound (51355 / 100000)).1
  have hhi := (cosTaylor26Interval_sound (51293 / 100000)).2
  norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
    Nat.factorial] at hlo hhi
  constructor <;> norm_num <;> linarith
...
private theorem e_x_trig_range {q : ℝ}
    (hq : (19967000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 19986000 / 100000000) :
    (19834500 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (19853300 / 100000000 : ℝ) ∧
      (98009400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (98013300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (19967000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (19986000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (19986000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (19967000 / 100000000)).2
...
private theorem e_y_trig_range {q : ℝ}
    (hq : (30578000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 30621000 / 100000000) :
    (30103700 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (30144800 / 100000000 : ℝ) ∧
      (95348200 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (95361300 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (30578000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (30621000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (30621000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (30578000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_w_trig_range {q : ℝ}
    (hq : (46115000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 46166000 / 100000000) :
    (44497800 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (44543500 / 100000000 : ℝ) ∧
      (89531400 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (89554200 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (46115000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (46166000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (46166000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (46115000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
private theorem e_v_trig_range {q : ℝ}
    (hq : (51293000 / 100000000 : ℝ) ≤ q ∧
      q ≤ 51355000 / 100000000) :
    (49073200 / 100000000 : ℝ) ≤ sin q ∧
      sin q ≤ (49127300 / 100000000 : ℝ) ∧
      (87100500 / 100000000 : ℝ) ≤ cos q ∧
      cos q ≤ (87131100 / 100000000 : ℝ) := by
  have hslo := (sinTaylor27Interval_sound (51293000 / 100000000)).1
  have hshi := (sinTaylor27Interval_sound (51355000 / 100000000)).2
  have hclo := (cosTaylor26Interval_sound (51355000 / 100000000)).1
  have hchi := (cosTaylor26Interval_sound (51293000 / 100000000)).2
  have hsLoMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.1
  have hsHiMono := Real.sin_le_sin_of_le_of_le_pi_div_two
    (by linarith [Real.pi_pos]) (by linarith [Real.pi_gt_d6]) hq.2
...
directional derivatives of the equal-area residual on B0078. -/
set_option maxHeartbeats 1000000 in
...
private theorem eReduced_deriv_bounds {t xi eta rho sigma : ℝ}
  ...
  have hll : (102781 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102791 / 100000 := by
    dsimp [ll]
    norm_num [lamMid, brick]
    constructor <;> linarith
  have hxx : (19967000 / 100000000 : ℝ) ≤ xx ∧
      xx ≤ 19986000 / 100000000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30578000 / 100000000 : ℝ) ≤ yy ∧
      yy ≤ 30621000 / 100000000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hww : (46115000 / 100000000 : ℝ) ≤ ww ∧
      ww ≤ 46166000 / 100000000 := by
    dsimp [ww]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
  have hvv : (51293000 / 100000000 : ℝ) ≤ vv ∧
      vv ≤ 51355000 / 100000000 := by
    dsimp [vv]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    constructor <;> linarith
...
pairs throughout the B0078 brick. -/
...
theorem descendingK3 :
  ...
  have hvLo : (9 / 20 : ℝ) ≤ v p := by
    ...
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (257 / 500 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwI :
      (⟨2 / 5, 231 / 500, by norm_num⟩ : QInterval).RealContains (w p) := by
    constructor <;> norm_num <;> assumption
  have hvI :
      (⟨9 / 20, 257 / 500, by norm_num⟩ : QInterval).RealContains (v p) := by
    constructor <;> norm_num <;> assumption
  have hsw :
    ...
    · have h := (sinTaylor27Interval_sound (2 / 5)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (231 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  have hsv :
    ...
    · have h := (sinTaylor27Interval_sound (9 / 20)).1
      ...
      norm_num
      linarith
    · have h := (sinTaylor27Interval_sound (257 / 500)).2
      norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
  ...
  have hcw :
    ...
    · constructor <;> linarith [Real.pi_gt_d6]
    · have h := (cosTaylor26Interval_sound (231 / 500)).1
      norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
        Nat.factorial] at h
      norm_num
      linarith
...
throughout the B0078 brick.  The explicit negative margin keeps this
...
theorem gap_upper :
  ...
  norm_num [InSymmetricBox, radiiReal, brick, Matrix.cons_val_two,
    Matrix.cons_val_three] at hz0 hz1 hz2 hz3
  have hlamLo : (102781 / 100000 : ℝ) ≤ lam p := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hlamHi : lam p ≤ (102791 / 100000 : ℝ) := by
    dsimp [p, pointOf, lam]
    norm_num [lamMid, brick]
    linarith
  have hxLo : (19967 / 100000 : ℝ) ≤ x p := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hxHi : x p ≤ (19986 / 100000 : ℝ) := by
    dsimp [p, pointOf, x]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hyLo : (30578 / 100000 : ℝ) ≤ y p := by
    dsimp [p, pointOf, y]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwLo : (46115 / 100000 : ℝ) ≤ w p := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hwHi : w p ≤ (46166 / 100000 : ℝ) := by
    dsimp [p, pointOf, w]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvLo : (51293 / 100000 : ℝ) ≤ v p := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hvHi : v p ≤ (51355 / 100000 : ℝ) := by
    dsimp [p, pointOf, v]
    norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
    linarith
  have hcxHi : cos (x p) ≤ (980133 / 1000000 : ℝ) := by
    have hmono : cos (x p) ≤ cos (19967 / 100000 : ℝ) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by norm_num)
        (by linarith [Real.pi_gt_d6]) hxLo
    have h := (cosTaylor26Interval_sound (19967 / 100000)).2
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hcwLo : (895314 / 1000000 : ℝ) ≤ cos (w p) := by
    have hmono : cos (46166 / 100000 : ℝ) ≤ cos (w p) :=
      Real.cos_le_cos_of_nonneg_of_le_pi (by linarith)
        (by linarith [Real.pi_gt_d6]) hwHi
    have h := (cosTaylor26Interval_sound (46166 / 100000)).1
    norm_num [cosTaylor26Interval, cosTaylor26, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hsvHi : sin (v p) ≤ (491273 / 1000000 : ℝ) := by
    have hmono : sin (v p) ≤ sin (51355 / 100000 : ℝ) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hvHi
    have h := (sinTaylor27Interval_sound (51355 / 100000)).2
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hswLo : (444978 / 1000000 : ℝ) ≤ sin (w p) := by
    have hmono : sin (46115 / 100000 : ℝ) ≤ sin (w p) :=
      Real.sin_le_sin_of_le_of_le_pi_div_two (by linarith [Real.pi_pos])
        (by linarith [Real.pi_gt_d6]) hwLo
    have h := (sinTaylor27Interval_sound (46115 / 100000)).1
    norm_num [sinTaylor27Interval, sinTaylor27, Finset.sum_range_succ,
      Nat.factorial] at h
    linarith
  have hlamvHi : lam p * v p ≤
      (102791 / 100000 : ℝ) * (51355 / 100000 : ℝ) := by
    exact mul_le_mul hlamHi hvHi (by linarith) (by norm_num)
  have hlamyLo : (102781 / 100000 : ℝ) * (30578 / 100000 : ℝ) ≤
      lam p * y p := by
    exact mul_le_mul hlamLo hyLo (by norm_num) (by linarith)
  have hAHi : B3 p + D3 p < (16274 / 5000 : ℝ) := by
    unfold B3 D3
  ...
  have hBLo : (16852 / 10000 : ℝ) < B4 p := by
    unfold B4
    linarith [Real.pi_gt_d6]
  have hfirst : cos (x p) * (B3 p + D3 p) <
      (980133 / 1000000 : ℝ) * (16274 / 5000 : ℝ) := by
    ...
    nlinarith
  have hsecond : (189531 / 100000 : ℝ) * (16852 / 10000 : ℝ) <
      (1 + cos (w p)) * B4 p := by
    have hf : (189531 / 100000 : ℝ) < 1 + cos (w p) := by linarith
...
private theorem c4Reduced_derivativeBounds :
  ...
  have hyArg :
      (30578 / 100000 : ℝ) ≤
          (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ∧
        (brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta ≤ 30621 / 100000 := by
    norm_num [brick]
    constructor <;> linarith
  have hsx := c4_sin_x_range hxArg
  have hsy := c4_sin_y_range hyArg
  have hcy := c4_cos_y_range hyArg
  have hlamLo : (102781 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
    norm_num [lamMid, brick]
    linarith
  have hlamHi : (lamMid : ℝ) + t ≤ (102791 / 100000 : ℝ) := by
    norm_num [lamMid, brick]
    linarith
  have hprodLo :
      (102781 / 100000 : ℝ) * (301037 / 1000000 : ℝ) ≤
        ((lamMid : ℝ) + t) *
  ...
  have hprodHi :
      ((lamMid : ℝ) + t) *
          sin ((brick.centers 1 : ℝ) + brick.slopes 1 * t +
            brick.yXiSlope * xi + eta) ≤
        (102791 / 100000 : ℝ) * (301448 / 1000000 : ℝ) :=
...
private theorem fReducedDerivT_abs_le {q xi : ℝ}
  ...
  let yy := (brick.centers 1 : ℝ) + brick.slopes 1 * q +
    brick.yXiSlope * xi
  let ll := (lamMid : ℝ) + q
  have hxx : (19967 / 100000 : ℝ) ≤ xx ∧ xx ≤ 19986 / 100000 := by
    dsimp [xx]
    norm_num [brick]
    constructor <;> linarith
  have hyy : (30578 / 100000 : ℝ) ≤ yy ∧ yy ≤ 30621 / 100000 := by
    dsimp [yy]
    norm_num [brick]
    constructor <;> linarith
  have hll : (102781 / 100000 : ℝ) ≤ ll ∧ ll ≤ 102791 / 100000 := by
  ...
  let exx : CertificateExpr := .atom xx
    ⟨19967 / 100000, 19986 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hxx)
  let eyy : CertificateExpr := .atom yy
    ⟨30578 / 100000, 30621 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hyy)
  let ell : CertificateExpr := .atom ll
    ⟨102781 / 100000, 102791 / 100000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hll)
  let esx : CertificateExpr := .atom (sin xx)
    ⟨198345 / 1000000, 198533 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsx)
  let ecx : CertificateExpr := .atom (cos xx)
    ⟨980094 / 1000000, 980133 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hcx)
  let esy : CertificateExpr := .atom (sin yy)
    ⟨301037 / 1000000, 301448 / 1000000, by norm_num⟩
      (by simpa [LeanSuffixReflective.QInterval.RealContains] using hsy)
  let ecy : CertificateExpr := .atom (cos yy)
    ⟨953482 / 1000000, 953613 / 1000000, by norm_num⟩
...
margin `88 · 10⁻⁹` over the complete B0078 brick. -/
...
margin `86 · 10⁻⁹` over the complete B0078 brick. -/
...
private theorem c3Reduced_derivativeBounds :
  ...
  · have hwArg :
    ...
    have hlamHi : (lamMid : ℝ) + t ≤ (102791 / 100000 : ℝ) := by
      ...
      linarith
    have hprodLo :
        (102781 / 100000 : ℝ) * (490732 / 1000000 : ℝ) ≤
          ((lamMid : ℝ) + t) *
    ...
    have hprodHi :
        ((lamMid : ℝ) + t) *
            sin ((brick.centers 3 : ℝ) + brick.slopes 3 * t) ≤
          (102791 / 100000 : ℝ) * (491273 / 1000000 : ℝ) :=
    ...
    have hvArg :
        (51293 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho ≤ 51355 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsw := c3_sin_w_range hwArg
    have hsv := c3_sin_v_range hvArg
  ...
  · have hvArg :
        (51293 / 100000 : ℝ) ≤
            (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ∧
          (brick.centers 3 : ℝ) + brick.slopes 3 * t +
              brick.vRhoSlope * rho + sigma ≤ 51355 / 100000 := by
      norm_num [brick, Matrix.cons_val_two, Matrix.cons_val_three]
      constructor <;> linarith
    have hsv := c3_sin_v_range hvArg
    have hlamLo : (102781 / 100000 : ℝ) ≤ (lamMid : ℝ) + t := by
...
/-- Proof-producing checker instance for inventory brick `B0078`.
...
/-- Sound projection of the B0078 checker instance into the generic
...
/-- Every projected type-(iv) height in B0078 has an equal-area regular
...
/-- Candidate-facing conclusion for B0078.  No stationarity hypothesis is
...
/-- Complete B0078 candidate-facing conclusion.  The checked stationary pair
