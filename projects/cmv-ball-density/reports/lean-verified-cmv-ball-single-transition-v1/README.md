# A Lean-Verified Single-Transition Theorem for CMV Ball Density
...
primary declaration is `CMVBallCase.typeC_dominance_persists`. A successful Lean build establishes
