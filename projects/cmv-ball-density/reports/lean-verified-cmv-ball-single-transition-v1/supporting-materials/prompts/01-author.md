...
Write `/mnt/games/Math_Project/LeanExperiment/projects/cmv-ball-density/reports/lean-verified-cmv-ball-single-transition-v1/supporting-materials/reviews/author-01.json` as strict JSON with exactly:
{
  "schema_version": 1,
